...
int sipwxTreeCtrl::OnCompareItems(const  ::wxTreeItemId& item1,const  ::wxTreeItemId& item2)
{
    ...
    extern int sipVH__core_171(sip_gilstate_t, sipVirtErrorHandlerFunc, sipSimpleWrapper *, PyObject *, const  ::wxTreeItemId&,const  ::wxTreeItemId&);

    return sipVH__core_171(sipGILState, 0, sipPySelf, sipMeth, item1, item2);
}
...
static sipEncodedTypeDef supers_wxTreeCtrl[] = {{93, 255, 1}};
...
static PyMethodDef methods_wxTreeCtrl[] = {
    ...
    {SIP_MLNAME_CAST(sipName_AddChild), SIP_MLMETH_CAST(meth_wxTreeCtrl_AddChild), METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxTreeCtrl_AddChild)},
    {SIP_MLNAME_CAST(sipName_AddRoot), SIP_MLMETH_CAST(meth_wxTreeCtrl_AddRoot), METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxTreeCtrl_AddRoot)},
    {SIP_MLNAME_CAST(sipName_AppendItem), SIP_MLMETH_CAST(meth_wxTreeCtrl_AppendItem), METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxTreeCtrl_AppendItem)},
    {SIP_MLNAME_CAST(sipName_AssignImageList), SIP_MLMETH_CAST(meth_wxTreeCtrl_AssignImageList), METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxTreeCtrl_AssignImageList)},
    {SIP_MLNAME_CAST(sipName_AssignStateImageList), SIP_MLMETH_CAST(meth_wxTreeCtrl_AssignStateImageList), METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxTreeCtrl_AssignStateImageList)},
    ...
    {SIP_MLNAME_CAST(sipName_Collapse), SIP_MLMETH_CAST(meth_wxTreeCtrl_Collapse), METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxTreeCtrl_Collapse)},
    {SIP_MLNAME_CAST(sipName_CollapseAll), meth_wxTreeCtrl_CollapseAll, METH_VARARGS, SIP_MLDOC_CAST(doc_wxTreeCtrl_CollapseAll)},
    {SIP_MLNAME_CAST(sipName_CollapseAllChildren), SIP_MLMETH_CAST(meth_wxTreeCtrl_CollapseAllChildren), METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxTreeCtrl_CollapseAllChildren)},
    {SIP_MLNAME_CAST(sipName_CollapseAndReset), SIP_MLMETH_CAST(meth_wxTreeCtrl_CollapseAndReset), METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxTreeCtrl_CollapseAndReset)},
    {SIP_MLNAME_CAST(sipName_Create), SIP_MLMETH_CAST(meth_wxTreeCtrl_Create), METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxTreeCtrl_Create)},
    {SIP_MLNAME_CAST(sipName_Delete), SIP_MLMETH_CAST(meth_wxTreeCtrl_Delete), METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxTreeCtrl_Delete)},
    ...
    {SIP_MLNAME_CAST(sipName_DeleteChildren), SIP_MLMETH_CAST(meth_wxTreeCtrl_DeleteChildren), METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxTreeCtrl_DeleteChildren)},
    {SIP_MLNAME_CAST(sipName_Destroy), meth_wxTreeCtrl_Destroy, METH_VARARGS, SIP_MLDOC_CAST(doc_wxTreeCtrl_Destroy)},
    {SIP_MLNAME_CAST(sipName_DoEnable), SIP_MLMETH_CAST(meth_wxTreeCtrl_DoEnable), METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxTreeCtrl_DoEnable)},
    {SIP_MLNAME_CAST(sipName_DoFreeze), meth_wxTreeCtrl_DoFreeze, METH_VARARGS, SIP_MLDOC_CAST(doc_wxTreeCtrl_DoFreeze)},
    {SIP_MLNAME_CAST(sipName_DoGetBestClientSize), meth_wxTreeCtrl_DoGetBestClientSize, METH_VARARGS, SIP_MLDOC_CAST(doc_wxTreeCtrl_DoGetBestClientSize)},
    {SIP_MLNAME_CAST(sipName_DoGetBestSize), meth_wxTreeCtrl_DoGetBestSize, METH_VARARGS, SIP_MLDOC_CAST(doc_wxTreeCtrl_DoGetBestSize)},
    {SIP_MLNAME_CAST(sipName_DoGetBorderSize), meth_wxTreeCtrl_DoGetBorderSize, METH_VARARGS, SIP_MLDOC_CAST(doc_wxTreeCtrl_DoGetBorderSize)},
    {SIP_MLNAME_CAST(sipName_DoGetClientSize), SIP_MLMETH_CAST(meth_wxTreeCtrl_DoGetClientSize), METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxTreeCtrl_DoGetClientSize)},
    {SIP_MLNAME_CAST(sipName_DoGetPosition), SIP_MLMETH_CAST(meth_wxTreeCtrl_DoGetPosition), METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxTreeCtrl_DoGetPosition)},
    {SIP_MLNAME_CAST(sipName_DoGetSize), SIP_MLMETH_CAST(meth_wxTreeCtrl_DoGetSize), METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxTreeCtrl_DoGetSize)},
    {SIP_MLNAME_CAST(sipName_DoMoveWindow), SIP_MLMETH_CAST(meth_wxTreeCtrl_DoMoveWindow), METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxTreeCtrl_DoMoveWindow)},
    {SIP_MLNAME_CAST(sipName_DoSetClientSize), SIP_MLMETH_CAST(meth_wxTreeCtrl_DoSetClientSize), METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxTreeCtrl_DoSetClientSize)},
    {SIP_MLNAME_CAST(sipName_DoSetSize), SIP_MLMETH_CAST(meth_wxTreeCtrl_DoSetSize), METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxTreeCtrl_DoSetSize)},
    {SIP_MLNAME_CAST(sipName_DoSetSizeHints), SIP_MLMETH_CAST(meth_wxTreeCtrl_DoSetSizeHints), METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxTreeCtrl_DoSetSizeHints)},
    {SIP_MLNAME_CAST(sipName_DoSetWindowVariant), SIP_MLMETH_CAST(meth_wxTreeCtrl_DoSetWindowVariant), METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxTreeCtrl_DoSetWindowVariant)},
    {SIP_MLNAME_CAST(sipName_DoThaw), meth_wxTreeCtrl_DoThaw, METH_VARARGS, SIP_MLDOC_CAST(doc_wxTreeCtrl_DoThaw)},
    {SIP_MLNAME_CAST(sipName_EditLabel), SIP_MLMETH_CAST(meth_wxTreeCtrl_EditLabel), METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxTreeCtrl_EditLabel)},
    {SIP_MLNAME_CAST(sipName_EnableBellOnNoMatch), SIP_MLMETH_CAST(meth_wxTreeCtrl_EnableBellOnNoMatch), METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxTreeCtrl_EnableBellOnNoMatch)},
    {SIP_MLNAME_CAST(sipName_EnableSystemTheme), SIP_MLMETH_CAST(meth_wxTreeCtrl_EnableSystemTheme), METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxTreeCtrl_EnableSystemTheme)},
    {SIP_MLNAME_CAST(sipName_EndEditLabel), SIP_MLMETH_CAST(meth_wxTreeCtrl_EndEditLabel), METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxTreeCtrl_EndEditLabel)},
    {SIP_MLNAME_CAST(sipName_EnsureVisible), SIP_MLMETH_CAST(meth_wxTreeCtrl_EnsureVisible), METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxTreeCtrl_EnsureVisible)},
    {SIP_MLNAME_CAST(sipName_Expand), SIP_MLMETH_CAST(meth_wxTreeCtrl_Expand), METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxTreeCtrl_Expand)},
    {SIP_MLNAME_CAST(sipName_ExpandAll), meth_wxTreeCtrl_ExpandAll, METH_VARARGS, SIP_MLDOC_CAST(doc_wxTreeCtrl_ExpandAll)},
    {SIP_MLNAME_CAST(sipName_ExpandAllChildren), SIP_MLMETH_CAST(meth_wxTreeCtrl_ExpandAllChildren), METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxTreeCtrl_ExpandAllChildren)},
    {SIP_MLNAME_CAST(sipName_GetBoundingRect), SIP_MLMETH_CAST(meth_wxTreeCtrl_GetBoundingRect), METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxTreeCtrl_GetBoundingRect)},
    {SIP_MLNAME_CAST(sipName_GetChildrenCount), SIP_MLMETH_CAST(meth_wxTreeCtrl_GetChildrenCount), METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxTreeCtrl_GetChildrenCount)},
    {SIP_MLNAME_CAST(sipName_GetClassDefaultAttributes), SIP_MLMETH_CAST(meth_wxTreeCtrl_GetClassDefaultAttributes), METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxTreeCtrl_GetClassDefaultAttributes)},
    ...
    {SIP_MLNAME_CAST(sipName_GetDefaultBorder), meth_wxTreeCtrl_GetDefaultBorder, METH_VARARGS, SIP_MLDOC_CAST(doc_wxTreeCtrl_GetDefaultBorder)},
    {SIP_MLNAME_CAST(sipName_GetDefaultBorderForControl), meth_wxTreeCtrl_GetDefaultBorderForControl, METH_VARARGS, SIP_MLDOC_CAST(doc_wxTreeCtrl_GetDefaultBorderForControl)},
    ...
    {SIP_MLNAME_CAST(sipName_GetFirstChild), SIP_MLMETH_CAST(meth_wxTreeCtrl_GetFirstChild), METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxTreeCtrl_GetFirstChild)},
    ...
    {SIP_MLNAME_CAST(sipName_GetItemBackgroundColour), SIP_MLMETH_CAST(meth_wxTreeCtrl_GetItemBackgroundColour), METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxTreeCtrl_GetItemBackgroundColour)},
    {SIP_MLNAME_CAST(sipName_GetItemData), SIP_MLMETH_CAST(meth_wxTreeCtrl_GetItemData), METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxTreeCtrl_GetItemData)},
    {SIP_MLNAME_CAST(sipName_GetItemFont), SIP_MLMETH_CAST(meth_wxTreeCtrl_GetItemFont), METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxTreeCtrl_GetItemFont)},
    {SIP_MLNAME_CAST(sipName_GetItemImage), SIP_MLMETH_CAST(meth_wxTreeCtrl_GetItemImage), METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxTreeCtrl_GetItemImage)},
    {SIP_MLNAME_CAST(sipName_GetItemParent), SIP_MLMETH_CAST(meth_wxTreeCtrl_GetItemParent), METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxTreeCtrl_GetItemParent)},
    {SIP_MLNAME_CAST(sipName_GetItemState), SIP_MLMETH_CAST(meth_wxTreeCtrl_GetItemState), METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxTreeCtrl_GetItemState)},
    {SIP_MLNAME_CAST(sipName_GetItemText), SIP_MLMETH_CAST(meth_wxTreeCtrl_GetItemText), METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxTreeCtrl_GetItemText)},
    {SIP_MLNAME_CAST(sipName_GetItemTextColour), SIP_MLMETH_CAST(meth_wxTreeCtrl_GetItemTextColour), METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxTreeCtrl_GetItemTextColour)},
    {SIP_MLNAME_CAST(sipName_GetLastChild), SIP_MLMETH_CAST(meth_wxTreeCtrl_GetLastChild), METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxTreeCtrl_GetLastChild)},
    ...
    {SIP_MLNAME_CAST(sipName_GetNextChild), SIP_MLMETH_CAST(meth_wxTreeCtrl_GetNextChild), METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxTreeCtrl_GetNextChild)},
    {SIP_MLNAME_CAST(sipName_GetNextSibling), SIP_MLMETH_CAST(meth_wxTreeCtrl_GetNextSibling), METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxTreeCtrl_GetNextSibling)},
    {SIP_MLNAME_CAST(sipName_GetNextVisible), SIP_MLMETH_CAST(meth_wxTreeCtrl_GetNextVisible), METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxTreeCtrl_GetNextVisible)},
    {SIP_MLNAME_CAST(sipName_GetPrevSibling), SIP_MLMETH_CAST(meth_wxTreeCtrl_GetPrevSibling), METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxTreeCtrl_GetPrevSibling)},
    {SIP_MLNAME_CAST(sipName_GetPrevVisible), SIP_MLMETH_CAST(meth_wxTreeCtrl_GetPrevVisible), METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxTreeCtrl_GetPrevVisible)},
    ...
    {SIP_MLNAME_CAST(sipName_GetSpacing), meth_wxTreeCtrl_GetSpacing, METH_VARARGS, SIP_MLDOC_CAST(doc_wxTreeCtrl_GetSpacing)},
    ...
    {SIP_MLNAME_CAST(sipName_GetValidator), meth_wxTreeCtrl_GetValidator, METH_VARARGS, SIP_MLDOC_CAST(doc_wxTreeCtrl_GetValidator)},
    {SIP_MLNAME_CAST(sipName_HasTransparentBackground), meth_wxTreeCtrl_HasTransparentBackground, METH_VARARGS, SIP_MLDOC_CAST(doc_wxTreeCtrl_HasTransparentBackground)},
    {SIP_MLNAME_CAST(sipName_HitTest), SIP_MLMETH_CAST(meth_wxTreeCtrl_HitTest), METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxTreeCtrl_HitTest)},
    {SIP_MLNAME_CAST(sipName_InformFirstDirection), SIP_MLMETH_CAST(meth_wxTreeCtrl_InformFirstDirection), METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxTreeCtrl_InformFirstDirection)},
    ...
    {SIP_MLNAME_CAST(sipName_InsertItem), SIP_MLMETH_CAST(meth_wxTreeCtrl_InsertItem), METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxTreeCtrl_InsertItem)},
    {SIP_MLNAME_CAST(sipName_IsBold), SIP_MLMETH_CAST(meth_wxTreeCtrl_IsBold), METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxTreeCtrl_IsBold)},
    {SIP_MLNAME_CAST(sipName_IsEmpty), meth_wxTreeCtrl_IsEmpty, METH_VARARGS, SIP_MLDOC_CAST(doc_wxTreeCtrl_IsEmpty)},
    {SIP_MLNAME_CAST(sipName_IsExpanded), SIP_MLMETH_CAST(meth_wxTreeCtrl_IsExpanded), METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxTreeCtrl_IsExpanded)},
    {SIP_MLNAME_CAST(sipName_IsSelected), SIP_MLMETH_CAST(meth_wxTreeCtrl_IsSelected), METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxTreeCtrl_IsSelected)},
    {SIP_MLNAME_CAST(sipName_IsVisible), SIP_MLMETH_CAST(meth_wxTreeCtrl_IsVisible), METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxTreeCtrl_IsVisible)},
    {SIP_MLNAME_CAST(sipName_ItemHasChildren), SIP_MLMETH_CAST(meth_wxTreeCtrl_ItemHasChildren), METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxTreeCtrl_ItemHasChildren)},
    {SIP_MLNAME_CAST(sipName_OnCompareItems), SIP_MLMETH_CAST(meth_wxTreeCtrl_OnCompareItems), METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxTreeCtrl_OnCompareItems)},
    ...
    {SIP_MLNAME_CAST(sipName_PrependItem), SIP_MLMETH_CAST(meth_wxTreeCtrl_PrependItem), METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxTreeCtrl_PrependItem)},
    {SIP_MLNAME_CAST(sipName_ProcessEvent), SIP_MLMETH_CAST(meth_wxTreeCtrl_ProcessEvent), METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxTreeCtrl_ProcessEvent)},
    {SIP_MLNAME_CAST(sipName_RemoveChild), SIP_MLMETH_CAST(meth_wxTreeCtrl_RemoveChild), METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxTreeCtrl_RemoveChild)},
    {SIP_MLNAME_CAST(sipName_ScrollTo), SIP_MLMETH_CAST(meth_wxTreeCtrl_ScrollTo), METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxTreeCtrl_ScrollTo)},
    {SIP_MLNAME_CAST(sipName_SelectChildren), SIP_MLMETH_CAST(meth_wxTreeCtrl_SelectChildren), METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxTreeCtrl_SelectChildren)},
    {SIP_MLNAME_CAST(sipName_SelectItem), SIP_MLMETH_CAST(meth_wxTreeCtrl_SelectItem), METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxTreeCtrl_SelectItem)},
    {SIP_MLNAME_CAST(sipName_SendDestroyEvent), meth_wxTreeCtrl_SendDestroyEvent, METH_VARARGS, SIP_NULLPTR},
    {SIP_MLNAME_CAST(sipName_SetCanFocus), SIP_MLMETH_CAST(meth_wxTreeCtrl_SetCanFocus), METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxTreeCtrl_SetCanFocus)},
    {SIP_MLNAME_CAST(sipName_SetFocusedItem), SIP_MLMETH_CAST(meth_wxTreeCtrl_SetFocusedItem), METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxTreeCtrl_SetFocusedItem)},
    {SIP_MLNAME_CAST(sipName_SetImageList), SIP_MLMETH_CAST(meth_wxTreeCtrl_SetImageList), METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxTreeCtrl_SetImageList)},
    {SIP_MLNAME_CAST(sipName_SetIndent), SIP_MLMETH_CAST(meth_wxTreeCtrl_SetIndent), METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxTreeCtrl_SetIndent)},
    {SIP_MLNAME_CAST(sipName_SetItemBackgroundColour), SIP_MLMETH_CAST(meth_wxTreeCtrl_SetItemBackgroundColour), METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxTreeCtrl_SetItemBackgroundColour)},
    {SIP_MLNAME_CAST(sipName_SetItemBold), SIP_MLMETH_CAST(meth_wxTreeCtrl_SetItemBold), METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxTreeCtrl_SetItemBold)},
    {SIP_MLNAME_CAST(sipName_SetItemData), SIP_MLMETH_CAST(meth_wxTreeCtrl_SetItemData), METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxTreeCtrl_SetItemData)},
    {SIP_MLNAME_CAST(sipName_SetItemDropHighlight), SIP_MLMETH_CAST(meth_wxTreeCtrl_SetItemDropHighlight), METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxTreeCtrl_SetItemDropHighlight)},
    {SIP_MLNAME_CAST(sipName_SetItemFont), SIP_MLMETH_CAST(meth_wxTreeCtrl_SetItemFont), METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxTreeCtrl_SetItemFont)},
    {SIP_MLNAME_CAST(sipName_SetItemHasChildren), SIP_MLMETH_CAST(meth_wxTreeCtrl_SetItemHasChildren), METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxTreeCtrl_SetItemHasChildren)},
    {SIP_MLNAME_CAST(sipName_SetItemImage), SIP_MLMETH_CAST(meth_wxTreeCtrl_SetItemImage), METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxTreeCtrl_SetItemImage)},
    {SIP_MLNAME_CAST(sipName_SetItemState), SIP_MLMETH_CAST(meth_wxTreeCtrl_SetItemState), METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxTreeCtrl_SetItemState)},
    {SIP_MLNAME_CAST(sipName_SetItemText), SIP_MLMETH_CAST(meth_wxTreeCtrl_SetItemText), METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxTreeCtrl_SetItemText)},
    {SIP_MLNAME_CAST(sipName_SetItemTextColour), SIP_MLMETH_CAST(meth_wxTreeCtrl_SetItemTextColour), METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxTreeCtrl_SetItemTextColour)},
    {SIP_MLNAME_CAST(sipName_SetQuickBestSize), SIP_MLMETH_CAST(meth_wxTreeCtrl_SetQuickBestSize), METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxTreeCtrl_SetQuickBestSize)},
    {SIP_MLNAME_CAST(sipName_SetSpacing), SIP_MLMETH_CAST(meth_wxTreeCtrl_SetSpacing), METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxTreeCtrl_SetSpacing)},
    {SIP_MLNAME_CAST(sipName_SetStateImageList), SIP_MLMETH_CAST(meth_wxTreeCtrl_SetStateImageList), METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxTreeCtrl_SetStateImageList)},
    {SIP_MLNAME_CAST(sipName_SetValidator), SIP_MLMETH_CAST(meth_wxTreeCtrl_SetValidator), METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxTreeCtrl_SetValidator)},
    {SIP_MLNAME_CAST(sipName_SetWindowStyle), SIP_MLMETH_CAST(meth_wxTreeCtrl_SetWindowStyle), METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxTreeCtrl_SetWindowStyle)},
    ...
    {SIP_MLNAME_CAST(sipName_SortChildren), SIP_MLMETH_CAST(meth_wxTreeCtrl_SortChildren), METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxTreeCtrl_SortChildren)},
    {SIP_MLNAME_CAST(sipName_Toggle), SIP_MLMETH_CAST(meth_wxTreeCtrl_Toggle), METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxTreeCtrl_Toggle)},
    {SIP_MLNAME_CAST(sipName_ToggleItemSelection), SIP_MLMETH_CAST(meth_wxTreeCtrl_ToggleItemSelection), METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxTreeCtrl_ToggleItemSelection)},
    ...
    {SIP_MLNAME_CAST(sipName_TryAfter), SIP_MLMETH_CAST(meth_wxTreeCtrl_TryAfter), METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxTreeCtrl_TryAfter)},
    {SIP_MLNAME_CAST(sipName_TryBefore), SIP_MLMETH_CAST(meth_wxTreeCtrl_TryBefore), METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxTreeCtrl_TryBefore)},
    ...
    {SIP_MLNAME_CAST(sipName_UnselectItem), SIP_MLMETH_CAST(meth_wxTreeCtrl_UnselectItem), METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxTreeCtrl_UnselectItem)},
...
sipVariableDef variables_wxTreeCtrl[] = {
    {PropertyVariable, sipName_StateImageList, &methods_wxTreeCtrl[73], &methods_wxTreeCtrl[112], SIP_NULLPTR, SIP_NULLPTR},
    {PropertyVariable, sipName_Spacing, &methods_wxTreeCtrl[72], &methods_wxTreeCtrl[111], SIP_NULLPTR, SIP_NULLPTR},
    {PropertyVariable, sipName_Selections, &methods_wxTreeCtrl[71], SIP_NULLPTR, SIP_NULLPTR, SIP_NULLPTR},
    {PropertyVariable, sipName_Selection, &methods_wxTreeCtrl[70], SIP_NULLPTR, SIP_NULLPTR, SIP_NULLPTR},
    {PropertyVariable, sipName_RootItem, &methods_wxTreeCtrl[69], SIP_NULLPTR, SIP_NULLPTR, SIP_NULLPTR},
    {PropertyVariable, sipName_QuickBestSize, &methods_wxTreeCtrl[68], &methods_wxTreeCtrl[110], SIP_NULLPTR, SIP_NULLPTR},
    {PropertyVariable, sipName_Indent, &methods_wxTreeCtrl[52], &methods_wxTreeCtrl[99], SIP_NULLPTR, SIP_NULLPTR},
    {PropertyVariable, sipName_ImageList, &methods_wxTreeCtrl[51], &methods_wxTreeCtrl[98], SIP_NULLPTR, SIP_NULLPTR},
    {PropertyVariable, sipName_FocusedItem, &methods_wxTreeCtrl[50], &methods_wxTreeCtrl[97], SIP_NULLPTR, SIP_NULLPTR},
    {PropertyVariable, sipName_FirstVisibleItem, &methods_wxTreeCtrl[49], SIP_NULLPTR, SIP_NULLPTR, SIP_NULLPTR},
    {PropertyVariable, sipName_EditControl, &methods_wxTreeCtrl[47], SIP_NULLPTR, SIP_NULLPTR, SIP_NULLPTR},
