...
bool sipwxRichTextCtrl::CanRedo() const
{
    ...
    sipMeth = sipIsPyMethod(&sipGILState,const_cast<char *>(&sipPyMethods[0]),sipPySelf,SIP_NULLPTR,sipName_CanRedo);
...
bool sipwxRichTextCtrl::CanUndo() const
{
    ...
    sipMeth = sipIsPyMethod(&sipGILState,const_cast<char *>(&sipPyMethods[1]),sipPySelf,SIP_NULLPTR,sipName_CanUndo);
...
bool sipwxRichTextCtrl::CanPaste() const
{
    ...
    sipMeth = sipIsPyMethod(&sipGILState,const_cast<char *>(&sipPyMethods[4]),sipPySelf,SIP_NULLPTR,sipName_CanPaste);
...
bool sipwxRichTextCtrl::CanCut() const
{
    ...
    sipMeth = sipIsPyMethod(&sipGILState,const_cast<char *>(&sipPyMethods[5]),sipPySelf,SIP_NULLPTR,sipName_CanCut);
...
bool sipwxRichTextCtrl::CanCopy() const
{
    ...
    sipMeth = sipIsPyMethod(&sipGILState,const_cast<char *>(&sipPyMethods[6]),sipPySelf,SIP_NULLPTR,sipName_CanCopy);
...
void sipwxRichTextCtrl::DoMoveWindow(int x,int y,int width,int height)
{
 ...
 ::wxSize sipwxRichTextCtrl::DoGetBorderSize() const
{
    sip_gilstate_t sipGILState;
    PyObject *sipMeth;
    ...
    if (!sipMeth)
        return  ::wxRichTextCtrl::DoGetBorderSize();
...
void sipwxRichTextCtrl::sipProtectVirt_DoSetSizeHints(bool sipSelfWasArg,int minW,int minH,int maxW,int maxH,int incW,int incH)
{
 ...
 ::wxSize sipwxRichTextCtrl::sipProtectVirt_DoGetBorderSize(bool sipSelfWasArg) const
{
    return (sipSelfWasArg ?  ::wxRichTextCtrl::DoGetBorderSize() : DoGetBorderSize());
}
...
PyDoc_STRVAR(doc_wxRichTextCtrl_DoGetBorderSize, "DoGetBorderSize(self) -> Size");

extern "C" {static PyObject *meth_wxRichTextCtrl_DoGetBorderSize(PyObject *, PyObject *);}
static PyObject *meth_wxRichTextCtrl_DoGetBorderSize(PyObject *sipSelf, PyObject *sipArgs)
{
    PyObject *sipParseErr = SIP_NULLPTR;
    bool sipSelfWasArg = (!sipSelf || sipIsDerivedClass((sipSimpleWrapper *)sipSelf));
    ...
    /* Raise an exception if the arguments couldn't be parsed. */
    sipNoMethod(sipParseErr, sipName_RichTextCtrl, sipName_DoGetBorderSize, doc_wxRichTextCtrl_DoGetBorderSize);
...
static PyMethodDef methods_wxRichTextCtrl[] = {
    {SIP_MLNAME_CAST(sipName_AcceptsFocus), meth_wxRichTextCtrl_AcceptsFocus, METH_VARARGS, SIP_MLDOC_CAST(doc_wxRichTextCtrl_AcceptsFocus)},
    {SIP_MLNAME_CAST(sipName_AcceptsFocusFromKeyboard), meth_wxRichTextCtrl_AcceptsFocusFromKeyboard, METH_VARARGS, SIP_MLDOC_CAST(doc_wxRichTextCtrl_AcceptsFocusFromKeyboard)},
    {SIP_MLNAME_CAST(sipName_AcceptsFocusRecursively), meth_wxRichTextCtrl_AcceptsFocusRecursively, METH_VARARGS, SIP_MLDOC_CAST(doc_wxRichTextCtrl_AcceptsFocusRecursively)},
    {SIP_MLNAME_CAST(sipName_AddChild), SIP_MLMETH_CAST(meth_wxRichTextCtrl_AddChild), METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxRichTextCtrl_AddChild)},
    {SIP_MLNAME_CAST(sipName_AddImage), SIP_MLMETH_CAST(meth_wxRichTextCtrl_AddImage), METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxRichTextCtrl_AddImage)},
    {SIP_MLNAME_CAST(sipName_AddParagraph), SIP_MLMETH_CAST(meth_wxRichTextCtrl_AddParagraph), METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxRichTextCtrl_AddParagraph)},
    {SIP_MLNAME_CAST(sipName_AppendText), SIP_MLMETH_CAST(meth_wxRichTextCtrl_AppendText), METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxRichTextCtrl_AppendText)},
    {SIP_MLNAME_CAST(sipName_ApplyAlignmentToSelection), SIP_MLMETH_CAST(meth_wxRichTextCtrl_ApplyAlignmentToSelection), METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxRichTextCtrl_ApplyAlignmentToSelection)},
    {SIP_MLNAME_CAST(sipName_ApplyBoldToSelection), meth_wxRichTextCtrl_ApplyBoldToSelection, METH_VARARGS, SIP_MLDOC_CAST(doc_wxRichTextCtrl_ApplyBoldToSelection)},
    {SIP_MLNAME_CAST(sipName_ApplyItalicToSelection), meth_wxRichTextCtrl_ApplyItalicToSelection, METH_VARARGS, SIP_MLDOC_CAST(doc_wxRichTextCtrl_ApplyItalicToSelection)},
    {SIP_MLNAME_CAST(sipName_ApplyStyle), SIP_MLMETH_CAST(meth_wxRichTextCtrl_ApplyStyle), METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxRichTextCtrl_ApplyStyle)},
    {SIP_MLNAME_CAST(sipName_ApplyStyleSheet), SIP_MLMETH_CAST(meth_wxRichTextCtrl_ApplyStyleSheet), METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxRichTextCtrl_ApplyStyleSheet)},
    {SIP_MLNAME_CAST(sipName_ApplyTextEffectToSelection), SIP_MLMETH_CAST(meth_wxRichTextCtrl_ApplyTextEffectToSelection), METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxRichTextCtrl_ApplyTextEffectToSelection)},
    {SIP_MLNAME_CAST(sipName_ApplyUnderlineToSelection), meth_wxRichTextCtrl_ApplyUnderlineToSelection, METH_VARARGS, SIP_MLDOC_CAST(doc_wxRichTextCtrl_ApplyUnderlineToSelection)},
    {SIP_MLNAME_CAST(sipName_AutoComplete), SIP_MLMETH_CAST(meth_wxRichTextCtrl_AutoComplete), METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxRichTextCtrl_AutoComplete)},
    {SIP_MLNAME_CAST(sipName_AutoCompleteDirectories), meth_wxRichTextCtrl_AutoCompleteDirectories, METH_VARARGS, SIP_MLDOC_CAST(doc_wxRichTextCtrl_AutoCompleteDirectories)},
    {SIP_MLNAME_CAST(sipName_AutoCompleteFileNames), meth_wxRichTextCtrl_AutoCompleteFileNames, METH_VARARGS, SIP_MLDOC_CAST(doc_wxRichTextCtrl_AutoCompleteFileNames)},
    {SIP_MLNAME_CAST(sipName_BatchingUndo), meth_wxRichTextCtrl_BatchingUndo, METH_VARARGS, SIP_MLDOC_CAST(doc_wxRichTextCtrl_BatchingUndo)},
    {SIP_MLNAME_CAST(sipName_BeginAlignment), SIP_MLMETH_CAST(meth_wxRichTextCtrl_BeginAlignment), METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxRichTextCtrl_BeginAlignment)},
    {SIP_MLNAME_CAST(sipName_BeginBatchUndo), SIP_MLMETH_CAST(meth_wxRichTextCtrl_BeginBatchUndo), METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxRichTextCtrl_BeginBatchUndo)},
    {SIP_MLNAME_CAST(sipName_BeginBold), meth_wxRichTextCtrl_BeginBold, METH_VARARGS, SIP_MLDOC_CAST(doc_wxRichTextCtrl_BeginBold)},
    {SIP_MLNAME_CAST(sipName_BeginCharacterStyle), SIP_MLMETH_CAST(meth_wxRichTextCtrl_BeginCharacterStyle), METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxRichTextCtrl_BeginCharacterStyle)},
    {SIP_MLNAME_CAST(sipName_BeginFont), SIP_MLMETH_CAST(meth_wxRichTextCtrl_BeginFont), METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxRichTextCtrl_BeginFont)},
    {SIP_MLNAME_CAST(sipName_BeginFontSize), SIP_MLMETH_CAST(meth_wxRichTextCtrl_BeginFontSize), METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxRichTextCtrl_BeginFontSize)},
    {SIP_MLNAME_CAST(sipName_BeginItalic), meth_wxRichTextCtrl_BeginItalic, METH_VARARGS, SIP_MLDOC_CAST(doc_wxRichTextCtrl_BeginItalic)},
    {SIP_MLNAME_CAST(sipName_BeginLeftIndent), SIP_MLMETH_CAST(meth_wxRichTextCtrl_BeginLeftIndent), METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxRichTextCtrl_BeginLeftIndent)},
    {SIP_MLNAME_CAST(sipName_BeginLineSpacing), SIP_MLMETH_CAST(meth_wxRichTextCtrl_BeginLineSpacing), METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxRichTextCtrl_BeginLineSpacing)},
    {SIP_MLNAME_CAST(sipName_BeginListStyle), SIP_MLMETH_CAST(meth_wxRichTextCtrl_BeginListStyle), METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxRichTextCtrl_BeginListStyle)},
    {SIP_MLNAME_CAST(sipName_BeginNumberedBullet), SIP_MLMETH_CAST(meth_wxRichTextCtrl_BeginNumberedBullet), METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxRichTextCtrl_BeginNumberedBullet)},
    {SIP_MLNAME_CAST(sipName_BeginParagraphSpacing), SIP_MLMETH_CAST(meth_wxRichTextCtrl_BeginParagraphSpacing), METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxRichTextCtrl_BeginParagraphSpacing)},
    {SIP_MLNAME_CAST(sipName_BeginParagraphStyle), SIP_MLMETH_CAST(meth_wxRichTextCtrl_BeginParagraphStyle), METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxRichTextCtrl_BeginParagraphStyle)},
    {SIP_MLNAME_CAST(sipName_BeginRightIndent), SIP_MLMETH_CAST(meth_wxRichTextCtrl_BeginRightIndent), METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxRichTextCtrl_BeginRightIndent)},
    {SIP_MLNAME_CAST(sipName_BeginStandardBullet), SIP_MLMETH_CAST(meth_wxRichTextCtrl_BeginStandardBullet), METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxRichTextCtrl_BeginStandardBullet)},
    {SIP_MLNAME_CAST(sipName_BeginStyle), SIP_MLMETH_CAST(meth_wxRichTextCtrl_BeginStyle), METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxRichTextCtrl_BeginStyle)},
    {SIP_MLNAME_CAST(sipName_BeginSuppressUndo), meth_wxRichTextCtrl_BeginSuppressUndo, METH_VARARGS, SIP_MLDOC_CAST(doc_wxRichTextCtrl_BeginSuppressUndo)},
    {SIP_MLNAME_CAST(sipName_BeginSymbolBullet), SIP_MLMETH_CAST(meth_wxRichTextCtrl_BeginSymbolBullet), METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxRichTextCtrl_BeginSymbolBullet)},
    {SIP_MLNAME_CAST(sipName_BeginTextColour), SIP_MLMETH_CAST(meth_wxRichTextCtrl_BeginTextColour), METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxRichTextCtrl_BeginTextColour)},
    {SIP_MLNAME_CAST(sipName_BeginURL), SIP_MLMETH_CAST(meth_wxRichTextCtrl_BeginURL), METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxRichTextCtrl_BeginURL)},
    {SIP_MLNAME_CAST(sipName_BeginUnderline), meth_wxRichTextCtrl_BeginUnderline, METH_VARARGS, SIP_MLDOC_CAST(doc_wxRichTextCtrl_BeginUnderline)},
    {SIP_MLNAME_CAST(sipName_CanCopy), meth_wxRichTextCtrl_CanCopy, METH_VARARGS, SIP_MLDOC_CAST(doc_wxRichTextCtrl_CanCopy)},
    {SIP_MLNAME_CAST(sipName_CanCut), meth_wxRichTextCtrl_CanCut, METH_VARARGS, SIP_MLDOC_CAST(doc_wxRichTextCtrl_CanCut)},
    {SIP_MLNAME_CAST(sipName_CanDeleteRange), SIP_MLMETH_CAST(meth_wxRichTextCtrl_CanDeleteRange), METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxRichTextCtrl_CanDeleteRange)},
    {SIP_MLNAME_CAST(sipName_CanDeleteSelection), meth_wxRichTextCtrl_CanDeleteSelection, METH_VARARGS, SIP_MLDOC_CAST(doc_wxRichTextCtrl_CanDeleteSelection)},
    {SIP_MLNAME_CAST(sipName_CanEditProperties), SIP_MLMETH_CAST(meth_wxRichTextCtrl_CanEditProperties), METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxRichTextCtrl_CanEditProperties)},
    {SIP_MLNAME_CAST(sipName_CanInsertContent), SIP_MLMETH_CAST(meth_wxRichTextCtrl_CanInsertContent), METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxRichTextCtrl_CanInsertContent)},
    {SIP_MLNAME_CAST(sipName_CanPaste), meth_wxRichTextCtrl_CanPaste, METH_VARARGS, SIP_MLDOC_CAST(doc_wxRichTextCtrl_CanPaste)},
    {SIP_MLNAME_CAST(sipName_CanRedo), meth_wxRichTextCtrl_CanRedo, METH_VARARGS, SIP_MLDOC_CAST(doc_wxRichTextCtrl_CanRedo)},
    {SIP_MLNAME_CAST(sipName_CanUndo), meth_wxRichTextCtrl_CanUndo, METH_VARARGS, SIP_MLDOC_CAST(doc_wxRichTextCtrl_CanUndo)},
    {SIP_MLNAME_CAST(sipName_ChangeValue), SIP_MLMETH_CAST(meth_wxRichTextCtrl_ChangeValue), METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxRichTextCtrl_ChangeValue)},
    {SIP_MLNAME_CAST(sipName_Clear), meth_wxRichTextCtrl_Clear, METH_VARARGS, SIP_MLDOC_CAST(doc_wxRichTextCtrl_Clear)},
    {SIP_MLNAME_CAST(sipName_ClearAvailableFontNames), meth_wxRichTextCtrl_ClearAvailableFontNames, METH_VARARGS, SIP_MLDOC_CAST(doc_wxRichTextCtrl_ClearAvailableFontNames)},
    {SIP_MLNAME_CAST(sipName_ClearListStyle), SIP_MLMETH_CAST(meth_wxRichTextCtrl_ClearListStyle), METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxRichTextCtrl_ClearListStyle)},
    {SIP_MLNAME_CAST(sipName_Command), SIP_MLMETH_CAST(meth_wxRichTextCtrl_Command), METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxRichTextCtrl_Command)},
    {SIP_MLNAME_CAST(sipName_Copy), meth_wxRichTextCtrl_Copy, METH_VARARGS, SIP_MLDOC_CAST(doc_wxRichTextCtrl_Copy)},
    {SIP_MLNAME_CAST(sipName_Create), SIP_MLMETH_CAST(meth_wxRichTextCtrl_Create), METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxRichTextCtrl_Create)},
    {SIP_MLNAME_CAST(sipName_Cut), meth_wxRichTextCtrl_Cut, METH_VARARGS, SIP_MLDOC_CAST(doc_wxRichTextCtrl_Cut)},
    {SIP_MLNAME_CAST(sipName_Delete), SIP_MLMETH_CAST(meth_wxRichTextCtrl_Delete), METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxRichTextCtrl_Delete)},
    {SIP_MLNAME_CAST(sipName_DeleteSelectedContent), SIP_MLMETH_CAST(meth_wxRichTextCtrl_DeleteSelectedContent), METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxRichTextCtrl_DeleteSelectedContent)},
    {SIP_MLNAME_CAST(sipName_DeleteSelection), meth_wxRichTextCtrl_DeleteSelection, METH_VARARGS, SIP_MLDOC_CAST(doc_wxRichTextCtrl_DeleteSelection)},
    {SIP_MLNAME_CAST(sipName_Destroy), meth_wxRichTextCtrl_Destroy, METH_VARARGS, SIP_MLDOC_CAST(doc_wxRichTextCtrl_Destroy)},
    {SIP_MLNAME_CAST(sipName_DiscardEdits), meth_wxRichTextCtrl_DiscardEdits, METH_VARARGS, SIP_MLDOC_CAST(doc_wxRichTextCtrl_DiscardEdits)},
    {SIP_MLNAME_CAST(sipName_DoEnable), SIP_MLMETH_CAST(meth_wxRichTextCtrl_DoEnable), METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxRichTextCtrl_DoEnable)},
    {SIP_MLNAME_CAST(sipName_DoFreeze), meth_wxRichTextCtrl_DoFreeze, METH_VARARGS, SIP_MLDOC_CAST(doc_wxRichTextCtrl_DoFreeze)},
    {SIP_MLNAME_CAST(sipName_DoGetBestClientSize), meth_wxRichTextCtrl_DoGetBestClientSize, METH_VARARGS, SIP_MLDOC_CAST(doc_wxRichTextCtrl_DoGetBestClientSize)},
    {SIP_MLNAME_CAST(sipName_DoGetBestSize), meth_wxRichTextCtrl_DoGetBestSize, METH_VARARGS, SIP_MLDOC_CAST(doc_wxRichTextCtrl_DoGetBestSize)},
    {SIP_MLNAME_CAST(sipName_DoGetBorderSize), meth_wxRichTextCtrl_DoGetBorderSize, METH_VARARGS, SIP_MLDOC_CAST(doc_wxRichTextCtrl_DoGetBorderSize)},
    {SIP_MLNAME_CAST(sipName_DoGetClientSize), SIP_MLMETH_CAST(meth_wxRichTextCtrl_DoGetClientSize), METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxRichTextCtrl_DoGetClientSize)},
    {SIP_MLNAME_CAST(sipName_DoGetPosition), SIP_MLMETH_CAST(meth_wxRichTextCtrl_DoGetPosition), METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxRichTextCtrl_DoGetPosition)},
    {SIP_MLNAME_CAST(sipName_DoGetSize), SIP_MLMETH_CAST(meth_wxRichTextCtrl_DoGetSize), METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxRichTextCtrl_DoGetSize)},
    {SIP_MLNAME_CAST(sipName_DoGetValue), meth_wxRichTextCtrl_DoGetValue, METH_VARARGS, SIP_MLDOC_CAST(doc_wxRichTextCtrl_DoGetValue)},
    {SIP_MLNAME_CAST(sipName_DoLayoutBuffer), SIP_MLMETH_CAST(meth_wxRichTextCtrl_DoLayoutBuffer), METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxRichTextCtrl_DoLayoutBuffer)},
    {SIP_MLNAME_CAST(sipName_DoLoadFile), SIP_MLMETH_CAST(meth_wxRichTextCtrl_DoLoadFile), METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxRichTextCtrl_DoLoadFile)},
    {SIP_MLNAME_CAST(sipName_DoMoveWindow), SIP_MLMETH_CAST(meth_wxRichTextCtrl_DoMoveWindow), METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxRichTextCtrl_DoMoveWindow)},
    {SIP_MLNAME_CAST(sipName_DoSaveFile), SIP_MLMETH_CAST(meth_wxRichTextCtrl_DoSaveFile), METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxRichTextCtrl_DoSaveFile)},
    {SIP_MLNAME_CAST(sipName_DoSetClientSize), SIP_MLMETH_CAST(meth_wxRichTextCtrl_DoSetClientSize), METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxRichTextCtrl_DoSetClientSize)},
    {SIP_MLNAME_CAST(sipName_DoSetSize), SIP_MLMETH_CAST(meth_wxRichTextCtrl_DoSetSize), METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxRichTextCtrl_DoSetSize)},
    {SIP_MLNAME_CAST(sipName_DoSetSizeHints), SIP_MLMETH_CAST(meth_wxRichTextCtrl_DoSetSizeHints), METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxRichTextCtrl_DoSetSizeHints)},
    {SIP_MLNAME_CAST(sipName_DoSetWindowVariant), SIP_MLMETH_CAST(meth_wxRichTextCtrl_DoSetWindowVariant), METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxRichTextCtrl_DoSetWindowVariant)},
    {SIP_MLNAME_CAST(sipName_DoThaw), meth_wxRichTextCtrl_DoThaw, METH_VARARGS, SIP_MLDOC_CAST(doc_wxRichTextCtrl_DoThaw)},
    {SIP_MLNAME_CAST(sipName_DoWriteText), SIP_MLMETH_CAST(meth_wxRichTextCtrl_DoWriteText), METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxRichTextCtrl_DoWriteText)},
    {SIP_MLNAME_CAST(sipName_DoesSelectionHaveTextEffectFlag), SIP_MLMETH_CAST(meth_wxRichTextCtrl_DoesSelectionHaveTextEffectFlag), METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxRichTextCtrl_DoesSelectionHaveTextEffectFlag)},
    {SIP_MLNAME_CAST(sipName_EditProperties), SIP_MLMETH_CAST(meth_wxRichTextCtrl_EditProperties), METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxRichTextCtrl_EditProperties)},
    {SIP_MLNAME_CAST(sipName_EnableDelayedImageLoading), SIP_MLMETH_CAST(meth_wxRichTextCtrl_EnableDelayedImageLoading), METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxRichTextCtrl_EnableDelayedImageLoading)},
    {SIP_MLNAME_CAST(sipName_EnableImages), SIP_MLMETH_CAST(meth_wxRichTextCtrl_EnableImages), METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxRichTextCtrl_EnableImages)},
    {SIP_MLNAME_CAST(sipName_EnableVerticalScrollbar), SIP_MLMETH_CAST(meth_wxRichTextCtrl_EnableVerticalScrollbar), METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxRichTextCtrl_EnableVerticalScrollbar)},
    {SIP_MLNAME_CAST(sipName_EnableVirtualAttributes), SIP_MLMETH_CAST(meth_wxRichTextCtrl_EnableVirtualAttributes), METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxRichTextCtrl_EnableVirtualAttributes)},
    {SIP_MLNAME_CAST(sipName_EndAlignment), meth_wxRichTextCtrl_EndAlignment, METH_VARARGS, SIP_MLDOC_CAST(doc_wxRichTextCtrl_EndAlignment)},
    {SIP_MLNAME_CAST(sipName_EndAllStyles), meth_wxRichTextCtrl_EndAllStyles, METH_VARARGS, SIP_MLDOC_CAST(doc_wxRichTextCtrl_EndAllStyles)},
    {SIP_MLNAME_CAST(sipName_EndBatchUndo), meth_wxRichTextCtrl_EndBatchUndo, METH_VARARGS, SIP_MLDOC_CAST(doc_wxRichTextCtrl_EndBatchUndo)},
    {SIP_MLNAME_CAST(sipName_EndBold), meth_wxRichTextCtrl_EndBold, METH_VARARGS, SIP_MLDOC_CAST(doc_wxRichTextCtrl_EndBold)},
    {SIP_MLNAME_CAST(sipName_EndCharacterStyle), meth_wxRichTextCtrl_EndCharacterStyle, METH_VARARGS, SIP_MLDOC_CAST(doc_wxRichTextCtrl_EndCharacterStyle)},
    {SIP_MLNAME_CAST(sipName_EndFont), meth_wxRichTextCtrl_EndFont, METH_VARARGS, SIP_MLDOC_CAST(doc_wxRichTextCtrl_EndFont)},
    {SIP_MLNAME_CAST(sipName_EndFontSize), meth_wxRichTextCtrl_EndFontSize, METH_VARARGS, SIP_MLDOC_CAST(doc_wxRichTextCtrl_EndFontSize)},
    {SIP_MLNAME_CAST(sipName_EndItalic), meth_wxRichTextCtrl_EndItalic, METH_VARARGS, SIP_MLDOC_CAST(doc_wxRichTextCtrl_EndItalic)},
    {SIP_MLNAME_CAST(sipName_EndLeftIndent), meth_wxRichTextCtrl_EndLeftIndent, METH_VARARGS, SIP_MLDOC_CAST(doc_wxRichTextCtrl_EndLeftIndent)},
    {SIP_MLNAME_CAST(sipName_EndLineSpacing), meth_wxRichTextCtrl_EndLineSpacing, METH_VARARGS, SIP_MLDOC_CAST(doc_wxRichTextCtrl_EndLineSpacing)},
    {SIP_MLNAME_CAST(sipName_EndListStyle), meth_wxRichTextCtrl_EndListStyle, METH_VARARGS, SIP_MLDOC_CAST(doc_wxRichTextCtrl_EndListStyle)},
    {SIP_MLNAME_CAST(sipName_EndNumberedBullet), meth_wxRichTextCtrl_EndNumberedBullet, METH_VARARGS, SIP_MLDOC_CAST(doc_wxRichTextCtrl_EndNumberedBullet)},
    {SIP_MLNAME_CAST(sipName_EndParagraphSpacing), meth_wxRichTextCtrl_EndParagraphSpacing, METH_VARARGS, SIP_MLDOC_CAST(doc_wxRichTextCtrl_EndParagraphSpacing)},
    {SIP_MLNAME_CAST(sipName_EndParagraphStyle), meth_wxRichTextCtrl_EndParagraphStyle, METH_VARARGS, SIP_MLDOC_CAST(doc_wxRichTextCtrl_EndParagraphStyle)},
    {SIP_MLNAME_CAST(sipName_EndRightIndent), meth_wxRichTextCtrl_EndRightIndent, METH_VARARGS, SIP_MLDOC_CAST(doc_wxRichTextCtrl_EndRightIndent)},
    {SIP_MLNAME_CAST(sipName_EndStandardBullet), meth_wxRichTextCtrl_EndStandardBullet, METH_VARARGS, SIP_MLDOC_CAST(doc_wxRichTextCtrl_EndStandardBullet)},
    {SIP_MLNAME_CAST(sipName_EndStyle), meth_wxRichTextCtrl_EndStyle, METH_VARARGS, SIP_MLDOC_CAST(doc_wxRichTextCtrl_EndStyle)},
    {SIP_MLNAME_CAST(sipName_EndSuppressUndo), meth_wxRichTextCtrl_EndSuppressUndo, METH_VARARGS, SIP_MLDOC_CAST(doc_wxRichTextCtrl_EndSuppressUndo)},
    {SIP_MLNAME_CAST(sipName_EndSymbolBullet), meth_wxRichTextCtrl_EndSymbolBullet, METH_VARARGS, SIP_MLDOC_CAST(doc_wxRichTextCtrl_EndSymbolBullet)},
    {SIP_MLNAME_CAST(sipName_EndTextColour), meth_wxRichTextCtrl_EndTextColour, METH_VARARGS, SIP_MLDOC_CAST(doc_wxRichTextCtrl_EndTextColour)},
    {SIP_MLNAME_CAST(sipName_EndURL), meth_wxRichTextCtrl_EndURL, METH_VARARGS, SIP_MLDOC_CAST(doc_wxRichTextCtrl_EndURL)},
    {SIP_MLNAME_CAST(sipName_EndUnderline), meth_wxRichTextCtrl_EndUnderline, METH_VARARGS, SIP_MLDOC_CAST(doc_wxRichTextCtrl_EndUnderline)},
    {SIP_MLNAME_CAST(sipName_ExtendCellSelection), SIP_MLMETH_CAST(meth_wxRichTextCtrl_ExtendCellSelection), METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxRichTextCtrl_ExtendCellSelection)},
    {SIP_MLNAME_CAST(sipName_ExtendSelection), SIP_MLMETH_CAST(meth_wxRichTextCtrl_ExtendSelection), METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxRichTextCtrl_ExtendSelection)},
    {SIP_MLNAME_CAST(sipName_FindCaretPositionForCharacterPosition), SIP_MLMETH_CAST(meth_wxRichTextCtrl_FindCaretPositionForCharacterPosition), METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxRichTextCtrl_FindCaretPositionForCharacterPosition)},
    {SIP_MLNAME_CAST(sipName_FindContainerAtPoint), SIP_MLMETH_CAST(meth_wxRichTextCtrl_FindContainerAtPoint), METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxRichTextCtrl_FindContainerAtPoint)},
    {SIP_MLNAME_CAST(sipName_FindNextWordPosition), SIP_MLMETH_CAST(meth_wxRichTextCtrl_FindNextWordPosition), METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxRichTextCtrl_FindNextWordPosition)},
    {SIP_MLNAME_CAST(sipName_FindRangeForList), SIP_MLMETH_CAST(meth_wxRichTextCtrl_FindRangeForList), METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxRichTextCtrl_FindRangeForList)},
    {SIP_MLNAME_CAST(sipName_ForceDelayedLayout), meth_wxRichTextCtrl_ForceDelayedLayout, METH_VARARGS, SIP_MLDOC_CAST(doc_wxRichTextCtrl_ForceDelayedLayout)},
    {SIP_MLNAME_CAST(sipName_ForceUpper), meth_wxRichTextCtrl_ForceUpper, METH_VARARGS, SIP_MLDOC_CAST(doc_wxRichTextCtrl_ForceUpper)},
    {SIP_MLNAME_CAST(sipName_GetAdjustedCaretPosition), SIP_MLMETH_CAST(meth_wxRichTextCtrl_GetAdjustedCaretPosition), METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxRichTextCtrl_GetAdjustedCaretPosition)},
    {SIP_MLNAME_CAST(sipName_GetAvailableFontNames), meth_wxRichTextCtrl_GetAvailableFontNames, METH_VARARGS, SIP_MLDOC_CAST(doc_wxRichTextCtrl_GetAvailableFontNames)},
    {SIP_MLNAME_CAST(sipName_GetBasicStyle), meth_wxRichTextCtrl_GetBasicStyle, METH_VARARGS, SIP_MLDOC_CAST(doc_wxRichTextCtrl_GetBasicStyle)},
    {SIP_MLNAME_CAST(sipName_GetBuffer), meth_wxRichTextCtrl_GetBuffer, METH_VARARGS, SIP_MLDOC_CAST(doc_wxRichTextCtrl_GetBuffer)},
    {SIP_MLNAME_CAST(sipName_GetCaretAtLineStart), meth_wxRichTextCtrl_GetCaretAtLineStart, METH_VARARGS, SIP_MLDOC_CAST(doc_wxRichTextCtrl_GetCaretAtLineStart)},
    {SIP_MLNAME_CAST(sipName_GetCaretPosition), meth_wxRichTextCtrl_GetCaretPosition, METH_VARARGS, SIP_MLDOC_CAST(doc_wxRichTextCtrl_GetCaretPosition)},
    {SIP_MLNAME_CAST(sipName_GetCaretPositionForDefaultStyle), meth_wxRichTextCtrl_GetCaretPositionForDefaultStyle, METH_VARARGS, SIP_MLDOC_CAST(doc_wxRichTextCtrl_GetCaretPositionForDefaultStyle)},
    {SIP_MLNAME_CAST(sipName_GetCaretPositionForIndex), SIP_MLMETH_CAST(meth_wxRichTextCtrl_GetCaretPositionForIndex), METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxRichTextCtrl_GetCaretPositionForIndex)},
    {SIP_MLNAME_CAST(sipName_GetClassDefaultAttributes), SIP_MLMETH_CAST(meth_wxRichTextCtrl_GetClassDefaultAttributes), METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxRichTextCtrl_GetClassDefaultAttributes)},
    {SIP_MLNAME_CAST(sipName_GetClientAreaOrigin), meth_wxRichTextCtrl_GetClientAreaOrigin, METH_VARARGS, SIP_MLDOC_CAST(doc_wxRichTextCtrl_GetClientAreaOrigin)},
    {SIP_MLNAME_CAST(sipName_GetCommandProcessor), meth_wxRichTextCtrl_GetCommandProcessor, METH_VARARGS, SIP_MLDOC_CAST(doc_wxRichTextCtrl_GetCommandProcessor)},
    {SIP_MLNAME_CAST(sipName_GetContextMenu), meth_wxRichTextCtrl_GetContextMenu, METH_VARARGS, SIP_MLDOC_CAST(doc_wxRichTextCtrl_GetContextMenu)},
    {SIP_MLNAME_CAST(sipName_GetContextMenuPropertiesInfo), meth_wxRichTextCtrl_GetContextMenuPropertiesInfo, METH_VARARGS, SIP_MLDOC_CAST(doc_wxRichTextCtrl_GetContextMenuPropertiesInfo)},
    {SIP_MLNAME_CAST(sipName_GetDefaultBorder), meth_wxRichTextCtrl_GetDefaultBorder, METH_VARARGS, SIP_MLDOC_CAST(doc_wxRichTextCtrl_GetDefaultBorder)},
    {SIP_MLNAME_CAST(sipName_GetDefaultBorderForControl), meth_wxRichTextCtrl_GetDefaultBorderForControl, METH_VARARGS, SIP_MLDOC_CAST(doc_wxRichTextCtrl_GetDefaultBorderForControl)},
    {SIP_MLNAME_CAST(sipName_GetDefaultStyleEx), meth_wxRichTextCtrl_GetDefaultStyleEx, METH_VARARGS, SIP_MLDOC_CAST(doc_wxRichTextCtrl_GetDefaultStyleEx)},
    {SIP_MLNAME_CAST(sipName_GetDelayedImageLoading), meth_wxRichTextCtrl_GetDelayedImageLoading, METH_VARARGS, SIP_MLDOC_CAST(doc_wxRichTextCtrl_GetDelayedImageLoading)},
    {SIP_MLNAME_CAST(sipName_GetDelayedImageProcessingRequired), meth_wxRichTextCtrl_GetDelayedImageProcessingRequired, METH_VARARGS, SIP_MLDOC_CAST(doc_wxRichTextCtrl_GetDelayedImageProcessingRequired)},
    {SIP_MLNAME_CAST(sipName_GetDelayedImageProcessingTime), meth_wxRichTextCtrl_GetDelayedImageProcessingTime, METH_VARARGS, SIP_MLDOC_CAST(doc_wxRichTextCtrl_GetDelayedImageProcessingTime)},
    {SIP_MLNAME_CAST(sipName_GetDelayedLayoutThreshold), meth_wxRichTextCtrl_GetDelayedLayoutThreshold, METH_VARARGS, SIP_MLDOC_CAST(doc_wxRichTextCtrl_GetDelayedLayoutThreshold)},
    {SIP_MLNAME_CAST(sipName_GetDimensionScale), meth_wxRichTextCtrl_GetDimensionScale, METH_VARARGS, SIP_MLDOC_CAST(doc_wxRichTextCtrl_GetDimensionScale)},
    {SIP_MLNAME_CAST(sipName_GetDragStartPoint), meth_wxRichTextCtrl_GetDragStartPoint, METH_VARARGS, SIP_MLDOC_CAST(doc_wxRichTextCtrl_GetDragStartPoint)},
    {SIP_MLNAME_CAST(sipName_GetDragStartTime), meth_wxRichTextCtrl_GetDragStartTime, METH_VARARGS, SIP_MLDOC_CAST(doc_wxRichTextCtrl_GetDragStartTime)},
    {SIP_MLNAME_CAST(sipName_GetDragging), meth_wxRichTextCtrl_GetDragging, METH_VARARGS, SIP_MLDOC_CAST(doc_wxRichTextCtrl_GetDragging)},
    {SIP_MLNAME_CAST(sipName_GetFilename), meth_wxRichTextCtrl_GetFilename, METH_VARARGS, SIP_MLDOC_CAST(doc_wxRichTextCtrl_GetFilename)},
    {SIP_MLNAME_CAST(sipName_GetFirstVisiblePoint), meth_wxRichTextCtrl_GetFirstVisiblePoint, METH_VARARGS, SIP_MLDOC_CAST(doc_wxRichTextCtrl_GetFirstVisiblePoint)},
    {SIP_MLNAME_CAST(sipName_GetFirstVisiblePosition), meth_wxRichTextCtrl_GetFirstVisiblePosition, METH_VARARGS, SIP_MLDOC_CAST(doc_wxRichTextCtrl_GetFirstVisiblePosition)},
    {SIP_MLNAME_CAST(sipName_GetFocusObject), meth_wxRichTextCtrl_GetFocusObject, METH_VARARGS, SIP_MLDOC_CAST(doc_wxRichTextCtrl_GetFocusObject)},
    {SIP_MLNAME_CAST(sipName_GetFontScale), meth_wxRichTextCtrl_GetFontScale, METH_VARARGS, SIP_MLDOC_CAST(doc_wxRichTextCtrl_GetFontScale)},
    {SIP_MLNAME_CAST(sipName_GetFullLayoutRequired), meth_wxRichTextCtrl_GetFullLayoutRequired, METH_VARARGS, SIP_MLDOC_CAST(doc_wxRichTextCtrl_GetFullLayoutRequired)},
    {SIP_MLNAME_CAST(sipName_GetFullLayoutSavedPosition), meth_wxRichTextCtrl_GetFullLayoutSavedPosition, METH_VARARGS, SIP_MLDOC_CAST(doc_wxRichTextCtrl_GetFullLayoutSavedPosition)},
    {SIP_MLNAME_CAST(sipName_GetFullLayoutTime), meth_wxRichTextCtrl_GetFullLayoutTime, METH_VARARGS, SIP_MLDOC_CAST(doc_wxRichTextCtrl_GetFullLayoutTime)},
    {SIP_MLNAME_CAST(sipName_GetHandlerFlags), meth_wxRichTextCtrl_GetHandlerFlags, METH_VARARGS, SIP_MLDOC_CAST(doc_wxRichTextCtrl_GetHandlerFlags)},
    {SIP_MLNAME_CAST(sipName_GetHint), meth_wxRichTextCtrl_GetHint, METH_VARARGS, SIP_MLDOC_CAST(doc_wxRichTextCtrl_GetHint)},
    {SIP_MLNAME_CAST(sipName_GetImagesEnabled), meth_wxRichTextCtrl_GetImagesEnabled, METH_VARARGS, SIP_MLDOC_CAST(doc_wxRichTextCtrl_GetImagesEnabled)},
    {SIP_MLNAME_CAST(sipName_GetInsertionPoint), meth_wxRichTextCtrl_GetInsertionPoint, METH_VARARGS, SIP_MLDOC_CAST(doc_wxRichTextCtrl_GetInsertionPoint)},
    {SIP_MLNAME_CAST(sipName_GetInternalSelectionRange), meth_wxRichTextCtrl_GetInternalSelectionRange, METH_VARARGS, SIP_MLDOC_CAST(doc_wxRichTextCtrl_GetInternalSelectionRange)},
    {SIP_MLNAME_CAST(sipName_GetLastPosition), meth_wxRichTextCtrl_GetLastPosition, METH_VARARGS, SIP_MLDOC_CAST(doc_wxRichTextCtrl_GetLastPosition)},
    {SIP_MLNAME_CAST(sipName_GetLineLength), SIP_MLMETH_CAST(meth_wxRichTextCtrl_GetLineLength), METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxRichTextCtrl_GetLineLength)},
    {SIP_MLNAME_CAST(sipName_GetLineText), SIP_MLMETH_CAST(meth_wxRichTextCtrl_GetLineText), METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxRichTextCtrl_GetLineText)},
    {SIP_MLNAME_CAST(sipName_GetLogicalPoint), SIP_MLMETH_CAST(meth_wxRichTextCtrl_GetLogicalPoint), METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxRichTextCtrl_GetLogicalPoint)},
    {SIP_MLNAME_CAST(sipName_GetMainWindowOfCompositeControl), meth_wxRichTextCtrl_GetMainWindowOfCompositeControl, METH_VARARGS, SIP_MLDOC_CAST(doc_wxRichTextCtrl_GetMainWindowOfCompositeControl)},
    {SIP_MLNAME_CAST(sipName_GetMargins), meth_wxRichTextCtrl_GetMargins, METH_VARARGS, SIP_MLDOC_CAST(doc_wxRichTextCtrl_GetMargins)},
    {SIP_MLNAME_CAST(sipName_GetNumberOfLines), meth_wxRichTextCtrl_GetNumberOfLines, METH_VARARGS, SIP_MLDOC_CAST(doc_wxRichTextCtrl_GetNumberOfLines)},
    {SIP_MLNAME_CAST(sipName_GetPhysicalPoint), SIP_MLMETH_CAST(meth_wxRichTextCtrl_GetPhysicalPoint), METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxRichTextCtrl_GetPhysicalPoint)},
    {SIP_MLNAME_CAST(sipName_GetPreDrag), meth_wxRichTextCtrl_GetPreDrag, METH_VARARGS, SIP_MLDOC_CAST(doc_wxRichTextCtrl_GetPreDrag)},
    {SIP_MLNAME_CAST(sipName_GetPropertiesMenuLabel), SIP_MLMETH_CAST(meth_wxRichTextCtrl_GetPropertiesMenuLabel), METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxRichTextCtrl_GetPropertiesMenuLabel)},
    {SIP_MLNAME_CAST(sipName_GetRange), SIP_MLMETH_CAST(meth_wxRichTextCtrl_GetRange), METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxRichTextCtrl_GetRange)},
    {SIP_MLNAME_CAST(sipName_GetScale), meth_wxRichTextCtrl_GetScale, METH_VARARGS, SIP_MLDOC_CAST(doc_wxRichTextCtrl_GetScale)},
    {SIP_MLNAME_CAST(sipName_GetScaledPoint), SIP_MLMETH_CAST(meth_wxRichTextCtrl_GetScaledPoint), METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxRichTextCtrl_GetScaledPoint)},
    {SIP_MLNAME_CAST(sipName_GetScaledRect), SIP_MLMETH_CAST(meth_wxRichTextCtrl_GetScaledRect), METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxRichTextCtrl_GetScaledRect)},
    {SIP_MLNAME_CAST(sipName_GetScaledSize), SIP_MLMETH_CAST(meth_wxRichTextCtrl_GetScaledSize), METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxRichTextCtrl_GetScaledSize)},
    {SIP_MLNAME_CAST(sipName_GetSelection), meth_wxRichTextCtrl_GetSelection, METH_VARARGS, SIP_MLDOC_CAST(doc_wxRichTextCtrl_GetSelection)},
    {SIP_MLNAME_CAST(sipName_GetSelectionAnchor), meth_wxRichTextCtrl_GetSelectionAnchor, METH_VARARGS, SIP_MLDOC_CAST(doc_wxRichTextCtrl_GetSelectionAnchor)},
    {SIP_MLNAME_CAST(sipName_GetSelectionAnchorObject), meth_wxRichTextCtrl_GetSelectionAnchorObject, METH_VARARGS, SIP_MLDOC_CAST(doc_wxRichTextCtrl_GetSelectionAnchorObject)},
    {SIP_MLNAME_CAST(sipName_GetSelectionRange), meth_wxRichTextCtrl_GetSelectionRange, METH_VARARGS, SIP_MLDOC_CAST(doc_wxRichTextCtrl_GetSelectionRange)},
    {SIP_MLNAME_CAST(sipName_GetStringSelection), meth_wxRichTextCtrl_GetStringSelection, METH_VARARGS, SIP_MLDOC_CAST(doc_wxRichTextCtrl_GetStringSelection)},
    {SIP_MLNAME_CAST(sipName_GetStyle), SIP_MLMETH_CAST(meth_wxRichTextCtrl_GetStyle), METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxRichTextCtrl_GetStyle)},
    {SIP_MLNAME_CAST(sipName_GetStyleForRange), SIP_MLMETH_CAST(meth_wxRichTextCtrl_GetStyleForRange), METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxRichTextCtrl_GetStyleForRange)},
    {SIP_MLNAME_CAST(sipName_GetStyleSheet), meth_wxRichTextCtrl_GetStyleSheet, METH_VARARGS, SIP_MLDOC_CAST(doc_wxRichTextCtrl_GetStyleSheet)},
    {SIP_MLNAME_CAST(sipName_GetTextCursor), meth_wxRichTextCtrl_GetTextCursor, METH_VARARGS, SIP_MLDOC_CAST(doc_wxRichTextCtrl_GetTextCursor)},
    {SIP_MLNAME_CAST(sipName_GetURLCursor), meth_wxRichTextCtrl_GetURLCursor, METH_VARARGS, SIP_MLDOC_CAST(doc_wxRichTextCtrl_GetURLCursor)},
    {SIP_MLNAME_CAST(sipName_GetUncombinedStyle), SIP_MLMETH_CAST(meth_wxRichTextCtrl_GetUncombinedStyle), METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxRichTextCtrl_GetUncombinedStyle)},
    {SIP_MLNAME_CAST(sipName_GetUnscaledPoint), SIP_MLMETH_CAST(meth_wxRichTextCtrl_GetUnscaledPoint), METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxRichTextCtrl_GetUnscaledPoint)},
    {SIP_MLNAME_CAST(sipName_GetUnscaledRect), SIP_MLMETH_CAST(meth_wxRichTextCtrl_GetUnscaledRect), METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxRichTextCtrl_GetUnscaledRect)},
    {SIP_MLNAME_CAST(sipName_GetUnscaledSize), SIP_MLMETH_CAST(meth_wxRichTextCtrl_GetUnscaledSize), METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxRichTextCtrl_GetUnscaledSize)},
    {SIP_MLNAME_CAST(sipName_GetValidator), meth_wxRichTextCtrl_GetValidator, METH_VARARGS, SIP_MLDOC_CAST(doc_wxRichTextCtrl_GetValidator)},
    {SIP_MLNAME_CAST(sipName_GetValue), meth_wxRichTextCtrl_GetValue, METH_VARARGS, SIP_MLDOC_CAST(doc_wxRichTextCtrl_GetValue)},
    {SIP_MLNAME_CAST(sipName_GetVerticalScrollbarEnabled), meth_wxRichTextCtrl_GetVerticalScrollbarEnabled, METH_VARARGS, SIP_MLDOC_CAST(doc_wxRichTextCtrl_GetVerticalScrollbarEnabled)},
    {SIP_MLNAME_CAST(sipName_GetVirtualAttributesEnabled), meth_wxRichTextCtrl_GetVirtualAttributesEnabled, METH_VARARGS, SIP_MLDOC_CAST(doc_wxRichTextCtrl_GetVirtualAttributesEnabled)},
    {SIP_MLNAME_CAST(sipName_GetVisibleLineForCaretPosition), SIP_MLMETH_CAST(meth_wxRichTextCtrl_GetVisibleLineForCaretPosition), METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxRichTextCtrl_GetVisibleLineForCaretPosition)},
    {SIP_MLNAME_CAST(sipName_HasCharacterAttributes), SIP_MLMETH_CAST(meth_wxRichTextCtrl_HasCharacterAttributes), METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxRichTextCtrl_HasCharacterAttributes)},
    {SIP_MLNAME_CAST(sipName_HasParagraphAttributes), SIP_MLMETH_CAST(meth_wxRichTextCtrl_HasParagraphAttributes), METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxRichTextCtrl_HasParagraphAttributes)},
    {SIP_MLNAME_CAST(sipName_HasSelection), meth_wxRichTextCtrl_HasSelection, METH_VARARGS, SIP_MLDOC_CAST(doc_wxRichTextCtrl_HasSelection)},
    {SIP_MLNAME_CAST(sipName_HasTransparentBackground), meth_wxRichTextCtrl_HasTransparentBackground, METH_VARARGS, SIP_MLDOC_CAST(doc_wxRichTextCtrl_HasTransparentBackground)},
    {SIP_MLNAME_CAST(sipName_HasUnfocusedSelection), meth_wxRichTextCtrl_HasUnfocusedSelection, METH_VARARGS, SIP_MLDOC_CAST(doc_wxRichTextCtrl_HasUnfocusedSelection)},
    {SIP_MLNAME_CAST(sipName_HitTest), SIP_MLMETH_CAST(meth_wxRichTextCtrl_HitTest), METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxRichTextCtrl_HitTest)},
    {SIP_MLNAME_CAST(sipName_HitTestXY), SIP_MLMETH_CAST(meth_wxRichTextCtrl_HitTestXY), METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxRichTextCtrl_HitTestXY)},
    {SIP_MLNAME_CAST(sipName_InformFirstDirection), SIP_MLMETH_CAST(meth_wxRichTextCtrl_InformFirstDirection), METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxRichTextCtrl_InformFirstDirection)},
    {SIP_MLNAME_CAST(sipName_InheritAttributes), meth_wxRichTextCtrl_InheritAttributes, METH_VARARGS, SIP_MLDOC_CAST(doc_wxRichTextCtrl_InheritAttributes)},
    {SIP_MLNAME_CAST(sipName_Init), meth_wxRichTextCtrl_Init, METH_VARARGS, SIP_MLDOC_CAST(doc_wxRichTextCtrl_Init)},
    {SIP_MLNAME_CAST(sipName_InitDialog), meth_wxRichTextCtrl_InitDialog, METH_VARARGS, SIP_MLDOC_CAST(doc_wxRichTextCtrl_InitDialog)},
    {SIP_MLNAME_CAST(sipName_Invalidate), meth_wxRichTextCtrl_Invalidate, METH_VARARGS, SIP_MLDOC_CAST(doc_wxRichTextCtrl_Invalidate)},
    {SIP_MLNAME_CAST(sipName_IsDefaultStyleShowing), meth_wxRichTextCtrl_IsDefaultStyleShowing, METH_VARARGS, SIP_MLDOC_CAST(doc_wxRichTextCtrl_IsDefaultStyleShowing)},
    {SIP_MLNAME_CAST(sipName_IsEditable), meth_wxRichTextCtrl_IsEditable, METH_VARARGS, SIP_MLDOC_CAST(doc_wxRichTextCtrl_IsEditable)},
    {SIP_MLNAME_CAST(sipName_IsEmpty), meth_wxRichTextCtrl_IsEmpty, METH_VARARGS, SIP_MLDOC_CAST(doc_wxRichTextCtrl_IsEmpty)},
    {SIP_MLNAME_CAST(sipName_IsModified), meth_wxRichTextCtrl_IsModified, METH_VARARGS, SIP_MLDOC_CAST(doc_wxRichTextCtrl_IsModified)},
    {SIP_MLNAME_CAST(sipName_IsMultiLine), meth_wxRichTextCtrl_IsMultiLine, METH_VARARGS, SIP_MLDOC_CAST(doc_wxRichTextCtrl_IsMultiLine)},
    {SIP_MLNAME_CAST(sipName_IsPositionVisible), SIP_MLMETH_CAST(meth_wxRichTextCtrl_IsPositionVisible), METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxRichTextCtrl_IsPositionVisible)},
    {SIP_MLNAME_CAST(sipName_IsSelectionAligned), SIP_MLMETH_CAST(meth_wxRichTextCtrl_IsSelectionAligned), METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxRichTextCtrl_IsSelectionAligned)},
    {SIP_MLNAME_CAST(sipName_IsSelectionBold), meth_wxRichTextCtrl_IsSelectionBold, METH_VARARGS, SIP_MLDOC_CAST(doc_wxRichTextCtrl_IsSelectionBold)},
    {SIP_MLNAME_CAST(sipName_IsSelectionItalics), meth_wxRichTextCtrl_IsSelectionItalics, METH_VARARGS, SIP_MLDOC_CAST(doc_wxRichTextCtrl_IsSelectionItalics)},
    {SIP_MLNAME_CAST(sipName_IsSelectionUnderlined), meth_wxRichTextCtrl_IsSelectionUnderlined, METH_VARARGS, SIP_MLDOC_CAST(doc_wxRichTextCtrl_IsSelectionUnderlined)},
    {SIP_MLNAME_CAST(sipName_IsSingleLine), meth_wxRichTextCtrl_IsSingleLine, METH_VARARGS, SIP_MLDOC_CAST(doc_wxRichTextCtrl_IsSingleLine)},
    {SIP_MLNAME_CAST(sipName_KeyboardNavigate), SIP_MLMETH_CAST(meth_wxRichTextCtrl_KeyboardNavigate), METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxRichTextCtrl_KeyboardNavigate)},
    {SIP_MLNAME_CAST(sipName_LayoutContent), SIP_MLMETH_CAST(meth_wxRichTextCtrl_LayoutContent), METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxRichTextCtrl_LayoutContent)},
    {SIP_MLNAME_CAST(sipName_LineBreak), meth_wxRichTextCtrl_LineBreak, METH_VARARGS, SIP_MLDOC_CAST(doc_wxRichTextCtrl_LineBreak)},
    {SIP_MLNAME_CAST(sipName_LoadFile), SIP_MLMETH_CAST(meth_wxRichTextCtrl_LoadFile), METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxRichTextCtrl_LoadFile)},
    {SIP_MLNAME_CAST(sipName_MarkDirty), meth_wxRichTextCtrl_MarkDirty, METH_VARARGS, SIP_MLDOC_CAST(doc_wxRichTextCtrl_MarkDirty)},
    {SIP_MLNAME_CAST(sipName_MoveCaret), SIP_MLMETH_CAST(meth_wxRichTextCtrl_MoveCaret), METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxRichTextCtrl_MoveCaret)},
    {SIP_MLNAME_CAST(sipName_MoveCaretBack), SIP_MLMETH_CAST(meth_wxRichTextCtrl_MoveCaretBack), METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxRichTextCtrl_MoveCaretBack)},
    {SIP_MLNAME_CAST(sipName_MoveCaretForward), SIP_MLMETH_CAST(meth_wxRichTextCtrl_MoveCaretForward), METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxRichTextCtrl_MoveCaretForward)},
    {SIP_MLNAME_CAST(sipName_MoveDown), SIP_MLMETH_CAST(meth_wxRichTextCtrl_MoveDown), METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxRichTextCtrl_MoveDown)},
    {SIP_MLNAME_CAST(sipName_MoveEnd), SIP_MLMETH_CAST(meth_wxRichTextCtrl_MoveEnd), METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxRichTextCtrl_MoveEnd)},
    {SIP_MLNAME_CAST(sipName_MoveHome), SIP_MLMETH_CAST(meth_wxRichTextCtrl_MoveHome), METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxRichTextCtrl_MoveHome)},
    {SIP_MLNAME_CAST(sipName_MoveLeft), SIP_MLMETH_CAST(meth_wxRichTextCtrl_MoveLeft), METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxRichTextCtrl_MoveLeft)},
    {SIP_MLNAME_CAST(sipName_MoveRight), SIP_MLMETH_CAST(meth_wxRichTextCtrl_MoveRight), METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxRichTextCtrl_MoveRight)},
    {SIP_MLNAME_CAST(sipName_MoveToLineEnd), SIP_MLMETH_CAST(meth_wxRichTextCtrl_MoveToLineEnd), METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxRichTextCtrl_MoveToLineEnd)},
    {SIP_MLNAME_CAST(sipName_MoveToLineStart), SIP_MLMETH_CAST(meth_wxRichTextCtrl_MoveToLineStart), METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxRichTextCtrl_MoveToLineStart)},
    {SIP_MLNAME_CAST(sipName_MoveToParagraphEnd), SIP_MLMETH_CAST(meth_wxRichTextCtrl_MoveToParagraphEnd), METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxRichTextCtrl_MoveToParagraphEnd)},
    {SIP_MLNAME_CAST(sipName_MoveToParagraphStart), SIP_MLMETH_CAST(meth_wxRichTextCtrl_MoveToParagraphStart), METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxRichTextCtrl_MoveToParagraphStart)},
    {SIP_MLNAME_CAST(sipName_MoveUp), SIP_MLMETH_CAST(meth_wxRichTextCtrl_MoveUp), METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxRichTextCtrl_MoveUp)},
    {SIP_MLNAME_CAST(sipName_Newline), meth_wxRichTextCtrl_Newline, METH_VARARGS, SIP_MLDOC_CAST(doc_wxRichTextCtrl_Newline)},
    {SIP_MLNAME_CAST(sipName_NumberList), SIP_MLMETH_CAST(meth_wxRichTextCtrl_NumberList), METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxRichTextCtrl_NumberList)},
    {SIP_MLNAME_CAST(sipName_OnCaptureLost), SIP_MLMETH_CAST(meth_wxRichTextCtrl_OnCaptureLost), METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxRichTextCtrl_OnCaptureLost)},
    {SIP_MLNAME_CAST(sipName_OnChar), SIP_MLMETH_CAST(meth_wxRichTextCtrl_OnChar), METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxRichTextCtrl_OnChar)},
    {SIP_MLNAME_CAST(sipName_OnClear), SIP_MLMETH_CAST(meth_wxRichTextCtrl_OnClear), METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxRichTextCtrl_OnClear)},
    {SIP_MLNAME_CAST(sipName_OnContextMenu), SIP_MLMETH_CAST(meth_wxRichTextCtrl_OnContextMenu), METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxRichTextCtrl_OnContextMenu)},
    {SIP_MLNAME_CAST(sipName_OnCopy), SIP_MLMETH_CAST(meth_wxRichTextCtrl_OnCopy), METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxRichTextCtrl_OnCopy)},
    {SIP_MLNAME_CAST(sipName_OnCut), SIP_MLMETH_CAST(meth_wxRichTextCtrl_OnCut), METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxRichTextCtrl_OnCut)},
    {SIP_MLNAME_CAST(sipName_OnDropFiles), SIP_MLMETH_CAST(meth_wxRichTextCtrl_OnDropFiles), METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxRichTextCtrl_OnDropFiles)},
    {SIP_MLNAME_CAST(sipName_OnEraseBackground), SIP_MLMETH_CAST(meth_wxRichTextCtrl_OnEraseBackground), METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxRichTextCtrl_OnEraseBackground)},
    {SIP_MLNAME_CAST(sipName_OnIdle), SIP_MLMETH_CAST(meth_wxRichTextCtrl_OnIdle), METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxRichTextCtrl_OnIdle)},
    {SIP_MLNAME_CAST(sipName_OnInternalIdle), meth_wxRichTextCtrl_OnInternalIdle, METH_VARARGS, SIP_MLDOC_CAST(doc_wxRichTextCtrl_OnInternalIdle)},
    {SIP_MLNAME_CAST(sipName_OnKillFocus), SIP_MLMETH_CAST(meth_wxRichTextCtrl_OnKillFocus), METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxRichTextCtrl_OnKillFocus)},
    {SIP_MLNAME_CAST(sipName_OnLeftClick), SIP_MLMETH_CAST(meth_wxRichTextCtrl_OnLeftClick), METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxRichTextCtrl_OnLeftClick)},
    {SIP_MLNAME_CAST(sipName_OnLeftDClick), SIP_MLMETH_CAST(meth_wxRichTextCtrl_OnLeftDClick), METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxRichTextCtrl_OnLeftDClick)},
    {SIP_MLNAME_CAST(sipName_OnLeftUp), SIP_MLMETH_CAST(meth_wxRichTextCtrl_OnLeftUp), METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxRichTextCtrl_OnLeftUp)},
    {SIP_MLNAME_CAST(sipName_OnMiddleClick), SIP_MLMETH_CAST(meth_wxRichTextCtrl_OnMiddleClick), METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxRichTextCtrl_OnMiddleClick)},
    {SIP_MLNAME_CAST(sipName_OnMoveMouse), SIP_MLMETH_CAST(meth_wxRichTextCtrl_OnMoveMouse), METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxRichTextCtrl_OnMoveMouse)},
    {SIP_MLNAME_CAST(sipName_OnPaint), SIP_MLMETH_CAST(meth_wxRichTextCtrl_OnPaint), METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxRichTextCtrl_OnPaint)},
    {SIP_MLNAME_CAST(sipName_OnPaste), SIP_MLMETH_CAST(meth_wxRichTextCtrl_OnPaste), METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxRichTextCtrl_OnPaste)},
    {SIP_MLNAME_CAST(sipName_OnProperties), SIP_MLMETH_CAST(meth_wxRichTextCtrl_OnProperties), METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxRichTextCtrl_OnProperties)},
    {SIP_MLNAME_CAST(sipName_OnRedo), SIP_MLMETH_CAST(meth_wxRichTextCtrl_OnRedo), METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxRichTextCtrl_OnRedo)},
    {SIP_MLNAME_CAST(sipName_OnRightClick), SIP_MLMETH_CAST(meth_wxRichTextCtrl_OnRightClick), METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxRichTextCtrl_OnRightClick)},
    {SIP_MLNAME_CAST(sipName_OnScroll), SIP_MLMETH_CAST(meth_wxRichTextCtrl_OnScroll), METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxRichTextCtrl_OnScroll)},
    {SIP_MLNAME_CAST(sipName_OnSelectAll), SIP_MLMETH_CAST(meth_wxRichTextCtrl_OnSelectAll), METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxRichTextCtrl_OnSelectAll)},
    {SIP_MLNAME_CAST(sipName_OnSetFocus), SIP_MLMETH_CAST(meth_wxRichTextCtrl_OnSetFocus), METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxRichTextCtrl_OnSetFocus)},
    {SIP_MLNAME_CAST(sipName_OnSize), SIP_MLMETH_CAST(meth_wxRichTextCtrl_OnSize), METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxRichTextCtrl_OnSize)},
    {SIP_MLNAME_CAST(sipName_OnSysColourChanged), SIP_MLMETH_CAST(meth_wxRichTextCtrl_OnSysColourChanged), METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxRichTextCtrl_OnSysColourChanged)},
    {SIP_MLNAME_CAST(sipName_OnTimer), SIP_MLMETH_CAST(meth_wxRichTextCtrl_OnTimer), METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxRichTextCtrl_OnTimer)},
    {SIP_MLNAME_CAST(sipName_OnUndo), SIP_MLMETH_CAST(meth_wxRichTextCtrl_OnUndo), METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxRichTextCtrl_OnUndo)},
    {SIP_MLNAME_CAST(sipName_OnUpdateClear), SIP_MLMETH_CAST(meth_wxRichTextCtrl_OnUpdateClear), METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxRichTextCtrl_OnUpdateClear)},
    {SIP_MLNAME_CAST(sipName_OnUpdateCopy), SIP_MLMETH_CAST(meth_wxRichTextCtrl_OnUpdateCopy), METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxRichTextCtrl_OnUpdateCopy)},
    {SIP_MLNAME_CAST(sipName_OnUpdateCut), SIP_MLMETH_CAST(meth_wxRichTextCtrl_OnUpdateCut), METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxRichTextCtrl_OnUpdateCut)},
    {SIP_MLNAME_CAST(sipName_OnUpdatePaste), SIP_MLMETH_CAST(meth_wxRichTextCtrl_OnUpdatePaste), METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxRichTextCtrl_OnUpdatePaste)},
    {SIP_MLNAME_CAST(sipName_OnUpdateProperties), SIP_MLMETH_CAST(meth_wxRichTextCtrl_OnUpdateProperties), METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxRichTextCtrl_OnUpdateProperties)},
    {SIP_MLNAME_CAST(sipName_OnUpdateRedo), SIP_MLMETH_CAST(meth_wxRichTextCtrl_OnUpdateRedo), METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxRichTextCtrl_OnUpdateRedo)},
    {SIP_MLNAME_CAST(sipName_OnUpdateSelectAll), SIP_MLMETH_CAST(meth_wxRichTextCtrl_OnUpdateSelectAll), METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxRichTextCtrl_OnUpdateSelectAll)},
    {SIP_MLNAME_CAST(sipName_OnUpdateUndo), SIP_MLMETH_CAST(meth_wxRichTextCtrl_OnUpdateUndo), METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxRichTextCtrl_OnUpdateUndo)},
    {SIP_MLNAME_CAST(sipName_PageDown), SIP_MLMETH_CAST(meth_wxRichTextCtrl_PageDown), METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxRichTextCtrl_PageDown)},
    {SIP_MLNAME_CAST(sipName_PageUp), SIP_MLMETH_CAST(meth_wxRichTextCtrl_PageUp), METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxRichTextCtrl_PageUp)},
    {SIP_MLNAME_CAST(sipName_PaintAboveContent), SIP_MLMETH_CAST(meth_wxRichTextCtrl_PaintAboveContent), METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxRichTextCtrl_PaintAboveContent)},
    {SIP_MLNAME_CAST(sipName_PaintBackground), SIP_MLMETH_CAST(meth_wxRichTextCtrl_PaintBackground), METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxRichTextCtrl_PaintBackground)},
    {SIP_MLNAME_CAST(sipName_Paste), meth_wxRichTextCtrl_Paste, METH_VARARGS, SIP_MLDOC_CAST(doc_wxRichTextCtrl_Paste)},
    {SIP_MLNAME_CAST(sipName_PopStyleSheet), meth_wxRichTextCtrl_PopStyleSheet, METH_VARARGS, SIP_MLDOC_CAST(doc_wxRichTextCtrl_PopStyleSheet)},
    {SIP_MLNAME_CAST(sipName_PositionCaret), SIP_MLMETH_CAST(meth_wxRichTextCtrl_PositionCaret), METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxRichTextCtrl_PositionCaret)},
    {SIP_MLNAME_CAST(sipName_PositionToXY), SIP_MLMETH_CAST(meth_wxRichTextCtrl_PositionToXY), METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxRichTextCtrl_PositionToXY)},
    {SIP_MLNAME_CAST(sipName_PrepareContent), SIP_MLMETH_CAST(meth_wxRichTextCtrl_PrepareContent), METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxRichTextCtrl_PrepareContent)},
    {SIP_MLNAME_CAST(sipName_PrepareContextMenu), SIP_MLMETH_CAST(meth_wxRichTextCtrl_PrepareContextMenu), METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxRichTextCtrl_PrepareContextMenu)},
    {SIP_MLNAME_CAST(sipName_ProcessBackKey), SIP_MLMETH_CAST(meth_wxRichTextCtrl_ProcessBackKey), METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxRichTextCtrl_ProcessBackKey)},
    {SIP_MLNAME_CAST(sipName_ProcessDelayedImageLoading), SIP_MLMETH_CAST(meth_wxRichTextCtrl_ProcessDelayedImageLoading), METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxRichTextCtrl_ProcessDelayedImageLoading)},
    {SIP_MLNAME_CAST(sipName_ProcessEvent), SIP_MLMETH_CAST(meth_wxRichTextCtrl_ProcessEvent), METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxRichTextCtrl_ProcessEvent)},
    {SIP_MLNAME_CAST(sipName_ProcessMouseMovement), SIP_MLMETH_CAST(meth_wxRichTextCtrl_ProcessMouseMovement), METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxRichTextCtrl_ProcessMouseMovement)},
    {SIP_MLNAME_CAST(sipName_PromoteList), SIP_MLMETH_CAST(meth_wxRichTextCtrl_PromoteList), METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxRichTextCtrl_PromoteList)},
    {SIP_MLNAME_CAST(sipName_PushStyleSheet), SIP_MLMETH_CAST(meth_wxRichTextCtrl_PushStyleSheet), METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxRichTextCtrl_PushStyleSheet)},
    {SIP_MLNAME_CAST(sipName_Redo), meth_wxRichTextCtrl_Redo, METH_VARARGS, SIP_MLDOC_CAST(doc_wxRichTextCtrl_Redo)},
    {SIP_MLNAME_CAST(sipName_RefreshForSelectionChange), SIP_MLMETH_CAST(meth_wxRichTextCtrl_RefreshForSelectionChange), METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxRichTextCtrl_RefreshForSelectionChange)},
    {SIP_MLNAME_CAST(sipName_Remove), SIP_MLMETH_CAST(meth_wxRichTextCtrl_Remove), METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxRichTextCtrl_Remove)},
    {SIP_MLNAME_CAST(sipName_RemoveChild), SIP_MLMETH_CAST(meth_wxRichTextCtrl_RemoveChild), METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxRichTextCtrl_RemoveChild)},
    {SIP_MLNAME_CAST(sipName_Replace), SIP_MLMETH_CAST(meth_wxRichTextCtrl_Replace), METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxRichTextCtrl_Replace)},
    {SIP_MLNAME_CAST(sipName_RequestDelayedImageProcessing), meth_wxRichTextCtrl_RequestDelayedImageProcessing, METH_VARARGS, SIP_MLDOC_CAST(doc_wxRichTextCtrl_RequestDelayedImageProcessing)},
    {SIP_MLNAME_CAST(sipName_SaveFile), SIP_MLMETH_CAST(meth_wxRichTextCtrl_SaveFile), METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxRichTextCtrl_SaveFile)},
    {SIP_MLNAME_CAST(sipName_ScrollIntoView), SIP_MLMETH_CAST(meth_wxRichTextCtrl_ScrollIntoView), METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxRichTextCtrl_ScrollIntoView)},
    {SIP_MLNAME_CAST(sipName_SelectAll), meth_wxRichTextCtrl_SelectAll, METH_VARARGS, SIP_MLDOC_CAST(doc_wxRichTextCtrl_SelectAll)},
    {SIP_MLNAME_CAST(sipName_SelectNone), meth_wxRichTextCtrl_SelectNone, METH_VARARGS, SIP_MLDOC_CAST(doc_wxRichTextCtrl_SelectNone)},
    {SIP_MLNAME_CAST(sipName_SelectWord), SIP_MLMETH_CAST(meth_wxRichTextCtrl_SelectWord), METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxRichTextCtrl_SelectWord)},
    {SIP_MLNAME_CAST(sipName_SendDestroyEvent), meth_wxRichTextCtrl_SendDestroyEvent, METH_VARARGS, SIP_NULLPTR},
    {SIP_MLNAME_CAST(sipName_SetAndShowDefaultStyle), SIP_MLMETH_CAST(meth_wxRichTextCtrl_SetAndShowDefaultStyle), METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxRichTextCtrl_SetAndShowDefaultStyle)},
    {SIP_MLNAME_CAST(sipName_SetBasicStyle), SIP_MLMETH_CAST(meth_wxRichTextCtrl_SetBasicStyle), METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxRichTextCtrl_SetBasicStyle)},
    {SIP_MLNAME_CAST(sipName_SetCanFocus), SIP_MLMETH_CAST(meth_wxRichTextCtrl_SetCanFocus), METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxRichTextCtrl_SetCanFocus)},
    {SIP_MLNAME_CAST(sipName_SetCaretAtLineStart), SIP_MLMETH_CAST(meth_wxRichTextCtrl_SetCaretAtLineStart), METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxRichTextCtrl_SetCaretAtLineStart)},
    {SIP_MLNAME_CAST(sipName_SetCaretPosition), SIP_MLMETH_CAST(meth_wxRichTextCtrl_SetCaretPosition), METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxRichTextCtrl_SetCaretPosition)},
    {SIP_MLNAME_CAST(sipName_SetCaretPositionAfterClick), SIP_MLMETH_CAST(meth_wxRichTextCtrl_SetCaretPositionAfterClick), METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxRichTextCtrl_SetCaretPositionAfterClick)},
    {SIP_MLNAME_CAST(sipName_SetCaretPositionForDefaultStyle), SIP_MLMETH_CAST(meth_wxRichTextCtrl_SetCaretPositionForDefaultStyle), METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxRichTextCtrl_SetCaretPositionForDefaultStyle)},
    {SIP_MLNAME_CAST(sipName_SetContextMenu), SIP_MLMETH_CAST(meth_wxRichTextCtrl_SetContextMenu), METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxRichTextCtrl_SetContextMenu)},
    {SIP_MLNAME_CAST(sipName_SetDefaultStyle), SIP_MLMETH_CAST(meth_wxRichTextCtrl_SetDefaultStyle), METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxRichTextCtrl_SetDefaultStyle)},
    {SIP_MLNAME_CAST(sipName_SetDefaultStyleToCursorStyle), meth_wxRichTextCtrl_SetDefaultStyleToCursorStyle, METH_VARARGS, SIP_MLDOC_CAST(doc_wxRichTextCtrl_SetDefaultStyleToCursorStyle)},
    {SIP_MLNAME_CAST(sipName_SetDelayedImageProcessingRequired), SIP_MLMETH_CAST(meth_wxRichTextCtrl_SetDelayedImageProcessingRequired), METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxRichTextCtrl_SetDelayedImageProcessingRequired)},
    {SIP_MLNAME_CAST(sipName_SetDelayedImageProcessingTime), SIP_MLMETH_CAST(meth_wxRichTextCtrl_SetDelayedImageProcessingTime), METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxRichTextCtrl_SetDelayedImageProcessingTime)},
    {SIP_MLNAME_CAST(sipName_SetDelayedLayoutThreshold), SIP_MLMETH_CAST(meth_wxRichTextCtrl_SetDelayedLayoutThreshold), METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxRichTextCtrl_SetDelayedLayoutThreshold)},
    {SIP_MLNAME_CAST(sipName_SetDimensionScale), SIP_MLMETH_CAST(meth_wxRichTextCtrl_SetDimensionScale), METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxRichTextCtrl_SetDimensionScale)},
    {SIP_MLNAME_CAST(sipName_SetDragStartPoint), SIP_MLMETH_CAST(meth_wxRichTextCtrl_SetDragStartPoint), METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxRichTextCtrl_SetDragStartPoint)},
    {SIP_MLNAME_CAST(sipName_SetDragStartTime), SIP_MLMETH_CAST(meth_wxRichTextCtrl_SetDragStartTime), METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxRichTextCtrl_SetDragStartTime)},
    {SIP_MLNAME_CAST(sipName_SetDragging), SIP_MLMETH_CAST(meth_wxRichTextCtrl_SetDragging), METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxRichTextCtrl_SetDragging)},
    {SIP_MLNAME_CAST(sipName_SetEditable), SIP_MLMETH_CAST(meth_wxRichTextCtrl_SetEditable), METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxRichTextCtrl_SetEditable)},
    {SIP_MLNAME_CAST(sipName_SetFilename), SIP_MLMETH_CAST(meth_wxRichTextCtrl_SetFilename), METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxRichTextCtrl_SetFilename)},
    {SIP_MLNAME_CAST(sipName_SetFocusObject), SIP_MLMETH_CAST(meth_wxRichTextCtrl_SetFocusObject), METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxRichTextCtrl_SetFocusObject)},
    {SIP_MLNAME_CAST(sipName_SetFont), SIP_MLMETH_CAST(meth_wxRichTextCtrl_SetFont), METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxRichTextCtrl_SetFont)},
    {SIP_MLNAME_CAST(sipName_SetFontScale), SIP_MLMETH_CAST(meth_wxRichTextCtrl_SetFontScale), METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxRichTextCtrl_SetFontScale)},
    {SIP_MLNAME_CAST(sipName_SetFullLayoutRequired), SIP_MLMETH_CAST(meth_wxRichTextCtrl_SetFullLayoutRequired), METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxRichTextCtrl_SetFullLayoutRequired)},
    {SIP_MLNAME_CAST(sipName_SetFullLayoutSavedPosition), SIP_MLMETH_CAST(meth_wxRichTextCtrl_SetFullLayoutSavedPosition), METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxRichTextCtrl_SetFullLayoutSavedPosition)},
    {SIP_MLNAME_CAST(sipName_SetFullLayoutTime), SIP_MLMETH_CAST(meth_wxRichTextCtrl_SetFullLayoutTime), METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxRichTextCtrl_SetFullLayoutTime)},
    {SIP_MLNAME_CAST(sipName_SetHandlerFlags), SIP_MLMETH_CAST(meth_wxRichTextCtrl_SetHandlerFlags), METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxRichTextCtrl_SetHandlerFlags)},
    {SIP_MLNAME_CAST(sipName_SetHint), SIP_MLMETH_CAST(meth_wxRichTextCtrl_SetHint), METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxRichTextCtrl_SetHint)},
    {SIP_MLNAME_CAST(sipName_SetInsertionPoint), SIP_MLMETH_CAST(meth_wxRichTextCtrl_SetInsertionPoint), METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxRichTextCtrl_SetInsertionPoint)},
    {SIP_MLNAME_CAST(sipName_SetInsertionPointEnd), meth_wxRichTextCtrl_SetInsertionPointEnd, METH_VARARGS, SIP_MLDOC_CAST(doc_wxRichTextCtrl_SetInsertionPointEnd)},
    {SIP_MLNAME_CAST(sipName_SetInternalSelectionRange), SIP_MLMETH_CAST(meth_wxRichTextCtrl_SetInternalSelectionRange), METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxRichTextCtrl_SetInternalSelectionRange)},
    {SIP_MLNAME_CAST(sipName_SetListStyle), SIP_MLMETH_CAST(meth_wxRichTextCtrl_SetListStyle), METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxRichTextCtrl_SetListStyle)},
    {SIP_MLNAME_CAST(sipName_SetMargins), SIP_MLMETH_CAST(meth_wxRichTextCtrl_SetMargins), METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxRichTextCtrl_SetMargins)},
    {SIP_MLNAME_CAST(sipName_SetMaxLength), SIP_MLMETH_CAST(meth_wxRichTextCtrl_SetMaxLength), METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxRichTextCtrl_SetMaxLength)},
    {SIP_MLNAME_CAST(sipName_SetModified), SIP_MLMETH_CAST(meth_wxRichTextCtrl_SetModified), METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxRichTextCtrl_SetModified)},
    {SIP_MLNAME_CAST(sipName_SetPreDrag), SIP_MLMETH_CAST(meth_wxRichTextCtrl_SetPreDrag), METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxRichTextCtrl_SetPreDrag)},
    {SIP_MLNAME_CAST(sipName_SetProperties), SIP_MLMETH_CAST(meth_wxRichTextCtrl_SetProperties), METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxRichTextCtrl_SetProperties)},
    {SIP_MLNAME_CAST(sipName_SetScale), SIP_MLMETH_CAST(meth_wxRichTextCtrl_SetScale), METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxRichTextCtrl_SetScale)},
    {SIP_MLNAME_CAST(sipName_SetSelection), SIP_MLMETH_CAST(meth_wxRichTextCtrl_SetSelection), METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxRichTextCtrl_SetSelection)},
    {SIP_MLNAME_CAST(sipName_SetSelectionAnchor), SIP_MLMETH_CAST(meth_wxRichTextCtrl_SetSelectionAnchor), METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxRichTextCtrl_SetSelectionAnchor)},
    {SIP_MLNAME_CAST(sipName_SetSelectionAnchorObject), SIP_MLMETH_CAST(meth_wxRichTextCtrl_SetSelectionAnchorObject), METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxRichTextCtrl_SetSelectionAnchorObject)},
    {SIP_MLNAME_CAST(sipName_SetSelectionRange), SIP_MLMETH_CAST(meth_wxRichTextCtrl_SetSelectionRange), METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxRichTextCtrl_SetSelectionRange)},
    {SIP_MLNAME_CAST(sipName_SetStyle), SIP_MLMETH_CAST(meth_wxRichTextCtrl_SetStyle), METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxRichTextCtrl_SetStyle)},
    {SIP_MLNAME_CAST(sipName_SetStyleEx), SIP_MLMETH_CAST(meth_wxRichTextCtrl_SetStyleEx), METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxRichTextCtrl_SetStyleEx)},
    {SIP_MLNAME_CAST(sipName_SetStyleSheet), SIP_MLMETH_CAST(meth_wxRichTextCtrl_SetStyleSheet), METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxRichTextCtrl_SetStyleSheet)},
    {SIP_MLNAME_CAST(sipName_SetTextCursor), SIP_MLMETH_CAST(meth_wxRichTextCtrl_SetTextCursor), METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxRichTextCtrl_SetTextCursor)},
    {SIP_MLNAME_CAST(sipName_SetURLCursor), SIP_MLMETH_CAST(meth_wxRichTextCtrl_SetURLCursor), METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxRichTextCtrl_SetURLCursor)},
    {SIP_MLNAME_CAST(sipName_SetValidator), SIP_MLMETH_CAST(meth_wxRichTextCtrl_SetValidator), METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxRichTextCtrl_SetValidator)},
    {SIP_MLNAME_CAST(sipName_SetValue), SIP_MLMETH_CAST(meth_wxRichTextCtrl_SetValue), METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxRichTextCtrl_SetValue)},
    {SIP_MLNAME_CAST(sipName_SetupScrollbars), SIP_MLMETH_CAST(meth_wxRichTextCtrl_SetupScrollbars), METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxRichTextCtrl_SetupScrollbars)},
    {SIP_MLNAME_CAST(sipName_ShouldInheritColours), meth_wxRichTextCtrl_ShouldInheritColours, METH_VARARGS, SIP_MLDOC_CAST(doc_wxRichTextCtrl_ShouldInheritColours)},
    {SIP_MLNAME_CAST(sipName_ShowContextMenu), SIP_MLMETH_CAST(meth_wxRichTextCtrl_ShowContextMenu), METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxRichTextCtrl_ShowContextMenu)},
    {SIP_MLNAME_CAST(sipName_ShowPosition), SIP_MLMETH_CAST(meth_wxRichTextCtrl_ShowPosition), METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxRichTextCtrl_ShowPosition)},
    {SIP_MLNAME_CAST(sipName_StartCellSelection), SIP_MLMETH_CAST(meth_wxRichTextCtrl_StartCellSelection), METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxRichTextCtrl_StartCellSelection)},
    {SIP_MLNAME_CAST(sipName_StoreFocusObject), SIP_MLMETH_CAST(meth_wxRichTextCtrl_StoreFocusObject), METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxRichTextCtrl_StoreFocusObject)},
    {SIP_MLNAME_CAST(sipName_SuppressingUndo), meth_wxRichTextCtrl_SuppressingUndo, METH_VARARGS, SIP_MLDOC_CAST(doc_wxRichTextCtrl_SuppressingUndo)},
    {SIP_MLNAME_CAST(sipName_TransferDataFromWindow), meth_wxRichTextCtrl_TransferDataFromWindow, METH_VARARGS, SIP_MLDOC_CAST(doc_wxRichTextCtrl_TransferDataFromWindow)},
    {SIP_MLNAME_CAST(sipName_TransferDataToWindow), meth_wxRichTextCtrl_TransferDataToWindow, METH_VARARGS, SIP_MLDOC_CAST(doc_wxRichTextCtrl_TransferDataToWindow)},
    {SIP_MLNAME_CAST(sipName_TryAfter), SIP_MLMETH_CAST(meth_wxRichTextCtrl_TryAfter), METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxRichTextCtrl_TryAfter)},
    {SIP_MLNAME_CAST(sipName_TryBefore), SIP_MLMETH_CAST(meth_wxRichTextCtrl_TryBefore), METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxRichTextCtrl_TryBefore)},
    {SIP_MLNAME_CAST(sipName_Undo), meth_wxRichTextCtrl_Undo, METH_VARARGS, SIP_MLDOC_CAST(doc_wxRichTextCtrl_Undo)},
    {SIP_MLNAME_CAST(sipName_Validate), meth_wxRichTextCtrl_Validate, METH_VARARGS, SIP_MLDOC_CAST(doc_wxRichTextCtrl_Validate)},
    {SIP_MLNAME_CAST(sipName_WordLeft), SIP_MLMETH_CAST(meth_wxRichTextCtrl_WordLeft), METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxRichTextCtrl_WordLeft)},
    {SIP_MLNAME_CAST(sipName_WordRight), SIP_MLMETH_CAST(meth_wxRichTextCtrl_WordRight), METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxRichTextCtrl_WordRight)},
    {SIP_MLNAME_CAST(sipName_WriteField), SIP_MLMETH_CAST(meth_wxRichTextCtrl_WriteField), METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxRichTextCtrl_WriteField)},
    {SIP_MLNAME_CAST(sipName_WriteImage), SIP_MLMETH_CAST(meth_wxRichTextCtrl_WriteImage), METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxRichTextCtrl_WriteImage)},
    {SIP_MLNAME_CAST(sipName_WriteTable), SIP_MLMETH_CAST(meth_wxRichTextCtrl_WriteTable), METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxRichTextCtrl_WriteTable)},
    {SIP_MLNAME_CAST(sipName_WriteText), SIP_MLMETH_CAST(meth_wxRichTextCtrl_WriteText), METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxRichTextCtrl_WriteText)},
    {SIP_MLNAME_CAST(sipName_WriteTextBox), SIP_MLMETH_CAST(meth_wxRichTextCtrl_WriteTextBox), METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxRichTextCtrl_WriteTextBox)},
    {SIP_MLNAME_CAST(sipName_XYToPosition), SIP_MLMETH_CAST(meth_wxRichTextCtrl_XYToPosition), METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxRichTextCtrl_XYToPosition)}
};
