...
const char sipStrings__richtext[] = {
    ...
    'w', 'x', 'R', 'i', 'c', 'h', 'T', 'e', 'x', 't', 'L', 'i', 'n', 'e', 'L', 'i', 's', 't', '_', 'i', 't', 'e', 'r', 'a', 't', 'o', 'r', 0,
    ...
    'w', 'x', 'R', 'i', 'c', 'h', 'T', 'e', 'x', 't', 'L', 'i', 'n', 'e', 'L', 'i', 's', 't', 0,
...
static sipEnumTypeDef enumTypes[] = {
    {{-1, 0, 0, SIP_TYPE_ENUM, sipNameNr_wxRichTextStyleListBox__wxRichTextStyleType, {0}, 0}, sipNameNr_RichTextStyleType, 66, SIP_NULLPTR},
    {{-1, 0, 0, SIP_TYPE_ENUM, sipNameNr_wxRichTextPageLocation, {0}, 0}, sipNameNr_RichTextPageLocation, -1, SIP_NULLPTR},
    {{-1, 0, 0, SIP_TYPE_ENUM, sipNameNr_wxRichTextOddEvenPage, {0}, 0}, sipNameNr_RichTextOddEvenPage, -1, SIP_NULLPTR},
    {{-1, 0, 0, SIP_TYPE_ENUM, sipNameNr_wxRichTextCtrlSelectionState, {0}, 0}, sipNameNr_RichTextCtrlSelectionState, -1, SIP_NULLPTR},
    {{-1, 0, 0, SIP_TYPE_ENUM, sipNameNr_wxRichTextCommandId, {0}, 0}, sipNameNr_RichTextCommandId, -1, SIP_NULLPTR},
    {{-1, 0, 0, SIP_TYPE_ENUM, sipNameNr_wxTextBoxAttrWhitespaceMode, {0}, 0}, sipNameNr_TextBoxAttrWhitespaceMode, -1, SIP_NULLPTR},
    {{-1, 0, 0, SIP_TYPE_ENUM, sipNameNr_wxTextBoxAttrVerticalAlignment, {0}, 0}, sipNameNr_TextBoxAttrVerticalAlignment, -1, SIP_NULLPTR},
    {{-1, 0, 0, SIP_TYPE_ENUM, sipNameNr_wxTextBoxAttrCollapseMode, {0}, 0}, sipNameNr_TextBoxAttrCollapseMode, -1, SIP_NULLPTR},
    {{-1, 0, 0, SIP_TYPE_ENUM, sipNameNr_wxTextBoxAttrClearStyle, {0}, 0}, sipNameNr_TextBoxAttrClearStyle, -1, SIP_NULLPTR},
    {{-1, 0, 0, SIP_TYPE_ENUM, sipNameNr_wxTextBoxAttrFloatStyle, {0}, 0}, sipNameNr_TextBoxAttrFloatStyle, -1, SIP_NULLPTR},
    {{-1, 0, 0, SIP_TYPE_ENUM, sipNameNr_wxTextAttrBorderWidth, {0}, 0}, sipNameNr_TextAttrBorderWidth, -1, SIP_NULLPTR},
    {{-1, 0, 0, SIP_TYPE_ENUM, sipNameNr_wxTextAttrBorderFlags, {0}, 0}, sipNameNr_TextAttrBorderFlags, -1, SIP_NULLPTR},
    {{-1, 0, 0, SIP_TYPE_ENUM, sipNameNr_wxTextAttrBorderStyle, {0}, 0}, sipNameNr_TextAttrBorderStyle, -1, SIP_NULLPTR},
    {{-1, 0, 0, SIP_TYPE_ENUM, sipNameNr_wxTextBoxAttrPosition, {0}, 0}, sipNameNr_TextBoxAttrPosition, -1, SIP_NULLPTR},
    {{-1, 0, 0, SIP_TYPE_ENUM, sipNameNr_wxTextAttrUnits, {0}, 0}, sipNameNr_TextAttrUnits, -1, SIP_NULLPTR},
    {{-1, 0, 0, SIP_TYPE_ENUM, sipNameNr_wxTextAttrValueFlags, {0}, 0}, sipNameNr_TextAttrValueFlags, -1, SIP_NULLPTR},
    {{-1, 0, 0, SIP_TYPE_ENUM, sipNameNr_wxTextBoxAttrFlags, {0}, 0}, sipNameNr_TextBoxAttrFlags, -1, SIP_NULLPTR},
    {{-1, 0, 0, SIP_TYPE_ENUM, sipNameNr_wxRichTextHitTestFlags, {0}, 0}, sipNameNr_RichTextHitTestFlags, -1, SIP_NULLPTR},
    {{-1, 0, 0, SIP_TYPE_ENUM, sipNameNr_wxRichTextFileType, {0}, 0}, sipNameNr_RichTextFileType, -1, SIP_NULLPTR},
};
...
static sipEnumMemberDef enummembers[] = {
    ...
    {sipName_RICHTEXT_PAGE_ALL, static_cast<int>(::wxRICHTEXT_PAGE_ALL), 49},
    {sipName_RICHTEXT_PAGE_CENTRE, static_cast<int>(::wxRICHTEXT_PAGE_CENTRE), 50},
    {sipName_RICHTEXT_PAGE_EVEN, static_cast<int>(::wxRICHTEXT_PAGE_EVEN), 49},
    {sipName_RICHTEXT_PAGE_LEFT, static_cast<int>(::wxRICHTEXT_PAGE_LEFT), 50},
    {sipName_RICHTEXT_PAGE_ODD, static_cast<int>(::wxRICHTEXT_PAGE_ODD), 49},
    {sipName_RICHTEXT_PAGE_RIGHT, static_cast<int>(::wxRICHTEXT_PAGE_RIGHT), 50},
    ...
    {sipName_TEXT_ATTR_UNITS_HUNDREDTHS_POINT, static_cast<int>(::wxTEXT_ATTR_UNITS_HUNDREDTHS_POINT), 85},
    {sipName_TEXT_ATTR_UNITS_MASK, static_cast<int>(::wxTEXT_ATTR_UNITS_MASK), 85},
    {sipName_TEXT_ATTR_UNITS_PERCENTAGE, static_cast<int>(::wxTEXT_ATTR_UNITS_PERCENTAGE), 85},
    {sipName_TEXT_ATTR_UNITS_PIXELS, static_cast<int>(::wxTEXT_ATTR_UNITS_PIXELS), 85},
    {sipName_TEXT_ATTR_UNITS_POINTS, static_cast<int>(::wxTEXT_ATTR_UNITS_POINTS), 85},
    {sipName_TEXT_ATTR_UNITS_TENTHS_MM, static_cast<int>(::wxTEXT_ATTR_UNITS_TENTHS_MM), 85},
    {sipName_TEXT_ATTR_VALUE_VALID, static_cast<int>(::wxTEXT_ATTR_VALUE_VALID), 86},
    {sipName_TEXT_ATTR_VALUE_VALID_MASK, static_cast<int>(::wxTEXT_ATTR_VALUE_VALID_MASK), 86},
    {sipName_TEXT_BOX_ATTR_BORDER_COLOUR, static_cast<int>(::wxTEXT_BOX_ATTR_BORDER_COLOUR), 76},
    {sipName_TEXT_BOX_ATTR_BORDER_DASHED, static_cast<int>(::wxTEXT_BOX_ATTR_BORDER_DASHED), 77},
    {sipName_TEXT_BOX_ATTR_BORDER_DOTTED, static_cast<int>(::wxTEXT_BOX_ATTR_BORDER_DOTTED), 77},
    {sipName_TEXT_BOX_ATTR_BORDER_DOUBLE, static_cast<int>(::wxTEXT_BOX_ATTR_BORDER_DOUBLE), 77},
    {sipName_TEXT_BOX_ATTR_BORDER_GROOVE, static_cast<int>(::wxTEXT_BOX_ATTR_BORDER_GROOVE), 77},
    {sipName_TEXT_BOX_ATTR_BORDER_INSET, static_cast<int>(::wxTEXT_BOX_ATTR_BORDER_INSET), 77},
    {sipName_TEXT_BOX_ATTR_BORDER_MEDIUM, static_cast<int>(::wxTEXT_BOX_ATTR_BORDER_MEDIUM), 78},
    {sipName_TEXT_BOX_ATTR_BORDER_NONE, static_cast<int>(::wxTEXT_BOX_ATTR_BORDER_NONE), 77},
    {sipName_TEXT_BOX_ATTR_BORDER_OUTSET, static_cast<int>(::wxTEXT_BOX_ATTR_BORDER_OUTSET), 77},
    {sipName_TEXT_BOX_ATTR_BORDER_RIDGE, static_cast<int>(::wxTEXT_BOX_ATTR_BORDER_RIDGE), 77},
    {sipName_TEXT_BOX_ATTR_BORDER_SOLID, static_cast<int>(::wxTEXT_BOX_ATTR_BORDER_SOLID), 77},
    {sipName_TEXT_BOX_ATTR_BORDER_STYLE, static_cast<int>(::wxTEXT_BOX_ATTR_BORDER_STYLE), 76},
    {sipName_TEXT_BOX_ATTR_BORDER_THICK, static_cast<int>(::wxTEXT_BOX_ATTR_BORDER_THICK), 78},
    {sipName_TEXT_BOX_ATTR_BORDER_THIN, static_cast<int>(::wxTEXT_BOX_ATTR_BORDER_THIN), 78},
    {sipName_TEXT_BOX_ATTR_BOX_STYLE_NAME, static_cast<int>(::wxTEXT_BOX_ATTR_BOX_STYLE_NAME), 90},
    {sipName_TEXT_BOX_ATTR_CLEAR, static_cast<int>(::wxTEXT_BOX_ATTR_CLEAR), 90},
    {sipName_TEXT_BOX_ATTR_CLEAR_BOTH, static_cast<int>(::wxTEXT_BOX_ATTR_CLEAR_BOTH), 88},
    {sipName_TEXT_BOX_ATTR_CLEAR_LEFT, static_cast<int>(::wxTEXT_BOX_ATTR_CLEAR_LEFT), 88},
    {sipName_TEXT_BOX_ATTR_CLEAR_NONE, static_cast<int>(::wxTEXT_BOX_ATTR_CLEAR_NONE), 88},
    {sipName_TEXT_BOX_ATTR_CLEAR_RIGHT, static_cast<int>(::wxTEXT_BOX_ATTR_CLEAR_RIGHT), 88},
    {sipName_TEXT_BOX_ATTR_COLLAPSE_BORDERS, static_cast<int>(::wxTEXT_BOX_ATTR_COLLAPSE_BORDERS), 90},
    {sipName_TEXT_BOX_ATTR_COLLAPSE_FULL, static_cast<int>(::wxTEXT_BOX_ATTR_COLLAPSE_FULL), 89},
    {sipName_TEXT_BOX_ATTR_COLLAPSE_NONE, static_cast<int>(::wxTEXT_BOX_ATTR_COLLAPSE_NONE), 89},
    {sipName_TEXT_BOX_ATTR_CORNER_RADIUS, static_cast<int>(::wxTEXT_BOX_ATTR_CORNER_RADIUS), 90},
    {sipName_TEXT_BOX_ATTR_FLOAT, static_cast<int>(::wxTEXT_BOX_ATTR_FLOAT), 90},
    {sipName_TEXT_BOX_ATTR_FLOAT_LEFT, static_cast<int>(::wxTEXT_BOX_ATTR_FLOAT_LEFT), 91},
    {sipName_TEXT_BOX_ATTR_FLOAT_NONE, static_cast<int>(::wxTEXT_BOX_ATTR_FLOAT_NONE), 91},
    {sipName_TEXT_BOX_ATTR_FLOAT_RIGHT, static_cast<int>(::wxTEXT_BOX_ATTR_FLOAT_RIGHT), 91},
    {sipName_TEXT_BOX_ATTR_POSITION_ABSOLUTE, static_cast<int>(::wxTEXT_BOX_ATTR_POSITION_ABSOLUTE), 92},
    {sipName_TEXT_BOX_ATTR_POSITION_FIXED, static_cast<int>(::wxTEXT_BOX_ATTR_POSITION_FIXED), 92},
    {sipName_TEXT_BOX_ATTR_POSITION_MASK, static_cast<int>(::wxTEXT_BOX_ATTR_POSITION_MASK), 92},
    {sipName_TEXT_BOX_ATTR_POSITION_RELATIVE, static_cast<int>(::wxTEXT_BOX_ATTR_POSITION_RELATIVE), 92},
    {sipName_TEXT_BOX_ATTR_POSITION_STATIC, static_cast<int>(::wxTEXT_BOX_ATTR_POSITION_STATIC), 92},
    {sipName_TEXT_BOX_ATTR_VERTICAL_ALIGNMENT, static_cast<int>(::wxTEXT_BOX_ATTR_VERTICAL_ALIGNMENT), 90},
    {sipName_TEXT_BOX_ATTR_VERTICAL_ALIGNMENT_BOTTOM, static_cast<int>(::wxTEXT_BOX_ATTR_VERTICAL_ALIGNMENT_BOTTOM), 93},
    {sipName_TEXT_BOX_ATTR_VERTICAL_ALIGNMENT_CENTRE, static_cast<int>(::wxTEXT_BOX_ATTR_VERTICAL_ALIGNMENT_CENTRE), 93},
    {sipName_TEXT_BOX_ATTR_VERTICAL_ALIGNMENT_NONE, static_cast<int>(::wxTEXT_BOX_ATTR_VERTICAL_ALIGNMENT_NONE), 93},
    {sipName_TEXT_BOX_ATTR_VERTICAL_ALIGNMENT_TOP, static_cast<int>(::wxTEXT_BOX_ATTR_VERTICAL_ALIGNMENT_TOP), 93},
    {sipName_TEXT_BOX_ATTR_WHITESPACE, static_cast<int>(::wxTEXT_BOX_ATTR_WHITESPACE), 90},
    {sipName_TEXT_BOX_ATTR_WHITESPACE_NONE, static_cast<int>(::wxTEXT_BOX_ATTR_WHITESPACE_NONE), 94},
    {sipName_TEXT_BOX_ATTR_WHITESPACE_NORMAL, static_cast<int>(::wxTEXT_BOX_ATTR_WHITESPACE_NORMAL), 94},
    {sipName_TEXT_BOX_ATTR_WHITESPACE_NO_WRAP, static_cast<int>(::wxTEXT_BOX_ATTR_WHITESPACE_NO_WRAP), 94},
    {sipName_TEXT_BOX_ATTR_WHITESPACE_PREFORMATTED, static_cast<int>(::wxTEXT_BOX_ATTR_WHITESPACE_PREFORMATTED), 94},
    {sipName_TEXT_BOX_ATTR_WHITESPACE_PREFORMATTED_LINE, static_cast<int>(::wxTEXT_BOX_ATTR_WHITESPACE_PREFORMATTED_LINE), 94},
    {sipName_TEXT_BOX_ATTR_WHITESPACE_PREFORMATTED_WRAP, static_cast<int>(::wxTEXT_BOX_ATTR_WHITESPACE_PREFORMATTED_WRAP), 94},
};
...
sipTypeDef *sipExportedTypes__richtext[] = {
    ...
    &sipTypeDef__richtext_wxRichTextLineList.ctd_base,
    &sipTypeDef__richtext_wxRichTextLineList_iterator.ctd_base,
...
#define SIP_MODULE_ENTRY        PyInit__richtext
#define SIP_MODULE_TYPE         PyObject *
#define SIP_MODULE_DISCARD(r)   Py_DECREF(r)
#define SIP_MODULE_RETURN(r)    return (r)
#else
#define SIP_MODULE_ENTRY        init_richtext
...
#endif
{
    static PyMethodDef sip_methods[] = {
        {SIP_MLNAME_CAST(sipName_RichTextModuleInit), func_RichTextModuleInit, METH_VARARGS, SIP_MLDOC_CAST(doc_RichTextModuleInit)},
        {SIP_MLNAME_CAST(sipName_TextAttrCollectCommonAttributes), SIP_MLMETH_CAST(func_TextAttrCollectCommonAttributes), METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_TextAttrCollectCommonAttributes)},
        {SIP_MLNAME_CAST(sipName_RichTextDecimalToRoman), SIP_MLMETH_CAST(func_RichTextDecimalToRoman), METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_RichTextDecimalToRoman)},
        {SIP_MLNAME_CAST(sipName_RichTextTabsEq), SIP_MLMETH_CAST(func_RichTextTabsEq), METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_RichTextTabsEq)},
        {SIP_MLNAME_CAST(sipName_RichTextSplitParaCharStyles), SIP_MLMETH_CAST(func_RichTextSplitParaCharStyles), METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_RichTextSplitParaCharStyles)},
        {SIP_MLNAME_CAST(sipName_RichTextBitlistsEqPartial), SIP_MLMETH_CAST(func_RichTextBitlistsEqPartial), METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_RichTextBitlistsEqPartial)},
        {SIP_MLNAME_CAST(sipName_RichTextCombineBitlists), SIP_MLMETH_CAST(func_RichTextCombineBitlists), METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_RichTextCombineBitlists)},
        {SIP_MLNAME_CAST(sipName_RichTextRemoveStyle), SIP_MLMETH_CAST(func_RichTextRemoveStyle), METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_RichTextRemoveStyle)},
        {SIP_MLNAME_CAST(sipName_RichTextApplyStyle), SIP_MLMETH_CAST(func_RichTextApplyStyle), METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_RichTextApplyStyle)},
        {SIP_MLNAME_CAST(sipName_TextAttrEq), SIP_MLMETH_CAST(func_TextAttrEq), METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_TextAttrEq)},
        {SIP_MLNAME_CAST(sipName_RichTextHasStyle), SIP_MLMETH_CAST(func_RichTextHasStyle), METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_RichTextHasStyle)},
    ...
    sipModule = Py_InitModule(sipName_wx__richtext, sip_methods);
#else
    sipModule = Py_InitModule(const_cast<char *>(sipName_wx__richtext), sip_methods);
#endif
...
#else
    sipAPI__richtext = reinterpret_cast<const sipAPIDef *>(PyCObject_AsVoidPtr(sip_capiobj));
#endif
    ...
    if (sipExportModule(&sipModuleAPI__richtext,SIP_API_MAJOR_NR,SIP_API_MINOR_NR,0) < 0)
    {
        SIP_MODULE_DISCARD(sipModule);
        SIP_MODULE_RETURN(SIP_NULLPTR);
    }
