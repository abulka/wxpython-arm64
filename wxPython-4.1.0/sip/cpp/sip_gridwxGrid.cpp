 ...
 ::wxPen sipwxGrid::GetRowGridLinePen(int row)
{
    ...
    extern  ::wxPen sipVH__grid_62(sip_gilstate_t, sipVirtErrorHandlerFunc, sipSimpleWrapper *, PyObject *, int);

    return sipVH__grid_62(sipGILState, 0, sipPySelf, sipMeth, row);
}
 ...
 ::wxPen sipwxGrid::GetDefaultGridLinePen()
{
    ...
    extern  ::wxPen sipVH__grid_63(sip_gilstate_t, sipVirtErrorHandlerFunc, sipSimpleWrapper *, PyObject *);
 ...
 ::wxPen sipwxGrid::GetColGridLinePen(int col)
{
    ...
    return sipVH__grid_62(sipGILState, 0, sipPySelf, sipMeth, col);
}
 ...
 ::wxSize sipwxGrid::DoGetBestClientSize() const
{
    ...
    extern  ::wxSize sipVH__grid_58(sip_gilstate_t, sipVirtErrorHandlerFunc, sipSimpleWrapper *, PyObject *);

    return sipVH__grid_58(sipGILState, 0, sipPySelf, sipMeth);
}
 ...
 ::wxBorder sipwxGrid::GetDefaultBorderForControl() const
{
    ...
    extern  ::wxBorder sipVH__grid_61(sip_gilstate_t, sipVirtErrorHandlerFunc, sipSimpleWrapper *, PyObject *);
...
void sipwxGrid::DoSetWindowVariant( ::wxWindowVariant variant)
{
    ...
    extern void sipVH__grid_60(sip_gilstate_t, sipVirtErrorHandlerFunc, sipSimpleWrapper *, PyObject *,  ::wxWindowVariant);

    sipVH__grid_60(sipGILState, 0, sipPySelf, sipMeth, variant);
}
...
void sipwxGrid::DoMoveWindow(int x,int y,int width,int height)
{
    ...
    extern void sipVH__grid_59(sip_gilstate_t, sipVirtErrorHandlerFunc, sipSimpleWrapper *, PyObject *, int,int,int,int);

    sipVH__grid_59(sipGILState, 0, sipPySelf, sipMeth, x, y, width, height);
}

 ::wxSize sipwxGrid::DoGetBorderSize() const
{
    sip_gilstate_t sipGILState;
    PyObject *sipMeth;
...
void sipwxGrid::DoSetSizeHints(int minW,int minH,int maxW,int maxH,int incW,int incH)
{
    ...
    extern void sipVH__grid_57(sip_gilstate_t, sipVirtErrorHandlerFunc, sipSimpleWrapper *, PyObject *, int,int,int,int,int,int);

    sipVH__grid_57(sipGILState, 0, sipPySelf, sipMeth, minW, minH, maxW, maxH, incW, incH);
}
...
void sipwxGrid::DoSetClientSize(int width,int height)
{
    ...
    extern void sipVH__grid_56(sip_gilstate_t, sipVirtErrorHandlerFunc, sipSimpleWrapper *, PyObject *, int,int);

    sipVH__grid_56(sipGILState, 0, sipPySelf, sipMeth, width, height);
}
...
void sipwxGrid::DoSetSize(int x,int y,int width,int height,int sizeFlags)
{
    ...
    extern void sipVH__grid_55(sip_gilstate_t, sipVirtErrorHandlerFunc, sipSimpleWrapper *, PyObject *, int,int,int,int,int);

    sipVH__grid_55(sipGILState, 0, sipPySelf, sipMeth, x, y, width, height, sizeFlags);
}
...
void sipwxGrid::DoGetClientSize(int*width,int*height) const
{
    ...
    extern void sipVH__grid_54(sip_gilstate_t, sipVirtErrorHandlerFunc, sipSimpleWrapper *, PyObject *, int*,int*);

    sipVH__grid_54(sipGILState, 0, sipPySelf, sipMeth, width, height);
}
...
void sipwxGrid::DoGetPosition(int*x,int*y) const
{
    ...
    sipVH__grid_54(sipGILState, 0, sipPySelf, sipMeth, x, y);
}
...
void sipwxGrid::DoEnable(bool enable)
{
    ...
    extern void sipVH__grid_49(sip_gilstate_t, sipVirtErrorHandlerFunc, sipSimpleWrapper *, PyObject *, bool);

    sipVH__grid_49(sipGILState, 0, sipPySelf, sipMeth, enable);
}
 ...
 ::wxWindow* sipwxGrid::GetMainWindowOfCompositeControl()
{
    ...
    extern  ::wxWindow* sipVH__grid_53(sip_gilstate_t, sipVirtErrorHandlerFunc, sipSimpleWrapper *, PyObject *);

    return sipVH__grid_53(sipGILState, 0, sipPySelf, sipMeth);
}
 ...
 ::wxValidator* sipwxGrid::GetValidator()
{
    ...
    extern  ::wxValidator* sipVH__grid_52(sip_gilstate_t, sipVirtErrorHandlerFunc, sipSimpleWrapper *, PyObject *);

    return sipVH__grid_52(sipGILState, 0, sipPySelf, sipMeth);
}
 ...
 ::wxPoint sipwxGrid::GetClientAreaOrigin() const
{
    ...
    extern  ::wxPoint sipVH__grid_51(sip_gilstate_t, sipVirtErrorHandlerFunc, sipSimpleWrapper *, PyObject *);

    return sipVH__grid_51(sipGILState, 0, sipPySelf, sipMeth);
}
...
bool sipwxGrid::InformFirstDirection(int direction,int size,int availableOtherDir)
{
    ...
    extern bool sipVH__grid_50(sip_gilstate_t, sipVirtErrorHandlerFunc, sipSimpleWrapper *, PyObject *, int,int,int);

    return sipVH__grid_50(sipGILState, 0, sipPySelf, sipMeth, direction, size, availableOtherDir);
}
...
void sipwxGrid::SetCanFocus(bool canFocus)
{
    ...
    sipVH__grid_49(sipGILState, 0, sipPySelf, sipMeth, canFocus);
}
...
bool sipwxGrid::TryAfter( ::wxEvent& event)
{
    ...
    extern bool sipVH__grid_48(sip_gilstate_t, sipVirtErrorHandlerFunc, sipSimpleWrapper *, PyObject *,  ::wxEvent&);

    return sipVH__grid_48(sipGILState, 0, sipPySelf, sipMeth, event);
}
...
void sipwxGrid::AddChild( ::wxWindowBase*child)
{
    ...
    extern void sipVH__grid_47(sip_gilstate_t, sipVirtErrorHandlerFunc, sipSimpleWrapper *, PyObject *,  ::wxWindowBase*);

    sipVH__grid_47(sipGILState, 0, sipPySelf, sipMeth, child);
}
...
void sipwxGrid::OnDraw( ::wxDC& dc)
{
    ...
    extern void sipVH__grid_46(sip_gilstate_t, sipVirtErrorHandlerFunc, sipSimpleWrapper *, PyObject *,  ::wxDC&);

    sipVH__grid_46(sipGILState, 0, sipPySelf, sipMeth, dc);
}
...
bool sipwxGrid::SendAutoScrollEvents( ::wxScrollWinEvent& event) const
{
    ...
    sipMeth = sipIsPyMethod(&sipGILState,const_cast<char *>(&sipPyMethods[43]),sipPySelf,SIP_NULLPTR,sipName_SendAutoScrollEvents);

    if (!sipMeth)
        return  ::wxGrid::SendAutoScrollEvents(event);

    extern bool sipVH__grid_45(sip_gilstate_t, sipVirtErrorHandlerFunc, sipSimpleWrapper *, PyObject *,  ::wxScrollWinEvent&);

    return sipVH__grid_45(sipGILState, 0, sipPySelf, sipMeth, event);
}
...
bool sipwxGrid::ShouldScrollToChildOnFocus( ::wxWindow*child)
{
    ...
    extern bool sipVH__grid_44(sip_gilstate_t, sipVirtErrorHandlerFunc, sipSimpleWrapper *, PyObject *,  ::wxWindow*);

    return sipVH__grid_44(sipGILState, 0, sipPySelf, sipMeth, child);
}
...
void sipwxGrid::sipProtectVirt_DoSetSizeHints(bool sipSelfWasArg,int minW,int minH,int maxW,int maxH,int incW,int incH)
{
 ...
 ::wxSize sipwxGrid::sipProtectVirt_DoGetBorderSize(bool sipSelfWasArg) const
{
    return (sipSelfWasArg ?  ::wxGrid::DoGetBorderSize() : DoGetBorderSize());
}
...
PyDoc_STRVAR(doc_wxGrid_DoGetBorderSize, "DoGetBorderSize(self) -> Size");

extern "C" {static PyObject *meth_wxGrid_DoGetBorderSize(PyObject *, PyObject *);}
static PyObject *meth_wxGrid_DoGetBorderSize(PyObject *sipSelf, PyObject *sipArgs)
{
    PyObject *sipParseErr = SIP_NULLPTR;
    bool sipSelfWasArg = (!sipSelf || sipIsDerivedClass((sipSimpleWrapper *)sipSelf));
    ...
    /* Raise an exception if the arguments couldn't be parsed. */
    sipNoMethod(sipParseErr, sipName_Grid, sipName_DoGetBorderSize, doc_wxGrid_DoGetBorderSize);
...
static void *cast_wxGrid(void *sipCppV, const sipTypeDef *targetType)
{
    ...
    if (targetType == sipType_wxScrolledCanvas)
        return static_cast< ::wxScrolledCanvas *>(sipCpp);
...
static sipEncodedTypeDef supers_wxGrid[] = {{24, 0, 1}};


static PyMethodDef methods_wxGrid[] = {
    {SIP_MLNAME_CAST(sipName_AcceptsFocus), meth_wxGrid_AcceptsFocus, METH_VARARGS, SIP_MLDOC_CAST(doc_wxGrid_AcceptsFocus)},
    {SIP_MLNAME_CAST(sipName_AcceptsFocusFromKeyboard), meth_wxGrid_AcceptsFocusFromKeyboard, METH_VARARGS, SIP_MLDOC_CAST(doc_wxGrid_AcceptsFocusFromKeyboard)},
    {SIP_MLNAME_CAST(sipName_AcceptsFocusRecursively), meth_wxGrid_AcceptsFocusRecursively, METH_VARARGS, SIP_MLDOC_CAST(doc_wxGrid_AcceptsFocusRecursively)},
    {SIP_MLNAME_CAST(sipName_AddChild), SIP_MLMETH_CAST(meth_wxGrid_AddChild), METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxGrid_AddChild)},
    {SIP_MLNAME_CAST(sipName_AppendCols), SIP_MLMETH_CAST(meth_wxGrid_AppendCols), METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxGrid_AppendCols)},
    {SIP_MLNAME_CAST(sipName_AppendRows), SIP_MLMETH_CAST(meth_wxGrid_AppendRows), METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxGrid_AppendRows)},
    {SIP_MLNAME_CAST(sipName_AreHorzGridLinesClipped), meth_wxGrid_AreHorzGridLinesClipped, METH_VARARGS, SIP_MLDOC_CAST(doc_wxGrid_AreHorzGridLinesClipped)},
    {SIP_MLNAME_CAST(sipName_AreVertGridLinesClipped), meth_wxGrid_AreVertGridLinesClipped, METH_VARARGS, SIP_MLDOC_CAST(doc_wxGrid_AreVertGridLinesClipped)},
    {SIP_MLNAME_CAST(sipName_AssignTable), SIP_MLMETH_CAST(meth_wxGrid_AssignTable), METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxGrid_AssignTable)},
    {SIP_MLNAME_CAST(sipName_AutoSize), meth_wxGrid_AutoSize, METH_VARARGS, SIP_MLDOC_CAST(doc_wxGrid_AutoSize)},
    {SIP_MLNAME_CAST(sipName_AutoSizeColLabelSize), SIP_MLMETH_CAST(meth_wxGrid_AutoSizeColLabelSize), METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxGrid_AutoSizeColLabelSize)},
    {SIP_MLNAME_CAST(sipName_AutoSizeColumn), SIP_MLMETH_CAST(meth_wxGrid_AutoSizeColumn), METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxGrid_AutoSizeColumn)},
    {SIP_MLNAME_CAST(sipName_AutoSizeColumns), SIP_MLMETH_CAST(meth_wxGrid_AutoSizeColumns), METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxGrid_AutoSizeColumns)},
    {SIP_MLNAME_CAST(sipName_AutoSizeRow), SIP_MLMETH_CAST(meth_wxGrid_AutoSizeRow), METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxGrid_AutoSizeRow)},
    {SIP_MLNAME_CAST(sipName_AutoSizeRowLabelSize), SIP_MLMETH_CAST(meth_wxGrid_AutoSizeRowLabelSize), METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxGrid_AutoSizeRowLabelSize)},
    {SIP_MLNAME_CAST(sipName_AutoSizeRows), SIP_MLMETH_CAST(meth_wxGrid_AutoSizeRows), METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxGrid_AutoSizeRows)},
    {SIP_MLNAME_CAST(sipName_BeginBatch), meth_wxGrid_BeginBatch, METH_VARARGS, SIP_MLDOC_CAST(doc_wxGrid_BeginBatch)},
    {SIP_MLNAME_CAST(sipName_BlockToDeviceRect), SIP_MLMETH_CAST(meth_wxGrid_BlockToDeviceRect), METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxGrid_BlockToDeviceRect)},
    {SIP_MLNAME_CAST(sipName_CalcCellsExposed), SIP_MLMETH_CAST(meth_wxGrid_CalcCellsExposed), METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxGrid_CalcCellsExposed)},
    {SIP_MLNAME_CAST(sipName_CalcColLabelsExposed), SIP_MLMETH_CAST(meth_wxGrid_CalcColLabelsExposed), METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxGrid_CalcColLabelsExposed)},
    {SIP_MLNAME_CAST(sipName_CalcGridWindowScrolledPosition), SIP_MLMETH_CAST(meth_wxGrid_CalcGridWindowScrolledPosition), METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxGrid_CalcGridWindowScrolledPosition)},
    {SIP_MLNAME_CAST(sipName_CalcGridWindowUnscrolledPosition), SIP_MLMETH_CAST(meth_wxGrid_CalcGridWindowUnscrolledPosition), METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxGrid_CalcGridWindowUnscrolledPosition)},
    {SIP_MLNAME_CAST(sipName_CalcRowLabelsExposed), SIP_MLMETH_CAST(meth_wxGrid_CalcRowLabelsExposed), METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxGrid_CalcRowLabelsExposed)},
    {SIP_MLNAME_CAST(sipName_CanDragCell), meth_wxGrid_CanDragCell, METH_VARARGS, SIP_MLDOC_CAST(doc_wxGrid_CanDragCell)},
    {SIP_MLNAME_CAST(sipName_CanDragColMove), meth_wxGrid_CanDragColMove, METH_VARARGS, SIP_MLDOC_CAST(doc_wxGrid_CanDragColMove)},
    {SIP_MLNAME_CAST(sipName_CanDragColSize), SIP_MLMETH_CAST(meth_wxGrid_CanDragColSize), METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxGrid_CanDragColSize)},
    {SIP_MLNAME_CAST(sipName_CanDragGridSize), meth_wxGrid_CanDragGridSize, METH_VARARGS, SIP_MLDOC_CAST(doc_wxGrid_CanDragGridSize)},
    {SIP_MLNAME_CAST(sipName_CanDragRowSize), SIP_MLMETH_CAST(meth_wxGrid_CanDragRowSize), METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxGrid_CanDragRowSize)},
    {SIP_MLNAME_CAST(sipName_CanEnableCellControl), meth_wxGrid_CanEnableCellControl, METH_VARARGS, SIP_MLDOC_CAST(doc_wxGrid_CanEnableCellControl)},
    {SIP_MLNAME_CAST(sipName_CanHaveAttributes), meth_wxGrid_CanHaveAttributes, METH_VARARGS, SIP_MLDOC_CAST(doc_wxGrid_CanHaveAttributes)},
    {SIP_MLNAME_CAST(sipName_CanHideColumns), meth_wxGrid_CanHideColumns, METH_VARARGS, SIP_MLDOC_CAST(doc_wxGrid_CanHideColumns)},
    {SIP_MLNAME_CAST(sipName_CellToGridWindow), SIP_MLMETH_CAST(meth_wxGrid_CellToGridWindow), METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxGrid_CellToGridWindow)},
    {SIP_MLNAME_CAST(sipName_CellToRect), SIP_MLMETH_CAST(meth_wxGrid_CellToRect), METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxGrid_CellToRect)},
    {SIP_MLNAME_CAST(sipName_ClearGrid), meth_wxGrid_ClearGrid, METH_VARARGS, SIP_MLDOC_CAST(doc_wxGrid_ClearGrid)},
    {SIP_MLNAME_CAST(sipName_ClearSelection), meth_wxGrid_ClearSelection, METH_VARARGS, SIP_MLDOC_CAST(doc_wxGrid_ClearSelection)},
    {SIP_MLNAME_CAST(sipName_ClipHorzGridLines), SIP_MLMETH_CAST(meth_wxGrid_ClipHorzGridLines), METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxGrid_ClipHorzGridLines)},
    {SIP_MLNAME_CAST(sipName_ClipVertGridLines), SIP_MLMETH_CAST(meth_wxGrid_ClipVertGridLines), METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxGrid_ClipVertGridLines)},
    {SIP_MLNAME_CAST(sipName_Create), SIP_MLMETH_CAST(meth_wxGrid_Create), METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxGrid_Create)},
    {SIP_MLNAME_CAST(sipName_CreateGrid), SIP_MLMETH_CAST(meth_wxGrid_CreateGrid), METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxGrid_CreateGrid)},
    {SIP_MLNAME_CAST(sipName_DeleteCols), SIP_MLMETH_CAST(meth_wxGrid_DeleteCols), METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxGrid_DeleteCols)},
    {SIP_MLNAME_CAST(sipName_DeleteRows), SIP_MLMETH_CAST(meth_wxGrid_DeleteRows), METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxGrid_DeleteRows)},
    {SIP_MLNAME_CAST(sipName_DeselectCell), SIP_MLMETH_CAST(meth_wxGrid_DeselectCell), METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxGrid_DeselectCell)},
    {SIP_MLNAME_CAST(sipName_DeselectCol), SIP_MLMETH_CAST(meth_wxGrid_DeselectCol), METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxGrid_DeselectCol)},
    {SIP_MLNAME_CAST(sipName_DeselectRow), SIP_MLMETH_CAST(meth_wxGrid_DeselectRow), METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxGrid_DeselectRow)},
    {SIP_MLNAME_CAST(sipName_Destroy), meth_wxGrid_Destroy, METH_VARARGS, SIP_MLDOC_CAST(doc_wxGrid_Destroy)},
    {SIP_MLNAME_CAST(sipName_DevicePosToGridWindow), SIP_MLMETH_CAST(meth_wxGrid_DevicePosToGridWindow), METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxGrid_DevicePosToGridWindow)},
    {SIP_MLNAME_CAST(sipName_DisableCellEditControl), meth_wxGrid_DisableCellEditControl, METH_VARARGS, SIP_MLDOC_CAST(doc_wxGrid_DisableCellEditControl)},
    {SIP_MLNAME_CAST(sipName_DisableColResize), SIP_MLMETH_CAST(meth_wxGrid_DisableColResize), METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxGrid_DisableColResize)},
    {SIP_MLNAME_CAST(sipName_DisableDragColMove), meth_wxGrid_DisableDragColMove, METH_VARARGS, SIP_MLDOC_CAST(doc_wxGrid_DisableDragColMove)},
    {SIP_MLNAME_CAST(sipName_DisableDragColSize), meth_wxGrid_DisableDragColSize, METH_VARARGS, SIP_MLDOC_CAST(doc_wxGrid_DisableDragColSize)},
    {SIP_MLNAME_CAST(sipName_DisableDragGridSize), meth_wxGrid_DisableDragGridSize, METH_VARARGS, SIP_MLDOC_CAST(doc_wxGrid_DisableDragGridSize)},
    {SIP_MLNAME_CAST(sipName_DisableDragRowSize), meth_wxGrid_DisableDragRowSize, METH_VARARGS, SIP_MLDOC_CAST(doc_wxGrid_DisableDragRowSize)},
    {SIP_MLNAME_CAST(sipName_DisableHidingColumns), meth_wxGrid_DisableHidingColumns, METH_VARARGS, SIP_MLDOC_CAST(doc_wxGrid_DisableHidingColumns)},
    {SIP_MLNAME_CAST(sipName_DisableRowResize), SIP_MLMETH_CAST(meth_wxGrid_DisableRowResize), METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxGrid_DisableRowResize)},
    {SIP_MLNAME_CAST(sipName_DoEnable), SIP_MLMETH_CAST(meth_wxGrid_DoEnable), METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxGrid_DoEnable)},
    {SIP_MLNAME_CAST(sipName_DoFreeze), meth_wxGrid_DoFreeze, METH_VARARGS, SIP_MLDOC_CAST(doc_wxGrid_DoFreeze)},
    {SIP_MLNAME_CAST(sipName_DoGetBestClientSize), meth_wxGrid_DoGetBestClientSize, METH_VARARGS, SIP_MLDOC_CAST(doc_wxGrid_DoGetBestClientSize)},
    {SIP_MLNAME_CAST(sipName_DoGetBestSize), meth_wxGrid_DoGetBestSize, METH_VARARGS, SIP_MLDOC_CAST(doc_wxGrid_DoGetBestSize)},
    {SIP_MLNAME_CAST(sipName_DoGetBorderSize), meth_wxGrid_DoGetBorderSize, METH_VARARGS, SIP_MLDOC_CAST(doc_wxGrid_DoGetBorderSize)},
    {SIP_MLNAME_CAST(sipName_DoGetClientSize), SIP_MLMETH_CAST(meth_wxGrid_DoGetClientSize), METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxGrid_DoGetClientSize)},
    {SIP_MLNAME_CAST(sipName_DoGetPosition), SIP_MLMETH_CAST(meth_wxGrid_DoGetPosition), METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxGrid_DoGetPosition)},
    {SIP_MLNAME_CAST(sipName_DoGetSize), SIP_MLMETH_CAST(meth_wxGrid_DoGetSize), METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxGrid_DoGetSize)},
    {SIP_MLNAME_CAST(sipName_DoMoveWindow), SIP_MLMETH_CAST(meth_wxGrid_DoMoveWindow), METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxGrid_DoMoveWindow)},
    {SIP_MLNAME_CAST(sipName_DoSetClientSize), SIP_MLMETH_CAST(meth_wxGrid_DoSetClientSize), METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxGrid_DoSetClientSize)},
    {SIP_MLNAME_CAST(sipName_DoSetSize), SIP_MLMETH_CAST(meth_wxGrid_DoSetSize), METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxGrid_DoSetSize)},
    {SIP_MLNAME_CAST(sipName_DoSetSizeHints), SIP_MLMETH_CAST(meth_wxGrid_DoSetSizeHints), METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxGrid_DoSetSizeHints)},
    {SIP_MLNAME_CAST(sipName_DoSetWindowVariant), SIP_MLMETH_CAST(meth_wxGrid_DoSetWindowVariant), METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxGrid_DoSetWindowVariant)},
    {SIP_MLNAME_CAST(sipName_DoThaw), meth_wxGrid_DoThaw, METH_VARARGS, SIP_MLDOC_CAST(doc_wxGrid_DoThaw)},
    {SIP_MLNAME_CAST(sipName_DrawCellHighlight), SIP_MLMETH_CAST(meth_wxGrid_DrawCellHighlight), METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxGrid_DrawCellHighlight)},
    {SIP_MLNAME_CAST(sipName_DrawColLabel), SIP_MLMETH_CAST(meth_wxGrid_DrawColLabel), METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxGrid_DrawColLabel)},
    {SIP_MLNAME_CAST(sipName_DrawColLabels), SIP_MLMETH_CAST(meth_wxGrid_DrawColLabels), METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxGrid_DrawColLabels)},
    {SIP_MLNAME_CAST(sipName_DrawCornerLabel), SIP_MLMETH_CAST(meth_wxGrid_DrawCornerLabel), METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxGrid_DrawCornerLabel)},
    {SIP_MLNAME_CAST(sipName_DrawRowLabel), SIP_MLMETH_CAST(meth_wxGrid_DrawRowLabel), METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxGrid_DrawRowLabel)},
    {SIP_MLNAME_CAST(sipName_DrawRowLabels), SIP_MLMETH_CAST(meth_wxGrid_DrawRowLabels), METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxGrid_DrawRowLabels)},
    {SIP_MLNAME_CAST(sipName_DrawTextRectangle), SIP_MLMETH_CAST(meth_wxGrid_DrawTextRectangle), METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxGrid_DrawTextRectangle)},
    {SIP_MLNAME_CAST(sipName_EnableCellEditControl), SIP_MLMETH_CAST(meth_wxGrid_EnableCellEditControl), METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxGrid_EnableCellEditControl)},
    {SIP_MLNAME_CAST(sipName_EnableDragCell), SIP_MLMETH_CAST(meth_wxGrid_EnableDragCell), METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxGrid_EnableDragCell)},
    {SIP_MLNAME_CAST(sipName_EnableDragColMove), SIP_MLMETH_CAST(meth_wxGrid_EnableDragColMove), METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxGrid_EnableDragColMove)},
    {SIP_MLNAME_CAST(sipName_EnableDragColSize), SIP_MLMETH_CAST(meth_wxGrid_EnableDragColSize), METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxGrid_EnableDragColSize)},
    {SIP_MLNAME_CAST(sipName_EnableDragGridSize), SIP_MLMETH_CAST(meth_wxGrid_EnableDragGridSize), METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxGrid_EnableDragGridSize)},
    {SIP_MLNAME_CAST(sipName_EnableDragRowSize), SIP_MLMETH_CAST(meth_wxGrid_EnableDragRowSize), METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxGrid_EnableDragRowSize)},
    {SIP_MLNAME_CAST(sipName_EnableEditing), SIP_MLMETH_CAST(meth_wxGrid_EnableEditing), METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxGrid_EnableEditing)},
    {SIP_MLNAME_CAST(sipName_EnableGridLines), SIP_MLMETH_CAST(meth_wxGrid_EnableGridLines), METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxGrid_EnableGridLines)},
    {SIP_MLNAME_CAST(sipName_EnableHidingColumns), SIP_MLMETH_CAST(meth_wxGrid_EnableHidingColumns), METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxGrid_EnableHidingColumns)},
    {SIP_MLNAME_CAST(sipName_EndBatch), meth_wxGrid_EndBatch, METH_VARARGS, SIP_MLDOC_CAST(doc_wxGrid_EndBatch)},
    {SIP_MLNAME_CAST(sipName_Fit), meth_wxGrid_Fit, METH_VARARGS, SIP_MLDOC_CAST(doc_wxGrid_Fit)},
    {SIP_MLNAME_CAST(sipName_ForceRefresh), meth_wxGrid_ForceRefresh, METH_VARARGS, SIP_MLDOC_CAST(doc_wxGrid_ForceRefresh)},
    {SIP_MLNAME_CAST(sipName_FreezeTo), SIP_MLMETH_CAST(meth_wxGrid_FreezeTo), METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxGrid_FreezeTo)},
    {SIP_MLNAME_CAST(sipName_GetBatchCount), meth_wxGrid_GetBatchCount, METH_VARARGS, SIP_MLDOC_CAST(doc_wxGrid_GetBatchCount)},
    {SIP_MLNAME_CAST(sipName_GetCellAlignment), SIP_MLMETH_CAST(meth_wxGrid_GetCellAlignment), METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxGrid_GetCellAlignment)},
    {SIP_MLNAME_CAST(sipName_GetCellBackgroundColour), SIP_MLMETH_CAST(meth_wxGrid_GetCellBackgroundColour), METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxGrid_GetCellBackgroundColour)},
    {SIP_MLNAME_CAST(sipName_GetCellEditor), SIP_MLMETH_CAST(meth_wxGrid_GetCellEditor), METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxGrid_GetCellEditor)},
    {SIP_MLNAME_CAST(sipName_GetCellFitMode), SIP_MLMETH_CAST(meth_wxGrid_GetCellFitMode), METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxGrid_GetCellFitMode)},
    {SIP_MLNAME_CAST(sipName_GetCellFont), SIP_MLMETH_CAST(meth_wxGrid_GetCellFont), METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxGrid_GetCellFont)},
    {SIP_MLNAME_CAST(sipName_GetCellHighlightColour), meth_wxGrid_GetCellHighlightColour, METH_VARARGS, SIP_MLDOC_CAST(doc_wxGrid_GetCellHighlightColour)},
    {SIP_MLNAME_CAST(sipName_GetCellHighlightPenWidth), meth_wxGrid_GetCellHighlightPenWidth, METH_VARARGS, SIP_MLDOC_CAST(doc_wxGrid_GetCellHighlightPenWidth)},
    {SIP_MLNAME_CAST(sipName_GetCellHighlightROPenWidth), meth_wxGrid_GetCellHighlightROPenWidth, METH_VARARGS, SIP_MLDOC_CAST(doc_wxGrid_GetCellHighlightROPenWidth)},
    {SIP_MLNAME_CAST(sipName_GetCellOverflow), SIP_MLMETH_CAST(meth_wxGrid_GetCellOverflow), METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxGrid_GetCellOverflow)},
    {SIP_MLNAME_CAST(sipName_GetCellRenderer), SIP_MLMETH_CAST(meth_wxGrid_GetCellRenderer), METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxGrid_GetCellRenderer)},
    {SIP_MLNAME_CAST(sipName_GetCellSize), SIP_MLMETH_CAST(meth_wxGrid_GetCellSize), METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxGrid_GetCellSize)},
    {SIP_MLNAME_CAST(sipName_GetCellTextColour), SIP_MLMETH_CAST(meth_wxGrid_GetCellTextColour), METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxGrid_GetCellTextColour)},
    {SIP_MLNAME_CAST(sipName_GetCellValue), SIP_MLMETH_CAST(meth_wxGrid_GetCellValue), METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxGrid_GetCellValue)},
    {SIP_MLNAME_CAST(sipName_GetClassDefaultAttributes), SIP_MLMETH_CAST(meth_wxGrid_GetClassDefaultAttributes), METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxGrid_GetClassDefaultAttributes)},
    {SIP_MLNAME_CAST(sipName_GetClientAreaOrigin), meth_wxGrid_GetClientAreaOrigin, METH_VARARGS, SIP_MLDOC_CAST(doc_wxGrid_GetClientAreaOrigin)},
    {SIP_MLNAME_CAST(sipName_GetColAt), SIP_MLMETH_CAST(meth_wxGrid_GetColAt), METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxGrid_GetColAt)},
    {SIP_MLNAME_CAST(sipName_GetColGridLinePen), SIP_MLMETH_CAST(meth_wxGrid_GetColGridLinePen), METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxGrid_GetColGridLinePen)},
    {SIP_MLNAME_CAST(sipName_GetColLabelAlignment), SIP_MLMETH_CAST(meth_wxGrid_GetColLabelAlignment), METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxGrid_GetColLabelAlignment)},
    {SIP_MLNAME_CAST(sipName_GetColLabelSize), meth_wxGrid_GetColLabelSize, METH_VARARGS, SIP_MLDOC_CAST(doc_wxGrid_GetColLabelSize)},
    {SIP_MLNAME_CAST(sipName_GetColLabelTextOrientation), meth_wxGrid_GetColLabelTextOrientation, METH_VARARGS, SIP_MLDOC_CAST(doc_wxGrid_GetColLabelTextOrientation)},
    {SIP_MLNAME_CAST(sipName_GetColLabelValue), SIP_MLMETH_CAST(meth_wxGrid_GetColLabelValue), METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxGrid_GetColLabelValue)},
    {SIP_MLNAME_CAST(sipName_GetColLeft), SIP_MLMETH_CAST(meth_wxGrid_GetColLeft), METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxGrid_GetColLeft)},
    {SIP_MLNAME_CAST(sipName_GetColMinimalAcceptableWidth), meth_wxGrid_GetColMinimalAcceptableWidth, METH_VARARGS, SIP_MLDOC_CAST(doc_wxGrid_GetColMinimalAcceptableWidth)},
    {SIP_MLNAME_CAST(sipName_GetColMinimalWidth), SIP_MLMETH_CAST(meth_wxGrid_GetColMinimalWidth), METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxGrid_GetColMinimalWidth)},
    {SIP_MLNAME_CAST(sipName_GetColPos), SIP_MLMETH_CAST(meth_wxGrid_GetColPos), METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxGrid_GetColPos)},
    {SIP_MLNAME_CAST(sipName_GetColRight), SIP_MLMETH_CAST(meth_wxGrid_GetColRight), METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxGrid_GetColRight)},
    {SIP_MLNAME_CAST(sipName_GetColSize), SIP_MLMETH_CAST(meth_wxGrid_GetColSize), METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxGrid_GetColSize)},
    {SIP_MLNAME_CAST(sipName_GetColSizes), meth_wxGrid_GetColSizes, METH_VARARGS, SIP_MLDOC_CAST(doc_wxGrid_GetColSizes)},
    {SIP_MLNAME_CAST(sipName_GetCornerLabelAlignment), SIP_MLMETH_CAST(meth_wxGrid_GetCornerLabelAlignment), METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxGrid_GetCornerLabelAlignment)},
    {SIP_MLNAME_CAST(sipName_GetCornerLabelTextOrientation), meth_wxGrid_GetCornerLabelTextOrientation, METH_VARARGS, SIP_MLDOC_CAST(doc_wxGrid_GetCornerLabelTextOrientation)},
    {SIP_MLNAME_CAST(sipName_GetCornerLabelValue), meth_wxGrid_GetCornerLabelValue, METH_VARARGS, SIP_MLDOC_CAST(doc_wxGrid_GetCornerLabelValue)},
    {SIP_MLNAME_CAST(sipName_GetDefaultBorder), meth_wxGrid_GetDefaultBorder, METH_VARARGS, SIP_MLDOC_CAST(doc_wxGrid_GetDefaultBorder)},
    {SIP_MLNAME_CAST(sipName_GetDefaultBorderForControl), meth_wxGrid_GetDefaultBorderForControl, METH_VARARGS, SIP_MLDOC_CAST(doc_wxGrid_GetDefaultBorderForControl)},
    {SIP_MLNAME_CAST(sipName_GetDefaultCellAlignment), SIP_MLMETH_CAST(meth_wxGrid_GetDefaultCellAlignment), METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxGrid_GetDefaultCellAlignment)},
    {SIP_MLNAME_CAST(sipName_GetDefaultCellBackgroundColour), meth_wxGrid_GetDefaultCellBackgroundColour, METH_VARARGS, SIP_MLDOC_CAST(doc_wxGrid_GetDefaultCellBackgroundColour)},
    {SIP_MLNAME_CAST(sipName_GetDefaultCellFitMode), meth_wxGrid_GetDefaultCellFitMode, METH_VARARGS, SIP_MLDOC_CAST(doc_wxGrid_GetDefaultCellFitMode)},
    {SIP_MLNAME_CAST(sipName_GetDefaultCellFont), meth_wxGrid_GetDefaultCellFont, METH_VARARGS, SIP_MLDOC_CAST(doc_wxGrid_GetDefaultCellFont)},
    {SIP_MLNAME_CAST(sipName_GetDefaultCellOverflow), meth_wxGrid_GetDefaultCellOverflow, METH_VARARGS, SIP_MLDOC_CAST(doc_wxGrid_GetDefaultCellOverflow)},
    {SIP_MLNAME_CAST(sipName_GetDefaultCellTextColour), meth_wxGrid_GetDefaultCellTextColour, METH_VARARGS, SIP_MLDOC_CAST(doc_wxGrid_GetDefaultCellTextColour)},
    {SIP_MLNAME_CAST(sipName_GetDefaultColLabelSize), meth_wxGrid_GetDefaultColLabelSize, METH_VARARGS, SIP_MLDOC_CAST(doc_wxGrid_GetDefaultColLabelSize)},
    {SIP_MLNAME_CAST(sipName_GetDefaultColSize), meth_wxGrid_GetDefaultColSize, METH_VARARGS, SIP_MLDOC_CAST(doc_wxGrid_GetDefaultColSize)},
    {SIP_MLNAME_CAST(sipName_GetDefaultEditor), meth_wxGrid_GetDefaultEditor, METH_VARARGS, SIP_MLDOC_CAST(doc_wxGrid_GetDefaultEditor)},
    {SIP_MLNAME_CAST(sipName_GetDefaultEditorForCell), SIP_MLMETH_CAST(meth_wxGrid_GetDefaultEditorForCell), METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxGrid_GetDefaultEditorForCell)},
    {SIP_MLNAME_CAST(sipName_GetDefaultEditorForType), SIP_MLMETH_CAST(meth_wxGrid_GetDefaultEditorForType), METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxGrid_GetDefaultEditorForType)},
    {SIP_MLNAME_CAST(sipName_GetDefaultGridLinePen), meth_wxGrid_GetDefaultGridLinePen, METH_VARARGS, SIP_MLDOC_CAST(doc_wxGrid_GetDefaultGridLinePen)},
    {SIP_MLNAME_CAST(sipName_GetDefaultRenderer), meth_wxGrid_GetDefaultRenderer, METH_VARARGS, SIP_MLDOC_CAST(doc_wxGrid_GetDefaultRenderer)},
    {SIP_MLNAME_CAST(sipName_GetDefaultRendererForCell), SIP_MLMETH_CAST(meth_wxGrid_GetDefaultRendererForCell), METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxGrid_GetDefaultRendererForCell)},
    {SIP_MLNAME_CAST(sipName_GetDefaultRendererForType), SIP_MLMETH_CAST(meth_wxGrid_GetDefaultRendererForType), METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxGrid_GetDefaultRendererForType)},
    {SIP_MLNAME_CAST(sipName_GetDefaultRowLabelSize), meth_wxGrid_GetDefaultRowLabelSize, METH_VARARGS, SIP_MLDOC_CAST(doc_wxGrid_GetDefaultRowLabelSize)},
    {SIP_MLNAME_CAST(sipName_GetDefaultRowSize), meth_wxGrid_GetDefaultRowSize, METH_VARARGS, SIP_MLDOC_CAST(doc_wxGrid_GetDefaultRowSize)},
    {SIP_MLNAME_CAST(sipName_GetFirstFullyVisibleColumn), meth_wxGrid_GetFirstFullyVisibleColumn, METH_VARARGS, SIP_MLDOC_CAST(doc_wxGrid_GetFirstFullyVisibleColumn)},
    {SIP_MLNAME_CAST(sipName_GetFirstFullyVisibleRow), meth_wxGrid_GetFirstFullyVisibleRow, METH_VARARGS, SIP_MLDOC_CAST(doc_wxGrid_GetFirstFullyVisibleRow)},
    {SIP_MLNAME_CAST(sipName_GetFrozenColGridWindow), meth_wxGrid_GetFrozenColGridWindow, METH_VARARGS, SIP_MLDOC_CAST(doc_wxGrid_GetFrozenColGridWindow)},
    {SIP_MLNAME_CAST(sipName_GetFrozenCornerGridWindow), meth_wxGrid_GetFrozenCornerGridWindow, METH_VARARGS, SIP_MLDOC_CAST(doc_wxGrid_GetFrozenCornerGridWindow)},
    {SIP_MLNAME_CAST(sipName_GetFrozenRowGridWindow), meth_wxGrid_GetFrozenRowGridWindow, METH_VARARGS, SIP_MLDOC_CAST(doc_wxGrid_GetFrozenRowGridWindow)},
    {SIP_MLNAME_CAST(sipName_GetGridColHeader), meth_wxGrid_GetGridColHeader, METH_VARARGS, SIP_MLDOC_CAST(doc_wxGrid_GetGridColHeader)},
    {SIP_MLNAME_CAST(sipName_GetGridColLabelWindow), meth_wxGrid_GetGridColLabelWindow, METH_VARARGS, SIP_MLDOC_CAST(doc_wxGrid_GetGridColLabelWindow)},
    {SIP_MLNAME_CAST(sipName_GetGridCornerLabelWindow), meth_wxGrid_GetGridCornerLabelWindow, METH_VARARGS, SIP_MLDOC_CAST(doc_wxGrid_GetGridCornerLabelWindow)},
    {SIP_MLNAME_CAST(sipName_GetGridCursorCol), meth_wxGrid_GetGridCursorCol, METH_VARARGS, SIP_MLDOC_CAST(doc_wxGrid_GetGridCursorCol)},
    {SIP_MLNAME_CAST(sipName_GetGridCursorCoords), meth_wxGrid_GetGridCursorCoords, METH_VARARGS, SIP_MLDOC_CAST(doc_wxGrid_GetGridCursorCoords)},
    {SIP_MLNAME_CAST(sipName_GetGridCursorRow), meth_wxGrid_GetGridCursorRow, METH_VARARGS, SIP_MLDOC_CAST(doc_wxGrid_GetGridCursorRow)},
    {SIP_MLNAME_CAST(sipName_GetGridLineColour), meth_wxGrid_GetGridLineColour, METH_VARARGS, SIP_MLDOC_CAST(doc_wxGrid_GetGridLineColour)},
    {SIP_MLNAME_CAST(sipName_GetGridRowLabelWindow), meth_wxGrid_GetGridRowLabelWindow, METH_VARARGS, SIP_MLDOC_CAST(doc_wxGrid_GetGridRowLabelWindow)},
    {SIP_MLNAME_CAST(sipName_GetGridWindow), meth_wxGrid_GetGridWindow, METH_VARARGS, SIP_MLDOC_CAST(doc_wxGrid_GetGridWindow)},
    {SIP_MLNAME_CAST(sipName_GetGridWindowOffset), SIP_MLMETH_CAST(meth_wxGrid_GetGridWindowOffset), METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxGrid_GetGridWindowOffset)},
    {SIP_MLNAME_CAST(sipName_GetLabelBackgroundColour), meth_wxGrid_GetLabelBackgroundColour, METH_VARARGS, SIP_MLDOC_CAST(doc_wxGrid_GetLabelBackgroundColour)},
    {SIP_MLNAME_CAST(sipName_GetLabelFont), meth_wxGrid_GetLabelFont, METH_VARARGS, SIP_MLDOC_CAST(doc_wxGrid_GetLabelFont)},
    {SIP_MLNAME_CAST(sipName_GetLabelTextColour), meth_wxGrid_GetLabelTextColour, METH_VARARGS, SIP_MLDOC_CAST(doc_wxGrid_GetLabelTextColour)},
    {SIP_MLNAME_CAST(sipName_GetMainWindowOfCompositeControl), meth_wxGrid_GetMainWindowOfCompositeControl, METH_VARARGS, SIP_MLDOC_CAST(doc_wxGrid_GetMainWindowOfCompositeControl)},
    {SIP_MLNAME_CAST(sipName_GetNumberCols), meth_wxGrid_GetNumberCols, METH_VARARGS, SIP_MLDOC_CAST(doc_wxGrid_GetNumberCols)},
    {SIP_MLNAME_CAST(sipName_GetNumberFrozenCols), meth_wxGrid_GetNumberFrozenCols, METH_VARARGS, SIP_MLDOC_CAST(doc_wxGrid_GetNumberFrozenCols)},
    {SIP_MLNAME_CAST(sipName_GetNumberFrozenRows), meth_wxGrid_GetNumberFrozenRows, METH_VARARGS, SIP_MLDOC_CAST(doc_wxGrid_GetNumberFrozenRows)},
    {SIP_MLNAME_CAST(sipName_GetNumberRows), meth_wxGrid_GetNumberRows, METH_VARARGS, SIP_MLDOC_CAST(doc_wxGrid_GetNumberRows)},
    {SIP_MLNAME_CAST(sipName_GetOrCreateCellAttr), SIP_MLMETH_CAST(meth_wxGrid_GetOrCreateCellAttr), METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxGrid_GetOrCreateCellAttr)},
    {SIP_MLNAME_CAST(sipName_GetOrCreateCellAttrPtr), SIP_MLMETH_CAST(meth_wxGrid_GetOrCreateCellAttrPtr), METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxGrid_GetOrCreateCellAttrPtr)},
    {SIP_MLNAME_CAST(sipName_GetRowGridLinePen), SIP_MLMETH_CAST(meth_wxGrid_GetRowGridLinePen), METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxGrid_GetRowGridLinePen)},
    {SIP_MLNAME_CAST(sipName_GetRowLabelAlignment), SIP_MLMETH_CAST(meth_wxGrid_GetRowLabelAlignment), METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxGrid_GetRowLabelAlignment)},
    {SIP_MLNAME_CAST(sipName_GetRowLabelSize), meth_wxGrid_GetRowLabelSize, METH_VARARGS, SIP_MLDOC_CAST(doc_wxGrid_GetRowLabelSize)},
    {SIP_MLNAME_CAST(sipName_GetRowLabelValue), SIP_MLMETH_CAST(meth_wxGrid_GetRowLabelValue), METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxGrid_GetRowLabelValue)},
    {SIP_MLNAME_CAST(sipName_GetRowMinimalAcceptableHeight), meth_wxGrid_GetRowMinimalAcceptableHeight, METH_VARARGS, SIP_MLDOC_CAST(doc_wxGrid_GetRowMinimalAcceptableHeight)},
    {SIP_MLNAME_CAST(sipName_GetRowMinimalHeight), SIP_MLMETH_CAST(meth_wxGrid_GetRowMinimalHeight), METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxGrid_GetRowMinimalHeight)},
    {SIP_MLNAME_CAST(sipName_GetRowSize), SIP_MLMETH_CAST(meth_wxGrid_GetRowSize), METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxGrid_GetRowSize)},
    {SIP_MLNAME_CAST(sipName_GetRowSizes), meth_wxGrid_GetRowSizes, METH_VARARGS, SIP_MLDOC_CAST(doc_wxGrid_GetRowSizes)},
    {SIP_MLNAME_CAST(sipName_GetScrollLineX), meth_wxGrid_GetScrollLineX, METH_VARARGS, SIP_MLDOC_CAST(doc_wxGrid_GetScrollLineX)},
    {SIP_MLNAME_CAST(sipName_GetScrollLineY), meth_wxGrid_GetScrollLineY, METH_VARARGS, SIP_MLDOC_CAST(doc_wxGrid_GetScrollLineY)},
    {SIP_MLNAME_CAST(sipName_GetSelectedBlocks), meth_wxGrid_GetSelectedBlocks, METH_VARARGS, SIP_MLDOC_CAST(doc_wxGrid_GetSelectedBlocks)},
    {SIP_MLNAME_CAST(sipName_GetSelectedCells), meth_wxGrid_GetSelectedCells, METH_VARARGS, SIP_MLDOC_CAST(doc_wxGrid_GetSelectedCells)},
    {SIP_MLNAME_CAST(sipName_GetSelectedCols), meth_wxGrid_GetSelectedCols, METH_VARARGS, SIP_MLDOC_CAST(doc_wxGrid_GetSelectedCols)},
    {SIP_MLNAME_CAST(sipName_GetSelectedRows), meth_wxGrid_GetSelectedRows, METH_VARARGS, SIP_MLDOC_CAST(doc_wxGrid_GetSelectedRows)},
    {SIP_MLNAME_CAST(sipName_GetSelectionBackground), meth_wxGrid_GetSelectionBackground, METH_VARARGS, SIP_MLDOC_CAST(doc_wxGrid_GetSelectionBackground)},
    {SIP_MLNAME_CAST(sipName_GetSelectionBlockBottomRight), meth_wxGrid_GetSelectionBlockBottomRight, METH_VARARGS, SIP_MLDOC_CAST(doc_wxGrid_GetSelectionBlockBottomRight)},
    {SIP_MLNAME_CAST(sipName_GetSelectionBlockTopLeft), meth_wxGrid_GetSelectionBlockTopLeft, METH_VARARGS, SIP_MLDOC_CAST(doc_wxGrid_GetSelectionBlockTopLeft)},
    {SIP_MLNAME_CAST(sipName_GetSelectionForeground), meth_wxGrid_GetSelectionForeground, METH_VARARGS, SIP_MLDOC_CAST(doc_wxGrid_GetSelectionForeground)},
    {SIP_MLNAME_CAST(sipName_GetSelectionMode), meth_wxGrid_GetSelectionMode, METH_VARARGS, SIP_MLDOC_CAST(doc_wxGrid_GetSelectionMode)},
    {SIP_MLNAME_CAST(sipName_GetSizeAvailableForScrollTarget), meth_wxGrid_GetSizeAvailableForScrollTarget, METH_VARARGS, SIP_NULLPTR},
    {SIP_MLNAME_CAST(sipName_GetSortingColumn), meth_wxGrid_GetSortingColumn, METH_VARARGS, SIP_MLDOC_CAST(doc_wxGrid_GetSortingColumn)},
    {SIP_MLNAME_CAST(sipName_GetTable), meth_wxGrid_GetTable, METH_VARARGS, SIP_MLDOC_CAST(doc_wxGrid_GetTable)},
    {SIP_MLNAME_CAST(sipName_GetValidator), meth_wxGrid_GetValidator, METH_VARARGS, SIP_MLDOC_CAST(doc_wxGrid_GetValidator)},
    {SIP_MLNAME_CAST(sipName_GoToCell), SIP_MLMETH_CAST(meth_wxGrid_GoToCell), METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxGrid_GoToCell)},
    {SIP_MLNAME_CAST(sipName_GridLinesEnabled), meth_wxGrid_GridLinesEnabled, METH_VARARGS, SIP_MLDOC_CAST(doc_wxGrid_GridLinesEnabled)},
    {SIP_MLNAME_CAST(sipName_HasTransparentBackground), meth_wxGrid_HasTransparentBackground, METH_VARARGS, SIP_MLDOC_CAST(doc_wxGrid_HasTransparentBackground)},
    {SIP_MLNAME_CAST(sipName_HideCellEditControl), meth_wxGrid_HideCellEditControl, METH_VARARGS, SIP_MLDOC_CAST(doc_wxGrid_HideCellEditControl)},
    {SIP_MLNAME_CAST(sipName_HideCol), SIP_MLMETH_CAST(meth_wxGrid_HideCol), METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxGrid_HideCol)},
    {SIP_MLNAME_CAST(sipName_HideColLabels), meth_wxGrid_HideColLabels, METH_VARARGS, SIP_MLDOC_CAST(doc_wxGrid_HideColLabels)},
    {SIP_MLNAME_CAST(sipName_HideRow), SIP_MLMETH_CAST(meth_wxGrid_HideRow), METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxGrid_HideRow)},
    {SIP_MLNAME_CAST(sipName_HideRowLabels), meth_wxGrid_HideRowLabels, METH_VARARGS, SIP_MLDOC_CAST(doc_wxGrid_HideRowLabels)},
    {SIP_MLNAME_CAST(sipName_InformFirstDirection), SIP_MLMETH_CAST(meth_wxGrid_InformFirstDirection), METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxGrid_InformFirstDirection)},
    {SIP_MLNAME_CAST(sipName_InheritAttributes), meth_wxGrid_InheritAttributes, METH_VARARGS, SIP_MLDOC_CAST(doc_wxGrid_InheritAttributes)},
    {SIP_MLNAME_CAST(sipName_InitDialog), meth_wxGrid_InitDialog, METH_VARARGS, SIP_MLDOC_CAST(doc_wxGrid_InitDialog)},
    {SIP_MLNAME_CAST(sipName_InsertCols), SIP_MLMETH_CAST(meth_wxGrid_InsertCols), METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxGrid_InsertCols)},
    {SIP_MLNAME_CAST(sipName_InsertRows), SIP_MLMETH_CAST(meth_wxGrid_InsertRows), METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxGrid_InsertRows)},
    {SIP_MLNAME_CAST(sipName_IsCellEditControlEnabled), meth_wxGrid_IsCellEditControlEnabled, METH_VARARGS, SIP_MLDOC_CAST(doc_wxGrid_IsCellEditControlEnabled)},
    {SIP_MLNAME_CAST(sipName_IsCellEditControlShown), meth_wxGrid_IsCellEditControlShown, METH_VARARGS, SIP_MLDOC_CAST(doc_wxGrid_IsCellEditControlShown)},
    {SIP_MLNAME_CAST(sipName_IsColShown), SIP_MLMETH_CAST(meth_wxGrid_IsColShown), METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxGrid_IsColShown)},
    {SIP_MLNAME_CAST(sipName_IsCurrentCellReadOnly), meth_wxGrid_IsCurrentCellReadOnly, METH_VARARGS, SIP_MLDOC_CAST(doc_wxGrid_IsCurrentCellReadOnly)},
    {SIP_MLNAME_CAST(sipName_IsEditable), meth_wxGrid_IsEditable, METH_VARARGS, SIP_MLDOC_CAST(doc_wxGrid_IsEditable)},
    {SIP_MLNAME_CAST(sipName_IsInSelection), SIP_MLMETH_CAST(meth_wxGrid_IsInSelection), METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxGrid_IsInSelection)},
    {SIP_MLNAME_CAST(sipName_IsReadOnly), SIP_MLMETH_CAST(meth_wxGrid_IsReadOnly), METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxGrid_IsReadOnly)},
    {SIP_MLNAME_CAST(sipName_IsRowShown), SIP_MLMETH_CAST(meth_wxGrid_IsRowShown), METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxGrid_IsRowShown)},
    {SIP_MLNAME_CAST(sipName_IsSelection), meth_wxGrid_IsSelection, METH_VARARGS, SIP_MLDOC_CAST(doc_wxGrid_IsSelection)},
    {SIP_MLNAME_CAST(sipName_IsSortOrderAscending), meth_wxGrid_IsSortOrderAscending, METH_VARARGS, SIP_MLDOC_CAST(doc_wxGrid_IsSortOrderAscending)},
    {SIP_MLNAME_CAST(sipName_IsSortingBy), SIP_MLMETH_CAST(meth_wxGrid_IsSortingBy), METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxGrid_IsSortingBy)},
    {SIP_MLNAME_CAST(sipName_IsUsingNativeHeader), meth_wxGrid_IsUsingNativeHeader, METH_VARARGS, SIP_MLDOC_CAST(doc_wxGrid_IsUsingNativeHeader)},
    {SIP_MLNAME_CAST(sipName_IsVisible), SIP_MLMETH_CAST(meth_wxGrid_IsVisible), METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxGrid_IsVisible)},
    {SIP_MLNAME_CAST(sipName_MakeCellVisible), SIP_MLMETH_CAST(meth_wxGrid_MakeCellVisible), METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxGrid_MakeCellVisible)},
    {SIP_MLNAME_CAST(sipName_MoveCursorDown), SIP_MLMETH_CAST(meth_wxGrid_MoveCursorDown), METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxGrid_MoveCursorDown)},
    {SIP_MLNAME_CAST(sipName_MoveCursorDownBlock), SIP_MLMETH_CAST(meth_wxGrid_MoveCursorDownBlock), METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxGrid_MoveCursorDownBlock)},
    {SIP_MLNAME_CAST(sipName_MoveCursorLeft), SIP_MLMETH_CAST(meth_wxGrid_MoveCursorLeft), METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxGrid_MoveCursorLeft)},
    {SIP_MLNAME_CAST(sipName_MoveCursorLeftBlock), SIP_MLMETH_CAST(meth_wxGrid_MoveCursorLeftBlock), METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxGrid_MoveCursorLeftBlock)},
    {SIP_MLNAME_CAST(sipName_MoveCursorRight), SIP_MLMETH_CAST(meth_wxGrid_MoveCursorRight), METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxGrid_MoveCursorRight)},
    {SIP_MLNAME_CAST(sipName_MoveCursorRightBlock), SIP_MLMETH_CAST(meth_wxGrid_MoveCursorRightBlock), METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxGrid_MoveCursorRightBlock)},
    {SIP_MLNAME_CAST(sipName_MoveCursorUp), SIP_MLMETH_CAST(meth_wxGrid_MoveCursorUp), METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxGrid_MoveCursorUp)},
    {SIP_MLNAME_CAST(sipName_MoveCursorUpBlock), SIP_MLMETH_CAST(meth_wxGrid_MoveCursorUpBlock), METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxGrid_MoveCursorUpBlock)},
    {SIP_MLNAME_CAST(sipName_MovePageDown), meth_wxGrid_MovePageDown, METH_VARARGS, SIP_MLDOC_CAST(doc_wxGrid_MovePageDown)},
    {SIP_MLNAME_CAST(sipName_MovePageUp), meth_wxGrid_MovePageUp, METH_VARARGS, SIP_MLDOC_CAST(doc_wxGrid_MovePageUp)},
    {SIP_MLNAME_CAST(sipName_OnInternalIdle), meth_wxGrid_OnInternalIdle, METH_VARARGS, SIP_MLDOC_CAST(doc_wxGrid_OnInternalIdle)},
    {SIP_MLNAME_CAST(sipName_ProcessEvent), SIP_MLMETH_CAST(meth_wxGrid_ProcessEvent), METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxGrid_ProcessEvent)},
    {SIP_MLNAME_CAST(sipName_ProcessTableMessage), SIP_MLMETH_CAST(meth_wxGrid_ProcessTableMessage), METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxGrid_ProcessTableMessage)},
    {SIP_MLNAME_CAST(sipName_RefreshAttr), SIP_MLMETH_CAST(meth_wxGrid_RefreshAttr), METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxGrid_RefreshAttr)},
    {SIP_MLNAME_CAST(sipName_RegisterDataType), SIP_MLMETH_CAST(meth_wxGrid_RegisterDataType), METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxGrid_RegisterDataType)},
    {SIP_MLNAME_CAST(sipName_RemoveChild), SIP_MLMETH_CAST(meth_wxGrid_RemoveChild), METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxGrid_RemoveChild)},
    {SIP_MLNAME_CAST(sipName_Render), SIP_MLMETH_CAST(meth_wxGrid_Render), METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxGrid_Render)},
    {SIP_MLNAME_CAST(sipName_ResetColPos), meth_wxGrid_ResetColPos, METH_VARARGS, SIP_MLDOC_CAST(doc_wxGrid_ResetColPos)},
    {SIP_MLNAME_CAST(sipName_SaveEditControlValue), meth_wxGrid_SaveEditControlValue, METH_VARARGS, SIP_MLDOC_CAST(doc_wxGrid_SaveEditControlValue)},
    {SIP_MLNAME_CAST(sipName_SelectAll), meth_wxGrid_SelectAll, METH_VARARGS, SIP_MLDOC_CAST(doc_wxGrid_SelectAll)},
    {SIP_MLNAME_CAST(sipName_SelectBlock), SIP_MLMETH_CAST(meth_wxGrid_SelectBlock), METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxGrid_SelectBlock)},
    {SIP_MLNAME_CAST(sipName_SelectCol), SIP_MLMETH_CAST(meth_wxGrid_SelectCol), METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxGrid_SelectCol)},
    {SIP_MLNAME_CAST(sipName_SelectRow), SIP_MLMETH_CAST(meth_wxGrid_SelectRow), METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxGrid_SelectRow)},
    {SIP_MLNAME_CAST(sipName_SendDestroyEvent), meth_wxGrid_SendDestroyEvent, METH_VARARGS, SIP_NULLPTR},
    {SIP_MLNAME_CAST(sipName_SetAttr), SIP_MLMETH_CAST(meth_wxGrid_SetAttr), METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxGrid_SetAttr)},
    {SIP_MLNAME_CAST(sipName_SetCanFocus), SIP_MLMETH_CAST(meth_wxGrid_SetCanFocus), METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxGrid_SetCanFocus)},
    {SIP_MLNAME_CAST(sipName_SetCellAlignment), SIP_MLMETH_CAST(meth_wxGrid_SetCellAlignment), METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxGrid_SetCellAlignment)},
    {SIP_MLNAME_CAST(sipName_SetCellBackgroundColour), SIP_MLMETH_CAST(meth_wxGrid_SetCellBackgroundColour), METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxGrid_SetCellBackgroundColour)},
    {SIP_MLNAME_CAST(sipName_SetCellEditor), SIP_MLMETH_CAST(meth_wxGrid_SetCellEditor), METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxGrid_SetCellEditor)},
    {SIP_MLNAME_CAST(sipName_SetCellFitMode), SIP_MLMETH_CAST(meth_wxGrid_SetCellFitMode), METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxGrid_SetCellFitMode)},
    {SIP_MLNAME_CAST(sipName_SetCellFont), SIP_MLMETH_CAST(meth_wxGrid_SetCellFont), METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxGrid_SetCellFont)},
    {SIP_MLNAME_CAST(sipName_SetCellHighlightColour), meth_wxGrid_SetCellHighlightColour, METH_VARARGS, SIP_MLDOC_CAST(doc_wxGrid_SetCellHighlightColour)},
    {SIP_MLNAME_CAST(sipName_SetCellHighlightPenWidth), SIP_MLMETH_CAST(meth_wxGrid_SetCellHighlightPenWidth), METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxGrid_SetCellHighlightPenWidth)},
    {SIP_MLNAME_CAST(sipName_SetCellHighlightROPenWidth), SIP_MLMETH_CAST(meth_wxGrid_SetCellHighlightROPenWidth), METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxGrid_SetCellHighlightROPenWidth)},
    {SIP_MLNAME_CAST(sipName_SetCellOverflow), SIP_MLMETH_CAST(meth_wxGrid_SetCellOverflow), METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxGrid_SetCellOverflow)},
    {SIP_MLNAME_CAST(sipName_SetCellRenderer), SIP_MLMETH_CAST(meth_wxGrid_SetCellRenderer), METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxGrid_SetCellRenderer)},
    {SIP_MLNAME_CAST(sipName_SetCellSize), SIP_MLMETH_CAST(meth_wxGrid_SetCellSize), METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxGrid_SetCellSize)},
    {SIP_MLNAME_CAST(sipName_SetCellTextColour), SIP_MLMETH_CAST(meth_wxGrid_SetCellTextColour), METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxGrid_SetCellTextColour)},
    {SIP_MLNAME_CAST(sipName_SetCellValue), SIP_MLMETH_CAST(meth_wxGrid_SetCellValue), METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxGrid_SetCellValue)},
    {SIP_MLNAME_CAST(sipName_SetColAttr), SIP_MLMETH_CAST(meth_wxGrid_SetColAttr), METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxGrid_SetColAttr)},
    {SIP_MLNAME_CAST(sipName_SetColFormatBool), SIP_MLMETH_CAST(meth_wxGrid_SetColFormatBool), METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxGrid_SetColFormatBool)},
    {SIP_MLNAME_CAST(sipName_SetColFormatCustom), SIP_MLMETH_CAST(meth_wxGrid_SetColFormatCustom), METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxGrid_SetColFormatCustom)},
    {SIP_MLNAME_CAST(sipName_SetColFormatDate), SIP_MLMETH_CAST(meth_wxGrid_SetColFormatDate), METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxGrid_SetColFormatDate)},
    {SIP_MLNAME_CAST(sipName_SetColFormatFloat), SIP_MLMETH_CAST(meth_wxGrid_SetColFormatFloat), METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxGrid_SetColFormatFloat)},
    {SIP_MLNAME_CAST(sipName_SetColFormatNumber), SIP_MLMETH_CAST(meth_wxGrid_SetColFormatNumber), METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxGrid_SetColFormatNumber)},
    {SIP_MLNAME_CAST(sipName_SetColLabelAlignment), SIP_MLMETH_CAST(meth_wxGrid_SetColLabelAlignment), METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxGrid_SetColLabelAlignment)},
    {SIP_MLNAME_CAST(sipName_SetColLabelSize), SIP_MLMETH_CAST(meth_wxGrid_SetColLabelSize), METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxGrid_SetColLabelSize)},
    {SIP_MLNAME_CAST(sipName_SetColLabelTextOrientation), SIP_MLMETH_CAST(meth_wxGrid_SetColLabelTextOrientation), METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxGrid_SetColLabelTextOrientation)},
    {SIP_MLNAME_CAST(sipName_SetColLabelValue), SIP_MLMETH_CAST(meth_wxGrid_SetColLabelValue), METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxGrid_SetColLabelValue)},
    {SIP_MLNAME_CAST(sipName_SetColMinimalAcceptableWidth), SIP_MLMETH_CAST(meth_wxGrid_SetColMinimalAcceptableWidth), METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxGrid_SetColMinimalAcceptableWidth)},
    {SIP_MLNAME_CAST(sipName_SetColMinimalWidth), SIP_MLMETH_CAST(meth_wxGrid_SetColMinimalWidth), METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxGrid_SetColMinimalWidth)},
    {SIP_MLNAME_CAST(sipName_SetColPos), SIP_MLMETH_CAST(meth_wxGrid_SetColPos), METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxGrid_SetColPos)},
    {SIP_MLNAME_CAST(sipName_SetColSize), SIP_MLMETH_CAST(meth_wxGrid_SetColSize), METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxGrid_SetColSize)},
    {SIP_MLNAME_CAST(sipName_SetColSizes), SIP_MLMETH_CAST(meth_wxGrid_SetColSizes), METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxGrid_SetColSizes)},
    {SIP_MLNAME_CAST(sipName_SetColumnsOrder), SIP_MLMETH_CAST(meth_wxGrid_SetColumnsOrder), METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxGrid_SetColumnsOrder)},
    {SIP_MLNAME_CAST(sipName_SetCornerLabelAlignment), SIP_MLMETH_CAST(meth_wxGrid_SetCornerLabelAlignment), METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxGrid_SetCornerLabelAlignment)},
    {SIP_MLNAME_CAST(sipName_SetCornerLabelTextOrientation), SIP_MLMETH_CAST(meth_wxGrid_SetCornerLabelTextOrientation), METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxGrid_SetCornerLabelTextOrientation)},
    {SIP_MLNAME_CAST(sipName_SetCornerLabelValue), meth_wxGrid_SetCornerLabelValue, METH_VARARGS, SIP_MLDOC_CAST(doc_wxGrid_SetCornerLabelValue)},
    {SIP_MLNAME_CAST(sipName_SetDefaultCellAlignment), SIP_MLMETH_CAST(meth_wxGrid_SetDefaultCellAlignment), METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxGrid_SetDefaultCellAlignment)},
    {SIP_MLNAME_CAST(sipName_SetDefaultCellBackgroundColour), SIP_MLMETH_CAST(meth_wxGrid_SetDefaultCellBackgroundColour), METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxGrid_SetDefaultCellBackgroundColour)},
    {SIP_MLNAME_CAST(sipName_SetDefaultCellFitMode), SIP_MLMETH_CAST(meth_wxGrid_SetDefaultCellFitMode), METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxGrid_SetDefaultCellFitMode)},
    {SIP_MLNAME_CAST(sipName_SetDefaultCellFont), SIP_MLMETH_CAST(meth_wxGrid_SetDefaultCellFont), METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxGrid_SetDefaultCellFont)},
    {SIP_MLNAME_CAST(sipName_SetDefaultCellOverflow), SIP_MLMETH_CAST(meth_wxGrid_SetDefaultCellOverflow), METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxGrid_SetDefaultCellOverflow)},
    {SIP_MLNAME_CAST(sipName_SetDefaultCellTextColour), SIP_MLMETH_CAST(meth_wxGrid_SetDefaultCellTextColour), METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxGrid_SetDefaultCellTextColour)},
    {SIP_MLNAME_CAST(sipName_SetDefaultColSize), SIP_MLMETH_CAST(meth_wxGrid_SetDefaultColSize), METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxGrid_SetDefaultColSize)},
    {SIP_MLNAME_CAST(sipName_SetDefaultEditor), SIP_MLMETH_CAST(meth_wxGrid_SetDefaultEditor), METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxGrid_SetDefaultEditor)},
    {SIP_MLNAME_CAST(sipName_SetDefaultRenderer), SIP_MLMETH_CAST(meth_wxGrid_SetDefaultRenderer), METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxGrid_SetDefaultRenderer)},
    {SIP_MLNAME_CAST(sipName_SetDefaultRowSize), SIP_MLMETH_CAST(meth_wxGrid_SetDefaultRowSize), METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxGrid_SetDefaultRowSize)},
    {SIP_MLNAME_CAST(sipName_SetGridCursor), SIP_MLMETH_CAST(meth_wxGrid_SetGridCursor), METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxGrid_SetGridCursor)},
    {SIP_MLNAME_CAST(sipName_SetGridFrozenBorderColour), meth_wxGrid_SetGridFrozenBorderColour, METH_VARARGS, SIP_MLDOC_CAST(doc_wxGrid_SetGridFrozenBorderColour)},
    {SIP_MLNAME_CAST(sipName_SetGridFrozenBorderPenWidth), SIP_MLMETH_CAST(meth_wxGrid_SetGridFrozenBorderPenWidth), METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxGrid_SetGridFrozenBorderPenWidth)},
    {SIP_MLNAME_CAST(sipName_SetGridLineColour), SIP_MLMETH_CAST(meth_wxGrid_SetGridLineColour), METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxGrid_SetGridLineColour)},
    {SIP_MLNAME_CAST(sipName_SetLabelBackgroundColour), SIP_MLMETH_CAST(meth_wxGrid_SetLabelBackgroundColour), METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxGrid_SetLabelBackgroundColour)},
    {SIP_MLNAME_CAST(sipName_SetLabelFont), SIP_MLMETH_CAST(meth_wxGrid_SetLabelFont), METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxGrid_SetLabelFont)},
    {SIP_MLNAME_CAST(sipName_SetLabelTextColour), SIP_MLMETH_CAST(meth_wxGrid_SetLabelTextColour), METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxGrid_SetLabelTextColour)},
    {SIP_MLNAME_CAST(sipName_SetMargins), SIP_MLMETH_CAST(meth_wxGrid_SetMargins), METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxGrid_SetMargins)},
    {SIP_MLNAME_CAST(sipName_SetReadOnly), SIP_MLMETH_CAST(meth_wxGrid_SetReadOnly), METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxGrid_SetReadOnly)},
    {SIP_MLNAME_CAST(sipName_SetRowAttr), SIP_MLMETH_CAST(meth_wxGrid_SetRowAttr), METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxGrid_SetRowAttr)},
    {SIP_MLNAME_CAST(sipName_SetRowLabelAlignment), SIP_MLMETH_CAST(meth_wxGrid_SetRowLabelAlignment), METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxGrid_SetRowLabelAlignment)},
    {SIP_MLNAME_CAST(sipName_SetRowLabelSize), SIP_MLMETH_CAST(meth_wxGrid_SetRowLabelSize), METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxGrid_SetRowLabelSize)},
    {SIP_MLNAME_CAST(sipName_SetRowLabelValue), SIP_MLMETH_CAST(meth_wxGrid_SetRowLabelValue), METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxGrid_SetRowLabelValue)},
    {SIP_MLNAME_CAST(sipName_SetRowMinimalAcceptableHeight), SIP_MLMETH_CAST(meth_wxGrid_SetRowMinimalAcceptableHeight), METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxGrid_SetRowMinimalAcceptableHeight)},
    {SIP_MLNAME_CAST(sipName_SetRowMinimalHeight), SIP_MLMETH_CAST(meth_wxGrid_SetRowMinimalHeight), METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxGrid_SetRowMinimalHeight)},
    {SIP_MLNAME_CAST(sipName_SetRowSize), SIP_MLMETH_CAST(meth_wxGrid_SetRowSize), METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxGrid_SetRowSize)},
    {SIP_MLNAME_CAST(sipName_SetRowSizes), SIP_MLMETH_CAST(meth_wxGrid_SetRowSizes), METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxGrid_SetRowSizes)},
    {SIP_MLNAME_CAST(sipName_SetScrollLineX), SIP_MLMETH_CAST(meth_wxGrid_SetScrollLineX), METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxGrid_SetScrollLineX)},
    {SIP_MLNAME_CAST(sipName_SetScrollLineY), SIP_MLMETH_CAST(meth_wxGrid_SetScrollLineY), METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxGrid_SetScrollLineY)},
    {SIP_MLNAME_CAST(sipName_SetSelectionBackground), SIP_MLMETH_CAST(meth_wxGrid_SetSelectionBackground), METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxGrid_SetSelectionBackground)},
    {SIP_MLNAME_CAST(sipName_SetSelectionForeground), SIP_MLMETH_CAST(meth_wxGrid_SetSelectionForeground), METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxGrid_SetSelectionForeground)},
    {SIP_MLNAME_CAST(sipName_SetSelectionMode), SIP_MLMETH_CAST(meth_wxGrid_SetSelectionMode), METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxGrid_SetSelectionMode)},
    {SIP_MLNAME_CAST(sipName_SetSortingColumn), SIP_MLMETH_CAST(meth_wxGrid_SetSortingColumn), METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxGrid_SetSortingColumn)},
    {SIP_MLNAME_CAST(sipName_SetTabBehaviour), SIP_MLMETH_CAST(meth_wxGrid_SetTabBehaviour), METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxGrid_SetTabBehaviour)},
    {SIP_MLNAME_CAST(sipName_SetUseNativeColLabels), SIP_MLMETH_CAST(meth_wxGrid_SetUseNativeColLabels), METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxGrid_SetUseNativeColLabels)},
    {SIP_MLNAME_CAST(sipName_SetValidator), SIP_MLMETH_CAST(meth_wxGrid_SetValidator), METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxGrid_SetValidator)},
    {SIP_MLNAME_CAST(sipName_ShouldInheritColours), meth_wxGrid_ShouldInheritColours, METH_VARARGS, SIP_MLDOC_CAST(doc_wxGrid_ShouldInheritColours)},
    {SIP_MLNAME_CAST(sipName_ShouldScrollToChildOnFocus), SIP_MLMETH_CAST(meth_wxGrid_ShouldScrollToChildOnFocus), METH_VARARGS|METH_KEYWORDS, SIP_NULLPTR},
    {SIP_MLNAME_CAST(sipName_ShowCellEditControl), meth_wxGrid_ShowCellEditControl, METH_VARARGS, SIP_MLDOC_CAST(doc_wxGrid_ShowCellEditControl)},
    {SIP_MLNAME_CAST(sipName_ShowCol), SIP_MLMETH_CAST(meth_wxGrid_ShowCol), METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxGrid_ShowCol)},
    {SIP_MLNAME_CAST(sipName_ShowRow), SIP_MLMETH_CAST(meth_wxGrid_ShowRow), METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxGrid_ShowRow)},
    {SIP_MLNAME_CAST(sipName_TransferDataFromWindow), meth_wxGrid_TransferDataFromWindow, METH_VARARGS, SIP_MLDOC_CAST(doc_wxGrid_TransferDataFromWindow)},
    {SIP_MLNAME_CAST(sipName_TransferDataToWindow), meth_wxGrid_TransferDataToWindow, METH_VARARGS, SIP_MLDOC_CAST(doc_wxGrid_TransferDataToWindow)},
    {SIP_MLNAME_CAST(sipName_TryAfter), SIP_MLMETH_CAST(meth_wxGrid_TryAfter), METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxGrid_TryAfter)},
    {SIP_MLNAME_CAST(sipName_TryBefore), SIP_MLMETH_CAST(meth_wxGrid_TryBefore), METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxGrid_TryBefore)},
    {SIP_MLNAME_CAST(sipName_UnsetSortingColumn), meth_wxGrid_UnsetSortingColumn, METH_VARARGS, SIP_MLDOC_CAST(doc_wxGrid_UnsetSortingColumn)},
    {SIP_MLNAME_CAST(sipName_UseNativeColHeader), SIP_MLMETH_CAST(meth_wxGrid_UseNativeColHeader), METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxGrid_UseNativeColHeader)},
    {SIP_MLNAME_CAST(sipName_Validate), meth_wxGrid_Validate, METH_VARARGS, SIP_MLDOC_CAST(doc_wxGrid_Validate)},
    {SIP_MLNAME_CAST(sipName_XToCol), SIP_MLMETH_CAST(meth_wxGrid_XToCol), METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxGrid_XToCol)},
    {SIP_MLNAME_CAST(sipName_XToEdgeOfCol), SIP_MLMETH_CAST(meth_wxGrid_XToEdgeOfCol), METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxGrid_XToEdgeOfCol)},
    {SIP_MLNAME_CAST(sipName_XYToCell), SIP_MLMETH_CAST(meth_wxGrid_XYToCell), METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxGrid_XYToCell)},
    {SIP_MLNAME_CAST(sipName_YToEdgeOfRow), SIP_MLMETH_CAST(meth_wxGrid_YToEdgeOfRow), METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxGrid_YToEdgeOfRow)},
    {SIP_MLNAME_CAST(sipName_YToRow), SIP_MLMETH_CAST(meth_wxGrid_YToRow), METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxGrid_YToRow)},
    {SIP_MLNAME_CAST(sipName__SetTable), SIP_MLMETH_CAST(meth_wxGrid__SetTable), METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxGrid__SetTable)}
};
...
sipVariableDef variables_wxGrid[] = {
    {PropertyVariable, sipName_SortingColumn, &methods_wxGrid[184], &methods_wxGrid[304], SIP_NULLPTR, SIP_NULLPTR},
    {PropertyVariable, sipName_SelectionMode, &methods_wxGrid[182], &methods_wxGrid[303], SIP_NULLPTR, SIP_NULLPTR},
    {PropertyVariable, sipName_SelectionForeground, &methods_wxGrid[181], &methods_wxGrid[302], SIP_NULLPTR, SIP_NULLPTR},
    {PropertyVariable, sipName_SelectionBlockTopLeft, &methods_wxGrid[180], SIP_NULLPTR, SIP_NULLPTR, SIP_NULLPTR},
    {PropertyVariable, sipName_SelectionBlockBottomRight, &methods_wxGrid[179], SIP_NULLPTR, SIP_NULLPTR, SIP_NULLPTR},
    {PropertyVariable, sipName_SelectionBackground, &methods_wxGrid[178], &methods_wxGrid[301], SIP_NULLPTR, SIP_NULLPTR},
    {PropertyVariable, sipName_SelectedRows, &methods_wxGrid[177], SIP_NULLPTR, SIP_NULLPTR, SIP_NULLPTR},
    {PropertyVariable, sipName_SelectedCols, &methods_wxGrid[176], SIP_NULLPTR, SIP_NULLPTR, SIP_NULLPTR},
    {PropertyVariable, sipName_SelectedCells, &methods_wxGrid[175], SIP_NULLPTR, SIP_NULLPTR, SIP_NULLPTR},
    {PropertyVariable, sipName_SelectedBlocks, &methods_wxGrid[174], SIP_NULLPTR, SIP_NULLPTR, SIP_NULLPTR},
    {PropertyVariable, sipName_ScrollLineY, &methods_wxGrid[173], &methods_wxGrid[300], SIP_NULLPTR, SIP_NULLPTR},
    {PropertyVariable, sipName_ScrollLineX, &methods_wxGrid[172], &methods_wxGrid[299], SIP_NULLPTR, SIP_NULLPTR},
    {PropertyVariable, sipName_RowSizes, &methods_wxGrid[171], &methods_wxGrid[298], SIP_NULLPTR, SIP_NULLPTR},
    {PropertyVariable, sipName_RowMinimalAcceptableHeight, &methods_wxGrid[168], &methods_wxGrid[295], SIP_NULLPTR, SIP_NULLPTR},
    {PropertyVariable, sipName_RowLabelSize, &methods_wxGrid[166], &methods_wxGrid[293], SIP_NULLPTR, SIP_NULLPTR},
    {PropertyVariable, sipName_NumberRows, &methods_wxGrid[161], SIP_NULLPTR, SIP_NULLPTR, SIP_NULLPTR},
    {PropertyVariable, sipName_NumberFrozenRows, &methods_wxGrid[160], SIP_NULLPTR, SIP_NULLPTR, SIP_NULLPTR},
    {PropertyVariable, sipName_NumberFrozenCols, &methods_wxGrid[159], SIP_NULLPTR, SIP_NULLPTR, SIP_NULLPTR},
    {PropertyVariable, sipName_NumberCols, &methods_wxGrid[158], SIP_NULLPTR, SIP_NULLPTR, SIP_NULLPTR},
    {PropertyVariable, sipName_LabelTextColour, &methods_wxGrid[156], &methods_wxGrid[288], SIP_NULLPTR, SIP_NULLPTR},
    {PropertyVariable, sipName_LabelFont, &methods_wxGrid[155], &methods_wxGrid[287], SIP_NULLPTR, SIP_NULLPTR},
    {PropertyVariable, sipName_LabelBackgroundColour, &methods_wxGrid[154], &methods_wxGrid[286], SIP_NULLPTR, SIP_NULLPTR},
    {PropertyVariable, sipName_GridWindow, &methods_wxGrid[152], SIP_NULLPTR, SIP_NULLPTR, SIP_NULLPTR},
    {PropertyVariable, sipName_GridRowLabelWindow, &methods_wxGrid[151], SIP_NULLPTR, SIP_NULLPTR, SIP_NULLPTR},
    {PropertyVariable, sipName_GridLineColour, &methods_wxGrid[150], &methods_wxGrid[285], SIP_NULLPTR, SIP_NULLPTR},
    {PropertyVariable, sipName_GridCursorRow, &methods_wxGrid[149], SIP_NULLPTR, SIP_NULLPTR, SIP_NULLPTR},
    {PropertyVariable, sipName_GridCursorCoords, &methods_wxGrid[148], SIP_NULLPTR, SIP_NULLPTR, SIP_NULLPTR},
    {PropertyVariable, sipName_GridCursorCol, &methods_wxGrid[147], SIP_NULLPTR, SIP_NULLPTR, SIP_NULLPTR},
    {PropertyVariable, sipName_GridCornerLabelWindow, &methods_wxGrid[146], SIP_NULLPTR, SIP_NULLPTR, SIP_NULLPTR},
    {PropertyVariable, sipName_GridColLabelWindow, &methods_wxGrid[145], SIP_NULLPTR, SIP_NULLPTR, SIP_NULLPTR},
    {PropertyVariable, sipName_GridColHeader, &methods_wxGrid[144], SIP_NULLPTR, SIP_NULLPTR, SIP_NULLPTR},
    {PropertyVariable, sipName_FrozenRowGridWindow, &methods_wxGrid[143], SIP_NULLPTR, SIP_NULLPTR, SIP_NULLPTR},
    {PropertyVariable, sipName_FrozenCornerGridWindow, &methods_wxGrid[142], SIP_NULLPTR, SIP_NULLPTR, SIP_NULLPTR},
    {PropertyVariable, sipName_FrozenColGridWindow, &methods_wxGrid[141], SIP_NULLPTR, SIP_NULLPTR, SIP_NULLPTR},
    {PropertyVariable, sipName_FirstFullyVisibleRow, &methods_wxGrid[140], SIP_NULLPTR, SIP_NULLPTR, SIP_NULLPTR},
    {PropertyVariable, sipName_FirstFullyVisibleColumn, &methods_wxGrid[139], SIP_NULLPTR, SIP_NULLPTR, SIP_NULLPTR},
    {PropertyVariable, sipName_DefaultRowSize, &methods_wxGrid[138], &methods_wxGrid[281], SIP_NULLPTR, SIP_NULLPTR},
    {PropertyVariable, sipName_DefaultRowLabelSize, &methods_wxGrid[137], SIP_NULLPTR, SIP_NULLPTR, SIP_NULLPTR},
    {PropertyVariable, sipName_DefaultRenderer, &methods_wxGrid[134], &methods_wxGrid[280], SIP_NULLPTR, SIP_NULLPTR},
    {PropertyVariable, sipName_DefaultGridLinePen, &methods_wxGrid[133], SIP_NULLPTR, SIP_NULLPTR, SIP_NULLPTR},
    {PropertyVariable, sipName_DefaultEditor, &methods_wxGrid[130], &methods_wxGrid[279], SIP_NULLPTR, SIP_NULLPTR},
    {PropertyVariable, sipName_DefaultColSize, &methods_wxGrid[129], &methods_wxGrid[278], SIP_NULLPTR, SIP_NULLPTR},
    {PropertyVariable, sipName_DefaultColLabelSize, &methods_wxGrid[128], SIP_NULLPTR, SIP_NULLPTR, SIP_NULLPTR},
    {PropertyVariable, sipName_DefaultCellTextColour, &methods_wxGrid[127], &methods_wxGrid[277], SIP_NULLPTR, SIP_NULLPTR},
    {PropertyVariable, sipName_DefaultCellOverflow, &methods_wxGrid[126], &methods_wxGrid[276], SIP_NULLPTR, SIP_NULLPTR},
    {PropertyVariable, sipName_DefaultCellFont, &methods_wxGrid[125], &methods_wxGrid[275], SIP_NULLPTR, SIP_NULLPTR},
    {PropertyVariable, sipName_DefaultCellFitMode, &methods_wxGrid[124], &methods_wxGrid[274], SIP_NULLPTR, SIP_NULLPTR},
    {PropertyVariable, sipName_DefaultCellBackgroundColour, &methods_wxGrid[123], &methods_wxGrid[273], SIP_NULLPTR, SIP_NULLPTR},
    {PropertyVariable, sipName_CornerLabelValue, &methods_wxGrid[119], &methods_wxGrid[271], SIP_NULLPTR, SIP_NULLPTR},
    {PropertyVariable, sipName_CornerLabelTextOrientation, &methods_wxGrid[118], &methods_wxGrid[270], SIP_NULLPTR, SIP_NULLPTR},
    {PropertyVariable, sipName_ColSizes, &methods_wxGrid[116], &methods_wxGrid[267], SIP_NULLPTR, SIP_NULLPTR},
    {PropertyVariable, sipName_ColMinimalAcceptableWidth, &methods_wxGrid[111], &methods_wxGrid[263], SIP_NULLPTR, SIP_NULLPTR},
    {PropertyVariable, sipName_ColLabelTextOrientation, &methods_wxGrid[108], &methods_wxGrid[261], SIP_NULLPTR, SIP_NULLPTR},
    {PropertyVariable, sipName_ColLabelSize, &methods_wxGrid[107], &methods_wxGrid[260], SIP_NULLPTR, SIP_NULLPTR},
    {PropertyVariable, sipName_CellHighlightROPenWidth, &methods_wxGrid[96], &methods_wxGrid[247], SIP_NULLPTR, SIP_NULLPTR},
    {PropertyVariable, sipName_CellHighlightPenWidth, &methods_wxGrid[95], &methods_wxGrid[246], SIP_NULLPTR, SIP_NULLPTR},
    {PropertyVariable, sipName_CellHighlightColour, &methods_wxGrid[94], &methods_wxGrid[245], SIP_NULLPTR, SIP_NULLPTR},
    {PropertyVariable, sipName_BatchCount, &methods_wxGrid[88], SIP_NULLPTR, SIP_NULLPTR, SIP_NULLPTR},
};
