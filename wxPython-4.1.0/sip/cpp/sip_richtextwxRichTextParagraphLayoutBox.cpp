...
extern "C" {static void assign_wxRichTextParagraphLayoutBox(void *, SIP_SSIZE_T, void *);}
static void assign_wxRichTextParagraphLayoutBox(void *sipDst, SIP_SSIZE_T sipDstIdx, void *sipSrc)
{
    reinterpret_cast< ::wxRichTextParagraphLayoutBox *>(sipDst)[sipDstIdx] = *reinterpret_cast< ::wxRichTextParagraphLayoutBox *>(sipSrc);
}


extern "C" {static void *array_wxRichTextParagraphLayoutBox(SIP_SSIZE_T);}
static void *array_wxRichTextParagraphLayoutBox(SIP_SSIZE_T sipNrElem)
{
    return new  ::wxRichTextParagraphLayoutBox[sipNrElem];
}


extern "C" {static void *copy_wxRichTextParagraphLayoutBox(const void *, SIP_SSIZE_T);}
static void *copy_wxRichTextParagraphLayoutBox(const void *sipSrc, SIP_SSIZE_T sipSrcIdx)
{
...
static PyMethodDef methods_wxRichTextParagraphLayoutBox[] = {
    {SIP_MLNAME_CAST(sipName_AcceptsFocus), meth_wxRichTextParagraphLayoutBox_AcceptsFocus, METH_VARARGS, SIP_MLDOC_CAST(doc_wxRichTextParagraphLayoutBox_AcceptsFocus)},
    {SIP_MLNAME_CAST(sipName_AddImage), SIP_MLMETH_CAST(meth_wxRichTextParagraphLayoutBox_AddImage), METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxRichTextParagraphLayoutBox_AddImage)},
    {SIP_MLNAME_CAST(sipName_AddParagraph), SIP_MLMETH_CAST(meth_wxRichTextParagraphLayoutBox_AddParagraph), METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxRichTextParagraphLayoutBox_AddParagraph)},
    {SIP_MLNAME_CAST(sipName_AddParagraphs), SIP_MLMETH_CAST(meth_wxRichTextParagraphLayoutBox_AddParagraphs), METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxRichTextParagraphLayoutBox_AddParagraphs)},
    {SIP_MLNAME_CAST(sipName_ApplyStyleSheet), SIP_MLMETH_CAST(meth_wxRichTextParagraphLayoutBox_ApplyStyleSheet), METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxRichTextParagraphLayoutBox_ApplyStyleSheet)},
    {SIP_MLNAME_CAST(sipName_Clear), meth_wxRichTextParagraphLayoutBox_Clear, METH_VARARGS, SIP_MLDOC_CAST(doc_wxRichTextParagraphLayoutBox_Clear)},
    {SIP_MLNAME_CAST(sipName_ClearListStyle), SIP_MLMETH_CAST(meth_wxRichTextParagraphLayoutBox_ClearListStyle), METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxRichTextParagraphLayoutBox_ClearListStyle)},
    {SIP_MLNAME_CAST(sipName_Clone), meth_wxRichTextParagraphLayoutBox_Clone, METH_VARARGS, SIP_MLDOC_CAST(doc_wxRichTextParagraphLayoutBox_Clone)},
    {SIP_MLNAME_CAST(sipName_CollectStyle), SIP_MLMETH_CAST(meth_wxRichTextParagraphLayoutBox_CollectStyle), METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxRichTextParagraphLayoutBox_CollectStyle)},
    {SIP_MLNAME_CAST(sipName_Copy), SIP_MLMETH_CAST(meth_wxRichTextParagraphLayoutBox_Copy), METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxRichTextParagraphLayoutBox_Copy)},
    {SIP_MLNAME_CAST(sipName_CopyFragment), SIP_MLMETH_CAST(meth_wxRichTextParagraphLayoutBox_CopyFragment), METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxRichTextParagraphLayoutBox_CopyFragment)},
    {SIP_MLNAME_CAST(sipName_DeleteRange), SIP_MLMETH_CAST(meth_wxRichTextParagraphLayoutBox_DeleteRange), METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxRichTextParagraphLayoutBox_DeleteRange)},
    {SIP_MLNAME_CAST(sipName_DeleteRangeWithUndo), SIP_MLMETH_CAST(meth_wxRichTextParagraphLayoutBox_DeleteRangeWithUndo), METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxRichTextParagraphLayoutBox_DeleteRangeWithUndo)},
    {SIP_MLNAME_CAST(sipName_DoGetStyle), SIP_MLMETH_CAST(meth_wxRichTextParagraphLayoutBox_DoGetStyle), METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxRichTextParagraphLayoutBox_DoGetStyle)},
    {SIP_MLNAME_CAST(sipName_DoInvalidate), SIP_MLMETH_CAST(meth_wxRichTextParagraphLayoutBox_DoInvalidate), METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxRichTextParagraphLayoutBox_DoInvalidate)},
    {SIP_MLNAME_CAST(sipName_DoNumberList), SIP_MLMETH_CAST(meth_wxRichTextParagraphLayoutBox_DoNumberList), METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxRichTextParagraphLayoutBox_DoNumberList)},
    {SIP_MLNAME_CAST(sipName_Draw), SIP_MLMETH_CAST(meth_wxRichTextParagraphLayoutBox_Draw), METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxRichTextParagraphLayoutBox_Draw)},
    {SIP_MLNAME_CAST(sipName_DrawFloats), SIP_MLMETH_CAST(meth_wxRichTextParagraphLayoutBox_DrawFloats), METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxRichTextParagraphLayoutBox_DrawFloats)},
    {SIP_MLNAME_CAST(sipName_FindNextParagraphNumber), SIP_MLMETH_CAST(meth_wxRichTextParagraphLayoutBox_FindNextParagraphNumber), METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxRichTextParagraphLayoutBox_FindNextParagraphNumber)},
    {SIP_MLNAME_CAST(sipName_GetBasicStyle), meth_wxRichTextParagraphLayoutBox_GetBasicStyle, METH_VARARGS, SIP_MLDOC_CAST(doc_wxRichTextParagraphLayoutBox_GetBasicStyle)},
    {SIP_MLNAME_CAST(sipName_GetDefaultStyle), meth_wxRichTextParagraphLayoutBox_GetDefaultStyle, METH_VARARGS, SIP_MLDOC_CAST(doc_wxRichTextParagraphLayoutBox_GetDefaultStyle)},
    {SIP_MLNAME_CAST(sipName_GetFloatCollector), meth_wxRichTextParagraphLayoutBox_GetFloatCollector, METH_VARARGS, SIP_MLDOC_CAST(doc_wxRichTextParagraphLayoutBox_GetFloatCollector)},
    {SIP_MLNAME_CAST(sipName_GetFloatingObjectCount), meth_wxRichTextParagraphLayoutBox_GetFloatingObjectCount, METH_VARARGS, SIP_MLDOC_CAST(doc_wxRichTextParagraphLayoutBox_GetFloatingObjectCount)},
    {SIP_MLNAME_CAST(sipName_GetFloatingObjects), SIP_MLMETH_CAST(meth_wxRichTextParagraphLayoutBox_GetFloatingObjects), METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxRichTextParagraphLayoutBox_GetFloatingObjects)},
    {SIP_MLNAME_CAST(sipName_GetInvalidRange), SIP_MLMETH_CAST(meth_wxRichTextParagraphLayoutBox_GetInvalidRange), METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxRichTextParagraphLayoutBox_GetInvalidRange)},
    {SIP_MLNAME_CAST(sipName_GetLeafObjectAtPosition), SIP_MLMETH_CAST(meth_wxRichTextParagraphLayoutBox_GetLeafObjectAtPosition), METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxRichTextParagraphLayoutBox_GetLeafObjectAtPosition)},
    {SIP_MLNAME_CAST(sipName_GetLineAtPosition), SIP_MLMETH_CAST(meth_wxRichTextParagraphLayoutBox_GetLineAtPosition), METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxRichTextParagraphLayoutBox_GetLineAtPosition)},
    {SIP_MLNAME_CAST(sipName_GetLineAtYPosition), SIP_MLMETH_CAST(meth_wxRichTextParagraphLayoutBox_GetLineAtYPosition), METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxRichTextParagraphLayoutBox_GetLineAtYPosition)},
    {SIP_MLNAME_CAST(sipName_GetLineCount), meth_wxRichTextParagraphLayoutBox_GetLineCount, METH_VARARGS, SIP_MLDOC_CAST(doc_wxRichTextParagraphLayoutBox_GetLineCount)},
    {SIP_MLNAME_CAST(sipName_GetLineForVisibleLineNumber), SIP_MLMETH_CAST(meth_wxRichTextParagraphLayoutBox_GetLineForVisibleLineNumber), METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxRichTextParagraphLayoutBox_GetLineForVisibleLineNumber)},
    {SIP_MLNAME_CAST(sipName_GetLineSizeAtPosition), SIP_MLMETH_CAST(meth_wxRichTextParagraphLayoutBox_GetLineSizeAtPosition), METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxRichTextParagraphLayoutBox_GetLineSizeAtPosition)},
    {SIP_MLNAME_CAST(sipName_GetParagraphAtLine), SIP_MLMETH_CAST(meth_wxRichTextParagraphLayoutBox_GetParagraphAtLine), METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxRichTextParagraphLayoutBox_GetParagraphAtLine)},
    {SIP_MLNAME_CAST(sipName_GetParagraphAtPosition), SIP_MLMETH_CAST(meth_wxRichTextParagraphLayoutBox_GetParagraphAtPosition), METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxRichTextParagraphLayoutBox_GetParagraphAtPosition)},
    {SIP_MLNAME_CAST(sipName_GetParagraphCount), meth_wxRichTextParagraphLayoutBox_GetParagraphCount, METH_VARARGS, SIP_MLDOC_CAST(doc_wxRichTextParagraphLayoutBox_GetParagraphCount)},
    {SIP_MLNAME_CAST(sipName_GetParagraphForLine), SIP_MLMETH_CAST(meth_wxRichTextParagraphLayoutBox_GetParagraphForLine), METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxRichTextParagraphLayoutBox_GetParagraphForLine)},
    {SIP_MLNAME_CAST(sipName_GetParagraphLength), SIP_MLMETH_CAST(meth_wxRichTextParagraphLayoutBox_GetParagraphLength), METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxRichTextParagraphLayoutBox_GetParagraphLength)},
    {SIP_MLNAME_CAST(sipName_GetParagraphText), SIP_MLMETH_CAST(meth_wxRichTextParagraphLayoutBox_GetParagraphText), METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxRichTextParagraphLayoutBox_GetParagraphText)},
    {SIP_MLNAME_CAST(sipName_GetPartialParagraph), meth_wxRichTextParagraphLayoutBox_GetPartialParagraph, METH_VARARGS, SIP_MLDOC_CAST(doc_wxRichTextParagraphLayoutBox_GetPartialParagraph)},
    {SIP_MLNAME_CAST(sipName_GetRangeSize), SIP_MLMETH_CAST(meth_wxRichTextParagraphLayoutBox_GetRangeSize), METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxRichTextParagraphLayoutBox_GetRangeSize)},
    {SIP_MLNAME_CAST(sipName_GetRichTextCtrl), meth_wxRichTextParagraphLayoutBox_GetRichTextCtrl, METH_VARARGS, SIP_MLDOC_CAST(doc_wxRichTextParagraphLayoutBox_GetRichTextCtrl)},
    {SIP_MLNAME_CAST(sipName_GetStyle), SIP_MLMETH_CAST(meth_wxRichTextParagraphLayoutBox_GetStyle), METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxRichTextParagraphLayoutBox_GetStyle)},
    {SIP_MLNAME_CAST(sipName_GetStyleForNewParagraph), SIP_MLMETH_CAST(meth_wxRichTextParagraphLayoutBox_GetStyleForNewParagraph), METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxRichTextParagraphLayoutBox_GetStyleForNewParagraph)},
    {SIP_MLNAME_CAST(sipName_GetStyleForRange), SIP_MLMETH_CAST(meth_wxRichTextParagraphLayoutBox_GetStyleForRange), METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxRichTextParagraphLayoutBox_GetStyleForRange)},
    {SIP_MLNAME_CAST(sipName_GetStyleSheet), meth_wxRichTextParagraphLayoutBox_GetStyleSheet, METH_VARARGS, SIP_MLDOC_CAST(doc_wxRichTextParagraphLayoutBox_GetStyleSheet)},
    {SIP_MLNAME_CAST(sipName_GetText), meth_wxRichTextParagraphLayoutBox_GetText, METH_VARARGS, SIP_MLDOC_CAST(doc_wxRichTextParagraphLayoutBox_GetText)},
    {SIP_MLNAME_CAST(sipName_GetTextForRange), SIP_MLMETH_CAST(meth_wxRichTextParagraphLayoutBox_GetTextForRange), METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxRichTextParagraphLayoutBox_GetTextForRange)},
    {SIP_MLNAME_CAST(sipName_GetUncombinedStyle), SIP_MLMETH_CAST(meth_wxRichTextParagraphLayoutBox_GetUncombinedStyle), METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxRichTextParagraphLayoutBox_GetUncombinedStyle)},
    {SIP_MLNAME_CAST(sipName_GetVisibleLineNumber), SIP_MLMETH_CAST(meth_wxRichTextParagraphLayoutBox_GetVisibleLineNumber), METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxRichTextParagraphLayoutBox_GetVisibleLineNumber)},
    {SIP_MLNAME_CAST(sipName_GetXMLNodeName), meth_wxRichTextParagraphLayoutBox_GetXMLNodeName, METH_VARARGS, SIP_MLDOC_CAST(doc_wxRichTextParagraphLayoutBox_GetXMLNodeName)},
    {SIP_MLNAME_CAST(sipName_HasCharacterAttributes), SIP_MLMETH_CAST(meth_wxRichTextParagraphLayoutBox_HasCharacterAttributes), METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxRichTextParagraphLayoutBox_HasCharacterAttributes)},
    {SIP_MLNAME_CAST(sipName_HasParagraphAttributes), SIP_MLMETH_CAST(meth_wxRichTextParagraphLayoutBox_HasParagraphAttributes), METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxRichTextParagraphLayoutBox_HasParagraphAttributes)},
    {SIP_MLNAME_CAST(sipName_HitTest), SIP_MLMETH_CAST(meth_wxRichTextParagraphLayoutBox_HitTest), METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxRichTextParagraphLayoutBox_HitTest)},
    {SIP_MLNAME_CAST(sipName_ImportFromXML), SIP_MLMETH_CAST(meth_wxRichTextParagraphLayoutBox_ImportFromXML), METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxRichTextParagraphLayoutBox_ImportFromXML)},
    {SIP_MLNAME_CAST(sipName_Init), meth_wxRichTextParagraphLayoutBox_Init, METH_VARARGS, SIP_MLDOC_CAST(doc_wxRichTextParagraphLayoutBox_Init)},
    {SIP_MLNAME_CAST(sipName_InsertFieldWithUndo), SIP_MLMETH_CAST(meth_wxRichTextParagraphLayoutBox_InsertFieldWithUndo), METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxRichTextParagraphLayoutBox_InsertFieldWithUndo)},
    {SIP_MLNAME_CAST(sipName_InsertFragment), SIP_MLMETH_CAST(meth_wxRichTextParagraphLayoutBox_InsertFragment), METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxRichTextParagraphLayoutBox_InsertFragment)},
    {SIP_MLNAME_CAST(sipName_InsertImageWithUndo), SIP_MLMETH_CAST(meth_wxRichTextParagraphLayoutBox_InsertImageWithUndo), METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxRichTextParagraphLayoutBox_InsertImageWithUndo)},
    {SIP_MLNAME_CAST(sipName_InsertNewlineWithUndo), SIP_MLMETH_CAST(meth_wxRichTextParagraphLayoutBox_InsertNewlineWithUndo), METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxRichTextParagraphLayoutBox_InsertNewlineWithUndo)},
    {SIP_MLNAME_CAST(sipName_InsertObjectWithUndo), SIP_MLMETH_CAST(meth_wxRichTextParagraphLayoutBox_InsertObjectWithUndo), METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxRichTextParagraphLayoutBox_InsertObjectWithUndo)},
    {SIP_MLNAME_CAST(sipName_InsertParagraphsWithUndo), SIP_MLMETH_CAST(meth_wxRichTextParagraphLayoutBox_InsertParagraphsWithUndo), METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxRichTextParagraphLayoutBox_InsertParagraphsWithUndo)},
    {SIP_MLNAME_CAST(sipName_InsertTextWithUndo), SIP_MLMETH_CAST(meth_wxRichTextParagraphLayoutBox_InsertTextWithUndo), METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxRichTextParagraphLayoutBox_InsertTextWithUndo)},
    {SIP_MLNAME_CAST(sipName_Invalidate), SIP_MLMETH_CAST(meth_wxRichTextParagraphLayoutBox_Invalidate), METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxRichTextParagraphLayoutBox_Invalidate)},
    {SIP_MLNAME_CAST(sipName_InvalidateHierarchy), SIP_MLMETH_CAST(meth_wxRichTextParagraphLayoutBox_InvalidateHierarchy), METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxRichTextParagraphLayoutBox_InvalidateHierarchy)},
    {SIP_MLNAME_CAST(sipName_IsDirty), meth_wxRichTextParagraphLayoutBox_IsDirty, METH_VARARGS, SIP_MLDOC_CAST(doc_wxRichTextParagraphLayoutBox_IsDirty)},
    {SIP_MLNAME_CAST(sipName_IsTopLevel), meth_wxRichTextParagraphLayoutBox_IsTopLevel, METH_VARARGS, SIP_MLDOC_CAST(doc_wxRichTextParagraphLayoutBox_IsTopLevel)},
    {SIP_MLNAME_CAST(sipName_Layout), SIP_MLMETH_CAST(meth_wxRichTextParagraphLayoutBox_Layout), METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxRichTextParagraphLayoutBox_Layout)},
    {SIP_MLNAME_CAST(sipName_MoveAnchoredObjectToParagraph), SIP_MLMETH_CAST(meth_wxRichTextParagraphLayoutBox_MoveAnchoredObjectToParagraph), METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxRichTextParagraphLayoutBox_MoveAnchoredObjectToParagraph)},
    {SIP_MLNAME_CAST(sipName_NumberList), SIP_MLMETH_CAST(meth_wxRichTextParagraphLayoutBox_NumberList), METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxRichTextParagraphLayoutBox_NumberList)},
    {SIP_MLNAME_CAST(sipName_PositionToXY), SIP_MLMETH_CAST(meth_wxRichTextParagraphLayoutBox_PositionToXY), METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxRichTextParagraphLayoutBox_PositionToXY)},
    {SIP_MLNAME_CAST(sipName_PrepareContent), SIP_MLMETH_CAST(meth_wxRichTextParagraphLayoutBox_PrepareContent), METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxRichTextParagraphLayoutBox_PrepareContent)},
    {SIP_MLNAME_CAST(sipName_PromoteList), SIP_MLMETH_CAST(meth_wxRichTextParagraphLayoutBox_PromoteList), METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxRichTextParagraphLayoutBox_PromoteList)},
    {SIP_MLNAME_CAST(sipName_Reset), meth_wxRichTextParagraphLayoutBox_Reset, METH_VARARGS, SIP_MLDOC_CAST(doc_wxRichTextParagraphLayoutBox_Reset)},
    {SIP_MLNAME_CAST(sipName_SetBasicStyle), SIP_MLMETH_CAST(meth_wxRichTextParagraphLayoutBox_SetBasicStyle), METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxRichTextParagraphLayoutBox_SetBasicStyle)},
    {SIP_MLNAME_CAST(sipName_SetDefaultStyle), SIP_MLMETH_CAST(meth_wxRichTextParagraphLayoutBox_SetDefaultStyle), METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxRichTextParagraphLayoutBox_SetDefaultStyle)},
    {SIP_MLNAME_CAST(sipName_SetListStyle), SIP_MLMETH_CAST(meth_wxRichTextParagraphLayoutBox_SetListStyle), METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxRichTextParagraphLayoutBox_SetListStyle)},
    {SIP_MLNAME_CAST(sipName_SetObjectPropertiesWithUndo), SIP_MLMETH_CAST(meth_wxRichTextParagraphLayoutBox_SetObjectPropertiesWithUndo), METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxRichTextParagraphLayoutBox_SetObjectPropertiesWithUndo)},
    {SIP_MLNAME_CAST(sipName_SetPartialParagraph), SIP_MLMETH_CAST(meth_wxRichTextParagraphLayoutBox_SetPartialParagraph), METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxRichTextParagraphLayoutBox_SetPartialParagraph)},
    {SIP_MLNAME_CAST(sipName_SetProperties), SIP_MLMETH_CAST(meth_wxRichTextParagraphLayoutBox_SetProperties), METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxRichTextParagraphLayoutBox_SetProperties)},
    {SIP_MLNAME_CAST(sipName_SetRichTextCtrl), SIP_MLMETH_CAST(meth_wxRichTextParagraphLayoutBox_SetRichTextCtrl), METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxRichTextParagraphLayoutBox_SetRichTextCtrl)},
    {SIP_MLNAME_CAST(sipName_SetStyle), SIP_MLMETH_CAST(meth_wxRichTextParagraphLayoutBox_SetStyle), METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxRichTextParagraphLayoutBox_SetStyle)},
    {SIP_MLNAME_CAST(sipName_UpdateFloatingObjects), SIP_MLMETH_CAST(meth_wxRichTextParagraphLayoutBox_UpdateFloatingObjects), METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxRichTextParagraphLayoutBox_UpdateFloatingObjects)},
    {SIP_MLNAME_CAST(sipName_UpdateRanges), meth_wxRichTextParagraphLayoutBox_UpdateRanges, METH_VARARGS, SIP_MLDOC_CAST(doc_wxRichTextParagraphLayoutBox_UpdateRanges)},
    {SIP_MLNAME_CAST(sipName_XYToPosition), SIP_MLMETH_CAST(meth_wxRichTextParagraphLayoutBox_XYToPosition), METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxRichTextParagraphLayoutBox_XYToPosition)}
};
