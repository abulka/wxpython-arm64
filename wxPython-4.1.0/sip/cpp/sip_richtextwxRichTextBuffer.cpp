...
size_t sipwxRichTextBuffer::GetStyleStackSize() const
{
    ...
    sipMeth = sipIsPyMethod(&sipGILState,const_cast<char *>(&sipPyMethods[0]),sipPySelf,SIP_NULLPTR,sipName_GetStyleStackSize);
...
bool sipwxRichTextBuffer::CanPasteFromClipboard() const
{
    ...
    sipMeth = sipIsPyMethod(&sipGILState,const_cast<char *>(&sipPyMethods[5]),sipPySelf,SIP_NULLPTR,sipName_CanPasteFromClipboard);
...
bool sipwxRichTextBuffer::SuppressingUndo() const
{
    ...
    sipMeth = sipIsPyMethod(&sipGILState,const_cast<char *>(&sipPyMethods[8]),sipPySelf,SIP_NULLPTR,sipName_SuppressingUndo);
 ...
 ::wxRichTextCommand* sipwxRichTextBuffer::GetBatchedCommand() const
{
    ...
    sipMeth = sipIsPyMethod(&sipGILState,const_cast<char *>(&sipPyMethods[11]),sipPySelf,SIP_NULLPTR,sipName_GetBatchedCommand);
...
bool sipwxRichTextBuffer::BatchingUndo() const
{
    ...
    sipMeth = sipIsPyMethod(&sipGILState,const_cast<char *>(&sipPyMethods[13]),sipPySelf,SIP_NULLPTR,sipName_BatchingUndo);
 ...
 ::wxRichTextObject* sipwxRichTextBuffer::GetChildAtPosition(long pos) const
{
    ...
    sipMeth = sipIsPyMethod(&sipGILState,const_cast<char *>(&sipPyMethods[21]),sipPySelf,SIP_NULLPTR,sipName_GetChildAtPosition);
 ...
 ::wxSize sipwxRichTextBuffer::GetBestSize() const
{
    ...
    sipMeth = sipIsPyMethod(&sipGILState,const_cast<char *>(&sipPyMethods[26]),sipPySelf,SIP_NULLPTR,sipName_GetBestSize);
...
bool sipwxRichTextBuffer::GetRangeSize(const  ::wxRichTextRange& range, ::wxSize& size,int& descent, ::wxDC& dc, ::wxRichTextDrawingContext& context,int flags,const  ::wxPoint& position,const  ::wxSize& parentSize, ::wxArrayInt*partialExtents) const
{
    ...
    sipMeth = sipIsPyMethod(&sipGILState,const_cast<char *>(&sipPyMethods[27]),sipPySelf,SIP_NULLPTR,sipName_GetRangeSize);
...
bool sipwxRichTextBuffer::IsEmpty() const
{
    ...
    sipMeth = sipIsPyMethod(&sipGILState,const_cast<char *>(&sipPyMethods[31]),sipPySelf,SIP_NULLPTR,sipName_IsEmpty);
...
bool sipwxRichTextBuffer::IsFloatable() const
{
    ...
    sipMeth = sipIsPyMethod(&sipGILState,const_cast<char *>(&sipPyMethods[32]),sipPySelf,SIP_NULLPTR,sipName_IsFloatable);
...
bool sipwxRichTextBuffer::IsFloating() const
{
    ...
    sipMeth = sipIsPyMethod(&sipGILState,const_cast<char *>(&sipPyMethods[33]),sipPySelf,SIP_NULLPTR,sipName_IsFloating);
...
int sipwxRichTextBuffer::GetFloatDirection() const
{
    ...
    sipMeth = sipIsPyMethod(&sipGILState,const_cast<char *>(&sipPyMethods[34]),sipPySelf,SIP_NULLPTR,sipName_GetFloatDirection);
 ...
 ::wxString sipwxRichTextBuffer::GetTextForRange(const  ::wxRichTextRange& range) const
{
    ...
    sipMeth = sipIsPyMethod(&sipGILState,const_cast<char *>(&sipPyMethods[35]),sipPySelf,SIP_NULLPTR,sipName_GetTextForRange);
...
bool sipwxRichTextBuffer::CanMerge( ::wxRichTextObject*object, ::wxRichTextDrawingContext& context) const
{
    ...
    sipMeth = sipIsPyMethod(&sipGILState,const_cast<char *>(&sipPyMethods[36]),sipPySelf,SIP_NULLPTR,sipName_CanMerge);
...
bool sipwxRichTextBuffer::CanSplit( ::wxRichTextDrawingContext& context) const
{
    ...
    sipMeth = sipIsPyMethod(&sipGILState,const_cast<char *>(&sipPyMethods[38]),sipPySelf,SIP_NULLPTR,sipName_CanSplit);
...
bool sipwxRichTextBuffer::CanEditProperties() const
{
    ...
    sipMeth = sipIsPyMethod(&sipGILState,const_cast<char *>(&sipPyMethods[40]),sipPySelf,SIP_NULLPTR,sipName_CanEditProperties);
...
bool sipwxRichTextBuffer::UsesParagraphAttributes() const
{
    ...
    sipMeth = sipIsPyMethod(&sipGILState,const_cast<char *>(&sipPyMethods[45]),sipPySelf,SIP_NULLPTR,sipName_UsesParagraphAttributes);
 ...
 ::wxString sipwxRichTextBuffer::GetXMLNodeName() const
{
    ...
    sipMeth = sipIsPyMethod(&sipGILState,const_cast<char *>(&sipPyMethods[46]),sipPySelf,SIP_NULLPTR,sipName_GetXMLNodeName);
...
bool sipwxRichTextBuffer::HandlesChildSelections() const
{
    ...
    sipMeth = sipIsPyMethod(&sipGILState,const_cast<char *>(&sipPyMethods[48]),sipPySelf,SIP_NULLPTR,sipName_HandlesChildSelections);
 ...
 ::wxRichTextSelection sipwxRichTextBuffer::GetSelection(long start,long end) const
{
    ...
    sipMeth = sipIsPyMethod(&sipGILState,const_cast<char *>(&sipPyMethods[49]),sipPySelf,SIP_NULLPTR,sipName_GetSelection);
 ...
 ::wxSize sipwxRichTextBuffer::GetCachedSize() const
{
    ...
    sipMeth = sipIsPyMethod(&sipGILState,const_cast<char *>(&sipPyMethods[50]),sipPySelf,SIP_NULLPTR,sipName_GetCachedSize);
 ...
 ::wxSize sipwxRichTextBuffer::GetMaxSize() const
{
    ...
    sipMeth = sipIsPyMethod(&sipGILState,const_cast<char *>(&sipPyMethods[52]),sipPySelf,SIP_NULLPTR,sipName_GetMaxSize);
 ...
 ::wxSize sipwxRichTextBuffer::GetMinSize() const
{
    ...
    sipMeth = sipIsPyMethod(&sipGILState,const_cast<char *>(&sipPyMethods[54]),sipPySelf,SIP_NULLPTR,sipName_GetMinSize);
 ...
 ::wxTextAttrSize sipwxRichTextBuffer::GetNaturalSize() const
{
    ...
    sipMeth = sipIsPyMethod(&sipGILState,const_cast<char *>(&sipPyMethods[56]),sipPySelf,SIP_NULLPTR,sipName_GetNaturalSize);
 ...
 ::wxPoint sipwxRichTextBuffer::GetPosition() const
{
    ...
    sipMeth = sipIsPyMethod(&sipGILState,const_cast<char *>(&sipPyMethods[57]),sipPySelf,SIP_NULLPTR,sipName_GetPosition);
 ...
 ::wxPoint sipwxRichTextBuffer::GetAbsolutePosition() const
{
    ...
    sipMeth = sipIsPyMethod(&sipGILState,const_cast<char *>(&sipPyMethods[59]),sipPySelf,SIP_NULLPTR,sipName_GetAbsolutePosition);
 ...
 ::wxRect sipwxRichTextBuffer::GetRect() const
{
    ...
    sipMeth = sipIsPyMethod(&sipGILState,const_cast<char *>(&sipPyMethods[60]),sipPySelf,SIP_NULLPTR,sipName_GetRect);
...
bool sipwxRichTextBuffer::IsComposite() const
{
    ...
    sipMeth = sipIsPyMethod(&sipGILState,const_cast<char *>(&sipPyMethods[61]),sipPySelf,SIP_NULLPTR,sipName_IsComposite);
...
bool sipwxRichTextBuffer::IsAtomic() const
{
    ...
    sipMeth = sipIsPyMethod(&sipGILState,const_cast<char *>(&sipPyMethods[62]),sipPySelf,SIP_NULLPTR,sipName_IsAtomic);
 ...
 ::wxRichTextObject* sipwxRichTextBuffer::GetParent() const
{
    ...
    sipMeth = sipIsPyMethod(&sipGILState,const_cast<char *>(&sipPyMethods[63]),sipPySelf,SIP_NULLPTR,sipName_GetParent);
 ...
 ::wxRichTextParagraphLayoutBox* sipwxRichTextBuffer::GetContainer() const
{
    ...
    sipMeth = sipIsPyMethod(&sipGILState,const_cast<char *>(&sipPyMethods[65]),sipPySelf,SIP_NULLPTR,sipName_GetContainer);
...
int sipwxRichTextBuffer::GetLeftMargin() const
{
    ...
    sipMeth = sipIsPyMethod(&sipGILState,const_cast<char *>(&sipPyMethods[69]),sipPySelf,SIP_NULLPTR,sipName_GetLeftMargin);
...
int sipwxRichTextBuffer::GetRightMargin() const
{
    ...
    sipMeth = sipIsPyMethod(&sipGILState,const_cast<char *>(&sipPyMethods[70]),sipPySelf,SIP_NULLPTR,sipName_GetRightMargin);
...
int sipwxRichTextBuffer::GetTopMargin() const
{
    ...
    sipMeth = sipIsPyMethod(&sipGILState,const_cast<char *>(&sipPyMethods[71]),sipPySelf,SIP_NULLPTR,sipName_GetTopMargin);
...
int sipwxRichTextBuffer::GetBottomMargin() const
{
    ...
    sipMeth = sipIsPyMethod(&sipGILState,const_cast<char *>(&sipPyMethods[72]),sipPySelf,SIP_NULLPTR,sipName_GetBottomMargin);
 ...
 ::wxRect sipwxRichTextBuffer::GetAvailableContentArea( ::wxDC& dc, ::wxRichTextDrawingContext& context,const  ::wxRect& outerRect) const
{
    ...
    sipMeth = sipIsPyMethod(&sipGILState,const_cast<char *>(&sipPyMethods[73]),sipPySelf,SIP_NULLPTR,sipName_GetAvailableContentArea);
...
bool sipwxRichTextBuffer::IsTopLevel() const
{
    ...
    sipMeth = sipIsPyMethod(&sipGILState,const_cast<char *>(&sipPyMethods[76]),sipPySelf,SIP_NULLPTR,sipName_IsTopLevel);
 ...
 ::wxRichTextObject* sipwxRichTextBuffer::Clone() const
{
    ...
    sipMeth = sipIsPyMethod(&sipGILState,const_cast<char *>(&sipPyMethods[78]),sipPySelf,SIP_NULLPTR,sipName_Clone);
 ...
 ::wxRichTextStyleSheet* sipwxRichTextBuffer::GetStyleSheet() const
{
    ...
    sipMeth = sipIsPyMethod(&sipGILState,const_cast<char *>(&sipPyMethods[86]),sipPySelf,SIP_NULLPTR,sipName_GetStyleSheet);
 ...
 ::wxRichTextLine* sipwxRichTextBuffer::GetLineAtPosition(long pos,bool caretPosition) const
{
    ...
    sipMeth = sipIsPyMethod(&sipGILState,const_cast<char *>(&sipPyMethods[92]),sipPySelf,SIP_NULLPTR,sipName_GetLineAtPosition);
 ...
 ::wxRichTextLine* sipwxRichTextBuffer::GetLineAtYPosition(int y) const
{
    ...
    sipMeth = sipIsPyMethod(&sipGILState,const_cast<char *>(&sipPyMethods[93]),sipPySelf,SIP_NULLPTR,sipName_GetLineAtYPosition);
 ...
 ::wxRichTextParagraph* sipwxRichTextBuffer::GetParagraphAtPosition(long pos,bool caretPosition) const
{
    ...
    sipMeth = sipIsPyMethod(&sipGILState,const_cast<char *>(&sipPyMethods[94]),sipPySelf,SIP_NULLPTR,sipName_GetParagraphAtPosition);
 ...
 ::wxSize sipwxRichTextBuffer::GetLineSizeAtPosition(long pos,bool caretPosition) const
{
    ...
    sipMeth = sipIsPyMethod(&sipGILState,const_cast<char *>(&sipPyMethods[95]),sipPySelf,SIP_NULLPTR,sipName_GetLineSizeAtPosition);
...
long sipwxRichTextBuffer::GetVisibleLineNumber(long pos,bool caretPosition,bool startOfLine) const
{
    ...
    sipMeth = sipIsPyMethod(&sipGILState,const_cast<char *>(&sipPyMethods[96]),sipPySelf,SIP_NULLPTR,sipName_GetVisibleLineNumber);
 ...
 ::wxRichTextLine* sipwxRichTextBuffer::GetLineForVisibleLineNumber(long lineNumber) const
{
    ...
    sipMeth = sipIsPyMethod(&sipGILState,const_cast<char *>(&sipPyMethods[97]),sipPySelf,SIP_NULLPTR,sipName_GetLineForVisibleLineNumber);
 ...
 ::wxRichTextObject* sipwxRichTextBuffer::GetLeafObjectAtPosition(long position) const
{
    ...
    sipMeth = sipIsPyMethod(&sipGILState,const_cast<char *>(&sipPyMethods[98]),sipPySelf,SIP_NULLPTR,sipName_GetLeafObjectAtPosition);
 ...
 ::wxRichTextParagraph* sipwxRichTextBuffer::GetParagraphAtLine(long paragraphNumber) const
{
    ...
    sipMeth = sipIsPyMethod(&sipGILState,const_cast<char *>(&sipPyMethods[99]),sipPySelf,SIP_NULLPTR,sipName_GetParagraphAtLine);
 ...
 ::wxRichTextParagraph* sipwxRichTextBuffer::GetParagraphForLine( ::wxRichTextLine*line) const
{
    ...
    sipMeth = sipIsPyMethod(&sipGILState,const_cast<char *>(&sipPyMethods[100]),sipPySelf,SIP_NULLPTR,sipName_GetParagraphForLine);
...
int sipwxRichTextBuffer::GetParagraphLength(long paragraphNumber) const
{
    ...
    sipMeth = sipIsPyMethod(&sipGILState,const_cast<char *>(&sipPyMethods[101]),sipPySelf,SIP_NULLPTR,sipName_GetParagraphLength);
...
int sipwxRichTextBuffer::GetParagraphCount() const
{
    ...
    sipMeth = sipIsPyMethod(&sipGILState,const_cast<char *>(&sipPyMethods[102]),sipPySelf,SIP_NULLPTR,sipName_GetParagraphCount);
...
int sipwxRichTextBuffer::GetLineCount() const
{
    ...
    sipMeth = sipIsPyMethod(&sipGILState,const_cast<char *>(&sipPyMethods[103]),sipPySelf,SIP_NULLPTR,sipName_GetLineCount);
 ...
 ::wxString sipwxRichTextBuffer::GetParagraphText(long paragraphNumber) const
{
    ...
    sipMeth = sipIsPyMethod(&sipGILState,const_cast<char *>(&sipPyMethods[104]),sipPySelf,SIP_NULLPTR,sipName_GetParagraphText);
...
long sipwxRichTextBuffer::XYToPosition(long x,long y) const
{
    ...
    sipMeth = sipIsPyMethod(&sipGILState,const_cast<char *>(&sipPyMethods[105]),sipPySelf,SIP_NULLPTR,sipName_XYToPosition);
...
bool sipwxRichTextBuffer::PositionToXY(long pos,long*x,long*y) const
{
    ...
    sipMeth = sipIsPyMethod(&sipGILState,const_cast<char *>(&sipPyMethods[106]),sipPySelf,SIP_NULLPTR,sipName_PositionToXY);
...
bool sipwxRichTextBuffer::FindNextParagraphNumber( ::wxRichTextParagraph*previousParagraph, ::wxRichTextAttr& attr) const
{
    ...
    sipMeth = sipIsPyMethod(&sipGILState,const_cast<char *>(&sipPyMethods[115]),sipPySelf,SIP_NULLPTR,sipName_FindNextParagraphNumber);
...
bool sipwxRichTextBuffer::HasCharacterAttributes(const  ::wxRichTextRange& range,const  ::wxRichTextAttr& style) const
{
    ...
    sipMeth = sipIsPyMethod(&sipGILState,const_cast<char *>(&sipPyMethods[118]),sipPySelf,SIP_NULLPTR,sipName_HasCharacterAttributes);
...
bool sipwxRichTextBuffer::HasParagraphAttributes(const  ::wxRichTextRange& range,const  ::wxRichTextAttr& style) const
{
    ...
    sipMeth = sipIsPyMethod(&sipGILState,const_cast<char *>(&sipPyMethods[119]),sipPySelf,SIP_NULLPTR,sipName_HasParagraphAttributes);
 ...
 ::wxString sipwxRichTextBuffer::GetText() const
{
    ...
    sipMeth = sipIsPyMethod(&sipGILState,const_cast<char *>(&sipPyMethods[125]),sipPySelf,SIP_NULLPTR,sipName_GetText);
...
const  ::wxRichTextAttr& sipwxRichTextBuffer::GetDefaultStyle() const
{
    ...
    sipMeth = sipIsPyMethod(&sipGILState,const_cast<char *>(&sipPyMethods[127]),sipPySelf,SIP_NULLPTR,sipName_GetDefaultStyle);
...
const  ::wxRichTextAttr& sipwxRichTextBuffer::GetBasicStyle() const
{
    ...
    sipMeth = sipIsPyMethod(&sipGILState,const_cast<char *>(&sipPyMethods[129]),sipPySelf,SIP_NULLPTR,sipName_GetBasicStyle);
...
PyDoc_STRVAR(doc_wxRichTextBuffer_GetRangeSize, "GetRangeSize(self, range: RichTextRange, size: Size, dc: DC, context: RichTextDrawingContext, flags: int, position: Point = wxPoint(0,0), parentSize: Size = wxDefaultSize, partialExtents: object = None) -> Tuple[bool, int]");
...
extern "C" {static void assign_wxRichTextBuffer(void *, SIP_SSIZE_T, void *);}
static void assign_wxRichTextBuffer(void *sipDst, SIP_SSIZE_T sipDstIdx, void *sipSrc)
{
    reinterpret_cast< ::wxRichTextBuffer *>(sipDst)[sipDstIdx] = *reinterpret_cast< ::wxRichTextBuffer *>(sipSrc);
}


extern "C" {static void *array_wxRichTextBuffer(SIP_SSIZE_T);}
static void *array_wxRichTextBuffer(SIP_SSIZE_T sipNrElem)
{
    return new  ::wxRichTextBuffer[sipNrElem];
}


extern "C" {static void *copy_wxRichTextBuffer(const void *, SIP_SSIZE_T);}
static void *copy_wxRichTextBuffer(const void *sipSrc, SIP_SSIZE_T sipSrcIdx)
{
...
static sipEncodedTypeDef supers_wxRichTextBuffer[] = {{52, 255, 1}};


static PyMethodDef methods_wxRichTextBuffer[] = {
    {SIP_MLNAME_CAST(sipName_AddDrawingHandler), SIP_MLMETH_CAST(meth_wxRichTextBuffer_AddDrawingHandler), METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxRichTextBuffer_AddDrawingHandler)},
    {SIP_MLNAME_CAST(sipName_AddEventHandler), SIP_MLMETH_CAST(meth_wxRichTextBuffer_AddEventHandler), METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxRichTextBuffer_AddEventHandler)},
    {SIP_MLNAME_CAST(sipName_AddFieldType), SIP_MLMETH_CAST(meth_wxRichTextBuffer_AddFieldType), METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxRichTextBuffer_AddFieldType)},
    {SIP_MLNAME_CAST(sipName_AddHandler), SIP_MLMETH_CAST(meth_wxRichTextBuffer_AddHandler), METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxRichTextBuffer_AddHandler)},
    {SIP_MLNAME_CAST(sipName_AddParagraph), SIP_MLMETH_CAST(meth_wxRichTextBuffer_AddParagraph), METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxRichTextBuffer_AddParagraph)},
    {SIP_MLNAME_CAST(sipName_BatchingUndo), meth_wxRichTextBuffer_BatchingUndo, METH_VARARGS, SIP_MLDOC_CAST(doc_wxRichTextBuffer_BatchingUndo)},
    {SIP_MLNAME_CAST(sipName_BeginAlignment), SIP_MLMETH_CAST(meth_wxRichTextBuffer_BeginAlignment), METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxRichTextBuffer_BeginAlignment)},
    {SIP_MLNAME_CAST(sipName_BeginBatchUndo), SIP_MLMETH_CAST(meth_wxRichTextBuffer_BeginBatchUndo), METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxRichTextBuffer_BeginBatchUndo)},
    {SIP_MLNAME_CAST(sipName_BeginBold), meth_wxRichTextBuffer_BeginBold, METH_VARARGS, SIP_MLDOC_CAST(doc_wxRichTextBuffer_BeginBold)},
    {SIP_MLNAME_CAST(sipName_BeginCharacterStyle), SIP_MLMETH_CAST(meth_wxRichTextBuffer_BeginCharacterStyle), METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxRichTextBuffer_BeginCharacterStyle)},
    {SIP_MLNAME_CAST(sipName_BeginFont), SIP_MLMETH_CAST(meth_wxRichTextBuffer_BeginFont), METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxRichTextBuffer_BeginFont)},
    {SIP_MLNAME_CAST(sipName_BeginFontSize), SIP_MLMETH_CAST(meth_wxRichTextBuffer_BeginFontSize), METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxRichTextBuffer_BeginFontSize)},
    {SIP_MLNAME_CAST(sipName_BeginItalic), meth_wxRichTextBuffer_BeginItalic, METH_VARARGS, SIP_MLDOC_CAST(doc_wxRichTextBuffer_BeginItalic)},
    {SIP_MLNAME_CAST(sipName_BeginLeftIndent), SIP_MLMETH_CAST(meth_wxRichTextBuffer_BeginLeftIndent), METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxRichTextBuffer_BeginLeftIndent)},
    {SIP_MLNAME_CAST(sipName_BeginLineSpacing), SIP_MLMETH_CAST(meth_wxRichTextBuffer_BeginLineSpacing), METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxRichTextBuffer_BeginLineSpacing)},
    {SIP_MLNAME_CAST(sipName_BeginListStyle), SIP_MLMETH_CAST(meth_wxRichTextBuffer_BeginListStyle), METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxRichTextBuffer_BeginListStyle)},
    {SIP_MLNAME_CAST(sipName_BeginNumberedBullet), SIP_MLMETH_CAST(meth_wxRichTextBuffer_BeginNumberedBullet), METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxRichTextBuffer_BeginNumberedBullet)},
    {SIP_MLNAME_CAST(sipName_BeginParagraphSpacing), SIP_MLMETH_CAST(meth_wxRichTextBuffer_BeginParagraphSpacing), METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxRichTextBuffer_BeginParagraphSpacing)},
    {SIP_MLNAME_CAST(sipName_BeginParagraphStyle), SIP_MLMETH_CAST(meth_wxRichTextBuffer_BeginParagraphStyle), METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxRichTextBuffer_BeginParagraphStyle)},
    {SIP_MLNAME_CAST(sipName_BeginRightIndent), SIP_MLMETH_CAST(meth_wxRichTextBuffer_BeginRightIndent), METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxRichTextBuffer_BeginRightIndent)},
    {SIP_MLNAME_CAST(sipName_BeginStandardBullet), SIP_MLMETH_CAST(meth_wxRichTextBuffer_BeginStandardBullet), METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxRichTextBuffer_BeginStandardBullet)},
    {SIP_MLNAME_CAST(sipName_BeginStyle), SIP_MLMETH_CAST(meth_wxRichTextBuffer_BeginStyle), METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxRichTextBuffer_BeginStyle)},
    {SIP_MLNAME_CAST(sipName_BeginSuppressUndo), meth_wxRichTextBuffer_BeginSuppressUndo, METH_VARARGS, SIP_MLDOC_CAST(doc_wxRichTextBuffer_BeginSuppressUndo)},
    {SIP_MLNAME_CAST(sipName_BeginSymbolBullet), SIP_MLMETH_CAST(meth_wxRichTextBuffer_BeginSymbolBullet), METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxRichTextBuffer_BeginSymbolBullet)},
    {SIP_MLNAME_CAST(sipName_BeginTextColour), SIP_MLMETH_CAST(meth_wxRichTextBuffer_BeginTextColour), METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxRichTextBuffer_BeginTextColour)},
    {SIP_MLNAME_CAST(sipName_BeginURL), SIP_MLMETH_CAST(meth_wxRichTextBuffer_BeginURL), METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxRichTextBuffer_BeginURL)},
    {SIP_MLNAME_CAST(sipName_BeginUnderline), meth_wxRichTextBuffer_BeginUnderline, METH_VARARGS, SIP_MLDOC_CAST(doc_wxRichTextBuffer_BeginUnderline)},
    {SIP_MLNAME_CAST(sipName_CanPasteFromClipboard), meth_wxRichTextBuffer_CanPasteFromClipboard, METH_VARARGS, SIP_MLDOC_CAST(doc_wxRichTextBuffer_CanPasteFromClipboard)},
    {SIP_MLNAME_CAST(sipName_CleanUpDrawingHandlers), meth_wxRichTextBuffer_CleanUpDrawingHandlers, METH_VARARGS, SIP_MLDOC_CAST(doc_wxRichTextBuffer_CleanUpDrawingHandlers)},
    {SIP_MLNAME_CAST(sipName_CleanUpFieldTypes), meth_wxRichTextBuffer_CleanUpFieldTypes, METH_VARARGS, SIP_MLDOC_CAST(doc_wxRichTextBuffer_CleanUpFieldTypes)},
    {SIP_MLNAME_CAST(sipName_CleanUpHandlers), meth_wxRichTextBuffer_CleanUpHandlers, METH_VARARGS, SIP_MLDOC_CAST(doc_wxRichTextBuffer_CleanUpHandlers)},
    {SIP_MLNAME_CAST(sipName_ClearEventHandlers), meth_wxRichTextBuffer_ClearEventHandlers, METH_VARARGS, SIP_MLDOC_CAST(doc_wxRichTextBuffer_ClearEventHandlers)},
    {SIP_MLNAME_CAST(sipName_ClearStyleStack), meth_wxRichTextBuffer_ClearStyleStack, METH_VARARGS, SIP_MLDOC_CAST(doc_wxRichTextBuffer_ClearStyleStack)},
    {SIP_MLNAME_CAST(sipName_Clone), meth_wxRichTextBuffer_Clone, METH_VARARGS, SIP_MLDOC_CAST(doc_wxRichTextBuffer_Clone)},
    {SIP_MLNAME_CAST(sipName_Copy), SIP_MLMETH_CAST(meth_wxRichTextBuffer_Copy), METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxRichTextBuffer_Copy)},
    {SIP_MLNAME_CAST(sipName_CopyToClipboard), SIP_MLMETH_CAST(meth_wxRichTextBuffer_CopyToClipboard), METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxRichTextBuffer_CopyToClipboard)},
    {SIP_MLNAME_CAST(sipName_DeleteRangeWithUndo), SIP_MLMETH_CAST(meth_wxRichTextBuffer_DeleteRangeWithUndo), METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxRichTextBuffer_DeleteRangeWithUndo)},
    {SIP_MLNAME_CAST(sipName_Draw), SIP_MLMETH_CAST(meth_wxRichTextBuffer_Draw), METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxRichTextBuffer_Draw)},
    {SIP_MLNAME_CAST(sipName_EndAlignment), meth_wxRichTextBuffer_EndAlignment, METH_VARARGS, SIP_MLDOC_CAST(doc_wxRichTextBuffer_EndAlignment)},
    {SIP_MLNAME_CAST(sipName_EndAllStyles), meth_wxRichTextBuffer_EndAllStyles, METH_VARARGS, SIP_MLDOC_CAST(doc_wxRichTextBuffer_EndAllStyles)},
    {SIP_MLNAME_CAST(sipName_EndBatchUndo), meth_wxRichTextBuffer_EndBatchUndo, METH_VARARGS, SIP_MLDOC_CAST(doc_wxRichTextBuffer_EndBatchUndo)},
    {SIP_MLNAME_CAST(sipName_EndBold), meth_wxRichTextBuffer_EndBold, METH_VARARGS, SIP_MLDOC_CAST(doc_wxRichTextBuffer_EndBold)},
    {SIP_MLNAME_CAST(sipName_EndCharacterStyle), meth_wxRichTextBuffer_EndCharacterStyle, METH_VARARGS, SIP_MLDOC_CAST(doc_wxRichTextBuffer_EndCharacterStyle)},
    {SIP_MLNAME_CAST(sipName_EndFont), meth_wxRichTextBuffer_EndFont, METH_VARARGS, SIP_MLDOC_CAST(doc_wxRichTextBuffer_EndFont)},
    {SIP_MLNAME_CAST(sipName_EndFontSize), meth_wxRichTextBuffer_EndFontSize, METH_VARARGS, SIP_MLDOC_CAST(doc_wxRichTextBuffer_EndFontSize)},
    {SIP_MLNAME_CAST(sipName_EndItalic), meth_wxRichTextBuffer_EndItalic, METH_VARARGS, SIP_MLDOC_CAST(doc_wxRichTextBuffer_EndItalic)},
    {SIP_MLNAME_CAST(sipName_EndLeftIndent), meth_wxRichTextBuffer_EndLeftIndent, METH_VARARGS, SIP_MLDOC_CAST(doc_wxRichTextBuffer_EndLeftIndent)},
    {SIP_MLNAME_CAST(sipName_EndLineSpacing), meth_wxRichTextBuffer_EndLineSpacing, METH_VARARGS, SIP_MLDOC_CAST(doc_wxRichTextBuffer_EndLineSpacing)},
    {SIP_MLNAME_CAST(sipName_EndListStyle), meth_wxRichTextBuffer_EndListStyle, METH_VARARGS, SIP_MLDOC_CAST(doc_wxRichTextBuffer_EndListStyle)},
    {SIP_MLNAME_CAST(sipName_EndNumberedBullet), meth_wxRichTextBuffer_EndNumberedBullet, METH_VARARGS, SIP_MLDOC_CAST(doc_wxRichTextBuffer_EndNumberedBullet)},
    {SIP_MLNAME_CAST(sipName_EndParagraphSpacing), meth_wxRichTextBuffer_EndParagraphSpacing, METH_VARARGS, SIP_MLDOC_CAST(doc_wxRichTextBuffer_EndParagraphSpacing)},
    {SIP_MLNAME_CAST(sipName_EndParagraphStyle), meth_wxRichTextBuffer_EndParagraphStyle, METH_VARARGS, SIP_MLDOC_CAST(doc_wxRichTextBuffer_EndParagraphStyle)},
    {SIP_MLNAME_CAST(sipName_EndRightIndent), meth_wxRichTextBuffer_EndRightIndent, METH_VARARGS, SIP_MLDOC_CAST(doc_wxRichTextBuffer_EndRightIndent)},
    {SIP_MLNAME_CAST(sipName_EndStandardBullet), meth_wxRichTextBuffer_EndStandardBullet, METH_VARARGS, SIP_MLDOC_CAST(doc_wxRichTextBuffer_EndStandardBullet)},
    {SIP_MLNAME_CAST(sipName_EndStyle), meth_wxRichTextBuffer_EndStyle, METH_VARARGS, SIP_MLDOC_CAST(doc_wxRichTextBuffer_EndStyle)},
    {SIP_MLNAME_CAST(sipName_EndSuppressUndo), meth_wxRichTextBuffer_EndSuppressUndo, METH_VARARGS, SIP_MLDOC_CAST(doc_wxRichTextBuffer_EndSuppressUndo)},
    {SIP_MLNAME_CAST(sipName_EndSymbolBullet), meth_wxRichTextBuffer_EndSymbolBullet, METH_VARARGS, SIP_MLDOC_CAST(doc_wxRichTextBuffer_EndSymbolBullet)},
    {SIP_MLNAME_CAST(sipName_EndTextColour), meth_wxRichTextBuffer_EndTextColour, METH_VARARGS, SIP_MLDOC_CAST(doc_wxRichTextBuffer_EndTextColour)},
    {SIP_MLNAME_CAST(sipName_EndURL), meth_wxRichTextBuffer_EndURL, METH_VARARGS, SIP_MLDOC_CAST(doc_wxRichTextBuffer_EndURL)},
    {SIP_MLNAME_CAST(sipName_EndUnderline), meth_wxRichTextBuffer_EndUnderline, METH_VARARGS, SIP_MLDOC_CAST(doc_wxRichTextBuffer_EndUnderline)},
    {SIP_MLNAME_CAST(sipName_FindDrawingHandler), SIP_MLMETH_CAST(meth_wxRichTextBuffer_FindDrawingHandler), METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxRichTextBuffer_FindDrawingHandler)},
    {SIP_MLNAME_CAST(sipName_FindFieldType), SIP_MLMETH_CAST(meth_wxRichTextBuffer_FindFieldType), METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxRichTextBuffer_FindFieldType)},
    {SIP_MLNAME_CAST(sipName_FindHandlerByExtension), SIP_MLMETH_CAST(meth_wxRichTextBuffer_FindHandlerByExtension), METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxRichTextBuffer_FindHandlerByExtension)},
    {SIP_MLNAME_CAST(sipName_FindHandlerByFilename), SIP_MLMETH_CAST(meth_wxRichTextBuffer_FindHandlerByFilename), METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxRichTextBuffer_FindHandlerByFilename)},
    {SIP_MLNAME_CAST(sipName_FindHandlerByName), SIP_MLMETH_CAST(meth_wxRichTextBuffer_FindHandlerByName), METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxRichTextBuffer_FindHandlerByName)},
    {SIP_MLNAME_CAST(sipName_FindHandlerByType), SIP_MLMETH_CAST(meth_wxRichTextBuffer_FindHandlerByType), METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxRichTextBuffer_FindHandlerByType)},
    {SIP_MLNAME_CAST(sipName_GetBatchedCommand), meth_wxRichTextBuffer_GetBatchedCommand, METH_VARARGS, SIP_MLDOC_CAST(doc_wxRichTextBuffer_GetBatchedCommand)},
    {SIP_MLNAME_CAST(sipName_GetBulletProportion), meth_wxRichTextBuffer_GetBulletProportion, METH_VARARGS, SIP_MLDOC_CAST(doc_wxRichTextBuffer_GetBulletProportion)},
    {SIP_MLNAME_CAST(sipName_GetBulletRightMargin), meth_wxRichTextBuffer_GetBulletRightMargin, METH_VARARGS, SIP_MLDOC_CAST(doc_wxRichTextBuffer_GetBulletRightMargin)},
    {SIP_MLNAME_CAST(sipName_GetCommandProcessor), meth_wxRichTextBuffer_GetCommandProcessor, METH_VARARGS, SIP_MLDOC_CAST(doc_wxRichTextBuffer_GetCommandProcessor)},
    {SIP_MLNAME_CAST(sipName_GetDimensionScale), meth_wxRichTextBuffer_GetDimensionScale, METH_VARARGS, SIP_MLDOC_CAST(doc_wxRichTextBuffer_GetDimensionScale)},
    {SIP_MLNAME_CAST(sipName_GetDrawingHandlers), meth_wxRichTextBuffer_GetDrawingHandlers, METH_VARARGS, SIP_MLDOC_CAST(doc_wxRichTextBuffer_GetDrawingHandlers)},
    {SIP_MLNAME_CAST(sipName_GetExtWildcard), SIP_MLMETH_CAST(meth_wxRichTextBuffer_GetExtWildcard), METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxRichTextBuffer_GetExtWildcard)},
    {SIP_MLNAME_CAST(sipName_GetFloatingLayoutMode), meth_wxRichTextBuffer_GetFloatingLayoutMode, METH_VARARGS, SIP_MLDOC_CAST(doc_wxRichTextBuffer_GetFloatingLayoutMode)},
    {SIP_MLNAME_CAST(sipName_GetFontScale), meth_wxRichTextBuffer_GetFontScale, METH_VARARGS, SIP_MLDOC_CAST(doc_wxRichTextBuffer_GetFontScale)},
    {SIP_MLNAME_CAST(sipName_GetFontTable), meth_wxRichTextBuffer_GetFontTable, METH_VARARGS, SIP_MLDOC_CAST(doc_wxRichTextBuffer_GetFontTable)},
    {SIP_MLNAME_CAST(sipName_GetHandlerFlags), meth_wxRichTextBuffer_GetHandlerFlags, METH_VARARGS, SIP_MLDOC_CAST(doc_wxRichTextBuffer_GetHandlerFlags)},
    {SIP_MLNAME_CAST(sipName_GetHandlers), meth_wxRichTextBuffer_GetHandlers, METH_VARARGS, SIP_MLDOC_CAST(doc_wxRichTextBuffer_GetHandlers)},
    {SIP_MLNAME_CAST(sipName_GetRangeSize), SIP_MLMETH_CAST(meth_wxRichTextBuffer_GetRangeSize), METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxRichTextBuffer_GetRangeSize)},
    {SIP_MLNAME_CAST(sipName_GetRenderer), meth_wxRichTextBuffer_GetRenderer, METH_VARARGS, SIP_MLDOC_CAST(doc_wxRichTextBuffer_GetRenderer)},
    {SIP_MLNAME_CAST(sipName_GetScale), meth_wxRichTextBuffer_GetScale, METH_VARARGS, SIP_MLDOC_CAST(doc_wxRichTextBuffer_GetScale)},
    {SIP_MLNAME_CAST(sipName_GetStyleSheet), meth_wxRichTextBuffer_GetStyleSheet, METH_VARARGS, SIP_MLDOC_CAST(doc_wxRichTextBuffer_GetStyleSheet)},
    {SIP_MLNAME_CAST(sipName_GetStyleStackSize), meth_wxRichTextBuffer_GetStyleStackSize, METH_VARARGS, SIP_MLDOC_CAST(doc_wxRichTextBuffer_GetStyleStackSize)},
    {SIP_MLNAME_CAST(sipName_HitTest), SIP_MLMETH_CAST(meth_wxRichTextBuffer_HitTest), METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxRichTextBuffer_HitTest)},
    {SIP_MLNAME_CAST(sipName_Init), meth_wxRichTextBuffer_Init, METH_VARARGS, SIP_MLDOC_CAST(doc_wxRichTextBuffer_Init)},
    {SIP_MLNAME_CAST(sipName_InitStandardHandlers), meth_wxRichTextBuffer_InitStandardHandlers, METH_VARARGS, SIP_MLDOC_CAST(doc_wxRichTextBuffer_InitStandardHandlers)},
    {SIP_MLNAME_CAST(sipName_InsertDrawingHandler), SIP_MLMETH_CAST(meth_wxRichTextBuffer_InsertDrawingHandler), METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxRichTextBuffer_InsertDrawingHandler)},
    {SIP_MLNAME_CAST(sipName_InsertHandler), SIP_MLMETH_CAST(meth_wxRichTextBuffer_InsertHandler), METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxRichTextBuffer_InsertHandler)},
    {SIP_MLNAME_CAST(sipName_InsertImageWithUndo), SIP_MLMETH_CAST(meth_wxRichTextBuffer_InsertImageWithUndo), METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxRichTextBuffer_InsertImageWithUndo)},
    {SIP_MLNAME_CAST(sipName_InsertNewlineWithUndo), SIP_MLMETH_CAST(meth_wxRichTextBuffer_InsertNewlineWithUndo), METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxRichTextBuffer_InsertNewlineWithUndo)},
    {SIP_MLNAME_CAST(sipName_InsertObjectWithUndo), SIP_MLMETH_CAST(meth_wxRichTextBuffer_InsertObjectWithUndo), METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxRichTextBuffer_InsertObjectWithUndo)},
    {SIP_MLNAME_CAST(sipName_InsertParagraphsWithUndo), SIP_MLMETH_CAST(meth_wxRichTextBuffer_InsertParagraphsWithUndo), METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxRichTextBuffer_InsertParagraphsWithUndo)},
    {SIP_MLNAME_CAST(sipName_InsertTextWithUndo), SIP_MLMETH_CAST(meth_wxRichTextBuffer_InsertTextWithUndo), METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxRichTextBuffer_InsertTextWithUndo)},
    {SIP_MLNAME_CAST(sipName_IsModified), meth_wxRichTextBuffer_IsModified, METH_VARARGS, SIP_MLDOC_CAST(doc_wxRichTextBuffer_IsModified)},
    {SIP_MLNAME_CAST(sipName_Layout), SIP_MLMETH_CAST(meth_wxRichTextBuffer_Layout), METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxRichTextBuffer_Layout)},
    {SIP_MLNAME_CAST(sipName_LoadFile), SIP_MLMETH_CAST(meth_wxRichTextBuffer_LoadFile), METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxRichTextBuffer_LoadFile)},
    {SIP_MLNAME_CAST(sipName_Modify), SIP_MLMETH_CAST(meth_wxRichTextBuffer_Modify), METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxRichTextBuffer_Modify)},
    {SIP_MLNAME_CAST(sipName_PasteFromClipboard), SIP_MLMETH_CAST(meth_wxRichTextBuffer_PasteFromClipboard), METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxRichTextBuffer_PasteFromClipboard)},
    {SIP_MLNAME_CAST(sipName_PopStyleSheet), meth_wxRichTextBuffer_PopStyleSheet, METH_VARARGS, SIP_MLDOC_CAST(doc_wxRichTextBuffer_PopStyleSheet)},
    {SIP_MLNAME_CAST(sipName_PushStyleSheet), SIP_MLMETH_CAST(meth_wxRichTextBuffer_PushStyleSheet), METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxRichTextBuffer_PushStyleSheet)},
    {SIP_MLNAME_CAST(sipName_RemoveDrawingHandler), SIP_MLMETH_CAST(meth_wxRichTextBuffer_RemoveDrawingHandler), METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxRichTextBuffer_RemoveDrawingHandler)},
    {SIP_MLNAME_CAST(sipName_RemoveEventHandler), SIP_MLMETH_CAST(meth_wxRichTextBuffer_RemoveEventHandler), METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxRichTextBuffer_RemoveEventHandler)},
    {SIP_MLNAME_CAST(sipName_RemoveFieldType), SIP_MLMETH_CAST(meth_wxRichTextBuffer_RemoveFieldType), METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxRichTextBuffer_RemoveFieldType)},
    {SIP_MLNAME_CAST(sipName_RemoveHandler), SIP_MLMETH_CAST(meth_wxRichTextBuffer_RemoveHandler), METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxRichTextBuffer_RemoveHandler)},
    {SIP_MLNAME_CAST(sipName_ResetAndClearCommands), meth_wxRichTextBuffer_ResetAndClearCommands, METH_VARARGS, SIP_MLDOC_CAST(doc_wxRichTextBuffer_ResetAndClearCommands)},
    {SIP_MLNAME_CAST(sipName_SaveFile), SIP_MLMETH_CAST(meth_wxRichTextBuffer_SaveFile), METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxRichTextBuffer_SaveFile)},
    {SIP_MLNAME_CAST(sipName_SendEvent), SIP_MLMETH_CAST(meth_wxRichTextBuffer_SendEvent), METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxRichTextBuffer_SendEvent)},
    {SIP_MLNAME_CAST(sipName_SetBulletProportion), SIP_MLMETH_CAST(meth_wxRichTextBuffer_SetBulletProportion), METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxRichTextBuffer_SetBulletProportion)},
    {SIP_MLNAME_CAST(sipName_SetBulletRightMargin), SIP_MLMETH_CAST(meth_wxRichTextBuffer_SetBulletRightMargin), METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxRichTextBuffer_SetBulletRightMargin)},
    {SIP_MLNAME_CAST(sipName_SetDimensionScale), SIP_MLMETH_CAST(meth_wxRichTextBuffer_SetDimensionScale), METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxRichTextBuffer_SetDimensionScale)},
    {SIP_MLNAME_CAST(sipName_SetFloatingLayoutMode), SIP_MLMETH_CAST(meth_wxRichTextBuffer_SetFloatingLayoutMode), METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxRichTextBuffer_SetFloatingLayoutMode)},
    {SIP_MLNAME_CAST(sipName_SetFontScale), SIP_MLMETH_CAST(meth_wxRichTextBuffer_SetFontScale), METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxRichTextBuffer_SetFontScale)},
    {SIP_MLNAME_CAST(sipName_SetFontTable), SIP_MLMETH_CAST(meth_wxRichTextBuffer_SetFontTable), METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxRichTextBuffer_SetFontTable)},
    {SIP_MLNAME_CAST(sipName_SetHandlerFlags), SIP_MLMETH_CAST(meth_wxRichTextBuffer_SetHandlerFlags), METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxRichTextBuffer_SetHandlerFlags)},
    {SIP_MLNAME_CAST(sipName_SetRenderer), SIP_MLMETH_CAST(meth_wxRichTextBuffer_SetRenderer), METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxRichTextBuffer_SetRenderer)},
    {SIP_MLNAME_CAST(sipName_SetScale), SIP_MLMETH_CAST(meth_wxRichTextBuffer_SetScale), METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxRichTextBuffer_SetScale)},
    {SIP_MLNAME_CAST(sipName_SetStyleSheet), SIP_MLMETH_CAST(meth_wxRichTextBuffer_SetStyleSheet), METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxRichTextBuffer_SetStyleSheet)},
    {SIP_MLNAME_CAST(sipName_SetStyleSheetAndNotify), SIP_MLMETH_CAST(meth_wxRichTextBuffer_SetStyleSheetAndNotify), METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxRichTextBuffer_SetStyleSheetAndNotify)},
    {SIP_MLNAME_CAST(sipName_SubmitAction), SIP_MLMETH_CAST(meth_wxRichTextBuffer_SubmitAction), METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxRichTextBuffer_SubmitAction)},
    {SIP_MLNAME_CAST(sipName_SuppressingUndo), meth_wxRichTextBuffer_SuppressingUndo, METH_VARARGS, SIP_MLDOC_CAST(doc_wxRichTextBuffer_SuppressingUndo)}
};
