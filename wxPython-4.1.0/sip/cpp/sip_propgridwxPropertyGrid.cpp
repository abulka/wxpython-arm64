 ...
 ::wxSize sipwxPropertyGrid::GetSizeAvailableForScrollTarget(const  ::wxSize& size)
{
    ...
    extern  ::wxSize sipVH__propgrid_60(sip_gilstate_t, sipVirtErrorHandlerFunc, sipSimpleWrapper *, PyObject *, const  ::wxSize&);

    return sipVH__propgrid_60(sipGILState, 0, sipPySelf, sipMeth, size);
}
...
bool sipwxPropertyGrid::ShouldScrollToChildOnFocus( ::wxWindow*child)
{
    ...
    return sipVH__propgrid_59(sipGILState, 0, sipPySelf, sipMeth, child);
}
...
bool sipwxPropertyGrid::SendAutoScrollEvents( ::wxScrollWinEvent& event) const
{
    ...
    extern bool sipVH__propgrid_58(sip_gilstate_t, sipVirtErrorHandlerFunc, sipSimpleWrapper *, PyObject *,  ::wxScrollWinEvent&);

    return sipVH__propgrid_58(sipGILState, 0, sipPySelf, sipMeth, event);
}
...
void sipwxPropertyGrid::OnDraw( ::wxDC& dc)
{
    ...
    extern void sipVH__propgrid_57(sip_gilstate_t, sipVirtErrorHandlerFunc, sipSimpleWrapper *, PyObject *,  ::wxDC&);

    sipVH__propgrid_57(sipGILState, 0, sipPySelf, sipMeth, dc);
}
...
static PyObject *meth_wxPropertyGrid_DoOnValidationFailure(PyObject *sipSelf, PyObject *sipArgs, PyObject *sipKwds)
{
...

    {
        ...
        if (sipParseKwdArgs(&sipParseErr, sipArgs, sipKwds, sipKwdList, SIP_NULLPTR, "BJ8J1", &sipSelf, sipType_wxPropertyGrid, &sipCpp, sipType_wxPGProperty, &property, sipType_wxPGVariant,&invalidValue, &invalidValueState))
        {
            ...
            Py_BEGIN_ALLOW_THREADS
            sipRes = sipCpp->DoOnValidationFailure(property,*invalidValue);
            Py_END_ALLOW_THREADS
...
static PyObject *meth_wxPropertyGrid_DoOnValidationFailureReset(PyObject *sipSelf, PyObject *sipArgs, PyObject *sipKwds)
{
...

    {
        ...
        if (sipParseKwdArgs(&sipParseErr, sipArgs, sipKwds, sipKwdList, SIP_NULLPTR, "BJ8", &sipSelf, sipType_wxPropertyGrid, &sipCpp, sipType_wxPGProperty, &property))
        {
            ...
            Py_BEGIN_ALLOW_THREADS
            sipCpp->DoOnValidationFailureReset(property);
            Py_END_ALLOW_THREADS
...
static PyObject *meth_wxPropertyGrid_AddChild(PyObject *sipSelf, PyObject *sipArgs, PyObject *sipKwds)
{
...

    {
        ...
        if (sipParseKwdArgs(&sipParseErr, sipArgs, sipKwds, sipKwdList, SIP_NULLPTR, "BJ8", &sipSelf, sipType_wxPropertyGrid, &sipCpp, sipType_wxWindowBase, &child))
        {
            PyErr_Clear();
...
static PyObject *meth_wxPropertyGrid_InformFirstDirection(PyObject *sipSelf, PyObject *sipArgs, PyObject *sipKwds)
{
...

    {
        ...
        if (sipParseKwdArgs(&sipParseErr, sipArgs, sipKwds, sipKwdList, SIP_NULLPTR, "Biii", &sipSelf, sipType_wxPropertyGrid, &sipCpp, &direction, &size, &availableOtherDir))
        {
            bool sipRes;
...
static PyObject *meth_wxPropertyGrid_SetCanFocus(PyObject *sipSelf, PyObject *sipArgs, PyObject *sipKwds)
{
...

    {
        ...
        if (sipParseKwdArgs(&sipParseErr, sipArgs, sipKwds, sipKwdList, SIP_NULLPTR, "Bb", &sipSelf, sipType_wxPropertyGrid, &sipCpp, &canFocus))
        {
            PyErr_Clear();
...
PyDoc_STRVAR(doc_wxPropertyGrid_SetValidator, "SetValidator(self, validator: Validator)");

extern "C" {static PyObject *meth_wxPropertyGrid_SetValidator(PyObject *, PyObject *, PyObject *);}
static PyObject *meth_wxPropertyGrid_SetValidator(PyObject *sipSelf, PyObject *sipArgs, PyObject *sipKwds)
{
    PyObject *sipParseErr = SIP_NULLPTR;
    bool sipSelfWasArg = (!sipSelf || sipIsDerivedClass((sipSimpleWrapper *)sipSelf));

    {
        ...
        if (sipParseKwdArgs(&sipParseErr, sipArgs, sipKwds, sipKwdList, SIP_NULLPTR, "BJ9", &sipSelf, sipType_wxPropertyGrid, &sipCpp, sipType_wxValidator, &validator))
        {
            PyErr_Clear();

            Py_BEGIN_ALLOW_THREADS
            (sipSelfWasArg ? sipCpp-> ::wxPropertyGrid::SetValidator(*validator) : sipCpp->SetValidator(*validator));
            Py_END_ALLOW_THREADS
    ...
    /* Raise an exception if the arguments couldn't be parsed. */
    sipNoMethod(sipParseErr, sipName_PropertyGrid, sipName_SetValidator, doc_wxPropertyGrid_SetValidator);

    return SIP_NULLPTR;
}


PyDoc_STRVAR(doc_wxPropertyGrid_GetValidator, "GetValidator(self) -> Validator");

extern "C" {static PyObject *meth_wxPropertyGrid_GetValidator(PyObject *, PyObject *);}
static PyObject *meth_wxPropertyGrid_GetValidator(PyObject *sipSelf, PyObject *sipArgs)
{
    PyObject *sipParseErr = SIP_NULLPTR;
    bool sipSelfWasArg = (!sipSelf || sipIsDerivedClass((sipSimpleWrapper *)sipSelf));

    {
        ...
        if (sipParseArgs(&sipParseErr, sipArgs, "B", &sipSelf, sipType_wxPropertyGrid, &sipCpp))
        {
            ...
            Py_BEGIN_ALLOW_THREADS
            sipRes = (sipSelfWasArg ? sipCpp-> ::wxPropertyGrid::GetValidator() : sipCpp->GetValidator());
            Py_END_ALLOW_THREADS
    ...
    /* Raise an exception if the arguments couldn't be parsed. */
    sipNoMethod(sipParseErr, sipName_PropertyGrid, sipName_GetValidator, doc_wxPropertyGrid_GetValidator);
...
extern "C" {static PyObject *meth_wxPropertyGrid_DoGetBorderSize(PyObject *, PyObject *);}
static PyObject *meth_wxPropertyGrid_DoGetBorderSize(PyObject *sipSelf, PyObject *sipArgs)
{
    PyObject *sipParseErr = SIP_NULLPTR;
    bool sipSelfWasArg = (!sipSelf || sipIsDerivedClass((sipSimpleWrapper *)sipSelf));
...
static PyMethodDef methods_wxPropertyGrid[] = {
    ...
    {SIP_MLNAME_CAST(sipName_AddActionTrigger), SIP_MLMETH_CAST(meth_wxPropertyGrid_AddActionTrigger), METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxPropertyGrid_AddActionTrigger)},
    {SIP_MLNAME_CAST(sipName_AddChild), SIP_MLMETH_CAST(meth_wxPropertyGrid_AddChild), METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxPropertyGrid_AddChild)},
    {SIP_MLNAME_CAST(sipName_AddToSelection), SIP_MLMETH_CAST(meth_wxPropertyGrid_AddToSelection), METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxPropertyGrid_AddToSelection)},
    {SIP_MLNAME_CAST(sipName_AdjustScrollbars), meth_wxPropertyGrid_AdjustScrollbars, METH_VARARGS, SIP_MLDOC_CAST(doc_wxPropertyGrid_AdjustScrollbars)},
    {SIP_MLNAME_CAST(sipName_AutoGetTranslation), SIP_MLMETH_CAST(meth_wxPropertyGrid_AutoGetTranslation), METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxPropertyGrid_AutoGetTranslation)},
    {SIP_MLNAME_CAST(sipName_BeginLabelEdit), SIP_MLMETH_CAST(meth_wxPropertyGrid_BeginLabelEdit), METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxPropertyGrid_BeginLabelEdit)},
    {SIP_MLNAME_CAST(sipName_CalcScrolledPosition), SIP_MLMETH_CAST(meth_wxPropertyGrid_CalcScrolledPosition), METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxPropertyGrid_CalcScrolledPosition)},
    {SIP_MLNAME_CAST(sipName_CalcUnscrolledPosition), SIP_MLMETH_CAST(meth_wxPropertyGrid_CalcUnscrolledPosition), METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxPropertyGrid_CalcUnscrolledPosition)},
    {SIP_MLNAME_CAST(sipName_CenterSplitter), SIP_MLMETH_CAST(meth_wxPropertyGrid_CenterSplitter), METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxPropertyGrid_CenterSplitter)},
    {SIP_MLNAME_CAST(sipName_ChangePropertyValue), SIP_MLMETH_CAST(meth_wxPropertyGrid_ChangePropertyValue), METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxPropertyGrid_ChangePropertyValue)},
    {SIP_MLNAME_CAST(sipName_Clear), meth_wxPropertyGrid_Clear, METH_VARARGS, SIP_MLDOC_CAST(doc_wxPropertyGrid_Clear)},
    {SIP_MLNAME_CAST(sipName_ClearActionTriggers), SIP_MLMETH_CAST(meth_wxPropertyGrid_ClearActionTriggers), METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxPropertyGrid_ClearActionTriggers)},
    {SIP_MLNAME_CAST(sipName_CommitChangesFromEditor), SIP_MLMETH_CAST(meth_wxPropertyGrid_CommitChangesFromEditor), METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxPropertyGrid_CommitChangesFromEditor)},
    {SIP_MLNAME_CAST(sipName_Create), SIP_MLMETH_CAST(meth_wxPropertyGrid_Create), METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxPropertyGrid_Create)},
    {SIP_MLNAME_CAST(sipName_DedicateKey), SIP_MLMETH_CAST(meth_wxPropertyGrid_DedicateKey), METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxPropertyGrid_DedicateKey)},
    {SIP_MLNAME_CAST(sipName_Destroy), meth_wxPropertyGrid_Destroy, METH_VARARGS, SIP_MLDOC_CAST(doc_wxPropertyGrid_Destroy)},
    {SIP_MLNAME_CAST(sipName_DisableKeyboardScrolling), meth_wxPropertyGrid_DisableKeyboardScrolling, METH_VARARGS, SIP_MLDOC_CAST(doc_wxPropertyGrid_DisableKeyboardScrolling)},
    {SIP_MLNAME_CAST(sipName_DoEnable), SIP_MLMETH_CAST(meth_wxPropertyGrid_DoEnable), METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxPropertyGrid_DoEnable)},
    {SIP_MLNAME_CAST(sipName_DoFreeze), meth_wxPropertyGrid_DoFreeze, METH_VARARGS, SIP_MLDOC_CAST(doc_wxPropertyGrid_DoFreeze)},
    {SIP_MLNAME_CAST(sipName_DoGetBestClientSize), meth_wxPropertyGrid_DoGetBestClientSize, METH_VARARGS, SIP_MLDOC_CAST(doc_wxPropertyGrid_DoGetBestClientSize)},
    {SIP_MLNAME_CAST(sipName_DoGetBestSize), meth_wxPropertyGrid_DoGetBestSize, METH_VARARGS, SIP_MLDOC_CAST(doc_wxPropertyGrid_DoGetBestSize)},
    {SIP_MLNAME_CAST(sipName_DoGetBorderSize), meth_wxPropertyGrid_DoGetBorderSize, METH_VARARGS, SIP_MLDOC_CAST(doc_wxPropertyGrid_DoGetBorderSize)},
    {SIP_MLNAME_CAST(sipName_DoGetClientSize), SIP_MLMETH_CAST(meth_wxPropertyGrid_DoGetClientSize), METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxPropertyGrid_DoGetClientSize)},
    {SIP_MLNAME_CAST(sipName_DoGetPosition), SIP_MLMETH_CAST(meth_wxPropertyGrid_DoGetPosition), METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxPropertyGrid_DoGetPosition)},
    {SIP_MLNAME_CAST(sipName_DoGetSize), SIP_MLMETH_CAST(meth_wxPropertyGrid_DoGetSize), METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxPropertyGrid_DoGetSize)},
    {SIP_MLNAME_CAST(sipName_DoHidePropertyError), SIP_MLMETH_CAST(meth_wxPropertyGrid_DoHidePropertyError), METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxPropertyGrid_DoHidePropertyError)},
    {SIP_MLNAME_CAST(sipName_DoMoveWindow), SIP_MLMETH_CAST(meth_wxPropertyGrid_DoMoveWindow), METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxPropertyGrid_DoMoveWindow)},
    {SIP_MLNAME_CAST(sipName_DoOnValidationFailure), SIP_MLMETH_CAST(meth_wxPropertyGrid_DoOnValidationFailure), METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxPropertyGrid_DoOnValidationFailure)},
    {SIP_MLNAME_CAST(sipName_DoOnValidationFailureReset), SIP_MLMETH_CAST(meth_wxPropertyGrid_DoOnValidationFailureReset), METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxPropertyGrid_DoOnValidationFailureReset)},
    {SIP_MLNAME_CAST(sipName_DoPrepareDC), SIP_MLMETH_CAST(meth_wxPropertyGrid_DoPrepareDC), METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxPropertyGrid_DoPrepareDC)},
    {SIP_MLNAME_CAST(sipName_DoRegisterEditorClass), SIP_MLMETH_CAST(meth_wxPropertyGrid_DoRegisterEditorClass), METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxPropertyGrid_DoRegisterEditorClass)},
    {SIP_MLNAME_CAST(sipName_DoSetClientSize), SIP_MLMETH_CAST(meth_wxPropertyGrid_DoSetClientSize), METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxPropertyGrid_DoSetClientSize)},
    {SIP_MLNAME_CAST(sipName_DoSetSize), SIP_MLMETH_CAST(meth_wxPropertyGrid_DoSetSize), METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxPropertyGrid_DoSetSize)},
    {SIP_MLNAME_CAST(sipName_DoSetSizeHints), SIP_MLMETH_CAST(meth_wxPropertyGrid_DoSetSizeHints), METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxPropertyGrid_DoSetSizeHints)},
    {SIP_MLNAME_CAST(sipName_DoSetWindowVariant), SIP_MLMETH_CAST(meth_wxPropertyGrid_DoSetWindowVariant), METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxPropertyGrid_DoSetWindowVariant)},
    {SIP_MLNAME_CAST(sipName_DoShowPropertyError), SIP_MLMETH_CAST(meth_wxPropertyGrid_DoShowPropertyError), METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxPropertyGrid_DoShowPropertyError)},
    {SIP_MLNAME_CAST(sipName_DoThaw), meth_wxPropertyGrid_DoThaw, METH_VARARGS, SIP_MLDOC_CAST(doc_wxPropertyGrid_DoThaw)},
    {SIP_MLNAME_CAST(sipName_DrawItemAndValueRelated), SIP_MLMETH_CAST(meth_wxPropertyGrid_DrawItemAndValueRelated), METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxPropertyGrid_DrawItemAndValueRelated)},
    ...
    {SIP_MLNAME_CAST(sipName_EnableCategories), SIP_MLMETH_CAST(meth_wxPropertyGrid_EnableCategories), METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxPropertyGrid_EnableCategories)},
    {SIP_MLNAME_CAST(sipName_EnableScrolling), SIP_MLMETH_CAST(meth_wxPropertyGrid_EnableScrolling), METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxPropertyGrid_EnableScrolling)},
    {SIP_MLNAME_CAST(sipName_EndLabelEdit), SIP_MLMETH_CAST(meth_wxPropertyGrid_EndLabelEdit), METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxPropertyGrid_EndLabelEdit)},
    {SIP_MLNAME_CAST(sipName_EnsureVisible), SIP_MLMETH_CAST(meth_wxPropertyGrid_EnsureVisible), METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxPropertyGrid_EnsureVisible)},
    ...
    {SIP_MLNAME_CAST(sipName_GetClassDefaultAttributes), SIP_MLMETH_CAST(meth_wxPropertyGrid_GetClassDefaultAttributes), METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxPropertyGrid_GetClassDefaultAttributes)},
    ...
    {SIP_MLNAME_CAST(sipName_GetDefaultBorder), meth_wxPropertyGrid_GetDefaultBorder, METH_VARARGS, SIP_MLDOC_CAST(doc_wxPropertyGrid_GetDefaultBorder)},
    {SIP_MLNAME_CAST(sipName_GetDefaultBorderForControl), meth_wxPropertyGrid_GetDefaultBorderForControl, METH_VARARGS, SIP_MLDOC_CAST(doc_wxPropertyGrid_GetDefaultBorderForControl)},
    ...
    {SIP_MLNAME_CAST(sipName_GetImageRect), SIP_MLMETH_CAST(meth_wxPropertyGrid_GetImageRect), METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxPropertyGrid_GetImageRect)},
    {SIP_MLNAME_CAST(sipName_GetImageSize), SIP_MLMETH_CAST(meth_wxPropertyGrid_GetImageSize), METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxPropertyGrid_GetImageSize)},
    ...
    {SIP_MLNAME_CAST(sipName_GetLastItem), SIP_MLMETH_CAST(meth_wxPropertyGrid_GetLastItem), METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxPropertyGrid_GetLastItem)},
    ...
    {SIP_MLNAME_CAST(sipName_GetMarginWidth), meth_wxPropertyGrid_GetMarginWidth, METH_VARARGS, SIP_MLDOC_CAST(doc_wxPropertyGrid_GetMarginWidth)},
    ...
    {SIP_MLNAME_CAST(sipName_GetScaleX), meth_wxPropertyGrid_GetScaleX, METH_VARARGS, SIP_MLDOC_CAST(doc_wxPropertyGrid_GetScaleX)},
    {SIP_MLNAME_CAST(sipName_GetScaleY), meth_wxPropertyGrid_GetScaleY, METH_VARARGS, SIP_MLDOC_CAST(doc_wxPropertyGrid_GetScaleY)},
    {SIP_MLNAME_CAST(sipName_GetScrollLines), SIP_MLMETH_CAST(meth_wxPropertyGrid_GetScrollLines), METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxPropertyGrid_GetScrollLines)},
    {SIP_MLNAME_CAST(sipName_GetScrollPageSize), SIP_MLMETH_CAST(meth_wxPropertyGrid_GetScrollPageSize), METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxPropertyGrid_GetScrollPageSize)},
    {SIP_MLNAME_CAST(sipName_GetScrollPixelsPerUnit), SIP_MLMETH_CAST(meth_wxPropertyGrid_GetScrollPixelsPerUnit), METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxPropertyGrid_GetScrollPixelsPerUnit)},
    ...
    {SIP_MLNAME_CAST(sipName_GetSizeAvailableForScrollTarget), SIP_MLMETH_CAST(meth_wxPropertyGrid_GetSizeAvailableForScrollTarget), METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxPropertyGrid_GetSizeAvailableForScrollTarget)},
    {SIP_MLNAME_CAST(sipName_GetSplitterPosition), SIP_MLMETH_CAST(meth_wxPropertyGrid_GetSplitterPosition), METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxPropertyGrid_GetSplitterPosition)},
    ...
    {SIP_MLNAME_CAST(sipName_GetTargetRect), meth_wxPropertyGrid_GetTargetRect, METH_VARARGS, SIP_MLDOC_CAST(doc_wxPropertyGrid_GetTargetRect)},
    {SIP_MLNAME_CAST(sipName_GetTargetWindow), meth_wxPropertyGrid_GetTargetWindow, METH_VARARGS, SIP_MLDOC_CAST(doc_wxPropertyGrid_GetTargetWindow)},
    ...
    {SIP_MLNAME_CAST(sipName_GetUnspecifiedValueText), SIP_MLMETH_CAST(meth_wxPropertyGrid_GetUnspecifiedValueText), METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxPropertyGrid_GetUnspecifiedValueText)},
    {SIP_MLNAME_CAST(sipName_GetValidator), meth_wxPropertyGrid_GetValidator, METH_VARARGS, SIP_MLDOC_CAST(doc_wxPropertyGrid_GetValidator)},
    ...
    {SIP_MLNAME_CAST(sipName_GetViewStart), SIP_MLMETH_CAST(meth_wxPropertyGrid_GetViewStart), METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxPropertyGrid_GetViewStart)},
    {SIP_MLNAME_CAST(sipName_HasTransparentBackground), meth_wxPropertyGrid_HasTransparentBackground, METH_VARARGS, SIP_MLDOC_CAST(doc_wxPropertyGrid_HasTransparentBackground)},
    {SIP_MLNAME_CAST(sipName_HitTest), SIP_MLMETH_CAST(meth_wxPropertyGrid_HitTest), METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxPropertyGrid_HitTest)},
    {SIP_MLNAME_CAST(sipName_InformFirstDirection), SIP_MLMETH_CAST(meth_wxPropertyGrid_InformFirstDirection), METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxPropertyGrid_InformFirstDirection)},
    ...
    {SIP_MLNAME_CAST(sipName_IsAutoScrolling), meth_wxPropertyGrid_IsAutoScrolling, METH_VARARGS, SIP_MLDOC_CAST(doc_wxPropertyGrid_IsAutoScrolling)},
    ...
    {SIP_MLNAME_CAST(sipName_IsRetained), meth_wxPropertyGrid_IsRetained, METH_VARARGS, SIP_MLDOC_CAST(doc_wxPropertyGrid_IsRetained)},
    {SIP_MLNAME_CAST(sipName_MakeColumnEditable), SIP_MLMETH_CAST(meth_wxPropertyGrid_MakeColumnEditable), METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxPropertyGrid_MakeColumnEditable)},
    {SIP_MLNAME_CAST(sipName_OnDraw), SIP_MLMETH_CAST(meth_wxPropertyGrid_OnDraw), METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxPropertyGrid_OnDraw)},
    ...
    {SIP_MLNAME_CAST(sipName_OnTLPChanging), SIP_MLMETH_CAST(meth_wxPropertyGrid_OnTLPChanging), METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxPropertyGrid_OnTLPChanging)},
    {SIP_MLNAME_CAST(sipName_PrepareDC), SIP_MLMETH_CAST(meth_wxPropertyGrid_PrepareDC), METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxPropertyGrid_PrepareDC)},
    {SIP_MLNAME_CAST(sipName_ProcessEvent), SIP_MLMETH_CAST(meth_wxPropertyGrid_ProcessEvent), METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxPropertyGrid_ProcessEvent)},
    ...
    {SIP_MLNAME_CAST(sipName_RefreshProperty), SIP_MLMETH_CAST(meth_wxPropertyGrid_RefreshProperty), METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxPropertyGrid_RefreshProperty)},
    {SIP_MLNAME_CAST(sipName_RegisterEditorClass), SIP_MLMETH_CAST(meth_wxPropertyGrid_RegisterEditorClass), METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxPropertyGrid_RegisterEditorClass)},
    {SIP_MLNAME_CAST(sipName_RemoveChild), SIP_MLMETH_CAST(meth_wxPropertyGrid_RemoveChild), METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxPropertyGrid_RemoveChild)},
    {SIP_MLNAME_CAST(sipName_RemoveFromSelection), SIP_MLMETH_CAST(meth_wxPropertyGrid_RemoveFromSelection), METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxPropertyGrid_RemoveFromSelection)},
    ...
    {SIP_MLNAME_CAST(sipName_ResetColumnSizes), SIP_MLMETH_CAST(meth_wxPropertyGrid_ResetColumnSizes), METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxPropertyGrid_ResetColumnSizes)},
    {SIP_MLNAME_CAST(sipName_Scroll), SIP_MLMETH_CAST(meth_wxPropertyGrid_Scroll), METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxPropertyGrid_Scroll)},
    {SIP_MLNAME_CAST(sipName_SelectProperty), SIP_MLMETH_CAST(meth_wxPropertyGrid_SelectProperty), METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxPropertyGrid_SelectProperty)},
    {SIP_MLNAME_CAST(sipName_SendAutoScrollEvents), SIP_MLMETH_CAST(meth_wxPropertyGrid_SendAutoScrollEvents), METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxPropertyGrid_SendAutoScrollEvents)},
    {SIP_MLNAME_CAST(sipName_SendDestroyEvent), meth_wxPropertyGrid_SendDestroyEvent, METH_VARARGS, SIP_NULLPTR},
    {SIP_MLNAME_CAST(sipName_SetCanFocus), SIP_MLMETH_CAST(meth_wxPropertyGrid_SetCanFocus), METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxPropertyGrid_SetCanFocus)},
    {SIP_MLNAME_CAST(sipName_SetCaptionBackgroundColour), SIP_MLMETH_CAST(meth_wxPropertyGrid_SetCaptionBackgroundColour), METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxPropertyGrid_SetCaptionBackgroundColour)},
    {SIP_MLNAME_CAST(sipName_SetCaptionTextColour), SIP_MLMETH_CAST(meth_wxPropertyGrid_SetCaptionTextColour), METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxPropertyGrid_SetCaptionTextColour)},
    {SIP_MLNAME_CAST(sipName_SetCellBackgroundColour), SIP_MLMETH_CAST(meth_wxPropertyGrid_SetCellBackgroundColour), METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxPropertyGrid_SetCellBackgroundColour)},
    {SIP_MLNAME_CAST(sipName_SetCellDisabledTextColour), SIP_MLMETH_CAST(meth_wxPropertyGrid_SetCellDisabledTextColour), METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxPropertyGrid_SetCellDisabledTextColour)},
    {SIP_MLNAME_CAST(sipName_SetCellTextColour), SIP_MLMETH_CAST(meth_wxPropertyGrid_SetCellTextColour), METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxPropertyGrid_SetCellTextColour)},
    {SIP_MLNAME_CAST(sipName_SetColumnCount), SIP_MLMETH_CAST(meth_wxPropertyGrid_SetColumnCount), METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxPropertyGrid_SetColumnCount)},
    {SIP_MLNAME_CAST(sipName_SetCurrentCategory), SIP_MLMETH_CAST(meth_wxPropertyGrid_SetCurrentCategory), METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxPropertyGrid_SetCurrentCategory)},
    {SIP_MLNAME_CAST(sipName_SetEmptySpaceColour), SIP_MLMETH_CAST(meth_wxPropertyGrid_SetEmptySpaceColour), METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxPropertyGrid_SetEmptySpaceColour)},
    {SIP_MLNAME_CAST(sipName_SetLineColour), SIP_MLMETH_CAST(meth_wxPropertyGrid_SetLineColour), METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxPropertyGrid_SetLineColour)},
    {SIP_MLNAME_CAST(sipName_SetMarginColour), SIP_MLMETH_CAST(meth_wxPropertyGrid_SetMarginColour), METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxPropertyGrid_SetMarginColour)},
    {SIP_MLNAME_CAST(sipName_SetScale), SIP_MLMETH_CAST(meth_wxPropertyGrid_SetScale), METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxPropertyGrid_SetScale)},
    {SIP_MLNAME_CAST(sipName_SetScrollPageSize), SIP_MLMETH_CAST(meth_wxPropertyGrid_SetScrollPageSize), METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxPropertyGrid_SetScrollPageSize)},
    {SIP_MLNAME_CAST(sipName_SetScrollRate), SIP_MLMETH_CAST(meth_wxPropertyGrid_SetScrollRate), METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxPropertyGrid_SetScrollRate)},
    {SIP_MLNAME_CAST(sipName_SetScrollbars), SIP_MLMETH_CAST(meth_wxPropertyGrid_SetScrollbars), METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxPropertyGrid_SetScrollbars)},
    {SIP_MLNAME_CAST(sipName_SetSelection), SIP_MLMETH_CAST(meth_wxPropertyGrid_SetSelection), METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxPropertyGrid_SetSelection)},
    {SIP_MLNAME_CAST(sipName_SetSelectionBackgroundColour), SIP_MLMETH_CAST(meth_wxPropertyGrid_SetSelectionBackgroundColour), METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxPropertyGrid_SetSelectionBackgroundColour)},
    {SIP_MLNAME_CAST(sipName_SetSelectionTextColour), SIP_MLMETH_CAST(meth_wxPropertyGrid_SetSelectionTextColour), METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxPropertyGrid_SetSelectionTextColour)},
    {SIP_MLNAME_CAST(sipName_SetSplitterLeft), SIP_MLMETH_CAST(meth_wxPropertyGrid_SetSplitterLeft), METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxPropertyGrid_SetSplitterLeft)},
    {SIP_MLNAME_CAST(sipName_SetSplitterPosition), SIP_MLMETH_CAST(meth_wxPropertyGrid_SetSplitterPosition), METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxPropertyGrid_SetSplitterPosition)},
    {SIP_MLNAME_CAST(sipName_SetTargetRect), SIP_MLMETH_CAST(meth_wxPropertyGrid_SetTargetRect), METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxPropertyGrid_SetTargetRect)},
    {SIP_MLNAME_CAST(sipName_SetTargetWindow), SIP_MLMETH_CAST(meth_wxPropertyGrid_SetTargetWindow), METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxPropertyGrid_SetTargetWindow)},
    {SIP_MLNAME_CAST(sipName_SetUnspecifiedValueAppearance), SIP_MLMETH_CAST(meth_wxPropertyGrid_SetUnspecifiedValueAppearance), METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxPropertyGrid_SetUnspecifiedValueAppearance)},
    {SIP_MLNAME_CAST(sipName_SetValidator), SIP_MLMETH_CAST(meth_wxPropertyGrid_SetValidator), METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxPropertyGrid_SetValidator)},
    {SIP_MLNAME_CAST(sipName_SetVerticalSpacing), SIP_MLMETH_CAST(meth_wxPropertyGrid_SetVerticalSpacing), METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxPropertyGrid_SetVerticalSpacing)},
    {SIP_MLNAME_CAST(sipName_SetVirtualWidth), SIP_MLMETH_CAST(meth_wxPropertyGrid_SetVirtualWidth), METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxPropertyGrid_SetVirtualWidth)},
    {SIP_MLNAME_CAST(sipName_SetupTextCtrlValue), SIP_MLMETH_CAST(meth_wxPropertyGrid_SetupTextCtrlValue), METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxPropertyGrid_SetupTextCtrlValue)},
    ...
    {SIP_MLNAME_CAST(sipName_ShouldScrollToChildOnFocus), SIP_MLMETH_CAST(meth_wxPropertyGrid_ShouldScrollToChildOnFocus), METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxPropertyGrid_ShouldScrollToChildOnFocus)},
    {SIP_MLNAME_CAST(sipName_ShowPropertyError), SIP_MLMETH_CAST(meth_wxPropertyGrid_ShowPropertyError), METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxPropertyGrid_ShowPropertyError)},
    {SIP_MLNAME_CAST(sipName_ShowScrollbars), SIP_MLMETH_CAST(meth_wxPropertyGrid_ShowScrollbars), METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxPropertyGrid_ShowScrollbars)},
    {SIP_MLNAME_CAST(sipName_StopAutoScrolling), meth_wxPropertyGrid_StopAutoScrolling, METH_VARARGS, SIP_MLDOC_CAST(doc_wxPropertyGrid_StopAutoScrolling)},
    ...
    {SIP_MLNAME_CAST(sipName_TryAfter), SIP_MLMETH_CAST(meth_wxPropertyGrid_TryAfter), METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxPropertyGrid_TryAfter)},
    {SIP_MLNAME_CAST(sipName_TryBefore), SIP_MLMETH_CAST(meth_wxPropertyGrid_TryBefore), METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxPropertyGrid_TryBefore)},
    {SIP_MLNAME_CAST(sipName_UnfocusEditor), meth_wxPropertyGrid_UnfocusEditor, METH_VARARGS, SIP_MLDOC_CAST(doc_wxPropertyGrid_UnfocusEditor)},
    {SIP_MLNAME_CAST(sipName_Validate), meth_wxPropertyGrid_Validate, METH_VARARGS, SIP_MLDOC_CAST(doc_wxPropertyGrid_Validate)},
    {SIP_MLNAME_CAST(sipName_ValueChangeInEvent), SIP_MLMETH_CAST(meth_wxPropertyGrid_ValueChangeInEvent), METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxPropertyGrid_ValueChangeInEvent)},
...
sipVariableDef variables_wxPropertyGrid[] = {
    {PropertyVariable, sipName_VerticalSpacing, &methods_wxPropertyGrid[92], &methods_wxPropertyGrid[146], SIP_NULLPTR, SIP_NULLPTR},
    {PropertyVariable, sipName_UnspecifiedValueText, &methods_wxPropertyGrid[90], SIP_NULLPTR, SIP_NULLPTR, SIP_NULLPTR},
    {PropertyVariable, sipName_UnspecifiedValueAppearance, &methods_wxPropertyGrid[89], &methods_wxPropertyGrid[144], SIP_NULLPTR, SIP_NULLPTR},
    {PropertyVariable, sipName_UncommittedPropertyValue, &methods_wxPropertyGrid[88], SIP_NULLPTR, SIP_NULLPTR, SIP_NULLPTR},
    {PropertyVariable, sipName_TargetWindow, &methods_wxPropertyGrid[87], &methods_wxPropertyGrid[143], SIP_NULLPTR, SIP_NULLPTR},
    {PropertyVariable, sipName_TargetRect, &methods_wxPropertyGrid[86], &methods_wxPropertyGrid[142], SIP_NULLPTR, SIP_NULLPTR},
    {PropertyVariable, sipName_StatusBar, &methods_wxPropertyGrid[85], SIP_NULLPTR, SIP_NULLPTR, SIP_NULLPTR},
    {PropertyVariable, sipName_SplitterPosition, &methods_wxPropertyGrid[84], &methods_wxPropertyGrid[141], SIP_NULLPTR, SIP_NULLPTR},
    {PropertyVariable, sipName_SelectionForegroundColour, &methods_wxPropertyGrid[82], SIP_NULLPTR, SIP_NULLPTR, SIP_NULLPTR},
    {PropertyVariable, sipName_SelectionBackgroundColour, &methods_wxPropertyGrid[81], &methods_wxPropertyGrid[138], SIP_NULLPTR, SIP_NULLPTR},
    {PropertyVariable, sipName_Selection, &methods_wxPropertyGrid[80], &methods_wxPropertyGrid[137], SIP_NULLPTR, SIP_NULLPTR},
    {PropertyVariable, sipName_SelectedProperty, &methods_wxPropertyGrid[79], SIP_NULLPTR, SIP_NULLPTR, SIP_NULLPTR},
    {PropertyVariable, sipName_ScaleY, &methods_wxPropertyGrid[75], SIP_NULLPTR, SIP_NULLPTR, SIP_NULLPTR},
    {PropertyVariable, sipName_ScaleX, &methods_wxPropertyGrid[74], SIP_NULLPTR, SIP_NULLPTR, SIP_NULLPTR},
    {PropertyVariable, sipName_RowHeight, &methods_wxPropertyGrid[73], SIP_NULLPTR, SIP_NULLPTR, SIP_NULLPTR},
    {PropertyVariable, sipName_Root, &methods_wxPropertyGrid[72], SIP_NULLPTR, SIP_NULLPTR, SIP_NULLPTR},
    {PropertyVariable, sipName_Panel, &methods_wxPropertyGrid[71], SIP_NULLPTR, SIP_NULLPTR, SIP_NULLPTR},
    {PropertyVariable, sipName_MarginWidth, &methods_wxPropertyGrid[70], SIP_NULLPTR, SIP_NULLPTR, SIP_NULLPTR},
    {PropertyVariable, sipName_MarginColour, &methods_wxPropertyGrid[69], &methods_wxPropertyGrid[132], SIP_NULLPTR, SIP_NULLPTR},
    {PropertyVariable, sipName_LineColour, &methods_wxPropertyGrid[67], &methods_wxPropertyGrid[131], SIP_NULLPTR, SIP_NULLPTR},
    {PropertyVariable, sipName_LastItem, &methods_wxPropertyGrid[66], SIP_NULLPTR, SIP_NULLPTR, SIP_NULLPTR},
    {PropertyVariable, sipName_LabelEditor, &methods_wxPropertyGrid[65], SIP_NULLPTR, SIP_NULLPTR, SIP_NULLPTR},
    {PropertyVariable, sipName_ImageSize, &methods_wxPropertyGrid[64], SIP_NULLPTR, SIP_NULLPTR, SIP_NULLPTR},
    {PropertyVariable, sipName_Grid, &methods_wxPropertyGrid[62], SIP_NULLPTR, SIP_NULLPTR, SIP_NULLPTR},
    {PropertyVariable, sipName_FontHeight, &methods_wxPropertyGrid[61], SIP_NULLPTR, SIP_NULLPTR, SIP_NULLPTR},
    {PropertyVariable, sipName_EmptySpaceColour, &methods_wxPropertyGrid[60], &methods_wxPropertyGrid[130], SIP_NULLPTR, SIP_NULLPTR},
    {PropertyVariable, sipName_EditorTextCtrl, &methods_wxPropertyGrid[59], SIP_NULLPTR, SIP_NULLPTR, SIP_NULLPTR},
    {PropertyVariable, sipName_ColumnCount, &methods_wxPropertyGrid[56], &methods_wxPropertyGrid[128], SIP_NULLPTR, SIP_NULLPTR},
    {PropertyVariable, sipName_CellTextColour, &methods_wxPropertyGrid[53], &methods_wxPropertyGrid[127], SIP_NULLPTR, SIP_NULLPTR},
    {PropertyVariable, sipName_CellDisabledTextColour, &methods_wxPropertyGrid[52], &methods_wxPropertyGrid[126], SIP_NULLPTR, SIP_NULLPTR},
    {PropertyVariable, sipName_CellBackgroundColour, &methods_wxPropertyGrid[51], &methods_wxPropertyGrid[125], SIP_NULLPTR, SIP_NULLPTR},
    ...
    {PropertyVariable, sipName_CaptionBackgroundColour, &methods_wxPropertyGrid[48], &methods_wxPropertyGrid[123], SIP_NULLPTR, SIP_NULLPTR},
};
