...
void sipwxWindow::DoMoveWindow(int x,int y,int width,int height)
{
 ...
 ::wxSize sipwxWindow::DoGetBorderSize() const
{
    sip_gilstate_t sipGILState;
    PyObject *sipMeth;
...
void sipwxWindow::sipProtectVirt_DoSetSizeHints(bool sipSelfWasArg,int minW,int minH,int maxW,int maxH,int incW,int incH)
{
 ...
 ::wxSize sipwxWindow::sipProtectVirt_DoGetBorderSize(bool sipSelfWasArg) const
{
...
PyDoc_STRVAR(doc_wxWindow_DoGetBorderSize, "DoGetBorderSize(self) -> Size");

extern "C" {static PyObject *meth_wxWindow_DoGetBorderSize(PyObject *, PyObject *);}
static PyObject *meth_wxWindow_DoGetBorderSize(PyObject *sipSelf, PyObject *sipArgs)
{
    PyObject *sipParseErr = SIP_NULLPTR;
    bool sipSelfWasArg = (!sipSelf || sipIsDerivedClass((sipSimpleWrapper *)sipSelf));
    ...
    /* Raise an exception if the arguments couldn't be parsed. */
    sipNoMethod(sipParseErr, sipName_Window, sipName_DoGetBorderSize, doc_wxWindow_DoGetBorderSize);
...
static sipEncodedTypeDef supers_wxWindow[] = {{605, 255, 1}};


static PyMethodDef methods_wxWindow[] = {
    {SIP_MLNAME_CAST(sipName_AcceptsFocus), meth_wxWindow_AcceptsFocus, METH_VARARGS, SIP_MLDOC_CAST(doc_wxWindow_AcceptsFocus)},
    {SIP_MLNAME_CAST(sipName_AcceptsFocusFromKeyboard), meth_wxWindow_AcceptsFocusFromKeyboard, METH_VARARGS, SIP_MLDOC_CAST(doc_wxWindow_AcceptsFocusFromKeyboard)},
    {SIP_MLNAME_CAST(sipName_AcceptsFocusRecursively), meth_wxWindow_AcceptsFocusRecursively, METH_VARARGS, SIP_MLDOC_CAST(doc_wxWindow_AcceptsFocusRecursively)},
    {SIP_MLNAME_CAST(sipName_AddChild), SIP_MLMETH_CAST(meth_wxWindow_AddChild), METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxWindow_AddChild)},
    {SIP_MLNAME_CAST(sipName_AdjustForLayoutDirection), SIP_MLMETH_CAST(meth_wxWindow_AdjustForLayoutDirection), METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxWindow_AdjustForLayoutDirection)},
    {SIP_MLNAME_CAST(sipName_AlwaysShowScrollbars), SIP_MLMETH_CAST(meth_wxWindow_AlwaysShowScrollbars), METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxWindow_AlwaysShowScrollbars)},
    {SIP_MLNAME_CAST(sipName_AssociateHandle), SIP_MLMETH_CAST(meth_wxWindow_AssociateHandle), METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxWindow_AssociateHandle)},
    {SIP_MLNAME_CAST(sipName_BeginRepositioningChildren), meth_wxWindow_BeginRepositioningChildren, METH_VARARGS, SIP_MLDOC_CAST(doc_wxWindow_BeginRepositioningChildren)},
    {SIP_MLNAME_CAST(sipName_CacheBestSize), SIP_MLMETH_CAST(meth_wxWindow_CacheBestSize), METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxWindow_CacheBestSize)},
    {SIP_MLNAME_CAST(sipName_CanAcceptFocus), meth_wxWindow_CanAcceptFocus, METH_VARARGS, SIP_MLDOC_CAST(doc_wxWindow_CanAcceptFocus)},
    {SIP_MLNAME_CAST(sipName_CanAcceptFocusFromKeyboard), meth_wxWindow_CanAcceptFocusFromKeyboard, METH_VARARGS, SIP_MLDOC_CAST(doc_wxWindow_CanAcceptFocusFromKeyboard)},
    {SIP_MLNAME_CAST(sipName_CanScroll), SIP_MLMETH_CAST(meth_wxWindow_CanScroll), METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxWindow_CanScroll)},
    {SIP_MLNAME_CAST(sipName_CanSetTransparent), meth_wxWindow_CanSetTransparent, METH_VARARGS, SIP_MLDOC_CAST(doc_wxWindow_CanSetTransparent)},
    {SIP_MLNAME_CAST(sipName_CaptureMouse), meth_wxWindow_CaptureMouse, METH_VARARGS, SIP_MLDOC_CAST(doc_wxWindow_CaptureMouse)},
    {SIP_MLNAME_CAST(sipName_Center), SIP_MLMETH_CAST(meth_wxWindow_Center), METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxWindow_Center)},
    {SIP_MLNAME_CAST(sipName_CenterOnParent), SIP_MLMETH_CAST(meth_wxWindow_CenterOnParent), METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxWindow_CenterOnParent)},
    {SIP_MLNAME_CAST(sipName_Centre), SIP_MLMETH_CAST(meth_wxWindow_Centre), METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxWindow_Centre)},
    {SIP_MLNAME_CAST(sipName_CentreOnParent), SIP_MLMETH_CAST(meth_wxWindow_CentreOnParent), METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxWindow_CentreOnParent)},
    {SIP_MLNAME_CAST(sipName_ClearBackground), meth_wxWindow_ClearBackground, METH_VARARGS, SIP_MLDOC_CAST(doc_wxWindow_ClearBackground)},
    {SIP_MLNAME_CAST(sipName_ClientToScreen), SIP_MLMETH_CAST(meth_wxWindow_ClientToScreen), METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxWindow_ClientToScreen)},
    {SIP_MLNAME_CAST(sipName_ClientToWindowSize), SIP_MLMETH_CAST(meth_wxWindow_ClientToWindowSize), METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxWindow_ClientToWindowSize)},
    {SIP_MLNAME_CAST(sipName_Close), SIP_MLMETH_CAST(meth_wxWindow_Close), METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxWindow_Close)},
    {SIP_MLNAME_CAST(sipName_ConvertDialogToPixels), SIP_MLMETH_CAST(meth_wxWindow_ConvertDialogToPixels), METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxWindow_ConvertDialogToPixels)},
    {SIP_MLNAME_CAST(sipName_ConvertPixelsToDialog), SIP_MLMETH_CAST(meth_wxWindow_ConvertPixelsToDialog), METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxWindow_ConvertPixelsToDialog)},
    {SIP_MLNAME_CAST(sipName_Create), SIP_MLMETH_CAST(meth_wxWindow_Create), METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxWindow_Create)},
    {SIP_MLNAME_CAST(sipName_Destroy), meth_wxWindow_Destroy, METH_VARARGS, SIP_MLDOC_CAST(doc_wxWindow_Destroy)},
    {SIP_MLNAME_CAST(sipName_DestroyChildren), meth_wxWindow_DestroyChildren, METH_VARARGS, SIP_MLDOC_CAST(doc_wxWindow_DestroyChildren)},
    {SIP_MLNAME_CAST(sipName_Disable), meth_wxWindow_Disable, METH_VARARGS, SIP_MLDOC_CAST(doc_wxWindow_Disable)},
    {SIP_MLNAME_CAST(sipName_DissociateHandle), meth_wxWindow_DissociateHandle, METH_VARARGS, SIP_MLDOC_CAST(doc_wxWindow_DissociateHandle)},
    {SIP_MLNAME_CAST(sipName_DoEnable), SIP_MLMETH_CAST(meth_wxWindow_DoEnable), METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxWindow_DoEnable)},
    {SIP_MLNAME_CAST(sipName_DoFreeze), meth_wxWindow_DoFreeze, METH_VARARGS, SIP_MLDOC_CAST(doc_wxWindow_DoFreeze)},
    {SIP_MLNAME_CAST(sipName_DoGetBestClientSize), meth_wxWindow_DoGetBestClientSize, METH_VARARGS, SIP_MLDOC_CAST(doc_wxWindow_DoGetBestClientSize)},
    {SIP_MLNAME_CAST(sipName_DoGetBestSize), meth_wxWindow_DoGetBestSize, METH_VARARGS, SIP_MLDOC_CAST(doc_wxWindow_DoGetBestSize)},
    {SIP_MLNAME_CAST(sipName_DoGetBorderSize), meth_wxWindow_DoGetBorderSize, METH_VARARGS, SIP_MLDOC_CAST(doc_wxWindow_DoGetBorderSize)},
    {SIP_MLNAME_CAST(sipName_DoGetClientSize), SIP_MLMETH_CAST(meth_wxWindow_DoGetClientSize), METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxWindow_DoGetClientSize)},
    {SIP_MLNAME_CAST(sipName_DoGetPosition), SIP_MLMETH_CAST(meth_wxWindow_DoGetPosition), METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxWindow_DoGetPosition)},
    {SIP_MLNAME_CAST(sipName_DoGetSize), SIP_MLMETH_CAST(meth_wxWindow_DoGetSize), METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxWindow_DoGetSize)},
    {SIP_MLNAME_CAST(sipName_DoMoveWindow), SIP_MLMETH_CAST(meth_wxWindow_DoMoveWindow), METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxWindow_DoMoveWindow)},
    {SIP_MLNAME_CAST(sipName_DoSetClientSize), SIP_MLMETH_CAST(meth_wxWindow_DoSetClientSize), METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxWindow_DoSetClientSize)},
    {SIP_MLNAME_CAST(sipName_DoSetSize), SIP_MLMETH_CAST(meth_wxWindow_DoSetSize), METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxWindow_DoSetSize)},
    {SIP_MLNAME_CAST(sipName_DoSetSizeHints), SIP_MLMETH_CAST(meth_wxWindow_DoSetSizeHints), METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxWindow_DoSetSizeHints)},
    {SIP_MLNAME_CAST(sipName_DoSetWindowVariant), SIP_MLMETH_CAST(meth_wxWindow_DoSetWindowVariant), METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxWindow_DoSetWindowVariant)},
    {SIP_MLNAME_CAST(sipName_DoThaw), meth_wxWindow_DoThaw, METH_VARARGS, SIP_MLDOC_CAST(doc_wxWindow_DoThaw)},
    {SIP_MLNAME_CAST(sipName_DoUpdateWindowUI), SIP_MLMETH_CAST(meth_wxWindow_DoUpdateWindowUI), METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxWindow_DoUpdateWindowUI)},
    {SIP_MLNAME_CAST(sipName_DragAcceptFiles), SIP_MLMETH_CAST(meth_wxWindow_DragAcceptFiles), METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxWindow_DragAcceptFiles)},
    {SIP_MLNAME_CAST(sipName_Enable), SIP_MLMETH_CAST(meth_wxWindow_Enable), METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxWindow_Enable)},
    {SIP_MLNAME_CAST(sipName_EnableTouchEvents), SIP_MLMETH_CAST(meth_wxWindow_EnableTouchEvents), METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxWindow_EnableTouchEvents)},
    {SIP_MLNAME_CAST(sipName_EndRepositioningChildren), meth_wxWindow_EndRepositioningChildren, METH_VARARGS, SIP_MLDOC_CAST(doc_wxWindow_EndRepositioningChildren)},
    {SIP_MLNAME_CAST(sipName_FindFocus), meth_wxWindow_FindFocus, METH_VARARGS, SIP_MLDOC_CAST(doc_wxWindow_FindFocus)},
    {SIP_MLNAME_CAST(sipName_FindWindow), SIP_MLMETH_CAST(meth_wxWindow_FindWindow), METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxWindow_FindWindow)},
    {SIP_MLNAME_CAST(sipName_FindWindowById), SIP_MLMETH_CAST(meth_wxWindow_FindWindowById), METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxWindow_FindWindowById)},
    {SIP_MLNAME_CAST(sipName_FindWindowByLabel), SIP_MLMETH_CAST(meth_wxWindow_FindWindowByLabel), METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxWindow_FindWindowByLabel)},
    {SIP_MLNAME_CAST(sipName_FindWindowByName), SIP_MLMETH_CAST(meth_wxWindow_FindWindowByName), METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxWindow_FindWindowByName)},
    {SIP_MLNAME_CAST(sipName_Fit), meth_wxWindow_Fit, METH_VARARGS, SIP_MLDOC_CAST(doc_wxWindow_Fit)},
    {SIP_MLNAME_CAST(sipName_FitInside), meth_wxWindow_FitInside, METH_VARARGS, SIP_MLDOC_CAST(doc_wxWindow_FitInside)},
    {SIP_MLNAME_CAST(sipName_Freeze), meth_wxWindow_Freeze, METH_VARARGS, SIP_MLDOC_CAST(doc_wxWindow_Freeze)},
    {SIP_MLNAME_CAST(sipName_FromDIP), SIP_MLMETH_CAST(meth_wxWindow_FromDIP), METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxWindow_FromDIP)},
    {SIP_MLNAME_CAST(sipName_GetAcceleratorTable), meth_wxWindow_GetAcceleratorTable, METH_VARARGS, SIP_MLDOC_CAST(doc_wxWindow_GetAcceleratorTable)},
    {SIP_MLNAME_CAST(sipName_GetAccessible), meth_wxWindow_GetAccessible, METH_VARARGS, SIP_MLDOC_CAST(doc_wxWindow_GetAccessible)},
    {SIP_MLNAME_CAST(sipName_GetAutoLayout), meth_wxWindow_GetAutoLayout, METH_VARARGS, SIP_MLDOC_CAST(doc_wxWindow_GetAutoLayout)},
    {SIP_MLNAME_CAST(sipName_GetBackgroundColour), meth_wxWindow_GetBackgroundColour, METH_VARARGS, SIP_MLDOC_CAST(doc_wxWindow_GetBackgroundColour)},
    {SIP_MLNAME_CAST(sipName_GetBackgroundStyle), meth_wxWindow_GetBackgroundStyle, METH_VARARGS, SIP_MLDOC_CAST(doc_wxWindow_GetBackgroundStyle)},
    {SIP_MLNAME_CAST(sipName_GetBestHeight), SIP_MLMETH_CAST(meth_wxWindow_GetBestHeight), METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxWindow_GetBestHeight)},
    {SIP_MLNAME_CAST(sipName_GetBestSize), meth_wxWindow_GetBestSize, METH_VARARGS, SIP_MLDOC_CAST(doc_wxWindow_GetBestSize)},
    {SIP_MLNAME_CAST(sipName_GetBestVirtualSize), meth_wxWindow_GetBestVirtualSize, METH_VARARGS, SIP_MLDOC_CAST(doc_wxWindow_GetBestVirtualSize)},
    {SIP_MLNAME_CAST(sipName_GetBestWidth), SIP_MLMETH_CAST(meth_wxWindow_GetBestWidth), METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxWindow_GetBestWidth)},
    {SIP_MLNAME_CAST(sipName_GetBorder), SIP_MLMETH_CAST(meth_wxWindow_GetBorder), METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxWindow_GetBorder)},
    {SIP_MLNAME_CAST(sipName_GetCapture), meth_wxWindow_GetCapture, METH_VARARGS, SIP_MLDOC_CAST(doc_wxWindow_GetCapture)},
    {SIP_MLNAME_CAST(sipName_GetCaret), meth_wxWindow_GetCaret, METH_VARARGS, SIP_MLDOC_CAST(doc_wxWindow_GetCaret)},
    {SIP_MLNAME_CAST(sipName_GetCharHeight), meth_wxWindow_GetCharHeight, METH_VARARGS, SIP_MLDOC_CAST(doc_wxWindow_GetCharHeight)},
    {SIP_MLNAME_CAST(sipName_GetCharWidth), meth_wxWindow_GetCharWidth, METH_VARARGS, SIP_MLDOC_CAST(doc_wxWindow_GetCharWidth)},
    {SIP_MLNAME_CAST(sipName_GetChildren), meth_wxWindow_GetChildren, METH_VARARGS, SIP_MLDOC_CAST(doc_wxWindow_GetChildren)},
    {SIP_MLNAME_CAST(sipName_GetClassDefaultAttributes), SIP_MLMETH_CAST(meth_wxWindow_GetClassDefaultAttributes), METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxWindow_GetClassDefaultAttributes)},
    {SIP_MLNAME_CAST(sipName_GetClientAreaOrigin), meth_wxWindow_GetClientAreaOrigin, METH_VARARGS, SIP_MLDOC_CAST(doc_wxWindow_GetClientAreaOrigin)},
    {SIP_MLNAME_CAST(sipName_GetClientRect), meth_wxWindow_GetClientRect, METH_VARARGS, SIP_MLDOC_CAST(doc_wxWindow_GetClientRect)},
    {SIP_MLNAME_CAST(sipName_GetClientSize), meth_wxWindow_GetClientSize, METH_VARARGS, SIP_MLDOC_CAST(doc_wxWindow_GetClientSize)},
    {SIP_MLNAME_CAST(sipName_GetConstraints), meth_wxWindow_GetConstraints, METH_VARARGS, SIP_MLDOC_CAST(doc_wxWindow_GetConstraints)},
    {SIP_MLNAME_CAST(sipName_GetContainingSizer), meth_wxWindow_GetContainingSizer, METH_VARARGS, SIP_MLDOC_CAST(doc_wxWindow_GetContainingSizer)},
    {SIP_MLNAME_CAST(sipName_GetContentScaleFactor), meth_wxWindow_GetContentScaleFactor, METH_VARARGS, SIP_MLDOC_CAST(doc_wxWindow_GetContentScaleFactor)},
    {SIP_MLNAME_CAST(sipName_GetCursor), meth_wxWindow_GetCursor, METH_VARARGS, SIP_MLDOC_CAST(doc_wxWindow_GetCursor)},
    {SIP_MLNAME_CAST(sipName_GetDPI), meth_wxWindow_GetDPI, METH_VARARGS, SIP_MLDOC_CAST(doc_wxWindow_GetDPI)},
    {SIP_MLNAME_CAST(sipName_GetDefaultAttributes), meth_wxWindow_GetDefaultAttributes, METH_VARARGS, SIP_MLDOC_CAST(doc_wxWindow_GetDefaultAttributes)},
    {SIP_MLNAME_CAST(sipName_GetDefaultBorder), meth_wxWindow_GetDefaultBorder, METH_VARARGS, SIP_MLDOC_CAST(doc_wxWindow_GetDefaultBorder)},
    {SIP_MLNAME_CAST(sipName_GetDefaultBorderForControl), meth_wxWindow_GetDefaultBorderForControl, METH_VARARGS, SIP_MLDOC_CAST(doc_wxWindow_GetDefaultBorderForControl)},
    {SIP_MLNAME_CAST(sipName_GetDropTarget), meth_wxWindow_GetDropTarget, METH_VARARGS, SIP_MLDOC_CAST(doc_wxWindow_GetDropTarget)},
    {SIP_MLNAME_CAST(sipName_GetEffectiveMinSize), meth_wxWindow_GetEffectiveMinSize, METH_VARARGS, SIP_MLDOC_CAST(doc_wxWindow_GetEffectiveMinSize)},
    {SIP_MLNAME_CAST(sipName_GetEventHandler), meth_wxWindow_GetEventHandler, METH_VARARGS, SIP_MLDOC_CAST(doc_wxWindow_GetEventHandler)},
    {SIP_MLNAME_CAST(sipName_GetExtraStyle), meth_wxWindow_GetExtraStyle, METH_VARARGS, SIP_MLDOC_CAST(doc_wxWindow_GetExtraStyle)},
    {SIP_MLNAME_CAST(sipName_GetFont), meth_wxWindow_GetFont, METH_VARARGS, SIP_MLDOC_CAST(doc_wxWindow_GetFont)},
    {SIP_MLNAME_CAST(sipName_GetForegroundColour), meth_wxWindow_GetForegroundColour, METH_VARARGS, SIP_MLDOC_CAST(doc_wxWindow_GetForegroundColour)},
    {SIP_MLNAME_CAST(sipName_GetFullTextExtent), SIP_MLMETH_CAST(meth_wxWindow_GetFullTextExtent), METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxWindow_GetFullTextExtent)},
    {SIP_MLNAME_CAST(sipName_GetGrandParent), meth_wxWindow_GetGrandParent, METH_VARARGS, SIP_MLDOC_CAST(doc_wxWindow_GetGrandParent)},
    {SIP_MLNAME_CAST(sipName_GetGtkWidget), meth_wxWindow_GetGtkWidget, METH_VARARGS, SIP_MLDOC_CAST(doc_wxWindow_GetGtkWidget)},
    {SIP_MLNAME_CAST(sipName_GetHandle), meth_wxWindow_GetHandle, METH_VARARGS, SIP_MLDOC_CAST(doc_wxWindow_GetHandle)},
    {SIP_MLNAME_CAST(sipName_GetHelpText), meth_wxWindow_GetHelpText, METH_VARARGS, SIP_MLDOC_CAST(doc_wxWindow_GetHelpText)},
    {SIP_MLNAME_CAST(sipName_GetHelpTextAtPoint), SIP_MLMETH_CAST(meth_wxWindow_GetHelpTextAtPoint), METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxWindow_GetHelpTextAtPoint)},
    {SIP_MLNAME_CAST(sipName_GetId), meth_wxWindow_GetId, METH_VARARGS, SIP_MLDOC_CAST(doc_wxWindow_GetId)},
    {SIP_MLNAME_CAST(sipName_GetLabel), meth_wxWindow_GetLabel, METH_VARARGS, SIP_MLDOC_CAST(doc_wxWindow_GetLabel)},
    {SIP_MLNAME_CAST(sipName_GetLayoutDirection), meth_wxWindow_GetLayoutDirection, METH_VARARGS, SIP_MLDOC_CAST(doc_wxWindow_GetLayoutDirection)},
    {SIP_MLNAME_CAST(sipName_GetMainWindowOfCompositeControl), meth_wxWindow_GetMainWindowOfCompositeControl, METH_VARARGS, SIP_MLDOC_CAST(doc_wxWindow_GetMainWindowOfCompositeControl)},
    {SIP_MLNAME_CAST(sipName_GetMaxClientSize), meth_wxWindow_GetMaxClientSize, METH_VARARGS, SIP_MLDOC_CAST(doc_wxWindow_GetMaxClientSize)},
    {SIP_MLNAME_CAST(sipName_GetMaxHeight), meth_wxWindow_GetMaxHeight, METH_VARARGS, SIP_MLDOC_CAST(doc_wxWindow_GetMaxHeight)},
    {SIP_MLNAME_CAST(sipName_GetMaxSize), meth_wxWindow_GetMaxSize, METH_VARARGS, SIP_MLDOC_CAST(doc_wxWindow_GetMaxSize)},
    {SIP_MLNAME_CAST(sipName_GetMaxWidth), meth_wxWindow_GetMaxWidth, METH_VARARGS, SIP_MLDOC_CAST(doc_wxWindow_GetMaxWidth)},
    {SIP_MLNAME_CAST(sipName_GetMinClientSize), meth_wxWindow_GetMinClientSize, METH_VARARGS, SIP_MLDOC_CAST(doc_wxWindow_GetMinClientSize)},
    {SIP_MLNAME_CAST(sipName_GetMinHeight), meth_wxWindow_GetMinHeight, METH_VARARGS, SIP_MLDOC_CAST(doc_wxWindow_GetMinHeight)},
    {SIP_MLNAME_CAST(sipName_GetMinSize), meth_wxWindow_GetMinSize, METH_VARARGS, SIP_MLDOC_CAST(doc_wxWindow_GetMinSize)},
    {SIP_MLNAME_CAST(sipName_GetMinWidth), meth_wxWindow_GetMinWidth, METH_VARARGS, SIP_MLDOC_CAST(doc_wxWindow_GetMinWidth)},
    {SIP_MLNAME_CAST(sipName_GetName), meth_wxWindow_GetName, METH_VARARGS, SIP_MLDOC_CAST(doc_wxWindow_GetName)},
    {SIP_MLNAME_CAST(sipName_GetNextSibling), meth_wxWindow_GetNextSibling, METH_VARARGS, SIP_MLDOC_CAST(doc_wxWindow_GetNextSibling)},
    {SIP_MLNAME_CAST(sipName_GetParent), meth_wxWindow_GetParent, METH_VARARGS, SIP_MLDOC_CAST(doc_wxWindow_GetParent)},
    {SIP_MLNAME_CAST(sipName_GetPopupMenuSelectionFromUser), SIP_MLMETH_CAST(meth_wxWindow_GetPopupMenuSelectionFromUser), METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxWindow_GetPopupMenuSelectionFromUser)},
    {SIP_MLNAME_CAST(sipName_GetPosition), meth_wxWindow_GetPosition, METH_VARARGS, SIP_MLDOC_CAST(doc_wxWindow_GetPosition)},
    {SIP_MLNAME_CAST(sipName_GetPrevSibling), meth_wxWindow_GetPrevSibling, METH_VARARGS, SIP_MLDOC_CAST(doc_wxWindow_GetPrevSibling)},
    {SIP_MLNAME_CAST(sipName_GetRect), meth_wxWindow_GetRect, METH_VARARGS, SIP_MLDOC_CAST(doc_wxWindow_GetRect)},
    {SIP_MLNAME_CAST(sipName_GetScreenPosition), meth_wxWindow_GetScreenPosition, METH_VARARGS, SIP_MLDOC_CAST(doc_wxWindow_GetScreenPosition)},
    {SIP_MLNAME_CAST(sipName_GetScreenRect), meth_wxWindow_GetScreenRect, METH_VARARGS, SIP_MLDOC_CAST(doc_wxWindow_GetScreenRect)},
    {SIP_MLNAME_CAST(sipName_GetScrollPos), SIP_MLMETH_CAST(meth_wxWindow_GetScrollPos), METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxWindow_GetScrollPos)},
    {SIP_MLNAME_CAST(sipName_GetScrollRange), SIP_MLMETH_CAST(meth_wxWindow_GetScrollRange), METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxWindow_GetScrollRange)},
    {SIP_MLNAME_CAST(sipName_GetScrollThumb), SIP_MLMETH_CAST(meth_wxWindow_GetScrollThumb), METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxWindow_GetScrollThumb)},
    {SIP_MLNAME_CAST(sipName_GetSize), meth_wxWindow_GetSize, METH_VARARGS, SIP_MLDOC_CAST(doc_wxWindow_GetSize)},
    {SIP_MLNAME_CAST(sipName_GetSizer), meth_wxWindow_GetSizer, METH_VARARGS, SIP_MLDOC_CAST(doc_wxWindow_GetSizer)},
    {SIP_MLNAME_CAST(sipName_GetTextExtent), SIP_MLMETH_CAST(meth_wxWindow_GetTextExtent), METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxWindow_GetTextExtent)},
    {SIP_MLNAME_CAST(sipName_GetThemeEnabled), meth_wxWindow_GetThemeEnabled, METH_VARARGS, SIP_MLDOC_CAST(doc_wxWindow_GetThemeEnabled)},
    {SIP_MLNAME_CAST(sipName_GetToolTip), meth_wxWindow_GetToolTip, METH_VARARGS, SIP_MLDOC_CAST(doc_wxWindow_GetToolTip)},
    {SIP_MLNAME_CAST(sipName_GetToolTipText), meth_wxWindow_GetToolTipText, METH_VARARGS, SIP_MLDOC_CAST(doc_wxWindow_GetToolTipText)},
    {SIP_MLNAME_CAST(sipName_GetTopLevelParent), meth_wxWindow_GetTopLevelParent, METH_VARARGS, SIP_MLDOC_CAST(doc_wxWindow_GetTopLevelParent)},
    {SIP_MLNAME_CAST(sipName_GetUpdateClientRect), meth_wxWindow_GetUpdateClientRect, METH_VARARGS, SIP_MLDOC_CAST(doc_wxWindow_GetUpdateClientRect)},
    {SIP_MLNAME_CAST(sipName_GetUpdateRegion), meth_wxWindow_GetUpdateRegion, METH_VARARGS, SIP_MLDOC_CAST(doc_wxWindow_GetUpdateRegion)},
    {SIP_MLNAME_CAST(sipName_GetValidator), meth_wxWindow_GetValidator, METH_VARARGS, SIP_MLDOC_CAST(doc_wxWindow_GetValidator)},
    {SIP_MLNAME_CAST(sipName_GetVirtualSize), meth_wxWindow_GetVirtualSize, METH_VARARGS, SIP_MLDOC_CAST(doc_wxWindow_GetVirtualSize)},
    {SIP_MLNAME_CAST(sipName_GetWindowBorderSize), meth_wxWindow_GetWindowBorderSize, METH_VARARGS, SIP_MLDOC_CAST(doc_wxWindow_GetWindowBorderSize)},
    {SIP_MLNAME_CAST(sipName_GetWindowStyle), meth_wxWindow_GetWindowStyle, METH_VARARGS, SIP_MLDOC_CAST(doc_wxWindow_GetWindowStyle)},
    {SIP_MLNAME_CAST(sipName_GetWindowStyleFlag), meth_wxWindow_GetWindowStyleFlag, METH_VARARGS, SIP_MLDOC_CAST(doc_wxWindow_GetWindowStyleFlag)},
    {SIP_MLNAME_CAST(sipName_GetWindowVariant), meth_wxWindow_GetWindowVariant, METH_VARARGS, SIP_MLDOC_CAST(doc_wxWindow_GetWindowVariant)},
    {SIP_MLNAME_CAST(sipName_HandleAsNavigationKey), SIP_MLMETH_CAST(meth_wxWindow_HandleAsNavigationKey), METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxWindow_HandleAsNavigationKey)},
    {SIP_MLNAME_CAST(sipName_HandleWindowEvent), SIP_MLMETH_CAST(meth_wxWindow_HandleWindowEvent), METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxWindow_HandleWindowEvent)},
    {SIP_MLNAME_CAST(sipName_HasCapture), meth_wxWindow_HasCapture, METH_VARARGS, SIP_MLDOC_CAST(doc_wxWindow_HasCapture)},
    {SIP_MLNAME_CAST(sipName_HasExtraStyle), SIP_MLMETH_CAST(meth_wxWindow_HasExtraStyle), METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxWindow_HasExtraStyle)},
    {SIP_MLNAME_CAST(sipName_HasFlag), SIP_MLMETH_CAST(meth_wxWindow_HasFlag), METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxWindow_HasFlag)},
    {SIP_MLNAME_CAST(sipName_HasFocus), meth_wxWindow_HasFocus, METH_VARARGS, SIP_MLDOC_CAST(doc_wxWindow_HasFocus)},
    {SIP_MLNAME_CAST(sipName_HasMultiplePages), meth_wxWindow_HasMultiplePages, METH_VARARGS, SIP_MLDOC_CAST(doc_wxWindow_HasMultiplePages)},
    {SIP_MLNAME_CAST(sipName_HasScrollbar), SIP_MLMETH_CAST(meth_wxWindow_HasScrollbar), METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxWindow_HasScrollbar)},
    {SIP_MLNAME_CAST(sipName_HasTransparentBackground), meth_wxWindow_HasTransparentBackground, METH_VARARGS, SIP_MLDOC_CAST(doc_wxWindow_HasTransparentBackground)},
    {SIP_MLNAME_CAST(sipName_Hide), meth_wxWindow_Hide, METH_VARARGS, SIP_MLDOC_CAST(doc_wxWindow_Hide)},
    {SIP_MLNAME_CAST(sipName_HideWithEffect), SIP_MLMETH_CAST(meth_wxWindow_HideWithEffect), METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxWindow_HideWithEffect)},
    {SIP_MLNAME_CAST(sipName_HitTest), SIP_MLMETH_CAST(meth_wxWindow_HitTest), METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxWindow_HitTest)},
    {SIP_MLNAME_CAST(sipName_InformFirstDirection), SIP_MLMETH_CAST(meth_wxWindow_InformFirstDirection), METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxWindow_InformFirstDirection)},
    {SIP_MLNAME_CAST(sipName_InheritAttributes), meth_wxWindow_InheritAttributes, METH_VARARGS, SIP_MLDOC_CAST(doc_wxWindow_InheritAttributes)},
    {SIP_MLNAME_CAST(sipName_InheritsBackgroundColour), meth_wxWindow_InheritsBackgroundColour, METH_VARARGS, SIP_MLDOC_CAST(doc_wxWindow_InheritsBackgroundColour)},
    {SIP_MLNAME_CAST(sipName_InheritsForegroundColour), meth_wxWindow_InheritsForegroundColour, METH_VARARGS, SIP_MLDOC_CAST(doc_wxWindow_InheritsForegroundColour)},
    {SIP_MLNAME_CAST(sipName_InitDialog), meth_wxWindow_InitDialog, METH_VARARGS, SIP_MLDOC_CAST(doc_wxWindow_InitDialog)},
    {SIP_MLNAME_CAST(sipName_InvalidateBestSize), meth_wxWindow_InvalidateBestSize, METH_VARARGS, SIP_MLDOC_CAST(doc_wxWindow_InvalidateBestSize)},
    {SIP_MLNAME_CAST(sipName_IsBeingDeleted), meth_wxWindow_IsBeingDeleted, METH_VARARGS, SIP_MLDOC_CAST(doc_wxWindow_IsBeingDeleted)},
    {SIP_MLNAME_CAST(sipName_IsDescendant), SIP_MLMETH_CAST(meth_wxWindow_IsDescendant), METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxWindow_IsDescendant)},
    {SIP_MLNAME_CAST(sipName_IsDoubleBuffered), meth_wxWindow_IsDoubleBuffered, METH_VARARGS, SIP_MLDOC_CAST(doc_wxWindow_IsDoubleBuffered)},
    {SIP_MLNAME_CAST(sipName_IsEnabled), meth_wxWindow_IsEnabled, METH_VARARGS, SIP_MLDOC_CAST(doc_wxWindow_IsEnabled)},
    {SIP_MLNAME_CAST(sipName_IsExposed), SIP_MLMETH_CAST(meth_wxWindow_IsExposed), METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxWindow_IsExposed)},
    {SIP_MLNAME_CAST(sipName_IsFocusable), meth_wxWindow_IsFocusable, METH_VARARGS, SIP_MLDOC_CAST(doc_wxWindow_IsFocusable)},
    {SIP_MLNAME_CAST(sipName_IsFrozen), meth_wxWindow_IsFrozen, METH_VARARGS, SIP_MLDOC_CAST(doc_wxWindow_IsFrozen)},
    {SIP_MLNAME_CAST(sipName_IsRetained), meth_wxWindow_IsRetained, METH_VARARGS, SIP_MLDOC_CAST(doc_wxWindow_IsRetained)},
    {SIP_MLNAME_CAST(sipName_IsScrollbarAlwaysShown), SIP_MLMETH_CAST(meth_wxWindow_IsScrollbarAlwaysShown), METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxWindow_IsScrollbarAlwaysShown)},
    {SIP_MLNAME_CAST(sipName_IsShown), meth_wxWindow_IsShown, METH_VARARGS, SIP_MLDOC_CAST(doc_wxWindow_IsShown)},
    {SIP_MLNAME_CAST(sipName_IsShownOnScreen), meth_wxWindow_IsShownOnScreen, METH_VARARGS, SIP_MLDOC_CAST(doc_wxWindow_IsShownOnScreen)},
    {SIP_MLNAME_CAST(sipName_IsThisEnabled), meth_wxWindow_IsThisEnabled, METH_VARARGS, SIP_MLDOC_CAST(doc_wxWindow_IsThisEnabled)},
    {SIP_MLNAME_CAST(sipName_IsTopLevel), meth_wxWindow_IsTopLevel, METH_VARARGS, SIP_MLDOC_CAST(doc_wxWindow_IsTopLevel)},
    {SIP_MLNAME_CAST(sipName_IsTransparentBackgroundSupported), SIP_MLMETH_CAST(meth_wxWindow_IsTransparentBackgroundSupported), METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxWindow_IsTransparentBackgroundSupported)},
    {SIP_MLNAME_CAST(sipName_Layout), meth_wxWindow_Layout, METH_VARARGS, SIP_MLDOC_CAST(doc_wxWindow_Layout)},
    {SIP_MLNAME_CAST(sipName_LineDown), meth_wxWindow_LineDown, METH_VARARGS, SIP_MLDOC_CAST(doc_wxWindow_LineDown)},
    {SIP_MLNAME_CAST(sipName_LineUp), meth_wxWindow_LineUp, METH_VARARGS, SIP_MLDOC_CAST(doc_wxWindow_LineUp)},
    {SIP_MLNAME_CAST(sipName_Lower), meth_wxWindow_Lower, METH_VARARGS, SIP_MLDOC_CAST(doc_wxWindow_Lower)},
    {SIP_MLNAME_CAST(sipName_MacIsWindowScrollbar), SIP_MLMETH_CAST(meth_wxWindow_MacIsWindowScrollbar), METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxWindow_MacIsWindowScrollbar)},
    {SIP_MLNAME_CAST(sipName_Move), SIP_MLMETH_CAST(meth_wxWindow_Move), METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxWindow_Move)},
    {SIP_MLNAME_CAST(sipName_MoveAfterInTabOrder), SIP_MLMETH_CAST(meth_wxWindow_MoveAfterInTabOrder), METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxWindow_MoveAfterInTabOrder)},
    {SIP_MLNAME_CAST(sipName_MoveBeforeInTabOrder), SIP_MLMETH_CAST(meth_wxWindow_MoveBeforeInTabOrder), METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxWindow_MoveBeforeInTabOrder)},
    {SIP_MLNAME_CAST(sipName_Navigate), SIP_MLMETH_CAST(meth_wxWindow_Navigate), METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxWindow_Navigate)},
    {SIP_MLNAME_CAST(sipName_NavigateIn), SIP_MLMETH_CAST(meth_wxWindow_NavigateIn), METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxWindow_NavigateIn)},
    {SIP_MLNAME_CAST(sipName_NewControlId), SIP_MLMETH_CAST(meth_wxWindow_NewControlId), METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxWindow_NewControlId)},
    {SIP_MLNAME_CAST(sipName_OnInternalIdle), meth_wxWindow_OnInternalIdle, METH_VARARGS, SIP_MLDOC_CAST(doc_wxWindow_OnInternalIdle)},
    {SIP_MLNAME_CAST(sipName_PageDown), meth_wxWindow_PageDown, METH_VARARGS, SIP_MLDOC_CAST(doc_wxWindow_PageDown)},
    {SIP_MLNAME_CAST(sipName_PageUp), meth_wxWindow_PageUp, METH_VARARGS, SIP_MLDOC_CAST(doc_wxWindow_PageUp)},
    {SIP_MLNAME_CAST(sipName_PopEventHandler), SIP_MLMETH_CAST(meth_wxWindow_PopEventHandler), METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxWindow_PopEventHandler)},
    {SIP_MLNAME_CAST(sipName_PopupMenu), SIP_MLMETH_CAST(meth_wxWindow_PopupMenu), METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxWindow_PopupMenu)},
    {SIP_MLNAME_CAST(sipName_PostSizeEvent), meth_wxWindow_PostSizeEvent, METH_VARARGS, SIP_MLDOC_CAST(doc_wxWindow_PostSizeEvent)},
    {SIP_MLNAME_CAST(sipName_PostSizeEventToParent), meth_wxWindow_PostSizeEventToParent, METH_VARARGS, SIP_MLDOC_CAST(doc_wxWindow_PostSizeEventToParent)},
    {SIP_MLNAME_CAST(sipName_ProcessEvent), SIP_MLMETH_CAST(meth_wxWindow_ProcessEvent), METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxWindow_ProcessEvent)},
    {SIP_MLNAME_CAST(sipName_ProcessWindowEvent), SIP_MLMETH_CAST(meth_wxWindow_ProcessWindowEvent), METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxWindow_ProcessWindowEvent)},
    {SIP_MLNAME_CAST(sipName_ProcessWindowEventLocally), SIP_MLMETH_CAST(meth_wxWindow_ProcessWindowEventLocally), METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxWindow_ProcessWindowEventLocally)},
    {SIP_MLNAME_CAST(sipName_PushEventHandler), SIP_MLMETH_CAST(meth_wxWindow_PushEventHandler), METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxWindow_PushEventHandler)},
    {SIP_MLNAME_CAST(sipName_Raise), meth_wxWindow_Raise, METH_VARARGS, SIP_MLDOC_CAST(doc_wxWindow_Raise)},
    {SIP_MLNAME_CAST(sipName_Refresh), SIP_MLMETH_CAST(meth_wxWindow_Refresh), METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxWindow_Refresh)},
    {SIP_MLNAME_CAST(sipName_RefreshRect), SIP_MLMETH_CAST(meth_wxWindow_RefreshRect), METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxWindow_RefreshRect)},
    {SIP_MLNAME_CAST(sipName_RegisterHotKey), SIP_MLMETH_CAST(meth_wxWindow_RegisterHotKey), METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxWindow_RegisterHotKey)},
    {SIP_MLNAME_CAST(sipName_ReleaseMouse), meth_wxWindow_ReleaseMouse, METH_VARARGS, SIP_MLDOC_CAST(doc_wxWindow_ReleaseMouse)},
    {SIP_MLNAME_CAST(sipName_RemoveChild), SIP_MLMETH_CAST(meth_wxWindow_RemoveChild), METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxWindow_RemoveChild)},
    {SIP_MLNAME_CAST(sipName_RemoveEventHandler), SIP_MLMETH_CAST(meth_wxWindow_RemoveEventHandler), METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxWindow_RemoveEventHandler)},
    {SIP_MLNAME_CAST(sipName_Reparent), SIP_MLMETH_CAST(meth_wxWindow_Reparent), METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxWindow_Reparent)},
    {SIP_MLNAME_CAST(sipName_ScreenToClient), SIP_MLMETH_CAST(meth_wxWindow_ScreenToClient), METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxWindow_ScreenToClient)},
    {SIP_MLNAME_CAST(sipName_ScrollLines), SIP_MLMETH_CAST(meth_wxWindow_ScrollLines), METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxWindow_ScrollLines)},
    {SIP_MLNAME_CAST(sipName_ScrollPages), SIP_MLMETH_CAST(meth_wxWindow_ScrollPages), METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxWindow_ScrollPages)},
    {SIP_MLNAME_CAST(sipName_ScrollWindow), SIP_MLMETH_CAST(meth_wxWindow_ScrollWindow), METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxWindow_ScrollWindow)},
    {SIP_MLNAME_CAST(sipName_SendDestroyEvent), meth_wxWindow_SendDestroyEvent, METH_VARARGS, SIP_MLDOC_CAST(doc_wxWindow_SendDestroyEvent)},
    {SIP_MLNAME_CAST(sipName_SendIdleEvents), SIP_MLMETH_CAST(meth_wxWindow_SendIdleEvents), METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxWindow_SendIdleEvents)},
    {SIP_MLNAME_CAST(sipName_SendSizeEvent), SIP_MLMETH_CAST(meth_wxWindow_SendSizeEvent), METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxWindow_SendSizeEvent)},
    {SIP_MLNAME_CAST(sipName_SendSizeEventToParent), SIP_MLMETH_CAST(meth_wxWindow_SendSizeEventToParent), METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxWindow_SendSizeEventToParent)},
    {SIP_MLNAME_CAST(sipName_SetAcceleratorTable), SIP_MLMETH_CAST(meth_wxWindow_SetAcceleratorTable), METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxWindow_SetAcceleratorTable)},
    {SIP_MLNAME_CAST(sipName_SetAccessible), SIP_MLMETH_CAST(meth_wxWindow_SetAccessible), METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxWindow_SetAccessible)},
    {SIP_MLNAME_CAST(sipName_SetAutoLayout), SIP_MLMETH_CAST(meth_wxWindow_SetAutoLayout), METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxWindow_SetAutoLayout)},
    {SIP_MLNAME_CAST(sipName_SetBackgroundColour), SIP_MLMETH_CAST(meth_wxWindow_SetBackgroundColour), METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxWindow_SetBackgroundColour)},
    {SIP_MLNAME_CAST(sipName_SetBackgroundStyle), SIP_MLMETH_CAST(meth_wxWindow_SetBackgroundStyle), METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxWindow_SetBackgroundStyle)},
    {SIP_MLNAME_CAST(sipName_SetCanFocus), SIP_MLMETH_CAST(meth_wxWindow_SetCanFocus), METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxWindow_SetCanFocus)},
    {SIP_MLNAME_CAST(sipName_SetCaret), SIP_MLMETH_CAST(meth_wxWindow_SetCaret), METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxWindow_SetCaret)},
    {SIP_MLNAME_CAST(sipName_SetClientSize), SIP_MLMETH_CAST(meth_wxWindow_SetClientSize), METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxWindow_SetClientSize)},
    {SIP_MLNAME_CAST(sipName_SetConstraints), SIP_MLMETH_CAST(meth_wxWindow_SetConstraints), METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxWindow_SetConstraints)},
    {SIP_MLNAME_CAST(sipName_SetContainingSizer), SIP_MLMETH_CAST(meth_wxWindow_SetContainingSizer), METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxWindow_SetContainingSizer)},
    {SIP_MLNAME_CAST(sipName_SetCursor), SIP_MLMETH_CAST(meth_wxWindow_SetCursor), METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxWindow_SetCursor)},
    {SIP_MLNAME_CAST(sipName_SetDimensions), SIP_MLMETH_CAST(meth_wxWindow_SetDimensions), METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxWindow_SetDimensions)},
    {SIP_MLNAME_CAST(sipName_SetDoubleBuffered), SIP_MLMETH_CAST(meth_wxWindow_SetDoubleBuffered), METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxWindow_SetDoubleBuffered)},
    {SIP_MLNAME_CAST(sipName_SetDropTarget), SIP_MLMETH_CAST(meth_wxWindow_SetDropTarget), METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxWindow_SetDropTarget)},
    {SIP_MLNAME_CAST(sipName_SetEventHandler), SIP_MLMETH_CAST(meth_wxWindow_SetEventHandler), METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxWindow_SetEventHandler)},
    {SIP_MLNAME_CAST(sipName_SetExtraStyle), SIP_MLMETH_CAST(meth_wxWindow_SetExtraStyle), METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxWindow_SetExtraStyle)},
    {SIP_MLNAME_CAST(sipName_SetFocus), meth_wxWindow_SetFocus, METH_VARARGS, SIP_MLDOC_CAST(doc_wxWindow_SetFocus)},
    {SIP_MLNAME_CAST(sipName_SetFocusFromKbd), meth_wxWindow_SetFocusFromKbd, METH_VARARGS, SIP_MLDOC_CAST(doc_wxWindow_SetFocusFromKbd)},
    {SIP_MLNAME_CAST(sipName_SetFont), SIP_MLMETH_CAST(meth_wxWindow_SetFont), METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxWindow_SetFont)},
    {SIP_MLNAME_CAST(sipName_SetForegroundColour), SIP_MLMETH_CAST(meth_wxWindow_SetForegroundColour), METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxWindow_SetForegroundColour)},
    {SIP_MLNAME_CAST(sipName_SetHelpText), SIP_MLMETH_CAST(meth_wxWindow_SetHelpText), METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxWindow_SetHelpText)},
    {SIP_MLNAME_CAST(sipName_SetId), SIP_MLMETH_CAST(meth_wxWindow_SetId), METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxWindow_SetId)},
    {SIP_MLNAME_CAST(sipName_SetInitialSize), SIP_MLMETH_CAST(meth_wxWindow_SetInitialSize), METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxWindow_SetInitialSize)},
    {SIP_MLNAME_CAST(sipName_SetLabel), SIP_MLMETH_CAST(meth_wxWindow_SetLabel), METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxWindow_SetLabel)},
    {SIP_MLNAME_CAST(sipName_SetLayoutDirection), SIP_MLMETH_CAST(meth_wxWindow_SetLayoutDirection), METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxWindow_SetLayoutDirection)},
    {SIP_MLNAME_CAST(sipName_SetMaxClientSize), SIP_MLMETH_CAST(meth_wxWindow_SetMaxClientSize), METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxWindow_SetMaxClientSize)},
    {SIP_MLNAME_CAST(sipName_SetMaxSize), SIP_MLMETH_CAST(meth_wxWindow_SetMaxSize), METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxWindow_SetMaxSize)},
    {SIP_MLNAME_CAST(sipName_SetMinClientSize), SIP_MLMETH_CAST(meth_wxWindow_SetMinClientSize), METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxWindow_SetMinClientSize)},
    {SIP_MLNAME_CAST(sipName_SetMinSize), SIP_MLMETH_CAST(meth_wxWindow_SetMinSize), METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxWindow_SetMinSize)},
    {SIP_MLNAME_CAST(sipName_SetName), SIP_MLMETH_CAST(meth_wxWindow_SetName), METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxWindow_SetName)},
    {SIP_MLNAME_CAST(sipName_SetNextHandler), SIP_MLMETH_CAST(meth_wxWindow_SetNextHandler), METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxWindow_SetNextHandler)},
    {SIP_MLNAME_CAST(sipName_SetOwnBackgroundColour), SIP_MLMETH_CAST(meth_wxWindow_SetOwnBackgroundColour), METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxWindow_SetOwnBackgroundColour)},
    {SIP_MLNAME_CAST(sipName_SetOwnFont), SIP_MLMETH_CAST(meth_wxWindow_SetOwnFont), METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxWindow_SetOwnFont)},
    {SIP_MLNAME_CAST(sipName_SetOwnForegroundColour), SIP_MLMETH_CAST(meth_wxWindow_SetOwnForegroundColour), METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxWindow_SetOwnForegroundColour)},
    {SIP_MLNAME_CAST(sipName_SetPalette), SIP_MLMETH_CAST(meth_wxWindow_SetPalette), METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxWindow_SetPalette)},
    {SIP_MLNAME_CAST(sipName_SetPosition), SIP_MLMETH_CAST(meth_wxWindow_SetPosition), METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxWindow_SetPosition)},
    {SIP_MLNAME_CAST(sipName_SetPreviousHandler), SIP_MLMETH_CAST(meth_wxWindow_SetPreviousHandler), METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxWindow_SetPreviousHandler)},
    {SIP_MLNAME_CAST(sipName_SetScrollPos), SIP_MLMETH_CAST(meth_wxWindow_SetScrollPos), METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxWindow_SetScrollPos)},
    {SIP_MLNAME_CAST(sipName_SetScrollbar), SIP_MLMETH_CAST(meth_wxWindow_SetScrollbar), METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxWindow_SetScrollbar)},
    {SIP_MLNAME_CAST(sipName_SetSize), SIP_MLMETH_CAST(meth_wxWindow_SetSize), METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxWindow_SetSize)},
    {SIP_MLNAME_CAST(sipName_SetSizeHints), SIP_MLMETH_CAST(meth_wxWindow_SetSizeHints), METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxWindow_SetSizeHints)},
    {SIP_MLNAME_CAST(sipName_SetSizer), SIP_MLMETH_CAST(meth_wxWindow_SetSizer), METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxWindow_SetSizer)},
    {SIP_MLNAME_CAST(sipName_SetSizerAndFit), SIP_MLMETH_CAST(meth_wxWindow_SetSizerAndFit), METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxWindow_SetSizerAndFit)},
    {SIP_MLNAME_CAST(sipName_SetThemeEnabled), SIP_MLMETH_CAST(meth_wxWindow_SetThemeEnabled), METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxWindow_SetThemeEnabled)},
    {SIP_MLNAME_CAST(sipName_SetToolTip), SIP_MLMETH_CAST(meth_wxWindow_SetToolTip), METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxWindow_SetToolTip)},
    {SIP_MLNAME_CAST(sipName_SetTransparent), SIP_MLMETH_CAST(meth_wxWindow_SetTransparent), METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxWindow_SetTransparent)},
    {SIP_MLNAME_CAST(sipName_SetValidator), SIP_MLMETH_CAST(meth_wxWindow_SetValidator), METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxWindow_SetValidator)},
    {SIP_MLNAME_CAST(sipName_SetVirtualSize), SIP_MLMETH_CAST(meth_wxWindow_SetVirtualSize), METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxWindow_SetVirtualSize)},
    {SIP_MLNAME_CAST(sipName_SetWindowStyle), SIP_MLMETH_CAST(meth_wxWindow_SetWindowStyle), METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxWindow_SetWindowStyle)},
    {SIP_MLNAME_CAST(sipName_SetWindowStyleFlag), SIP_MLMETH_CAST(meth_wxWindow_SetWindowStyleFlag), METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxWindow_SetWindowStyleFlag)},
    {SIP_MLNAME_CAST(sipName_SetWindowVariant), SIP_MLMETH_CAST(meth_wxWindow_SetWindowVariant), METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxWindow_SetWindowVariant)},
    {SIP_MLNAME_CAST(sipName_ShouldInheritColours), meth_wxWindow_ShouldInheritColours, METH_VARARGS, SIP_MLDOC_CAST(doc_wxWindow_ShouldInheritColours)},
    {SIP_MLNAME_CAST(sipName_Show), SIP_MLMETH_CAST(meth_wxWindow_Show), METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxWindow_Show)},
    {SIP_MLNAME_CAST(sipName_ShowWithEffect), SIP_MLMETH_CAST(meth_wxWindow_ShowWithEffect), METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxWindow_ShowWithEffect)},
    {SIP_MLNAME_CAST(sipName_Thaw), meth_wxWindow_Thaw, METH_VARARGS, SIP_MLDOC_CAST(doc_wxWindow_Thaw)},
    {SIP_MLNAME_CAST(sipName_ToDIP), SIP_MLMETH_CAST(meth_wxWindow_ToDIP), METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxWindow_ToDIP)},
    {SIP_MLNAME_CAST(sipName_ToggleWindowStyle), SIP_MLMETH_CAST(meth_wxWindow_ToggleWindowStyle), METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxWindow_ToggleWindowStyle)},
    {SIP_MLNAME_CAST(sipName_TransferDataFromWindow), meth_wxWindow_TransferDataFromWindow, METH_VARARGS, SIP_MLDOC_CAST(doc_wxWindow_TransferDataFromWindow)},
    {SIP_MLNAME_CAST(sipName_TransferDataToWindow), meth_wxWindow_TransferDataToWindow, METH_VARARGS, SIP_MLDOC_CAST(doc_wxWindow_TransferDataToWindow)},
    {SIP_MLNAME_CAST(sipName_TryAfter), SIP_MLMETH_CAST(meth_wxWindow_TryAfter), METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxWindow_TryAfter)},
    {SIP_MLNAME_CAST(sipName_TryBefore), SIP_MLMETH_CAST(meth_wxWindow_TryBefore), METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxWindow_TryBefore)},
    {SIP_MLNAME_CAST(sipName_UnregisterHotKey), SIP_MLMETH_CAST(meth_wxWindow_UnregisterHotKey), METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxWindow_UnregisterHotKey)},
    {SIP_MLNAME_CAST(sipName_UnreserveControlId), SIP_MLMETH_CAST(meth_wxWindow_UnreserveControlId), METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxWindow_UnreserveControlId)},
    {SIP_MLNAME_CAST(sipName_UnsetToolTip), meth_wxWindow_UnsetToolTip, METH_VARARGS, SIP_MLDOC_CAST(doc_wxWindow_UnsetToolTip)},
    {SIP_MLNAME_CAST(sipName_Update), meth_wxWindow_Update, METH_VARARGS, SIP_MLDOC_CAST(doc_wxWindow_Update)},
    {SIP_MLNAME_CAST(sipName_UpdateWindowUI), SIP_MLMETH_CAST(meth_wxWindow_UpdateWindowUI), METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxWindow_UpdateWindowUI)},
    {SIP_MLNAME_CAST(sipName_UseBackgroundColour), meth_wxWindow_UseBackgroundColour, METH_VARARGS, SIP_MLDOC_CAST(doc_wxWindow_UseBackgroundColour)},
    {SIP_MLNAME_CAST(sipName_UseBgCol), meth_wxWindow_UseBgCol, METH_VARARGS, SIP_MLDOC_CAST(doc_wxWindow_UseBgCol)},
    {SIP_MLNAME_CAST(sipName_UseForegroundColour), meth_wxWindow_UseForegroundColour, METH_VARARGS, SIP_MLDOC_CAST(doc_wxWindow_UseForegroundColour)},
    {SIP_MLNAME_CAST(sipName_Validate), meth_wxWindow_Validate, METH_VARARGS, SIP_MLDOC_CAST(doc_wxWindow_Validate)},
    {SIP_MLNAME_CAST(sipName_WarpPointer), SIP_MLMETH_CAST(meth_wxWindow_WarpPointer), METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxWindow_WarpPointer)},
    {SIP_MLNAME_CAST(sipName_WindowToClientSize), SIP_MLMETH_CAST(meth_wxWindow_WindowToClientSize), METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxWindow_WindowToClientSize)}
};

sipVariableDef variables_wxWindow[] = {
    {PropertyVariable, sipName_MaxClientSize, &methods_wxWindow[100], &methods_wxWindow[230], SIP_NULLPTR, SIP_NULLPTR},
    {PropertyVariable, sipName_MinClientSize, &methods_wxWindow[104], &methods_wxWindow[232], SIP_NULLPTR, SIP_NULLPTR},
    {PropertyVariable, sipName_TopLevel, &methods_wxWindow[165], SIP_NULLPTR, SIP_NULLPTR, SIP_NULLPTR},
    {PropertyVariable, sipName_Enabled, &methods_wxWindow[156], &methods_wxWindow[45], SIP_NULLPTR, SIP_NULLPTR},
    {PropertyVariable, sipName_Shown, &methods_wxWindow[162], &methods_wxWindow[257], SIP_NULLPTR, SIP_NULLPTR},
    {PropertyVariable, sipName_WindowVariant, &methods_wxWindow[134], &methods_wxWindow[255], SIP_NULLPTR, SIP_NULLPTR},
    {PropertyVariable, sipName_WindowStyleFlag, &methods_wxWindow[133], &methods_wxWindow[254], SIP_NULLPTR, SIP_NULLPTR},
    {PropertyVariable, sipName_WindowStyle, &methods_wxWindow[132], &methods_wxWindow[253], SIP_NULLPTR, SIP_NULLPTR},
    {PropertyVariable, sipName_VirtualSize, &methods_wxWindow[130], &methods_wxWindow[252], SIP_NULLPTR, SIP_NULLPTR},
    {PropertyVariable, sipName_Validator, &methods_wxWindow[129], &methods_wxWindow[251], SIP_NULLPTR, SIP_NULLPTR},
    {PropertyVariable, sipName_UpdateRegion, &methods_wxWindow[128], SIP_NULLPTR, SIP_NULLPTR, SIP_NULLPTR},
    {PropertyVariable, sipName_UpdateClientRect, &methods_wxWindow[127], SIP_NULLPTR, SIP_NULLPTR, SIP_NULLPTR},
    {PropertyVariable, sipName_ToolTip, &methods_wxWindow[124], &methods_wxWindow[249], SIP_NULLPTR, SIP_NULLPTR},
    {PropertyVariable, sipName_ThemeEnabled, &methods_wxWindow[123], &methods_wxWindow[248], SIP_NULLPTR, SIP_NULLPTR},
    {PropertyVariable, sipName_Sizer, &methods_wxWindow[121], &methods_wxWindow[246], SIP_NULLPTR, SIP_NULLPTR},
    {PropertyVariable, sipName_Size, &methods_wxWindow[120], &methods_wxWindow[244], SIP_NULLPTR, SIP_NULLPTR},
    {PropertyVariable, sipName_ScreenRect, &methods_wxWindow[116], SIP_NULLPTR, SIP_NULLPTR, SIP_NULLPTR},
    {PropertyVariable, sipName_ScreenPosition, &methods_wxWindow[115], SIP_NULLPTR, SIP_NULLPTR, SIP_NULLPTR},
    {PropertyVariable, sipName_Position, &methods_wxWindow[112], &methods_wxWindow[240], SIP_NULLPTR, SIP_NULLPTR},
    {PropertyVariable, sipName_Parent, &methods_wxWindow[110], SIP_NULLPTR, SIP_NULLPTR, SIP_NULLPTR},
    {PropertyVariable, sipName_Name, &methods_wxWindow[108], &methods_wxWindow[234], SIP_NULLPTR, SIP_NULLPTR},
    {PropertyVariable, sipName_MinWidth, &methods_wxWindow[107], SIP_NULLPTR, SIP_NULLPTR, SIP_NULLPTR},
    {PropertyVariable, sipName_MinSize, &methods_wxWindow[106], &methods_wxWindow[233], SIP_NULLPTR, SIP_NULLPTR},
    {PropertyVariable, sipName_MinHeight, &methods_wxWindow[105], SIP_NULLPTR, SIP_NULLPTR, SIP_NULLPTR},
    {PropertyVariable, sipName_MaxWidth, &methods_wxWindow[103], SIP_NULLPTR, SIP_NULLPTR, SIP_NULLPTR},
    {PropertyVariable, sipName_MaxSize, &methods_wxWindow[102], &methods_wxWindow[231], SIP_NULLPTR, SIP_NULLPTR},
    {PropertyVariable, sipName_MaxHeight, &methods_wxWindow[101], SIP_NULLPTR, SIP_NULLPTR, SIP_NULLPTR},
    {PropertyVariable, sipName_LayoutDirection, &methods_wxWindow[98], &methods_wxWindow[229], SIP_NULLPTR, SIP_NULLPTR},
    {PropertyVariable, sipName_Label, &methods_wxWindow[97], &methods_wxWindow[228], SIP_NULLPTR, SIP_NULLPTR},
    {PropertyVariable, sipName_Id, &methods_wxWindow[96], &methods_wxWindow[226], SIP_NULLPTR, SIP_NULLPTR},
    {PropertyVariable, sipName_HelpText, &methods_wxWindow[94], &methods_wxWindow[225], SIP_NULLPTR, SIP_NULLPTR},
    {PropertyVariable, sipName_Handle, &methods_wxWindow[93], SIP_NULLPTR, SIP_NULLPTR, SIP_NULLPTR},
    {PropertyVariable, sipName_TopLevelParent, &methods_wxWindow[126], SIP_NULLPTR, SIP_NULLPTR, SIP_NULLPTR},
    {PropertyVariable, sipName_GrandParent, &methods_wxWindow[91], SIP_NULLPTR, SIP_NULLPTR, SIP_NULLPTR},
    {PropertyVariable, sipName_ForegroundColour, &methods_wxWindow[89], &methods_wxWindow[224], SIP_NULLPTR, SIP_NULLPTR},
    {PropertyVariable, sipName_Font, &methods_wxWindow[88], &methods_wxWindow[223], SIP_NULLPTR, SIP_NULLPTR},
    {PropertyVariable, sipName_ExtraStyle, &methods_wxWindow[87], &methods_wxWindow[220], SIP_NULLPTR, SIP_NULLPTR},
    {PropertyVariable, sipName_EventHandler, &methods_wxWindow[86], &methods_wxWindow[219], SIP_NULLPTR, SIP_NULLPTR},
    {PropertyVariable, sipName_DropTarget, &methods_wxWindow[84], &methods_wxWindow[218], SIP_NULLPTR, SIP_NULLPTR},
    {PropertyVariable, sipName_DefaultAttributes, &methods_wxWindow[81], SIP_NULLPTR, SIP_NULLPTR, SIP_NULLPTR},
    {PropertyVariable, sipName_Cursor, &methods_wxWindow[79], &methods_wxWindow[215], SIP_NULLPTR, SIP_NULLPTR},
    {PropertyVariable, sipName_ContainingSizer, &methods_wxWindow[77], &methods_wxWindow[214], SIP_NULLPTR, SIP_NULLPTR},
    {PropertyVariable, sipName_Constraints, &methods_wxWindow[76], &methods_wxWindow[213], SIP_NULLPTR, SIP_NULLPTR},
    {PropertyVariable, sipName_ClientSize, &methods_wxWindow[75], &methods_wxWindow[212], SIP_NULLPTR, SIP_NULLPTR},
    {PropertyVariable, sipName_ClientAreaOrigin, &methods_wxWindow[73], SIP_NULLPTR, SIP_NULLPTR, SIP_NULLPTR},
    {PropertyVariable, sipName_Children, &methods_wxWindow[71], SIP_NULLPTR, SIP_NULLPTR, SIP_NULLPTR},
    {PropertyVariable, sipName_CharWidth, &methods_wxWindow[70], SIP_NULLPTR, SIP_NULLPTR, SIP_NULLPTR},
    {PropertyVariable, sipName_CharHeight, &methods_wxWindow[69], SIP_NULLPTR, SIP_NULLPTR, SIP_NULLPTR},
    {PropertyVariable, sipName_Caret, &methods_wxWindow[68], &methods_wxWindow[211], SIP_NULLPTR, SIP_NULLPTR},
    {PropertyVariable, sipName_Border, &methods_wxWindow[66], SIP_NULLPTR, SIP_NULLPTR, SIP_NULLPTR},
    {PropertyVariable, sipName_BestVirtualSize, &methods_wxWindow[64], SIP_NULLPTR, SIP_NULLPTR, SIP_NULLPTR},
    {PropertyVariable, sipName_BestSize, &methods_wxWindow[63], SIP_NULLPTR, SIP_NULLPTR, SIP_NULLPTR},
    {PropertyVariable, sipName_EffectiveMinSize, &methods_wxWindow[85], SIP_NULLPTR, SIP_NULLPTR, SIP_NULLPTR},
    {PropertyVariable, sipName_BackgroundStyle, &methods_wxWindow[61], &methods_wxWindow[209], SIP_NULLPTR, SIP_NULLPTR},
    {PropertyVariable, sipName_BackgroundColour, &methods_wxWindow[60], &methods_wxWindow[208], SIP_NULLPTR, SIP_NULLPTR},
    {PropertyVariable, sipName_AutoLayout, &methods_wxWindow[59], &methods_wxWindow[207], SIP_NULLPTR, SIP_NULLPTR},
    {PropertyVariable, sipName_AcceleratorTable, &methods_wxWindow[57], &methods_wxWindow[205], SIP_NULLPTR, SIP_NULLPTR},
};
