...
bool sipwxListCtrl::OnGetItemIsChecked(long item) const
{
    ...
    sipMeth = sipIsPyMethod(&sipGILState,const_cast<char *>(&sipPyMethods[0]),sipPySelf,SIP_NULLPTR,sipName_OnGetItemIsChecked);
 ...
 ::wxString sipwxListCtrl::OnGetItemText(long item,long column) const
{
    ...
    sipMeth = sipIsPyMethod(&sipGILState,const_cast<char *>(&sipPyMethods[1]),sipPySelf,SIP_NULLPTR,sipName_OnGetItemText);
...
int sipwxListCtrl::OnGetItemImage(long item) const
{
    ...
    sipMeth = sipIsPyMethod(&sipGILState,const_cast<char *>(&sipPyMethods[2]),sipPySelf,SIP_NULLPTR,sipName_OnGetItemImage);
...
int sipwxListCtrl::OnGetItemColumnImage(long item,long column) const
{
    ...
    sipMeth = sipIsPyMethod(&sipGILState,const_cast<char *>(&sipPyMethods[3]),sipPySelf,SIP_NULLPTR,sipName_OnGetItemColumnImage);
 ...
 ::wxItemAttr* sipwxListCtrl::OnGetItemAttr(long item) const
{
    ...
    sipMeth = sipIsPyMethod(&sipGILState,const_cast<char *>(&sipPyMethods[4]),sipPySelf,SIP_NULLPTR,sipName_OnGetItemAttr);
...
PyDoc_STRVAR(doc_wxListCtrl_CheckItem, "CheckItem(item, check)\n"
"\n"
...
static PyObject *meth_wxListCtrl_CheckItem(PyObject *sipSelf, PyObject *sipArgs, PyObject *sipKwds)
{
...

    {
        ...
        if (sipParseKwdArgs(&sipParseErr, sipArgs, sipKwds, sipKwdList, SIP_NULLPTR, "Blb", &sipSelf, sipType_wxListCtrl, &sipCpp, &item, &check))
        {
            PyErr_Clear();
...
extern "C" {static PyObject *meth_wxListCtrl_DoGetBorderSize(PyObject *, PyObject *);}
static PyObject *meth_wxListCtrl_DoGetBorderSize(PyObject *sipSelf, PyObject *sipArgs)
{
    PyObject *sipParseErr = SIP_NULLPTR;
    bool sipSelfWasArg = (!sipSelf || sipIsDerivedClass((sipSimpleWrapper *)sipSelf));
...
static sipEncodedTypeDef supers_wxListCtrl[] = {{93, 255, 1}};
...
static PyMethodDef methods_wxListCtrl[] = {
    ...
    {SIP_MLNAME_CAST(sipName_AddChild), SIP_MLMETH_CAST(meth_wxListCtrl_AddChild), METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxListCtrl_AddChild)},
    {SIP_MLNAME_CAST(sipName_AppendColumn), SIP_MLMETH_CAST(meth_wxListCtrl_AppendColumn), METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxListCtrl_AppendColumn)},
    {SIP_MLNAME_CAST(sipName_Arrange), SIP_MLMETH_CAST(meth_wxListCtrl_Arrange), METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxListCtrl_Arrange)},
    {SIP_MLNAME_CAST(sipName_AssignImageList), SIP_MLMETH_CAST(meth_wxListCtrl_AssignImageList), METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxListCtrl_AssignImageList)},
    {SIP_MLNAME_CAST(sipName_CheckItem), SIP_MLMETH_CAST(meth_wxListCtrl_CheckItem), METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxListCtrl_CheckItem)},
    {SIP_MLNAME_CAST(sipName_ClearAll), meth_wxListCtrl_ClearAll, METH_VARARGS, SIP_MLDOC_CAST(doc_wxListCtrl_ClearAll)},
    {SIP_MLNAME_CAST(sipName_Create), SIP_MLMETH_CAST(meth_wxListCtrl_Create), METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxListCtrl_Create)},
    {SIP_MLNAME_CAST(sipName_DeleteAllColumns), meth_wxListCtrl_DeleteAllColumns, METH_VARARGS, SIP_MLDOC_CAST(doc_wxListCtrl_DeleteAllColumns)},
    ...
    {SIP_MLNAME_CAST(sipName_DeleteColumn), SIP_MLMETH_CAST(meth_wxListCtrl_DeleteColumn), METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxListCtrl_DeleteColumn)},
    {SIP_MLNAME_CAST(sipName_DeleteItem), SIP_MLMETH_CAST(meth_wxListCtrl_DeleteItem), METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxListCtrl_DeleteItem)},
    {SIP_MLNAME_CAST(sipName_Destroy), meth_wxListCtrl_Destroy, METH_VARARGS, SIP_MLDOC_CAST(doc_wxListCtrl_Destroy)},
    {SIP_MLNAME_CAST(sipName_DoEnable), SIP_MLMETH_CAST(meth_wxListCtrl_DoEnable), METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxListCtrl_DoEnable)},
    {SIP_MLNAME_CAST(sipName_DoFreeze), meth_wxListCtrl_DoFreeze, METH_VARARGS, SIP_MLDOC_CAST(doc_wxListCtrl_DoFreeze)},
    {SIP_MLNAME_CAST(sipName_DoGetBestClientSize), meth_wxListCtrl_DoGetBestClientSize, METH_VARARGS, SIP_MLDOC_CAST(doc_wxListCtrl_DoGetBestClientSize)},
    {SIP_MLNAME_CAST(sipName_DoGetBestSize), meth_wxListCtrl_DoGetBestSize, METH_VARARGS, SIP_MLDOC_CAST(doc_wxListCtrl_DoGetBestSize)},
    {SIP_MLNAME_CAST(sipName_DoGetBorderSize), meth_wxListCtrl_DoGetBorderSize, METH_VARARGS, SIP_MLDOC_CAST(doc_wxListCtrl_DoGetBorderSize)},
    {SIP_MLNAME_CAST(sipName_DoGetClientSize), SIP_MLMETH_CAST(meth_wxListCtrl_DoGetClientSize), METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxListCtrl_DoGetClientSize)},
    {SIP_MLNAME_CAST(sipName_DoGetPosition), SIP_MLMETH_CAST(meth_wxListCtrl_DoGetPosition), METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxListCtrl_DoGetPosition)},
    {SIP_MLNAME_CAST(sipName_DoGetSize), SIP_MLMETH_CAST(meth_wxListCtrl_DoGetSize), METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxListCtrl_DoGetSize)},
    {SIP_MLNAME_CAST(sipName_DoMoveWindow), SIP_MLMETH_CAST(meth_wxListCtrl_DoMoveWindow), METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxListCtrl_DoMoveWindow)},
    {SIP_MLNAME_CAST(sipName_DoSetClientSize), SIP_MLMETH_CAST(meth_wxListCtrl_DoSetClientSize), METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxListCtrl_DoSetClientSize)},
    {SIP_MLNAME_CAST(sipName_DoSetSize), SIP_MLMETH_CAST(meth_wxListCtrl_DoSetSize), METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxListCtrl_DoSetSize)},
    {SIP_MLNAME_CAST(sipName_DoSetSizeHints), SIP_MLMETH_CAST(meth_wxListCtrl_DoSetSizeHints), METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxListCtrl_DoSetSizeHints)},
    {SIP_MLNAME_CAST(sipName_DoSetWindowVariant), SIP_MLMETH_CAST(meth_wxListCtrl_DoSetWindowVariant), METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxListCtrl_DoSetWindowVariant)},
    {SIP_MLNAME_CAST(sipName_DoThaw), meth_wxListCtrl_DoThaw, METH_VARARGS, SIP_MLDOC_CAST(doc_wxListCtrl_DoThaw)},
    {SIP_MLNAME_CAST(sipName_EditLabel), SIP_MLMETH_CAST(meth_wxListCtrl_EditLabel), METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxListCtrl_EditLabel)},
    {SIP_MLNAME_CAST(sipName_EnableAlternateRowColours), SIP_MLMETH_CAST(meth_wxListCtrl_EnableAlternateRowColours), METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxListCtrl_EnableAlternateRowColours)},
    {SIP_MLNAME_CAST(sipName_EnableBellOnNoMatch), SIP_MLMETH_CAST(meth_wxListCtrl_EnableBellOnNoMatch), METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxListCtrl_EnableBellOnNoMatch)},
    {SIP_MLNAME_CAST(sipName_EnableCheckBoxes), SIP_MLMETH_CAST(meth_wxListCtrl_EnableCheckBoxes), METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxListCtrl_EnableCheckBoxes)},
    {SIP_MLNAME_CAST(sipName_EnableSystemTheme), SIP_MLMETH_CAST(meth_wxListCtrl_EnableSystemTheme), METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxListCtrl_EnableSystemTheme)},
    {SIP_MLNAME_CAST(sipName_EnsureVisible), SIP_MLMETH_CAST(meth_wxListCtrl_EnsureVisible), METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxListCtrl_EnsureVisible)},
    {SIP_MLNAME_CAST(sipName_FindItem), SIP_MLMETH_CAST(meth_wxListCtrl_FindItem), METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxListCtrl_FindItem)},
    {SIP_MLNAME_CAST(sipName_GetAlternateRowColour), meth_wxListCtrl_GetAlternateRowColour, METH_VARARGS, SIP_MLDOC_CAST(doc_wxListCtrl_GetAlternateRowColour)},
    {SIP_MLNAME_CAST(sipName_GetClassDefaultAttributes), SIP_MLMETH_CAST(meth_wxListCtrl_GetClassDefaultAttributes), METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxListCtrl_GetClassDefaultAttributes)},
    ...
    {SIP_MLNAME_CAST(sipName_GetColumn), SIP_MLMETH_CAST(meth_wxListCtrl_GetColumn), METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxListCtrl_GetColumn)},
    ...
    {SIP_MLNAME_CAST(sipName_GetColumnIndexFromOrder), SIP_MLMETH_CAST(meth_wxListCtrl_GetColumnIndexFromOrder), METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxListCtrl_GetColumnIndexFromOrder)},
    {SIP_MLNAME_CAST(sipName_GetColumnOrder), SIP_MLMETH_CAST(meth_wxListCtrl_GetColumnOrder), METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxListCtrl_GetColumnOrder)},
    {SIP_MLNAME_CAST(sipName_GetColumnWidth), SIP_MLMETH_CAST(meth_wxListCtrl_GetColumnWidth), METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxListCtrl_GetColumnWidth)},
    ...
    {SIP_MLNAME_CAST(sipName_GetDefaultBorder), meth_wxListCtrl_GetDefaultBorder, METH_VARARGS, SIP_MLDOC_CAST(doc_wxListCtrl_GetDefaultBorder)},
    {SIP_MLNAME_CAST(sipName_GetDefaultBorderForControl), meth_wxListCtrl_GetDefaultBorderForControl, METH_VARARGS, SIP_MLDOC_CAST(doc_wxListCtrl_GetDefaultBorderForControl)},
    ...
    {SIP_MLNAME_CAST(sipName_GetImageList), SIP_MLMETH_CAST(meth_wxListCtrl_GetImageList), METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxListCtrl_GetImageList)},
    {SIP_MLNAME_CAST(sipName_GetItem), SIP_MLMETH_CAST(meth_wxListCtrl_GetItem), METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxListCtrl_GetItem)},
    {SIP_MLNAME_CAST(sipName_GetItemBackgroundColour), SIP_MLMETH_CAST(meth_wxListCtrl_GetItemBackgroundColour), METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxListCtrl_GetItemBackgroundColour)},
    ...
    {SIP_MLNAME_CAST(sipName_GetItemData), SIP_MLMETH_CAST(meth_wxListCtrl_GetItemData), METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxListCtrl_GetItemData)},
    {SIP_MLNAME_CAST(sipName_GetItemFont), SIP_MLMETH_CAST(meth_wxListCtrl_GetItemFont), METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxListCtrl_GetItemFont)},
    {SIP_MLNAME_CAST(sipName_GetItemPosition), SIP_MLMETH_CAST(meth_wxListCtrl_GetItemPosition), METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxListCtrl_GetItemPosition)},
    {SIP_MLNAME_CAST(sipName_GetItemRect), SIP_MLMETH_CAST(meth_wxListCtrl_GetItemRect), METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxListCtrl_GetItemRect)},
    ...
    {SIP_MLNAME_CAST(sipName_GetItemState), SIP_MLMETH_CAST(meth_wxListCtrl_GetItemState), METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxListCtrl_GetItemState)},
    {SIP_MLNAME_CAST(sipName_GetItemText), SIP_MLMETH_CAST(meth_wxListCtrl_GetItemText), METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxListCtrl_GetItemText)},
    {SIP_MLNAME_CAST(sipName_GetItemTextColour), SIP_MLMETH_CAST(meth_wxListCtrl_GetItemTextColour), METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxListCtrl_GetItemTextColour)},
    ...
    {SIP_MLNAME_CAST(sipName_GetNextItem), SIP_MLMETH_CAST(meth_wxListCtrl_GetNextItem), METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxListCtrl_GetNextItem)},
    ...
    {SIP_MLNAME_CAST(sipName_GetSubItemRect), SIP_MLMETH_CAST(meth_wxListCtrl_GetSubItemRect), METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxListCtrl_GetSubItemRect)},
    ...
    {SIP_MLNAME_CAST(sipName_GetValidator), meth_wxListCtrl_GetValidator, METH_VARARGS, SIP_MLDOC_CAST(doc_wxListCtrl_GetValidator)},
    {SIP_MLNAME_CAST(sipName_GetViewRect), meth_wxListCtrl_GetViewRect, METH_VARARGS, SIP_MLDOC_CAST(doc_wxListCtrl_GetViewRect)},
    {SIP_MLNAME_CAST(sipName_HasCheckBoxes), meth_wxListCtrl_HasCheckBoxes, METH_VARARGS, SIP_MLDOC_CAST(doc_wxListCtrl_HasCheckBoxes)},
    ...
    {SIP_MLNAME_CAST(sipName_HasTransparentBackground), meth_wxListCtrl_HasTransparentBackground, METH_VARARGS, SIP_MLDOC_CAST(doc_wxListCtrl_HasTransparentBackground)},
    {SIP_MLNAME_CAST(sipName_HitTest), SIP_MLMETH_CAST(meth_wxListCtrl_HitTest), METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxListCtrl_HitTest)},
    {SIP_MLNAME_CAST(sipName_HitTestSubItem), SIP_MLMETH_CAST(meth_wxListCtrl_HitTestSubItem), METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxListCtrl_HitTestSubItem)},
    ...
    {SIP_MLNAME_CAST(sipName_InformFirstDirection), SIP_MLMETH_CAST(meth_wxListCtrl_InformFirstDirection), METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxListCtrl_InformFirstDirection)},
    ...
    {SIP_MLNAME_CAST(sipName_InsertColumn), SIP_MLMETH_CAST(meth_wxListCtrl_InsertColumn), METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxListCtrl_InsertColumn)},
    {SIP_MLNAME_CAST(sipName_InsertItem), SIP_MLMETH_CAST(meth_wxListCtrl_InsertItem), METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxListCtrl_InsertItem)},
    {SIP_MLNAME_CAST(sipName_IsEmpty), meth_wxListCtrl_IsEmpty, METH_VARARGS, SIP_MLDOC_CAST(doc_wxListCtrl_IsEmpty)},
    {SIP_MLNAME_CAST(sipName_IsItemChecked), SIP_MLMETH_CAST(meth_wxListCtrl_IsItemChecked), METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxListCtrl_IsItemChecked)},
    {SIP_MLNAME_CAST(sipName_IsVirtual), meth_wxListCtrl_IsVirtual, METH_VARARGS, SIP_MLDOC_CAST(doc_wxListCtrl_IsVirtual)},
    {SIP_MLNAME_CAST(sipName_IsVisible), SIP_MLMETH_CAST(meth_wxListCtrl_IsVisible), METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxListCtrl_IsVisible)},
    {SIP_MLNAME_CAST(sipName_OnGetItemAttr), SIP_MLMETH_CAST(meth_wxListCtrl_OnGetItemAttr), METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxListCtrl_OnGetItemAttr)},
    {SIP_MLNAME_CAST(sipName_OnGetItemColumnImage), SIP_MLMETH_CAST(meth_wxListCtrl_OnGetItemColumnImage), METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxListCtrl_OnGetItemColumnImage)},
    {SIP_MLNAME_CAST(sipName_OnGetItemImage), SIP_MLMETH_CAST(meth_wxListCtrl_OnGetItemImage), METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxListCtrl_OnGetItemImage)},
    {SIP_MLNAME_CAST(sipName_OnGetItemIsChecked), SIP_MLMETH_CAST(meth_wxListCtrl_OnGetItemIsChecked), METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxListCtrl_OnGetItemIsChecked)},
    {SIP_MLNAME_CAST(sipName_OnGetItemText), SIP_MLMETH_CAST(meth_wxListCtrl_OnGetItemText), METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxListCtrl_OnGetItemText)},
    ...
    {SIP_MLNAME_CAST(sipName_ProcessEvent), SIP_MLMETH_CAST(meth_wxListCtrl_ProcessEvent), METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxListCtrl_ProcessEvent)},
    {SIP_MLNAME_CAST(sipName_RefreshItem), SIP_MLMETH_CAST(meth_wxListCtrl_RefreshItem), METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxListCtrl_RefreshItem)},
    {SIP_MLNAME_CAST(sipName_RefreshItems), SIP_MLMETH_CAST(meth_wxListCtrl_RefreshItems), METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxListCtrl_RefreshItems)},
    {SIP_MLNAME_CAST(sipName_RemoveChild), SIP_MLMETH_CAST(meth_wxListCtrl_RemoveChild), METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxListCtrl_RemoveChild)},
    {SIP_MLNAME_CAST(sipName_ScrollList), SIP_MLMETH_CAST(meth_wxListCtrl_ScrollList), METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxListCtrl_ScrollList)},
    {SIP_MLNAME_CAST(sipName_SendDestroyEvent), meth_wxListCtrl_SendDestroyEvent, METH_VARARGS, SIP_NULLPTR},
    {SIP_MLNAME_CAST(sipName_SetAlternateRowColour), SIP_MLMETH_CAST(meth_wxListCtrl_SetAlternateRowColour), METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxListCtrl_SetAlternateRowColour)},
    {SIP_MLNAME_CAST(sipName_SetBackgroundColour), SIP_MLMETH_CAST(meth_wxListCtrl_SetBackgroundColour), METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxListCtrl_SetBackgroundColour)},
    {SIP_MLNAME_CAST(sipName_SetCanFocus), SIP_MLMETH_CAST(meth_wxListCtrl_SetCanFocus), METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxListCtrl_SetCanFocus)},
    {SIP_MLNAME_CAST(sipName_SetColumn), SIP_MLMETH_CAST(meth_wxListCtrl_SetColumn), METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxListCtrl_SetColumn)},
    {SIP_MLNAME_CAST(sipName_SetColumnWidth), SIP_MLMETH_CAST(meth_wxListCtrl_SetColumnWidth), METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxListCtrl_SetColumnWidth)},
    {SIP_MLNAME_CAST(sipName_SetColumnsOrder), SIP_MLMETH_CAST(meth_wxListCtrl_SetColumnsOrder), METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxListCtrl_SetColumnsOrder)},
    {SIP_MLNAME_CAST(sipName_SetHeaderAttr), SIP_MLMETH_CAST(meth_wxListCtrl_SetHeaderAttr), METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxListCtrl_SetHeaderAttr)},
    {SIP_MLNAME_CAST(sipName_SetImageList), SIP_MLMETH_CAST(meth_wxListCtrl_SetImageList), METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxListCtrl_SetImageList)},
    {SIP_MLNAME_CAST(sipName_SetItem), SIP_MLMETH_CAST(meth_wxListCtrl_SetItem), METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxListCtrl_SetItem)},
    {SIP_MLNAME_CAST(sipName_SetItemBackgroundColour), SIP_MLMETH_CAST(meth_wxListCtrl_SetItemBackgroundColour), METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxListCtrl_SetItemBackgroundColour)},
    {SIP_MLNAME_CAST(sipName_SetItemColumnImage), SIP_MLMETH_CAST(meth_wxListCtrl_SetItemColumnImage), METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxListCtrl_SetItemColumnImage)},
    {SIP_MLNAME_CAST(sipName_SetItemCount), SIP_MLMETH_CAST(meth_wxListCtrl_SetItemCount), METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxListCtrl_SetItemCount)},
    {SIP_MLNAME_CAST(sipName_SetItemData), SIP_MLMETH_CAST(meth_wxListCtrl_SetItemData), METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxListCtrl_SetItemData)},
    {SIP_MLNAME_CAST(sipName_SetItemFont), SIP_MLMETH_CAST(meth_wxListCtrl_SetItemFont), METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxListCtrl_SetItemFont)},
    {SIP_MLNAME_CAST(sipName_SetItemImage), SIP_MLMETH_CAST(meth_wxListCtrl_SetItemImage), METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxListCtrl_SetItemImage)},
    {SIP_MLNAME_CAST(sipName_SetItemPosition), SIP_MLMETH_CAST(meth_wxListCtrl_SetItemPosition), METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxListCtrl_SetItemPosition)},
    {SIP_MLNAME_CAST(sipName_SetItemState), SIP_MLMETH_CAST(meth_wxListCtrl_SetItemState), METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxListCtrl_SetItemState)},
    {SIP_MLNAME_CAST(sipName_SetItemText), SIP_MLMETH_CAST(meth_wxListCtrl_SetItemText), METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxListCtrl_SetItemText)},
    {SIP_MLNAME_CAST(sipName_SetItemTextColour), SIP_MLMETH_CAST(meth_wxListCtrl_SetItemTextColour), METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxListCtrl_SetItemTextColour)},
    {SIP_MLNAME_CAST(sipName_SetSingleStyle), SIP_MLMETH_CAST(meth_wxListCtrl_SetSingleStyle), METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxListCtrl_SetSingleStyle)},
    {SIP_MLNAME_CAST(sipName_SetTextColour), SIP_MLMETH_CAST(meth_wxListCtrl_SetTextColour), METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxListCtrl_SetTextColour)},
    {SIP_MLNAME_CAST(sipName_SetValidator), SIP_MLMETH_CAST(meth_wxListCtrl_SetValidator), METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxListCtrl_SetValidator)},
    {SIP_MLNAME_CAST(sipName_SetWindowStyleFlag), SIP_MLMETH_CAST(meth_wxListCtrl_SetWindowStyleFlag), METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxListCtrl_SetWindowStyleFlag)},
    ...
    {SIP_MLNAME_CAST(sipName_SortItems), SIP_MLMETH_CAST(meth_wxListCtrl_SortItems), METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxListCtrl_SortItems)},
    ...
    {SIP_MLNAME_CAST(sipName_TryAfter), SIP_MLMETH_CAST(meth_wxListCtrl_TryAfter), METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxListCtrl_TryAfter)},
    {SIP_MLNAME_CAST(sipName_TryBefore), SIP_MLMETH_CAST(meth_wxListCtrl_TryBefore), METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxListCtrl_TryBefore)},
...
sipVariableDef variables_wxListCtrl[] = {
    {PropertyVariable, sipName_ViewRect, &methods_wxListCtrl[69], SIP_NULLPTR, SIP_NULLPTR, SIP_NULLPTR},
    {PropertyVariable, sipName_TopItem, &methods_wxListCtrl[67], SIP_NULLPTR, SIP_NULLPTR, SIP_NULLPTR},
    {PropertyVariable, sipName_TextColour, &methods_wxListCtrl[66], &methods_wxListCtrl[117], SIP_NULLPTR, SIP_NULLPTR},
    {PropertyVariable, sipName_SelectedItemCount, &methods_wxListCtrl[64], SIP_NULLPTR, SIP_NULLPTR, SIP_NULLPTR},
    {PropertyVariable, sipName_MainWindow, &methods_wxListCtrl[61], SIP_NULLPTR, SIP_NULLPTR, SIP_NULLPTR},
    {PropertyVariable, sipName_ItemSpacing, &methods_wxListCtrl[57], SIP_NULLPTR, SIP_NULLPTR, SIP_NULLPTR},
    {PropertyVariable, sipName_ItemRect, &methods_wxListCtrl[56], SIP_NULLPTR, SIP_NULLPTR, SIP_NULLPTR},
    {PropertyVariable, sipName_ItemPosition, &methods_wxListCtrl[55], &methods_wxListCtrl[112], SIP_NULLPTR, SIP_NULLPTR},
    {PropertyVariable, sipName_ItemCount, &methods_wxListCtrl[52], &methods_wxListCtrl[108], SIP_NULLPTR, SIP_NULLPTR},
    {PropertyVariable, sipName_Item, &methods_wxListCtrl[50], &methods_wxListCtrl[105], SIP_NULLPTR, SIP_NULLPTR},
    {PropertyVariable, sipName_EditControl, &methods_wxListCtrl[48], SIP_NULLPTR, SIP_NULLPTR, SIP_NULLPTR},
    {PropertyVariable, sipName_CountPerPage, &methods_wxListCtrl[45], SIP_NULLPTR, SIP_NULLPTR, SIP_NULLPTR},
    {PropertyVariable, sipName_ColumnsOrder, &methods_wxListCtrl[44], &methods_wxListCtrl[102], SIP_NULLPTR, SIP_NULLPTR},
    {PropertyVariable, sipName_ColumnCount, &methods_wxListCtrl[40], SIP_NULLPTR, SIP_NULLPTR, SIP_NULLPTR},
    {PropertyVariable, sipName_Column, &methods_wxListCtrl[39], &methods_wxListCtrl[100], SIP_NULLPTR, SIP_NULLPTR},
    {PropertyVariable, sipName_AlternateRowColour, &methods_wxListCtrl[36], &methods_wxListCtrl[97], SIP_NULLPTR, SIP_NULLPTR},
};
...
sipClassTypeDef sipTypeDef__core_wxListCtrl = {
    ...
    },
    {
        sipNameNr_ListCtrl,
        {0, 0, 1},
        127, methods_wxListCtrl,
        0, SIP_NULLPTR,
        16, variables_wxListCtrl,
